...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Merged {
     ...
     * QUQI_MT020002AB.AuthorRole: Null Author Role <p>This is a 
     * messaging artifact used by HL7 to allow the time, signiture 
     * and method to be captured when the author is not sent. This 
     * will happen in circumstances where the author information is 
     * sent as part of the authentication token.</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"MCAI_MT700211CA.AuthorRole","QUQI_MT020000AB.AuthorRole","QUQI_MT020002AB.AuthorRole"})]
    public class NullAuthorRole : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Merged.IAuthorPerson {
