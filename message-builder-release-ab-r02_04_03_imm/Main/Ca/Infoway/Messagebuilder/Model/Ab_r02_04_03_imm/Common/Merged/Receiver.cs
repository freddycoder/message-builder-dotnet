...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Merged {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"MCCI_MT002100CA.Receiver","MCCI_MT002300CA.Receiver"})]
    public class Receiver : MessagePartBean {
         ...
         * Relationship: MCCI_MT002300CA.Device2.name 
         * Conformance/Cardinality: OPTIONAL (0-1) <p>Optional 
         * application name.</p> <p>Optional name of receiver 
         ...
         * application.</p> <p>Name of the receiver application.</p></remarks>
         */
         ...
         * <p>Unique identifier for the receiver organization.</p></remarks>
         */
