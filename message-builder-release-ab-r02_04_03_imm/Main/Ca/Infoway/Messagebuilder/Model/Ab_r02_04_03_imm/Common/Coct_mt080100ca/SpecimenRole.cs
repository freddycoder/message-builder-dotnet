...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt080100ca {
    ...
    public class SpecimenRole : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt080100ca.OtherSpecimenIdentifications> specimenMaterialAsIdentifiedEntity;
        private CV specimenMaterialAsContentContainerRiskCode;
        private IList<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt080100ca.SpecimenProcessSteps> subjectOfTransportationEvent;
        private Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt080100ca.SpecimenCollectionProcedure productOfSpecimenCollectionProcedureEvent;

        public SpecimenRole() {
            this.id = new IIImpl();
            this.specimenMaterialCode = new CDImpl();
            this.specimenMaterialDesc = new STImpl();
            this.specimenMaterialAsIdentifiedEntity = new List<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt080100ca.OtherSpecimenIdentifications>();
            this.specimenMaterialAsContentContainerRiskCode = new CVImpl();
            this.subjectOfTransportationEvent = new List<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt080100ca.SpecimenProcessSteps>();
        }
        /**
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt080100ca.OtherSpecimenIdentifications> SpecimenMaterialAsIdentifiedEntity {
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt080100ca.SpecimenProcessSteps> SubjectOfTransportationEvent {
        ...
        public Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt080100ca.SpecimenCollectionProcedure ProductOfSpecimenCollectionProcedureEvent {
