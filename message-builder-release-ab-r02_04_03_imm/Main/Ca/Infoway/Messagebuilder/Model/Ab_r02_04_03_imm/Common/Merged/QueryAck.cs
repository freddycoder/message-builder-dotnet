...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Merged {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"QUQI_MT120006AB.QueryAck","QUQI_MT120008AB.QueryAck"})]
    public class QueryAck : MessagePartBean {
         ...
         * Relationship: QUQI_MT120008AB.QueryAck.queryId 
         ...
         * QUQI_MT120006AB.QueryAck.queryId Conformance/Cardinality: 
         ...
         * queued.</p> <p>Identifies the query being acknowledged</p></remarks>
         */
         ...
         * QUQI_MT120008AB.QueryAck.queryResponseCode 
         ...
         * Relationship: QUQI_MT120008AB.QueryAck.resultTotalQuantity 
         ...
         * QUQI_MT120008AB.QueryAck.resultCurrentQuantity 
         ...
         * Relationship: 
         * QUQI_MT120008AB.QueryAck.resultRemainingQuantity 
