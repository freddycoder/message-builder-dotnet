...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Merged {
     ...
     * 
     * <remarks>QUQI_MT120006AB.Subject2: f:refers to <p>Provides 
     ...
     * QUQI_MT120008AB.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"MCAI_MT700211CA.Subject2","MCAI_MT700227CA.Subject2","QUQI_MT120006AB.Subject2","QUQI_MT120008AB.Subject2"})]
    public class RefersTo<ACT> : MessagePartBean {
         ...
         * CascadeResponsibilityIndicator Relationship: 
         * QUQI_MT120008AB.Subject2.contextConductionInd 
         * Conformance/Cardinality: MANDATORY (1) <p>Cascading of 
         * trigger event objects allows different messages to employ 
         * consistent and common objects.</p><p>Attribute is mandatory 
         * to ensure that cascading will be specified one way or 
         ...
         * CascadeResponsibilityIndicator Relationship: 
         * MCAI_MT700227CA.Subject2.contextConductionInd 
         * Conformance/Cardinality: MANDATORY (1) <p>Cascading of 
         * trigger event objects allows different messages to employ 
         * consistent and common objects.</p><p>Attribute is mandatory 
         * to ensure that cascading will be specified one way or 
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: QUQI_MT120006AB.Subject2.act 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * QUQI_MT120008AB.Subject2.act Conformance/Cardinality: 
