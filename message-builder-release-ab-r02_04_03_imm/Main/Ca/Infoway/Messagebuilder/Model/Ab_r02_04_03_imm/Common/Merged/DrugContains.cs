...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Merged {
     ...
     * 
     * <remarks>COCT_MT220100CA.Ingredient: drug contains <p>Useful 
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT220100CA.Ingredient","COCT_MT220110CA.Ingredient","COCT_MT220200CA.Ingredient","COCT_MT220210CA.Ingredient"})]
    public class DrugContains : MessagePartBean {

        private BL negationInd;
        private PQ quantity;
        private CV ingredientSubstanceCode;
        private ST ingredientSubstanceName;
        ...
        /**
         * <summary>Business Name: DrugDoesNotContainIndicator</summary>
         * 
        ...
        /**
         * <summary>Business Name: DrugIngredientQuantity</summary>
         * 
         * <remarks>Un-merged Business Name: DrugIngredientQuantity 
         ...
         */
        [Hl7XmlMappingAttribute(new string[] {"ingredientSubstance/code"})]
        public ActiveIngredientDrugEntityType IngredientSubstanceCode {
            get { return (ActiveIngredientDrugEntityType) this.ingredientSubstanceCode.Value; }
            set { this.ingredientSubstanceCode.Value = value; }
        }

        /**
         * <summary>Business Name: DrugIngredientName</summary>
         * 
         * <remarks>Un-merged Business Name: DrugIngredientName 
         * Relationship: COCT_MT220100CA.Substance.name 
         * Conformance/Cardinality: REQUIRED (0-1) 
         ...
         * chemical.</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"ingredientSubstance/name"})]
        public String IngredientSubstanceName {
            get { return this.ingredientSubstanceName.Value; }
            set { this.ingredientSubstanceName.Value = value; }
        }
