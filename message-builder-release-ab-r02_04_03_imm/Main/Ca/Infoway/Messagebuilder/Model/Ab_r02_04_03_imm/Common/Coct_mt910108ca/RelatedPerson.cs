...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt910108ca {
    ...
    public class RelatedPerson : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Common.Coct_mt911108ca.IActingPerson {
         ...
         * dispenses.</p><p>[UseCommon CWE]</p> <p>EPHS:this cmet is 
         * used for self-reports as well as reports by other related 
         * parties</p> <p>A coded value indicating how the person is 
         ...
         * address(s) by which a related person may be contacted as 
         * known by the client registry.</p></remarks>
         */
