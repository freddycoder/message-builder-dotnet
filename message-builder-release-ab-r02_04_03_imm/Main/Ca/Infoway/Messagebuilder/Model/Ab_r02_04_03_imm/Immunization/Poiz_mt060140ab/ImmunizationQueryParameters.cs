...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Immunization.Poiz_mt060140ab {
     ...
     * response.</p>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"POIZ_MT060140AB.ParameterList"})]
    public class ImmunizationQueryParameters : MessagePartBean {
         ...
         * POIZ_MT060140AB.ImmunizationEventID.value 
