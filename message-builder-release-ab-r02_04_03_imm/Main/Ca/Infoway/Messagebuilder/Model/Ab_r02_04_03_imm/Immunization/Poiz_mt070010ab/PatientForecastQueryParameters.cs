...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Immunization.Poiz_mt070010ab {
     ...
     * response.</p>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"POIZ_MT070010AB.ParameterList"})]
    public class PatientForecastQueryParameters : MessagePartBean {
         ...
         * POIZ_MT070010AB.PatientBirthDate.value 
         ...
         * 
         * <remarks>Relationship: POIZ_MT070010AB.PatientGender.value 
         ...
         * 
         * <remarks>Relationship: POIZ_MT070010AB.PatientID.value 
         ...
         * 
         * <remarks>Relationship: POIZ_MT070010AB.PatientName.value 
