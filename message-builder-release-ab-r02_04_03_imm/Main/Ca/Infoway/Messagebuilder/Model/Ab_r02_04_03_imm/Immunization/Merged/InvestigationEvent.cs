...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Immunization.Merged {
     ...
     * 
     * <remarks>POIZ_MT030050AB.InvestigationEvent: Investigation 
     ...
     * POIZ_MT061150AB.InvestigationEvent: Investigation Event 
     ...
     * event.</p> POIZ_MT060150AB.InvestigationEvent: Investigation 
     * Event <p>Provides additional information about the 
     * immunization event by indicating an adverse event is 
     * associated and also provides a mechanism for communicating 
     * information about the report that was filed.</p> <p>Provides 
     * information about an adverse event report associated with 
     * the immunization event.</p> 
     * POIZ_MT030060AB.InvestigationEvent: Investigation Event 
     * <p>Provides additional information about the immunization 
     * event by indicating an adverse event is associated and also 
     * provides a mechanism for communicating information about the 
     * report that was filed.</p> <p>Provides information about an 
     ...
     * event.</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"POIZ_MT030050AB.InvestigationEvent","POIZ_MT030060AB.InvestigationEvent","POIZ_MT060150AB.InvestigationEvent","POIZ_MT061150AB.InvestigationEvent"})]
    public class InvestigationEvent : MessagePartBean {
         ...
         * Relationship: POIZ_MT030050AB.InvestigationEvent.id 
         * Conformance/Cardinality: REQUIRED (1) <p>Provides refeence 
         * to the Adverse Event Report in the case that follow up is 
         * needed. However, this ID may not alwasy be known.</p> 
         * <p>Identifier associated with the Adverse Event Report.</p> 
         * Un-merged Business Name: AdverseEventReportID Relationship: 
         * POIZ_MT060150AB.InvestigationEvent.id 
         * Conformance/Cardinality: REQUIRED (1) <p>Provides reference 
         * to the Adverse Event Report in the case that follow up is 
         * needed. However, this ID may not always be known.</p> 
         * <p>Identifier associated with the Adverse Event Report.</p> 
         * Un-merged Business Name: AdverseEventReportID Relationship: 
         * POIZ_MT061150AB.InvestigationEvent.id 
         * Conformance/Cardinality: REQUIRED (1) <p>Provides reference 
         * to the Adverse Event Report in the case that follow up is 
         * needed. However, this ID may not always be known.</p> 
         * <p>Identifier associated with the Adverse Event Report.</p> 
         * Un-merged Business Name: AdverseEventReportID Relationship: 
         * POIZ_MT030060AB.InvestigationEvent.id 
         * Conformance/Cardinality: REQUIRED (1) <p>Provides reference 
         * to the Adverse Event Report in the case that follow up is 
         * needed. However, this ID may not always be known.</p></remarks>
         */
         ...
         * POIZ_MT030050AB.InvestigationEvent.code 
         ...
         * POIZ_MT060150AB.InvestigationEvent.code 
         * Conformance/Cardinality: MANDATORY (1) <p>Provides a 
         * mechanism to categorizing the report.</p> <p>A coded value 
         * that indicates the type of report that was filed.</p> 
         * Un-merged Business Name: ReportType Relationship: 
         * POIZ_MT061150AB.InvestigationEvent.code 
         * Conformance/Cardinality: MANDATORY (1) <p>Provides a 
         * mechanism to categorizing the report.</p> <p>A coded value 
         * that indicates the type of report that was filed.</p> 
         * Un-merged Business Name: ReportType Relationship: 
         * POIZ_MT030060AB.InvestigationEvent.code 
         * Conformance/Cardinality: MANDATORY (1) <p>Provides a 
         * mechanism to categorizing the report.</p> <p>A coded value 
        ...
        /**
         * <summary>Un-merged Business Name: AdverseEventText</summary>
         * 
         * <remarks>Relationship: 
         * POIZ_MT030050AB.InvestigationEvent.text 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Provide 
         ...
         * Un-merged Business Name: AdverseEventReportText 
         * Relationship: POIZ_MT060150AB.InvestigationEvent.text 
         ...
         * the Adverse Event Following Immunization reported.</p> 
         * Un-merged Business Name: AdverseEventReportText 
         * Relationship: POIZ_MT061150AB.InvestigationEvent.text 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Provides 
         * information about the adverse event in addition to an 
         * indication that an adverse event occurred - information that 
         * would not otherwise be known.</p> <p>Textual description of 
         * the Adverse Event Following Immunization reported.</p> 
         * Un-merged Business Name: AdverseEventReportText 
         * Relationship: POIZ_MT030060AB.InvestigationEvent.text 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Provides 
         * information about the adverse event in addition to an 
         * indication that an adverse event occurred - information that 
         * would not otherwise be known.</p> <p>Textual description of 
         ...
         * POIZ_MT030050AB.InvestigationEvent.statusCode 
         ...
         * POIZ_MT060150AB.InvestigationEvent.statusCode 
         * Conformance/Cardinality: MANDATORY (1) <p>Provides 
         * additional context to the receiver as to the state of the 
         * referenced report. As a result, this attribute is 
         * mandatory.</p> <p>Code indicating the operative status of 
         ...
         * Report. Status examples: active, completed, etc.</p> 
         * Un-merged Business Name: ReportStatus Relationship: 
         * POIZ_MT061150AB.InvestigationEvent.statusCode 
         * Conformance/Cardinality: MANDATORY (1) <p>Provides 
         * additional context to the receiver as to the state of the 
         * referenced report. As a result, this attribute is 
         * mandatory.</p> <p>Code indicating the operative status of 
         ...
         * Report. Status examples: active, completed, etc.</p> 
         * Un-merged Business Name: ReportStatus Relationship: 
         * POIZ_MT030060AB.InvestigationEvent.statusCode 
         * Conformance/Cardinality: MANDATORY (1) <p>Provides 
         * additional context to the receiver as to the state of the 
         * referenced report. As a result, this attribute is 
         * mandatory.</p> <p>Code indicating the operative status of 
