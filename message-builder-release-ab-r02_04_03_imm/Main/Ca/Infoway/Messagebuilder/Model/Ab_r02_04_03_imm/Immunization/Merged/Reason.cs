...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Immunization.Merged {
    ...
    /**
     * <summary>POIZ_MT030060AB.Reason: (no business name)</summary>
     * 
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"POIZ_MT030050AB.Reason","POIZ_MT030060AB.Reason","POIZ_MT060150AB.Reason"})]
    public class Reason : MessagePartBean {

        private Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Immunization.Merged.IChoice choice;
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: POIZ_MT030060AB.Reason.choice 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * POIZ_MT060150AB.Reason.choice Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: POIZ_MT030050AB.Reason.choice 
         * Conformance/Cardinality: REQUIRED (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"choice"})]
        public Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_imm.Immunization.Merged.IChoice Choice {
