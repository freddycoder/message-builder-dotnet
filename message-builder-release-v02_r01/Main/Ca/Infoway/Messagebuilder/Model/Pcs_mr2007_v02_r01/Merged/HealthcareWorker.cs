...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Merged {
    ...
    public class HealthcareWorker : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged.IParty, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Merged.IRecipient, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Pharmacy.Merged.IChangedBy, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Common.Coct_mt911108ca.IActingPerson, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Common.Merged.IActingPerson {
         ...
         * use the recommended dose and is therefore mandatory</p> 
         * C:Knowledgebase Vendor Name <p>The name of a clinical 
         * knowledgebase vendor organization.</p> <p>Allows a 
         ...
         * knowledgebase vendor to be referenced by name.</p><p>The 
         * attribute is mandatory because it is the only information 
         * collected about a knowledgebase vendor.</p> H: Organization 
         * Name <p>Identifies the name of the organization</p> 
         * <p>Allows for human recognition of the organization as well 
         * as confirmation of the identifier. As a result, the 
         * attribute is mandatory.</p> E: Organization Name 
         ...
         * is mandatory.</p> Formulary Owner Name <p>The name of the 
         * organization or facility responsible for the formulary.</p> 
         * <p>Helps identify the circumstances in which the formulary 
         * applies.</p> D:Medication Document Author Name <p>The name 
         * of the organization responsible for creating the medication 
