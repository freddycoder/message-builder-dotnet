...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Merged {
     ...
     * PORR_MT050016CA.Author: Monograph Source <p>Provides a means 
     * of evaluating accuracy of the content of the monograph.</p> 
     * <p>Expresses who is responsible for the content of the 
     * monograph</p> PORX_MT060160CA.Author5: *refused by <p>Allows 
     * follow-up and traceability of the refusal.</p><p>Association 
     * is mandatory as the provider refusing the fill must be 
     * known.</p> <p>Indicates who refused to fulfill the 
     * prescription</p> PORX_MT020070CA.Author: bc:prescribed by 
     * <p>Used to create an 'inferred' prescription if an 
     * electronic prescription does not already exist in the 
     * EHR.</p> <p>The person who prescribed the medication.</p> 
     ...
     * active medication&quot;.</p> PORX_MT060190CA.Author3: 
     ...
     * POME_MT010040CA.Author: Monograph Source 
     * <p>ZPC1.1(organization.ID)</p> <p>ZPD2.1</p> <p>Provides a 
     * means of evaluating accuracy of the content of the 
     * monograph.</p> <p>Expresses who is responsible for the 
     * content of the monograph</p> PORX_MT030040CA.Author: 
     * *refused by <p>Allows follow-up and traceability of the 
     * refusal and is therefore mandatory.</p> <p>Indicates who 
     * refused to fulfill the prescription</p> 
    ...
    public class RefusedBy : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * POME_MT010040CA.Author.assignedEntity 
         * Conformance/Cardinality: POPULATED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         ...
         * POPULATED (1) <p>Identifies timing of allergy/intolerance 
