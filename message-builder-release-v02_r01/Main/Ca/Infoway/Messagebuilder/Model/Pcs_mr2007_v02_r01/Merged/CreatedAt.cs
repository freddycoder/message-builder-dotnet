...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Merged {
     ...
     * the event occurred.</p> COMT_MT300003CA.Location: 
     ...
     * MCAI_MT700211CA.Location: *a1:created at <p>Indicates where 
     ...
     * occurred.</p> PORX_MT060060CA.Location2: *c:targeted to 
     ...
     * prescription has been directed or which has currently 
     * assumed responsibility for dispensing the prescription.</p> 
     * MCAI_MT700222CA.Location: *a1:created at <p>Indicates where 
     * paper records may be located, and may be important to 
     * determining authorization.</p><p>The association is optional 
     * because in some jurisdictions this information will be 
     * conveyed as part of the authentication token.</p> 
     * <p>Indicates the service delivery location where the event 
     * occurred.</p> MCAI_MT700212CA.Location: *a1:created at 
     * <p>Indicates where paper records may be located, and may be 
     * important to determining authorization.</p><p>The 
     * association is optional because in some jurisdictions this 
     * information will be conveyed as part of the authentication 
     * token.</p> <p>Indicates the service delivery location where 
     * the event occurred.</p> COCT_MT260020CA.Location: 
     * *b:dispensed at <p>A_DetectedMedicationIssue</p> <p>Used for 
     * contacting the pharmacy or pharmacist involved in the 
     * dispense.</p><p>The association is only marked as 
     * 'populated' because it may be masked.</p> <p>Indicates the 
     * facility where the implicated dispense event was 
     * performed</p> MCAI_MT700220CA.Location: *a1:created at 
     * <p>Indicates where paper records may be located, and may be 
     * important to determining authorization.</p><p>The 
     * association is optional because in some jurisdictions this 
     * information will be conveyed as part of the authentication 
     * token.</p> <p>Indicates the service delivery location where 
     * the event occurred.</p> PORX_MT060340CA.Location: 
     ...
     * performed.</p> MCAI_MT700231CA.Location: *a1:created at 
     * <p>Indicates where paper records may be located, and may be 
     * important to determining authorization.</p><p>The 
     * association is optional because in some jurisdictions this 
     * information will be conveyed as part of the authentication 
     * token.</p> <p>Indicates the service delivery location where 
     * the event occurred.</p> MCAI_MT700221CA.Location: 
     ...
     * delivery location where the event occurred.</p> 
     * REPC_MT000009CA.Location: *i:recorded at <p>Indicates where 
     ...
     * QUQI_MT020002CA.Location: *a1:created at <p>Indicates where 
     * paper records may be located, and may be important to 
     * determining authorization.</p><p>The association is optional 
     * because in some jurisdictions this information will be 
     * conveyed as part of the authentication token.</p> 
     * <p>Indicates the service delivery location where the event 
     * occurred.</p> PORX_MT060160CA.Location: *d:dispensed from 
     ...
     * prescription has been directed or which has currently 
     * assumed responsibility for dispensing the prescription.</p> 
     * MCAI_MT700232CA.Location: *a1:created at <p>Indicates where 
     * paper records may be located, and may be important to 
     * determining authorization.</p><p>The association is optional 
     * because in some jurisdictions this information will be 
     * conveyed as part of the authentication token.</p> 
     * <p>Indicates the service delivery location where the event 
     * occurred.</p> PORX_MT060020CA.Location: *dispensed from 
     * <p>Used for follow-up communication on the dispensed 
     * product, and therefore mandatory.</p> <p>Identification of 
     * the service delivery location where the device was 
     * dispensed.</p> PORX_MT060210CA.Location2: *c:recorded at 
     * <p>Important for performing follow-up and is therefore 
     * mandatory.</p> <p>Indicates the facility/location where the 
     * other medication was recorded.</p> 
     * PORX_MT010110CA.Location2: *c:targeted to pharmacy <p>Allows 
     * prescriptions to be directed on the request of the patient 
     * or by legal requirement. Also allows indication of which 
     * pharmacy is the current 'custodian' of the 
     * prescription.</p><p>This should always be known or should 
     ...
     * records are likely kept for follow-
