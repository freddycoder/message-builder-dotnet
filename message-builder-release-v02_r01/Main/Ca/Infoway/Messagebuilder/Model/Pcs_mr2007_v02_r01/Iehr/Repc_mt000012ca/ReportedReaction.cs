...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Repc_mt000012ca {
     ...
     * must be fixed to DX if not using SNOMED</p> <p>Useful in 
     ...
     * using the drug or combination of drugs.</p> <p>This is a 
     * record of an adverse reaction considered relevant to the 
     * patient's clinical record.</p>
     */
    ...
    public class ReportedReaction : MessagePartBean {
        ...
        private CV value;
        private TS informantTime;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Merged.AllergyIntoleranceSeverityLevel subjectOf1SeverityObservation;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged.ReportedReactions> subjectOf2CausalityAssessment;
        ...
        public ReportedReaction() {
            ...
            this.informantTime = new TSImpl();
            this.subjectOf2CausalityAssessment = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged.ReportedReactions>();
        }
        /**
        ...
        /**
         * <summary>Business Name: Reported date</summary>
         * 
         * <remarks>Relationship: REPC_MT000012CA.Informant.time 
         ...
         * reported.</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"informant/time"})]
        public PlatformDate InformantTime {
            get { return this.informantTime.Value; }
            set { this.informantTime.Value = value; }
        }
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Merged.AllergyIntoleranceSeverityLevel SubjectOf1SeverityObservation {
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged.ReportedReactions> SubjectOf2CausalityAssessment {
