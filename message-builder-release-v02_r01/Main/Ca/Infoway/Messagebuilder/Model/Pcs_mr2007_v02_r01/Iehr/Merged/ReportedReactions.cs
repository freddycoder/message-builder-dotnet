...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged {
     ...
     * Otherise code must be RXNASSESS and value must be 
     * RELATED</p> <p>This is a recording of the exposures and 
    ...
    public class ReportedReactions : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged.IRecords {
         ...
         * fixed value of 'DX'.</p> Assessment Type <p>Indicates the 
         ...
         * RXNASSESS.</p> Assessment Type <p>Indicates the type of 
         ...
         * the exposure.</p> <p>Creates the link between the exposure 
         * and the reaction. Because the details of the assessment will 
         * be communicated in the 'code' attribute for SNOMED, this 
