...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged {
     ...
     * Assessments <p>Value is mandatory if not using SNOMED</p> 
     ...
     * must be fixed to DX if not using SNOMED</p> <p>Helps 
     * providers to distinguish between proper allergies and 
     * intolerances. Allows the provider recording the allergy to 
     * assign appropriate severity to the allergy. May give insight 
     * on how to mitigate an intolerance that is likely to be 
     ...
     * one of Id or Value must be specified.</p> 
     * REPC_MT000009CA.ObservationEvent: (no business name) 
     * <p>Value must not be present when using SNOMED, mandatory 
     * otherwise</p> REPC_MT000013CA.ObservationEvent: (no business 
     * name) <p>If code is SNOMED, value is not permitted, 
     * otherwise it is mandatory and code must be DX</p>
     */
    ...
    public class ReportedReactions : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged.IRecords {

        private CD code;
        private CV value;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged.Exposures startsAfterStartOfExposureEvent;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged.ReportedReactions subjectObservationEvent;
        private II id;
        private BL negationInd;
        private ST text;
        private IVL<TS, Interval<PlatformDate>> effectiveTime;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Merged.AllergyIntoleranceSeverityLevel subjectOfSeverityObservation;
         ...
         * it should have a fixed value of &quot;RELATED&quot;.</p> 
         * <p>Indicates whether the reaction is deemed to be related to 
         * the exposure.</p> Un-merged Business Name: Reaction 
         ...
         * experienced by the patient.</p> Un-merged Business Name: 
         * RelatednessAssessment Relationship: 
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged.Exposures StartsAfterStartOfExposureEvent {
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Iehr.Merged.ReportedReactions SubjectObservationEvent {
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Merged.AllergyIntoleranceSeverityLevel SubjectOfSeverityObservation {
