...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca {
    ...
    public class InvoiceIdentifier : MessagePartBean {
        ...
        private MO amt;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca.AdministrativeContactsS primaryPerformerContactParty;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca.TaxAccountOfProvider> pertinentInformationProviderBillingTaxAccount;
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca.IInvoiceElementChoice> reasonOfInvoiceElementChoice;

        public InvoiceIdentifier() {
            this.id = new SETImpl<II, Identifier>(typeof(IIImpl));
            this.amt = new MOImpl();
            this.pertinentInformationProviderBillingTaxAccount = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca.TaxAccountOfProvider>();
            this.reasonOfInvoiceElementChoice = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca.IInvoiceElementChoice>();
        }
        /**
         * <summary>Invoice Identifier</summary>
         * 
         ...
         * in a message.</p><p>For example:</p> <p>Invoice Identifier: 
         * Used for management of payment request objects by 
         * adjudicators to help with traceability of messages to their 
         * applications. This does not need to be surfaced to the 
         ...
         * message.</p><p>For example:</p> <p>Invoice Identifier: Used 
         ...
         * be included in a message.</p><p>For example:</p></remarks>
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca.AdministrativeContactsS PrimaryPerformerContactParty {
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca.TaxAccountOfProvider> PertinentInformationProviderBillingTaxAccount {
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca.IInvoiceElementChoice> ReasonOfInvoiceElementChoice {
