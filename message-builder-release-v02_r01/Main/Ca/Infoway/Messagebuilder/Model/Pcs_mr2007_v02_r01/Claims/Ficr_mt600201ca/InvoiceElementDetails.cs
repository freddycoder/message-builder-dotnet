...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca {
    ...
    /**
     * <summary>Invoice Element Details</summary>
     * 
     * <remarks><p>Domain for InvoiceElementDetail.code is 
    ...
    public class InvoiceElementDetails : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca.IInvoiceElementChoice {
         ...
         * Invoice Line item.</p> <p>Only one identifier for an Invoice 
         ...
         * 
         * <remarks><p>Product/Service Code e.g. Office Visit ,Taxes, 
         * Markup, Dispense + Product/Service Code Modifier e.g. 
         * northern isolation, off hours, specialty, on call. Also 
         * allows for specification of equivalents for each code for 
         * each Payor</p> <p>RxS1: Select one of MARKUP (markup), 
         * PROFFEE (professional fee), or 
         ...
         * surcharges and discounts.</p><p>There are specific rules, by 
         * code set, for specification of these codes (e.g. CCI codes 
         * are stripped of punctuation).</p></remarks>
         */
         ...
         * 
         * <remarks><p>A description of the number of instances of a 
         * product or service. I.e.. 4 hours, 4 mg, 4 boxes, 15 each of 
         * a container of 1000 each</p> <p>Field length for value 
         * (value) may include a decimal point (e.g. 3.5 hours) with no 
         * restriction on the number of digits past the decimal 
         ...
         * service. I.e.. $0.20/mg, $250/day, $50</p> <p>Field length 
         ...
         * 
         * <remarks><p>The amount billed for the Invoice Line product 
         * or service. This is the result of Submitted Unit Quantity * 
        ...
        /**
         * <summary><p>Tax percentage applied to unitPriceAmt</p></summary>
         * 
         * <remarks><p>Factor numbers are used for taxes. They 
         * represent the percentage of tax applied to unitPriceAmt.</p> 
