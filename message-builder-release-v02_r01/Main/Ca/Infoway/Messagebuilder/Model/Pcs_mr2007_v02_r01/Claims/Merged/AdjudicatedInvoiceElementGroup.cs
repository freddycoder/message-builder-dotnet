...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Merged {
    ...
    public class AdjudicatedInvoiceElementGroup : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca.IAdjudicatedInvoiceElementChoice {

        private II id;
        private CV code;
        private CS statusCode;
        private MO netAmt;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Merged.PaymentIntent reasonPaymentIntent;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Merged.AdjudicatedInvoiceElementGroup referenceAdjudicatedInvoiceElementGroup;
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca.AdjudicatedInvoiceAuthor author;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca.AdjudicatedInvoiceCoverage> coverage;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca.IAdjudicatedInvoiceElementChoice> componentAdjudicatedInvoiceElementChoice;
        ...
        public AdjudicatedInvoiceElementGroup() {
            ...
            this.coverage = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca.AdjudicatedInvoiceCoverage>();
            this.componentAdjudicatedInvoiceElementChoice = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca.IAdjudicatedInvoiceElementChoice>();
        }
        /**
         ...
         * 
         * <remarks>(no business name) <p>(Invoice Type e.g. Healthcare 
         * Services, Rx Dispense, Rx Compound, Healthcare Goods, 
         * Preferred Accomodation</p> Invoice Type <p>Invoice Type e.g. 
         * Healthcare Services, Rx Dispense, Rx Compound</p> <p>For 
         * Invoice (COB) : Invoice type (for root) cannot be different 
         * from submitted invoice. This would be a cause for rejecting 
         * the invoice.</p><p>For Adjudication Results: code must match 
         * to the corresponding invoice element that was 
         ...
         * the EOB is an estimate</p> (no business name) <p>Invoice 
         * Status - Completed when done, Suspended if waiting for 
         * external information, Active if delayed by Adjudicator</p> 
         ...
         * 
         * <remarks>(no business name) <p>Identifies the total monetary 
         * amount billed for the invoice element. = unit_qty * 
         * unit_price_amt * factor_nbr * points_nbr. E.g. $150 CAD</p> 
         * Paid Amount <p>Paid Amount</p> <p>For Coverage Extension 
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Merged.PaymentIntent ReasonPaymentIntent {
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Merged.AdjudicatedInvoiceElementGroup ReferenceAdjudicatedInvoiceElementGroup {
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca.AdjudicatedInvoiceAuthor Author {
            get { return this.author; }
            set { this.author = value; }
        }

        [Hl7XmlMappingAttribute(new string[] {"coverage"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca.AdjudicatedInvoiceCoverage> Coverage {
            get { return this.coverage; }
        }

        [Hl7XmlMappingAttribute(new string[] {"component/adjudicatedInvoiceElementChoice"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca.IAdjudicatedInvoiceElementChoice> ComponentAdjudicatedInvoiceElementChoice {
