...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca {
    ...
    public class AdjudicatedInvoiceAuthor : MessagePartBean {
        ...
        /**
         * <summary>Relationship: 
         * COCT_MT680000CA.AdjudicatorDevice.softwareName</summary>
         * 
         * <remarks>Conformance/Cardinality: MANDATORY (1) <p>(COB 
         * Source. Which s/w rules were used to create the COB CMET 
         * such as CPhA, NeCST. Use modifier for Invoice or PreDet</p></remarks>
         */
