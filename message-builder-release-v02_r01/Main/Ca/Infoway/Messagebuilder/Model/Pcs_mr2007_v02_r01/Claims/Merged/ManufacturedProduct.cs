...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Merged {
    ...
    public class ManufacturedProduct : MessagePartBean {
         ...
         * Relationship: COCT_MT290000CA.ManufacturedProduct.id 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Organisation 
         * Name</p> Un-merged Business Name: (no business name 
         ...
         * telephone/email</p> Un-merged Business Name: (no business 
         ...
         * Conformance/Cardinality: POPULATED (1) <p>DIN/PIN</p></remarks>
         */
