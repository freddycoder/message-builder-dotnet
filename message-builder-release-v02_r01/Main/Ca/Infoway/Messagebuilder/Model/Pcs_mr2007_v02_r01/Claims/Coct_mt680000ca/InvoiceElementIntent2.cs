...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca {
    ...
    /**
     * <summary><p>Domain for InvoiceElementDetail.code is 
     * GenericBillableItemModifier</p></summary>
     */
    ...
    public class InvoiceElementIntent2 : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Coct_mt680000ca.IInvoiceElementChoice {
        ...
        /**
         * <summary><p>(Product/Service Code e.g. Office Visit ,Taxes, 
         * Markup, Dispense, including Product/Service Code Modifier 
         * e.g. northern isolation, off hours specialty, on call</p></summary>
         */
        ...
        /**
         * <summary><p>e.g. 3 {boxes}</p></summary>
         */
        ...
        /**
         * <summary><p>e.g. $50 CAD/ 1 {box}</p></summary>
         */
        ...
        /**
         * <summary><p>(= unit_qty * unit_price_amt * factor_nbr * 
         * points_nbr. E.g. $150 CAD</p></summary>
         */
        ...
        /**
         * <summary><p>multiplier, can be used for tax percentages such 
         * as 0.07</p></summary>
         */
