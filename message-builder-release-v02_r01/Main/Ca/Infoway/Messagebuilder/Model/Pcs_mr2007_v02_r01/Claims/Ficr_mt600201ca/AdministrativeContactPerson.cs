...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"FICR_MT600201CA.ContactPerson"})]
    public class AdministrativeContactPerson : MessagePartBean {

        private PN name;
        private TEL telecom;

        public AdministrativeContactPerson() {
