...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Qucr_mt830201ca {
    ...
    public class ResultOfAdjudication : MessagePartBean {
        ...
        private II id;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Qucr_mt830201ca.AdjudicationResultReference> reference;

        public ResultOfAdjudication() {
            this.id = new IIImpl();
            this.reference = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Qucr_mt830201ca.AdjudicationResultReference>();
        }
        /**
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Qucr_mt830201ca.AdjudicationResultReference> Reference {
