...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt630000ca {
    ...
    public class InvoiceElementGroup : MessagePartBean {
         ...
         * <p>May include data centre and sequence numbers</p> <p>Set 
         ...
         * within an Message Type.</p> <p>Invoice Type - Health Care 
         * Services/Goods, Rx Dispense, Rx compound, Preferred 
         * Accom.</p></remarks>
         */
