...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Merged {
    ...
    public class InvoiceType : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Claims.Ficr_mt600201ca.IInvoiceElementChoice {
         ...
         * Invoice Grouping.</p> <p>For example:</p> Invoice Grouping 
         * Identifiers <p>There are some situations where more than 1 
         * identifier for this object can be included in a message.</p> 
         * <p>For example:</p> Invoice Grouping Identifier(s <p>Set of 
         * identifiers that uniquely identify the Invoice Grouping.</p> 
         * <p>For example:</p> <p>OID (object identifier) + unique 
         * number generated by the pharmacy software for the specific 
         * invoice element group.</p><p>For child Invoice Element 
         * Groups, the identifier will be the same as its parent 
         ...
         * &quot;12942.2&quot;.</p><p>Must not be the same identifier 
         * as the PaymentRequest.id or the InvoiceElementDetail.id.</p></remarks>
         */
         ...
         * Preferred Accomodation</p> <p>RXDINV, RXCINV, CSINV, CPINV, 
         * CSPINV only for root invoice element group. RXDINV only for 
         * root invoice element group. DRGING for specify drug 
         * group.</p> <p>Invoice Type is the indication to the payor as 
         ...
         * Preferred Accom, Rx Dispense, Rx Compound</p> <p>This is 
         * used to indicate the type of Invoice 
         ...
         * within an Message Type.</p> <p>This is used to indicate the 
         ...
         * not generate unique and distinct XML schemas that can tested 
         * independent of each other. They must be tested together 
         * within an Message Type.</p> (no business name) <p>Invoice 
         * Type e.g. Healthcare Services, Rx Dispense, Rx Compound, 
         * Healthcare Goods, Preferred Accomodation</p> <p>Information 
         ...
         * not generate unique and distinct XML schemas that can tested 
         * independent of each other. They must be tested together 
         * within an Message Type.</p></remarks>
         */
         ...
         * that is being cancelled.</p><p>Attribute cannot be mandatory 
         * as it may not be present for a Coverage Extension 
         * Request.</p> Invoice Sub-total <p>Identifies the total 
