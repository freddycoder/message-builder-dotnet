...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Common.Merged {
     ...
     * condition (episode)-based collections and general care-based 
     * collections such as &quot;gynecological care&quot;.</p> 
     * MCAI_MT700212CA.Component: Care Compositions <p>Allows 
     * linking records to encounters, condition and care-based 
     * compositions. Useful for searching and navigation of the 
     * patient's record.</p> <p>A care composition is a record, 
     * which summarizes the events that happened during care 
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"MCAI_MT700210CA.Component","MCAI_MT700211CA.Component","MCAI_MT700212CA.Component","QUQI_MT020000CA.Component","QUQI_MT120006CA.Component"})]
    public class CareCompositions : MessagePartBean {

        private CS typeCode;
        private BL contextConductionInd;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Common.Coct_mt011001ca.CareCompositions patientCareProvisionEvent;
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: QUQI_MT020000CA.Component.typeCode 
         ...
         * specified) Relationship: MCAI_MT700211CA.Component.typeCode 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * QUQI_MT120006CA.Component.typeCode Conformance/Cardinality: 
         * MANDATORY (1) Un-merged Business Name: (no business name 
         * specified) Relationship: MCAI_MT700212CA.Component.typeCode 
         ...
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * MCAI_MT700212CA.Component.contextConductionInd 
         * Conformance/Cardinality: MANDATORY (1)</remarks>
         */
         ...
         * Conformance/Cardinality: POPULATED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * MCAI_MT700212CA.Component.patientCareProvisionEvent 
         * Conformance/Cardinality: POPULATED (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"patientCareProvisionEvent"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Common.Coct_mt011001ca.CareCompositions PatientCareProvisionEvent {
