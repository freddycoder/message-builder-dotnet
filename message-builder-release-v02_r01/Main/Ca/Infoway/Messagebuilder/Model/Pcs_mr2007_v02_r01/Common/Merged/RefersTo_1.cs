...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Common.Merged {
     ...
     * MCAI_MT700222CA.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     ...
     * trigger event.</p><p>Will be mandatory in wrappers with 
     * payload messages, otherwise not present.</p> 
     * MCAI_MT700211CA.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     ...
     * trigger event.</p><p>Will be mandatory in wrappers with 
     * payload messages, otherwise not present.</p> 
     * MCAI_MT700221CA.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     ...
     * trigger event.</p><p>Will be mandatory in wrappers with 
     * payload messages, otherwise not present.</p> 
     * MCAI_MT700212CA.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     ...
     * trigger event.</p><p>Will be mandatory in wrappers with 
     * payload messages, otherwise not present.</p> 
     * MCAI_MT700217CA.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     ...
     * trigger event.</p><p>Will be mandatory in wrappers with 
     * payload messages, otherwise not present.</p> 
     * MCAI_MT700218CA.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     ...
     * trigger event.</p><p>Will be mandatory in wrappers with 
     * payload messages, otherwise not present.</p> 
     * MCAI_MT700226CA.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     ...
     * MCAI_MT700216CA.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     ...
     * trigger event.</p><p>Will be mandatory in wrappers with 
     * payload messages, otherwise not present.</p> 
     * MCAI_MT700227CA.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     ...
     * trigger event.</p><p>Will be mandatory in wrappers with 
     * payload messages, otherwise not present.</p> 
     * MCAI_MT700220CA.Subject2: f:refers to <p>Provides 
     * information about the thing being created, modified or 
     * removed.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
    ...
    public class RefersTo_1<ACT> : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * MCAI_MT700227CA.Subject2.act Conformance/Cardinality: 
         * MANDATORY (1) Un-merged Business Name: (no business name 
