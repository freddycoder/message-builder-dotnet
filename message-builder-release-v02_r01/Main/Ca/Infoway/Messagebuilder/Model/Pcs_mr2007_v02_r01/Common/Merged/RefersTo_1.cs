...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Common.Merged {
     ...
     * MCAI_MT700222CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     ...
     * of work.</p> QUQI_MT120008CA.Subject2: f:refers to 
     ...
     * either accepted or rejected as a single action. I.e. One 
     * trigger event = 1 unit of work.</p> 
     * MCAI_MT700211CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     * not present.</p> <p>Indicates the item(s) being acted upon 
     * by this trigger event.</p><p>Will be mandatory in wrappers 
     ...
     * items, the changes to all of them must be either accepted or 
     * rejected as a single action. I.e. One trigger event = 1 unit 
     * of work.</p> MCAI_MT700221CA.Subject2: f:refers to 
     * <p>Indicates the item(s) being acted upon by this trigger 
     * event.</p><p>Will be mandatory in wrappers with payload 
     * messages, otherwise not present.</p> <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     ...
     * either accepted or rejected as a single action. I.e. One 
     * trigger event = 1 unit of work.</p> 
     * MCAI_MT700212CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     * not present.</p> <p>Indicates the item(s) being acted upon 
     * by this trigger event.</p><p>Will be mandatory in wrappers 
     ...
     * items, the changes to all of them must be either accepted or 
     * rejected as a single action. I.e. One trigger event = 1 unit 
     * of work.</p> MCAI_MT700217CA.Subject2: f:refers to 
     * <p>Indicates the item(s) being acted upon by this trigger 
     * event.</p><p>Will be mandatory in wrappers with payload 
     * messages, otherwise not present.</p> <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     ...
     * either accepted or rejected as a single action. I.e. One 
     * trigger event = 1 unit of work.</p> 
     * MCAI_MT700218CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     * not present.</p> <p>Indicates the item(s) being acted upon 
     * by this trigger event.</p><p>Will be mandatory in wrappers 
     ...
     * items, the changes to all of them must be either accepted or 
     * rejected as a single action. I.e. One trigger event = 1 unit 
     * of work.</p> MCAI_MT700226CA.Subject2: f:refers to 
     * <p>Indicates the item(s) being acted upon by this trigger 
     * event.</p><p>Will be mandatory in wrappers with payload 
     * messages, otherwise not present.</p> <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     ...
     * either accepted or rejected as a single action. I.e. One 
     * trigger event = 1 unit of work.</p> 
     * MCAI_MT700210CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     ...
     * is carried according to the dataEnterer.contextControlCode 
     * (propogate to the payload and add to any data enterer(s) 
     * already present in the payload).</p> <p>Provides information 
     ...
     * MCAI_MT700216CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     * not present.</p> <p>Indicates the item(s) being acted upon 
     * by this trigger event.</p><p>Will be mandatory in wrappers 
