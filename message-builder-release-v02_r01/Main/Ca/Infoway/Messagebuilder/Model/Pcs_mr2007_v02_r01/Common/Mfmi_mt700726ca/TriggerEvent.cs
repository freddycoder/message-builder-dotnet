 ...
 * Last modified: $LastChangedDate: 2012-02-16 11:05:34 -0500 (Thu, 16 Feb 2012) $
 * Revision:      $LastChangedRevision: 5453 $
 */
...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Common.Mfmi_mt700726ca {
    ...
    public class TriggerEvent<RR> : MessagePartBean {
         ...
         * 
         * <remarks><p>On creation interactions (where the state 
         * transition is null-&gt;active), this must be true otherwise 
         * it must be false.</p> <p>Indicates whether or not objects of 
