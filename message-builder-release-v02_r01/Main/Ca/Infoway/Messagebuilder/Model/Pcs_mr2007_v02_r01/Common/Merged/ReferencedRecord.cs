...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Common.Merged {
    ...
    public class ReferencedRecord : MessagePartBean {
         ...
         * and is therefore mandatory.</p> Record Ids <p>The identifier 
         * assigned by the registry to the role record being referred 
         * to</p> <p>Allows the role record to be uniquely referenced 
