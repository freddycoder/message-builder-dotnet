...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Common.Merged {
     ...
     * 
     * <remarks>MCAI_MT700211CA.Author: a:*created by <p>Critical 
     * for auditing and for validating permissions and therefore 
     * mandatory.</p> <p>Choice of Patient CMET is as follows:</p> 
     * <p>Indicates the person responsible for the event that 
     * caused this message.</p> MFMI_MT700751CA.Author: a:*created 
     * by <p>Critical for auditing and for validating permissions 
     * and therefore mandatory.</p> <p>Indicates the person 
     * responsible for the event that caused this message.</p> 
     * MCAI_MT700212CA.Author: a:*created by <p>Critical for 
     * auditing and for validating permissions and therefore 
     * mandatory.</p> <p>Choice of Patient CMET is as follows:</p> 
     * <p>Indicates the person responsible for the event that 
     * caused this message.</p> MCAI_MT700220CA.Author: a:*created 
     * by <p>Critical for auditing and for validating permissions 
     * and therefore mandatory.</p> <p>Choice of Patient CMET is as 
     * follows:</p> <p>Indicates the person responsible for the 
     * event that caused this message.</p> MCAI_MT700210CA.Author: 
     * a:*created by <p>Critical for auditing and for validating 
     * permissions and therefore mandatory.</p> <p>Choice of 
     * Patient CMET is as follows:</p> <p>Indicates the person 
     * responsible for the event that caused this message.</p> 
     * MCAI_MT700230CA.Author: a:*created by <p>Critical for 
     * auditing and for validating permissions and therefore 
     * mandatory.</p> <p>Choice of Patient CMET is as follows:</p> 
     * <p>Indicates the person responsible for the event that 
     * caused this message.</p> MFMI_MT700711CA.Author: a:*created 
     * by <p>Critical for auditing and for validating permissions 
     * and therefore mandatory.</p> <p>Choice of Patient CMET is as 
     * follows:</p> <p>Indicates the person responsible for the 
     * event that caused this message.</p> MCAI_MT700221CA.Author: 
     * a:*created by <p>Critical for auditing and for validating 
     * permissions and therefore mandatory.</p> <p>Choice of 
     * Patient CMET is as follows:</p> <p>Indicates the person 
     * responsible for the event that caused this message.</p> 
     * MCAI_MT700222CA.Author: a:*created by <p>Critical for 
     * auditing and for validating permissions and therefore 
     * mandatory.</p> <p>Choice of Patient CMET is as follows:</p> 
     * <p>Indicates the person responsible for the event that 
     ...
     * and therefore mandatory.</p> <p>Choice of Patient CMET is as 
     * follows:</p> <p>Indicates the person responsible for the 
     * event that caused this message.</p> MCAI_MT700232CA.Author: 
     * a:*created by <p>Critical for auditing and for validating 
     * permissions and therefore mandatory.</p> <p>Choice of 
     * Patient CMET is as follows:</p> <p>Indicates the person 
     * responsible for the event that caused this message.</p> 
     * QUQI_MT020000CA.Author: a:*created by <p>Critical for 
     * auditing and for validating permissions and therefore 
     * mandatory.</p> <p>Choice of Patient CMET is as follows:</p> 
     * <p>Indicates the person responsible for the event that 
    ...
    public class CreatedBy : MessagePartBean {
         ...
         * MFMI_MT700751CA.Author.time Conformance/Cardinality: 
         ...
         * effective period would be next Tuesday.)</p><p>This date can 
         * be back-dated.</p> Un-merged Business Name: TimeOfCreation 
         * Relationship: MFMI_MT700711CA.Author.time 
         * Conformance/Cardinality: MANDATORY (1) <p>The time a change 
         * is made is a critical piece of audit information and is 
         * therefore mandatory.</p> <p>The time the person responsible 
         * for the event made the decision for it to occur. This may be 
         ...
         * MFMI_MT700751CA.Author.signatureText 
         * Conformance/Cardinality: OPTIONAL (0-1) <p>Digital 
         * signatures may be needed for authentication of message 
         * content. The attribute is marked as optional because it is 
         * not yet clear whether there is a use-case for this, or where 
         ...
         * MFMI_MT700751CA.Author.authorPerson Conformance/Cardinality: 
         ...
         * POPULATED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: MFMI_MT700711CA.Author.authorPerson 
         * Conformance/Cardinality: POPULATED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
