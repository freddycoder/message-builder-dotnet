...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r01.Cr.Merged {
    ...
    public class PersonalRelationship : MessagePartBean {
         ...
         * <p>A unique identifier for the next of kin</p> Un-merged 
         ...
         * identification of the next of kin</p> <p>A unique identifier 
         * for the next of kin</p> Un-merged Business Name: 
         * NextOfKinIdentifier Relationship: 
         * PRPA_MT101102CA.ParentPerson.id Conformance/Cardinality: 
         * MANDATORY (1) Un-merged Business Name: NextOfKinIdentifier 
         * Relationship: PRPA_MT101002CA.ParentPerson.id 
         * Conformance/Cardinality: MANDATORY (1) <p>Mandatory 
         * attribute supports the identification of the next of kin</p> 
         * <p>A unique identifier for the next of kin</p></remarks>
         */
