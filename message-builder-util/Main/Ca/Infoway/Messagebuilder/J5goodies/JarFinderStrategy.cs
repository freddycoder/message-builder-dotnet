...
//!	using ILOG.J2CsMapping.IO.Jar;
	...
	internal class JarFinderStrategy : FinderStrategy {
	
		private String jarLocation;
	
		internal JarFinderStrategy(String root) {
			this.jarLocation = Ca.Infoway.Messagebuilder.StringUtils.SubstringAfter(root, "jar:");
		}
