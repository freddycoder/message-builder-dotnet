...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Lab.Merged {
     ...
     * according to the parent order classCode.</p> <p>This is used 
     * primarily for Order referrals.</p> <p>Must contain a value 
     * assigned by the order-placing organization that uniquely 
     * identifies this test request among all test requests in the 
     * receiving application.</p> POLB_MT001001CA.PriorActRequest: 
     * Prior Test Request <p>The classCode shall carry one of 
     * 'ACT', 'BATTERY' or 'OBS' according to the parent order 
     * classCode.</p> <p>This is used primarily for Order 
     * referrals.</p> <p>Must contain a value assigned by the 
