...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pr.Prpm_mt309000ca {
    ...
    public class TerritorialAuthority : MessagePartBean {
        ...
        private CV territorialAuthorityType;
        private CV jurisdictionType;
        ...
        public TerritorialAuthority() {
            this.territorialAuthorityType = new CVImpl();
            this.jurisdictionType = new CVImpl();
        }
        /**
         * <summary>Territorial Authority Type</summary>
         * 
         * <remarks><p>The code identifying the specific Territorial 
         * Authority</p> <p>Populated attribute supports the validation 
         * and identification of the healthcare provider</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"code"})]
        public Code TerritorialAuthorityType {
            get { return (Code) this.territorialAuthorityType.Value; }
            set { this.territorialAuthorityType.Value = value; }
        }
         ...
         * Provider is operating.</p> <p>Populated attribute supports 
        ...
        public Code JurisdictionType {
            get { return (Code) this.jurisdictionType.Value; }
            set { this.jurisdictionType.Value = value; }
        }
