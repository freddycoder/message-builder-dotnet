...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Claims.Ficr_mt630000ca {
    ...
    public class InvoiceElementGroup : MessagePartBean {
        ...
        private CV code;
        private MO netAmt;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Claims.Merged.AdjudicationResultIdentifier> referenceAdjudicatedInvoiceElementGroup;

        public InvoiceElementGroup() {
            this.id = new IIImpl();
            this.code = new CVImpl();
            this.netAmt = new MOImpl();
            this.referenceAdjudicatedInvoiceElementGroup = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Claims.Merged.AdjudicationResultIdentifier>();
        }
        /**
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Claims.Merged.AdjudicationResultIdentifier> ReferenceAdjudicatedInvoiceElementGroup {
