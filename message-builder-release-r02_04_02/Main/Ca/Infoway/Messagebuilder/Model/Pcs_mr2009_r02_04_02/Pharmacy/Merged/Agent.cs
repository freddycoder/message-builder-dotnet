...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Merged {
    ...
    public class Agent : MessagePartBean {
        ...
        private II substitutingPersonIdentifier;

        public Agent() {
            this.substitutingPersonIdentifier = new IIImpl();
        }
        /**
        ...
        public Identifier SubstitutingPersonIdentifier {
            get { return this.substitutingPersonIdentifier.Value; }
            set { this.substitutingPersonIdentifier.Value = value; }
        }
