...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Pome_mt010040ca {
    ...
    public class DrugValidityPeriod : MessagePartBean {
        ...
        private IVL<TS, Interval<PlatformDate>> firstFillPeriod;

        public DrugValidityPeriod() {
            this.firstFillPeriod = new IVLImpl<TS, Interval<PlatformDate>>();
        }
        /**
        ...
        public Interval<PlatformDate> FirstFillPeriod {
            get { return this.firstFillPeriod.Value; }
            set { this.firstFillPeriod.Value = value; }
        }
