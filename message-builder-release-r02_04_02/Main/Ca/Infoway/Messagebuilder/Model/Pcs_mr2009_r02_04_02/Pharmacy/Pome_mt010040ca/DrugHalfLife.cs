...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Pome_mt010040ca {
    ...
    public class DrugHalfLife : MessagePartBean {
        ...
        private PQ halfLifePeriod;

        public DrugHalfLife() {
            this.halfLifePeriod = new PQImpl();
        }
        /**
        ...
        public PhysicalQuantity HalfLifePeriod {
            get { return this.halfLifePeriod.Value; }
            set { this.halfLifePeriod.Value = value; }
        }
