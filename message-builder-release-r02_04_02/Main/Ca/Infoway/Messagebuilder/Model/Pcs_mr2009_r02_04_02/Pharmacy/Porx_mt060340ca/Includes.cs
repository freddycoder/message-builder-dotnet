...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Porx_mt060340ca {
     ...
     * the association is allowed to be null when the order is for 
     * a medication which requires no dispense authorization (e.g. 
     * over-the-counter medications), or when the patient already 
     * has sufficient supply of the medication on hand to complete 
     * the therapy.</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"PORX_MT060340CA.Component6"})]
    public class Includes : MessagePartBean {

        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Porx_mt060340ca.DispenseInstructions supplyRequest;

        public Includes() {
        }
        [Hl7XmlMappingAttribute(new string[] {"supplyRequest"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Porx_mt060340ca.DispenseInstructions SupplyRequest {
