...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Porx_mt010120ca {
    ...
    public class Component2 : MessagePartBean {
        ...
        private BL notEligibleForTrial;

        public Component2() {
            this.notEligibleForTrial = new BLImpl();
        }
        /**
        ...
        public bool? NotEligibleForTrial {
            get { return this.notEligibleForTrial.Value; }
            set { this.notEligibleForTrial.Value = value; }
        }
