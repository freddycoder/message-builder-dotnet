...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Merged {
    ...
    public class LastDispenseInformation_2 : MessagePartBean {
        ...
        private IVL<TS, Interval<PlatformDate>> lastDispensePickupDate;
        private INT lastQuantityDispensed;

        public LastDispenseInformation_2() {
            this.lastDispensePickupDate = new IVLImpl<TS, Interval<PlatformDate>>();
            this.lastQuantityDispensed = new INTImpl();
        }
        /**
        ...
        public Interval<PlatformDate> LastDispensePickupDate {
            get { return this.lastDispensePickupDate.Value; }
            set { this.lastDispensePickupDate.Value = value; }
        }
        ...
        public int? LastQuantityDispensed {
            get { return this.lastQuantityDispensed.Value; }
            set { this.lastQuantityDispensed.Value = value; }
        }
