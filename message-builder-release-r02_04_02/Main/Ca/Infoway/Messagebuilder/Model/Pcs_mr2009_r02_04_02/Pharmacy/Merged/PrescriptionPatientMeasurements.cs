...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Merged {
    ...
    public class PrescriptionPatientMeasurements : MessagePartBean {
         ...
         * to evaluate currency of the information.</p><p>Because the 
         * date of measurement determines the relevance of the 
         * information, this attribute is defined as 'populated'.</p> 
         * <p>The date on which the measurement was made</p> Un-merged 
         * Business Name: PrescriptionPatientMeasurementTime 
         * Relationship: 
