...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Pome_mt010040ca {
    ...
    public class PatientCharacteristics : MessagePartBean {
        ...
        private CV patientCharacteristicType;
        private BL excludeCharacteristic;
        private IVL<PQ, Interval<PhysicalQuantity>> patientCharacteristicValue;

        public PatientCharacteristics() {
            this.patientCharacteristicType = new CVImpl();
            this.excludeCharacteristic = new BLImpl();
            this.patientCharacteristicValue = new IVLImpl<PQ, Interval<PhysicalQuantity>>();
        }
        /**
        ...
        public ObservationDosageDefinitionPreconditionType PatientCharacteristicType {
            get { return (ObservationDosageDefinitionPreconditionType) this.patientCharacteristicType.Value; }
            set { this.patientCharacteristicType.Value = value; }
        }
        ...
        public bool? ExcludeCharacteristic {
            get { return this.excludeCharacteristic.Value; }
            set { this.excludeCharacteristic.Value = value; }
        }
        ...
        public Interval<PhysicalQuantity> PatientCharacteristicValue {
            get { return this.patientCharacteristicValue.Value; }
            set { this.patientCharacteristicValue.Value = value; }
        }
