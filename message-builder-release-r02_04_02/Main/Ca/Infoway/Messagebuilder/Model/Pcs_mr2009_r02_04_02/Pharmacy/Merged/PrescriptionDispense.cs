...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Merged {
    ...
    public class PrescriptionDispense : MessagePartBean {
         ...
         * prescription and all dispenses masked.</p><p>Communicates 
         ...
         * dispenses masked.</p><p>Communicates the intent of the 
         * patient to restrict access to their 
         * prescriptions.</p><p>Provides support for additional 
         * confidentiality constraint, giving patients a level of 
         * control over their information.</p><p>Valid values are: 'N' 
         * (normal - denotes 'Not Masked'); 'R' (restricted - denotes 
         ...
         * prescription is unmasked.)</p> E:Prescription Masking 
         * Indicators <p>Communicates the intent of the patient to 
         ...
         * access by patients.</p><p>Valid values are: 'N' (normal - 
         * denotes 'Not Masked'); 'R' (restricted - denotes 'Masked'); 
         * 'V' (very restricted - denotes very restrict
