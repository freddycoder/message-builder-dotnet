...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Pharmacy.Merged {
    ...
    public class SupplyOrder : MessagePartBean {
        ...
        private SET<II, Identifier> prescriptionIdentifier;
        ...
        public SupplyOrder() {
            this.prescriptionIdentifier = new SETImpl<II, Identifier>(typeof(IIImpl));
        ...
        public ICollection<Identifier> PrescriptionIdentifier {
            get { return this.prescriptionIdentifier.RawSet(); }
        }
