...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged {
    ...
    public class Issues : MessagePartBean {
        ...
        private CV issueType;
        private ST text;
        private CV issuePriority;
        private SET<ST, String> messageIssueLocation;
        ...
        private CV severityCode;
        private BL triggerForActRequest;
        private BL subjectOf1StorageIntent;

        public Issues() {
            this.issueType = new CVImpl();
            this.text = new STImpl();
            this.issuePriority = new CVImpl();
            this.messageIssueLocation = new SETImpl<ST, String>(typeof(STImpl));
         ...
         * 'True')</p><p>Distinguishes between DAI, DDI, DosageCheck, 
         * DPD, and Duplicate Therapy 
         * Contraindications</p><p>Contraindication.DosageContr
         * ... [rest of documentation truncated due to excessive length]
         */
        [Hl7XmlMappingAttribute(new string[] {"code"})]
        public ActDetectedIssueCode IssueType {
            get { return (ActDetectedIssueCode) this.issueType.Value; }
            set { this.issueType.Value = value; }
        }
         ...
         * detailed description of the alert</p> D:Issue Details 
        ...
        public ActIssuePriority IssuePriority {
            get { return (ActIssuePriority) this.issuePriority.Value; }
            set { this.issuePriority.Value = value; }
        }
        ...
        public ICollection<String> MessageIssueLocation {
            get { return this.messageIssueLocation.RawSet(); }
        }
        ...
        public SeverityObservation SeverityCode {
            get { return (SeverityObservation) this.severityCode.Value; }
            set { this.severityCode.Value = value; }
        }
