...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged {
    ...
    /**
     * <summary>Business Name: ActingPerson</summary>
     * 
     * <remarks>COCT_MT090102CA.Person: Acting Person <p>Even when 
     * an organization is taking responsibility, a person is 
     * generally involved in the work.</p> <p>Describes the person 
     * actually involved in the action.</p></remarks>
     */
    ...
    public class ActingPerson : MessagePartBean {
        ...
        /**
         * <summary>Un-merged Business Name: PatientName</summary>
         * 
         ...
         * the underlying client registry application</p> Un-merged 
         * Business Name: HealthcareWorkerName Relationship: 
         * POIZ_MT030050CA.Person.name Conformance/Cardinality: 
         * MANDATORY (1) <p>This is a human-readable name and is thus 
         * essential for both display and validation of the person. As 
         * a result, the attribute is mandatory.</p> <p>The name of the 
         * participating person.</p> Un-merged Business Name: 
         * HealthcareWorkerName Relationship: 
         * COCT_MT090108CA.Person.name Conformance/Cardinality: 
         * POPULATED (1) <p>This is a human-readable name and is thus 
         * essential for both display and validation of the person. As 
         * a result, the attribute is mandatory.</p> <p>The name of the 
         * participating person.</p> Un-merged Business Name: 
         * HealthcareWorkerName Relationship: 
         * COCT_MT090102CA.Person.name Conformance/Cardinality: 
         * POPULATED (1) <p>This is a human-readable name and is 
         * essential for validation of the person. As a result, the 
         * attribute is mandatory</p> <p>The name of the involved 
         * person.</p> Un-merged Business Name: RelatedPersonName 
         * Relationship: COCT_MT910108CA.Person.name 
         ...
         * POIZ_MT030060CA.Person.name Conformance/Cardinality: 
         * MANDATORY (1) <p>This is a human-readable name and is thus 
         * essential for both display and validation of the person. As 
         * a result, the attribute is mandatory.</p> <p>The name of the 
         * participating person.</p> Un-merged Business Name: 
         * HealthcareWorkerName Relationship: 
         * POIZ_MT060150CA.Person.name Conformance/Cardinality: 
         * MANDATORY (1) <p>This is a human-readable name and is thus 
         * essential for both display and validation of the person. As 
         * a result, the attribute is mandatory.</p> <p>The name of the 
         * participating person.</p> Un-merged Business Name: 
         * PatientName Relationship: COCT_MT050007CA.Person.name 
         * Conformance/Cardinality: POPULATED (1) <p>Used, with other 
         ...
         * has been reported or recorded.</p> Un-merged Business Name: 
         * PatientName Relationship: COCT_MT050207CA.Person.name 
         * Conformance/Cardinality: POPULATED (1) <p>ZPA.1 
         * (partType=Given)</p> <p>ZPA.2 (partType=Family)</p> <p>ZPA.3 
         * (partType=Given - all repetitions except first)</p> <p>C37 
         * (partType=Given)</p> <p>C38 (partType=Family)</p> 
         ...
         * system.</p> <p>The name by which the patient is known.</p> 
         * Un-merged Business Name: PatientName Relationship: 
         * COCT_MT050208CA.Person.name Conformance/Cardinality: 
         * POPULATED (1) <p>ZPA.1 (partType=Given)</p> <p>ZPA.2 
         * (partType=Family)</p> <p>ZPA.3 (partType=Given - all 
         * repetitions except first)</p> <p>C37 (partType=Given)</p> 
         * <p>C38 (partType=Family)</p> <p>PTT.030-01 
         * (partType=Family)</p> <p>PTT.030-02 (partType=Given - 1st 
         * occurrence)</p> <p>PTT.030-03 (partType=Given - subsequen 
         * occurrences)</p> <p>PTT.030-04 (partType=Suffix)</p> 
         * <p>PTT.030-05 (partType=Prefix)</p> <p>patient Initials</p> 
         * <p>PID.5</p> <p>Patient.310-CA (partType=Given)</p> 
         * <p>Patient.311-CB (partType=Family)</p> <p>Recipient Name 
         * First (partType=Given)</p> <p>Recipient Name Last 
         * (partType=Family)</p> <p>PID.5</p> <p>PID.9 (any name other 
         * than first repetition is an alias)</p> <p>ZDU.3</p> 
         * <p>ZKW.2</p> <p>Person.givenName</p> <p>Person.lastName</p> 
         * <p>Person.middleName</p> <p>Person.namePrefix</p> 
         * <p>Person.nameSuffix</p> <p>Potentially used by PoS systems 
         * to confirm patient identity. Also acts as the visual 
         * confirmation to the user about the patient being 
         * viewed.</p><p>The element is populated because the patient's 
         * name is important for display. However, there may be 
         * circumstances where a name is not available in the registry 
         * (e.g. newborns).</p> <p>The name by which the patient is 
         * known to the client registry.</p></remarks>
         */
         ...
         * relevant.</p> Un-merged Business Name: PatientGender 
         * Relationship: 
         ...
         * if they are considered relevant.</p> Un-merged Business 
         * Name: PatientGender Relationship: 
         * COCT_MT050207CA.Person.administrativeGenderCode 
         * Conformance/Cardinality: POPULATED (1) <p>C40 
         ...
         * observations if they are considered relevant.</p> Un-merged 
        ...
        /**
         * <summary>Un-merged Business Name: PatientBirthDate</summary>
         * 
         ...
         * registry.</p> Un-merged Business Name: PatientBirthDatetime 
         * Relationship: COCT_MT050007CA.Person.birthTime 
         * Conformance/Cardinality: POPULATED (1) <p>Used to confirm 
         * patient identity.</p> <p>Indicates the date on which the 
         * patient was born.</p> Un-merged Business Name: 
         * PatientBirthDate Relationship: 
         * COCT_MT050207CA.Person.birthTime Conformance/Cardinality: 
         * POPULATED (1) <p>C34</p> <p>PTT.020</p> <p>A.2b</p> 
         * <p>HC-SA</p> <p>PID.7</p> <p>patient.304-C4</p> <p>PID.7</p> 
         ...
         * born as known by the client registry.</p> Un-merged Business 
         * Name: PatientBirthDate Relationship: 
         * COCT_MT050208CA.Person.birthTime Conformance/Cardinality: 
         * POPULATED (1) <p>C34</p> <p>PTT.020</p> <p>A.2b</p> 
         * <p>HC-SA</p> <p>PID.7</p> <p>patient.304-C4</p> <p>PID.7</p> 
         * <p>Used to confirm patient identity.</p><p>May also 
         * influence clinical decision support such as dosage and 
         ...
         * Relationship: POIZ_MT030050CA.HealthCareProvider.id 
         ...
         * root of AssignedEntity class is the same as the license 
         * number, the license number should be sent in both 
         * places.</p><p>Detailed information about the status and 
         * effective period of licenses must be retrieved from the 
         * provider registry.</p> <p>The license number issued to the 
         * provider and relevant to the current action.</p> Un-merged 
         * Business Name: LicenseNumber Relationship: 
         * COCT_MT090108CA.HealthCareProvider.id 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows lookup on 
         * college website, confirmation of identity, etc. Regulations 
         * occasionally require license numbers to be specified as part 
         * of clinical records.</p> <p>If the identifier used in the 
         ...
         * current action.</p> Un-merged Business Name: LicenseNumber 
         * Relationship: POIZ_MT030060CA.HealthCareProvider.id 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows lookup on 
         * college website, confirmation of identity, etc. Regulations 
         * occasionally require license numbers to be specified as part 
         * of clinical records.</p> <p>If the identifier used in the 
         ...
         * provider and relevant to the current action.</p> Un-merged 
         * Business Name: LicenseNumber Relationship: 
         * POIZ_MT060150CA.HealthCareProvider.id 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows lookup on 
         * college website, confirmation of identity, etc. Regulations 
         * occasionally require license numbers to be specified as part 
         * of clinical records.</p> <p>If the identifier used in the 
         ...
         * effective period of licenses must be retrieved from the 
         * provider registry.</p> <p>The license number issued to the 
         * provider and relevant to the current action.</p></remarks>
         */
         ...
         * COCT_MT910108CA.Person.telecom Conformance/Cardinality: 
         * REQUIRED (0-5) <p>Used to contact the related person.</p> 
        ...
        /**
         * <summary>Business Name: PatientDeceasedIndicator</summary>
         * 
         * <remarks>Un-merged Business Name: PatientDeceasedIndicator 
         * Relationship: COCT_MT050007CA.Person.deceasedInd 
        ...
        /**
         * <summary>Business Name: PatientDeceasedDatetime</summary>
         * 
         * <remarks>Un-merged Business Name: PatientDeceasedDatetime 
         * Relationship: COCT_MT050007CA.Person.deceasedTime 
         ...
         * COCT_MT050007CA.Person.asIdentifiedEntity 
         * Conformance/Cardinality: REQUIRED (0-4)</remarks>
         */
