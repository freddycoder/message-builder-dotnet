...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged {
     ...
     * Diagnosis</p> COMT_MT400001CA.Diagnosis: Diagnosis 
    ...
    public class Diagnosis : MessagePartBean {
        ...
        private CV code;
        private ST diagnosisDescription;
        private CV value;

        public Diagnosis() {
            this.code = new CVImpl();
            this.diagnosisDescription = new STImpl();
         ...
         * Otherwise value is mandatory and code must be DX</p> <p>Used 
         * to indicate that this observation is a diagnosis, and for 
         * SNOMED, provides details of what the diagnosis is.</p> 
         * <p>Needed to convey the diagnosis information to be masked, 
         * and attribute is therefore mandatory.</p> Diagnosis type 
         * <p>admit, intermediate, discharge diagnosis</p> Diagnosis 
         * Code <p>ObservationDiagnosis Type</p></remarks>
         */
        ...
        public String DiagnosisDescription {
            get { return this.diagnosisDescription.Value; }
            set { this.diagnosisDescription.Value = value; }
        }
