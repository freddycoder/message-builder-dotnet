...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged {
     ...
     * 
     * <remarks><p>Indicates the facility/location where the 
     * patient note was recorded.</p> <p>Important for performing 
     ...
     * always be known or should have an explicit null flavor of 
     * 'NA' (non-assigned) or 'UNK' (paper prescription). Thus the 
     * association is 'populated'.</p> REPC_MT230001CA.Location: 
     * i:occurred at <p>This identifies the location where the 
     ...
     * always be known or should have an explicit null flavor of 
     * 'NA' (non-assigned) or 'UNK' (paper prescription). Thus the 
     * association is 'populated'.</p> REPC_MT500003CA.Location: 
     * h:occurred at <p>Must not be specified when Care Composition 
     * Type is 'Condition-based'</p> </p><p>In circumstances where 
     * number of locations involved is greater than the limit 
     * supported by the message, multiple encounters should be 
     * used.</p> </p><p>In circumstances where number of locations 
     * involved is greater than the limit supported by the message, 
     * multiple encounters should be used.</p> </p><p>Multiple 
     * repetitions are allowed for telehealth and other remote 
     * encounters.</p> </p><p>Multiple repetitions are allowed for 
     * telehealth and other remote encounters.</p> 
     * REPC_MT230003CA.Location: i:occurred at <p>This identifies 
     ...
     * provides context for interpreting the record. In some cases, 
     * it may also provide follow-up information</p> <p>This 
     * identifies the location where the actual discharge/care 
     * event occurred. E.g. Patient's residence, clinic, work site, 
     * hospital, etc. It only needs to be specified when the 
     * occurrence location differs from the official record 
     * location.</p><p>The site of the actual event provides 
     * context for interpreting the record. In some cases, it may 
     * also provide follow-up information</p> <p>The site of the 
     * actual event provides context for interpreting the record. 
     * In some cases, it may also provide follow-up information</p> 
     * PORX_MT060160CA.Location: *d:dispensed from <p>Indicates the 
     * facility/location where the dispensing was performed.</p> 
     * <p>Important for performing follow-up and therefore 
     * mandatory.</p> REPC_MT230002CA.Location: i:occurred at 
     ...
     * performed.</p> <p>The site of the actual event provides 
     * context for interpreting the record. In some cases, it may 
     * also provide follow-up information</p> 
     ...
     * mandatory.</p> REPC_MT210003CA.Location3: v:referred to 
     ...
     * follow-up information</p> <p>Indicates the service Delivery 
     * Location where the referral service is targeted to be 
     * preformed.</p><p>The target site of the referral service 
     * provides context for interpreting the record. In some cases, 
     * it may also provide follow-up information</p> <p>If the 
     * referral was targeted to a service delivery location then 
     * the identity of the location must be known.</p> 
    ...
    public class OccurredAt : MessagePartBean {
        ...
        private IVL<TS, Interval<PlatformDate>> toBePickedUpWhen;
        private CV substitutionConditionCode;
        private CS contextControlCode;

        public OccurredAt() {
            this.toBePickedUpWhen = new IVLImpl<TS, Interval<PlatformDate>>();
        ...
        public Interval<PlatformDate> ToBePickedUpWhen {
            get { return this.toBePickedUpWhen.Value; }
            set { this.toBePickedUpWhen.Value = value; }
        }
