...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged {
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT220100CA.Ingredient","COCT_MT220110CA.Ingredient","COCT_MT220200CA.Ingredient","COCT_MT220210CA.Ingredient","FICR_MT400003CA.Ingredient","FICR_MT400004CA.Ingredient","FICR_MT490102CA.Ingredient","POME_MT010040CA.Ingredient","POME_MT010100CA.Ingredient"})]
    public class DrugContains : MessagePartBean {

        private BL negationInd;
        private PQ quantity;
        private CV ingredientCode;
        private ST ingredientName;

        public DrugContains() {
            this.negationInd = new BLImpl();
            this.quantity = new PQImpl();
            this.ingredientCode = new CVImpl();
            this.ingredientName = new STImpl();
        }
        /**
         * <summary>Un-merged Business Name: 
         * DrugDoesNotContainIndicator</summary>
         * 
         * <remarks>Relationship: 
         * FICR_MT490102CA.Ingredient.negationInd 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: DoesNotContainIndicator Relationship: 
         ...
         * FICR_MT400003CA.Ingredient.negationInd 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: DoesNotContainIndicator Relationship: 
         ...
         * inactive).</p> Un-merged Business Name: 
         * DrugDoesNotContainIndicator Relationship: 
         * FICR_MT400004CA.Ingredient.negationInd 
        ...
        /**
         * <summary>Un-merged Business Name: DrugIngredientQuantity</summary>
         * 
         * <remarks>Relationship: FICR_MT490102CA.Ingredient.quantity 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: IngredientQuantity Relationship: 
         * POME_MT010040CA.Ingredient.quantity Conformance/Cardinality: 
         * REQUIRED (0-1) <p>Essential for evaluating appropriate 
         * dosage based on strength, as well as for creating custom 
         * compounds with proper composition.</p> <p>The quantity of 
         ...
         * Relationship: FICR_MT400003CA.Ingredient.quantity 
         ...
         * mg/vol, %, etc.</p> Un-merged Business Name: 
         * DrugIngredientQuantity Relationship: 
         * FICR_MT400004CA.Ingredient.quantity Conformance/Cardinality: 
         ...
         * Relationship: FICR_MT490102CA.Substance.code 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: DrugIngredientIdentifier Relationship: 
         * POME_MT010040CA.Substance.code Conformance/Cardinality: 
         * POPULATED (1) <p>Allows un-ambiguous identification of the 
         ...
         * the drug or chemical.</p> Un-merged Business Name: 
         * DrugIngredientIdentifier Relationship: 
         * FICR_MT400003CA.Substance.code Conformance/Cardinality: 
         * REQUIRED (0-1) Un-merged Business Name: 
         * DrugIngredientIdentifier Relationship: 
         * POME_MT010100CA.Substance.code Conformance/Cardinality: 
         * POPULATED (1) <p>Allows un-ambiguous identification of the 
         * ingredients of a drug for performing various alert 
         * checking.</p><p>Also allows for the identification of 
         ...
         * COCT_MT220200CA.Substance.code Conformance/Cardinality: 
         * REQUIRED (0-1) 
         * <p>CompoundIngredient.IngredientDrug.activeIngredientCode</p> 
         * <p>CompoundIngredient.IngredientDrug.DIN</p> 
         * <p>CompoundIngredient.IngredientDrug.hcAigNumber</p> 
         ...
         * <p>The unique identifier for the drug or chemical.</p> 
         * Un-merged Business Name: DrugIngredientIdentifier 
         * Relationship: COCT_MT220110CA.Substance.code 
         * Conformance/Cardinality: REQUIRED (0-1) 
         * <p>CompoundIngredient.IngredientDrug.activeIngredientCode</p> 
         * <p>CompoundIngredient.IngredientDrug.DIN</p> 
         * <p>CompoundIngredient.IngredientDrug.hcAigNumber</p> 
         ...
         * unique identifier for the drug or chemical.</p> Un-merged 
         * Business Name: DrugIngredientIdentifier Relationship: 
         * FICR_MT400004CA.Substance.code Conformance/Cardinality: 
         * REQUIRED (0-1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"ingredient/code"})]
        public ActiveIngredientDrugEntityType IngredientCode {
            get { return (ActiveIngredientDrugEntityType) this.ingredientCode.Value; }
            set { this.ingredientCode.Value = value; }
        }

        /**
         * <summary>Un-merged Business Name: DrugIngredientName</summary>
         * 
         * <remarks>Relationship: FICR_MT490102CA.Substance.name 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: IngredientName Relationship: 
         * POME_MT010040CA.Substance.name Conformance/Cardinality: 
         * POPULATED (1) <p>Used for communication between and display 
         * to providers.</p><p>This attribute is marked as 
         ...
         * FICR_MT400003CA.Substance.name Conformance/Cardinality: 
         * REQUIRED (0-1) Un-merged Business Name: IngredientName 
         * Relationship: POME_MT010100CA.Substance.name 
         * Conformance/Cardinality: POPULATED (1) <p>Used for 
         * communication between and display to providers.</p><p>This 
         * attribute is marked as &quot;populated&quot; as an 
         * ingredient name should be available in most cases.</p> 
         * <p>The name of the contained drug or chemical.</p> Un-merged 
         * Business Name: DrugIngredientName Relationship: 
         ...
         * Relationship: COCT_MT220200CA.Substance.name 
         * Conformance/Cardinality: REQUIRED (0-1) 
         * <p>CompoundIngredient.IngredientDrug.drugProductName</p> 
         * <p>Used for communication between and display to 
         * providers.</p> <p>The name of the contained drug or 
         ...
         * providers.</p> <p>The name of the contained drug or 
         * chemical.</p> Un-merged Business Name: DrugIngredientName 
         * Relationship: FICR_MT400004CA.Substance.name 
         * Conformance/Cardinality: REQUIRED (0-1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"ingredient/name"})]
        public String IngredientName {
            get { return this.ingredientName.Value; }
            set { this.ingredientName.Value = value; }
        }
