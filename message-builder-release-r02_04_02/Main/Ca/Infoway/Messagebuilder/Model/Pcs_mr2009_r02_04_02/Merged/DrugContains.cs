...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged {
     ...
     * quantities.</p> <p>Useful to providers in deciding 
     * appropriate use instruction (dosage specification) for 
     * patients. Also important in checking for potential adverse 
     * reactions to non-active ingredients. For compounds, allows 
     * contraindication checking against ingredients of custom 
     * compounds.</p> POME_MT010100CA.Ingredient: drug contains 
     * <p>Identification of which ingredients are contained (or are 
     * not contained) in a drug, along with their respective 
     * quantities.</p> <p>Useful to providers in deciding 
     * appropriate use instruction (dosage specification) for 
     ...
     * reactions to non-active ingredients. For compounds, allows 
     * contraindication checking against ingredients of custom 
     * compounds.</p> COCT_MT220100CA.Ingredient: drug contains 
     * <p>Identification of which ingredients are contained (or are 
     * not contained) in a drug, along with their respective 
     * quantities.</p> <p>Useful to providers in deciding 
     * appropriate use instruction (dosage specification) for 
     ...
     * reactions to non-active ingredients. For compounds, allows 
     * contraindication checking against ingredients of custom 
     * compounds.</p> COCT_MT220200CA.Ingredient: drug contains 
     * <p>Identification of which ingredients are contained (or are 
     * not contained) in a drug, along with their respective 
     * quantities.</p> <p>Useful to providers in deciding 
     * appropriate use instruction (dosage specification) for 
     ...
     * reactions to non-active ingredients. For compounds, allows 
     * contraindication checking against ingredients of custom 
     * compounds.</p> COCT_MT220210CA.Ingredient: drug contains 
     * <p>Identification of which ingredients are contained (or are 
     * not contained) in a drug, along with their respective 
     * quantities.</p> <p>Useful to providers in deciding 
     * appropriate use instruction (dosage specification) for 
     ...
     * reactions to non-active ingredients. For compounds, allows 
     * contraindication checking against ingredients of custom 
     * compounds.</p> COCT_MT220110CA.Ingredient: drug contains 
     * <p>Identification of which ingredients are contained (or are 
     * not contained) in a drug, along with their respective 
     * quantities.</p> <p>Useful to providers in deciding 
     * appropriate use instruction (dosage specification) for 
    ...
    public class DrugContains : MessagePartBean {
        ...
        private PQ quantity;
        private CV drugIngredientIdentifier;
        private ST ingredientName;

        public DrugContains() {
            this.negationInd = new BLImpl();
            this.quantity = new PQImpl();
            this.drugIngredientIdentifier = new CVImpl();
            this.ingredientName = new STImpl();
        }
        /**
         * <summary>D:Drug Does Not Contain Indicator</summary>
         * 
         ...
         * contain&quot; and &quot;does/must not contain&quot; is 
         * essential, however in some circumstances it is necessary to 
         * say &quot;may contain&quot;.</p> L:Does Not Contain 
         ...
         * contain&quot;, this attribute allows null values.</p> Does 
         * Not Contain Indicator <p>An indication that a drug does not 
         * contain the specified ingredient (active or inactive).</p> 
         ...
         * etc.</p><p>Because product descriptions (particularly 
         * herbals) occasionally use the phrase &quot;may 
         * contain&quot;, this attribute allows null values.</p> Drug 
         * Does Not Contain Indicator</remarks>
         */
        ...
        /**
         * <summary>C:Drug Ingredient Quantity</summary>
         * 
         ...
         * M:Ingredient Quantity <p>The quantity of the ingredient in a 
         * drug. This is represented/measured in various forms/units 
         * including: mg, mg/vol, %, etc.</p> <p>Essential for 
         * evaluating appropriate dosage based on strength, as well as 
         * for creating custom compounds with proper composition.</p> 
         * Drug Ingredient Quantity Ingredient Quantity <p>The quantity 
         ...
         * 
         * <remarks>J:Drug Ingredient Identifier <p>The unique 
         * identifier for the drug or chemical.</p> <p>Allows 
         * un-ambiguous identification of the ingredients of a drug for 
         * performing various alert checking.</p><p>Also allows for the 
         * identification of antigens as class of ingredients in 
         * vaccines.</p><p>This attribute is marked as 
         * &quot;populated&quot; as an ingredient code should be 
         * available in most cases.</p> <p>Allows un-ambiguous 
         * identification of the ingredients of a drug for performing 
         * various alert checking.</p><p>Also allows for the 
         * identification of antigens as class of ingredients in 
         * vaccines.</p><p>This attribute is marked as 
         * &quot;populated&quot; as an ingredient code should be 
         * available in most cases.</p> <p>Allows un-ambiguous 
         ...
         * vaccines.</p><p>This attribute is marked as 
         * &quot;populated&quot; as an ingredient code should be 
         * available in most cases.</p> A:Drug Ingredient Identifier 
         ...
         * system)</p><p>ZPB3.6(mnemonic)</p><p>ZPB3.7(print 
         * name)</p><p>ZPJ1.1(mnemonic)</p><p>ZPJ1.2(print 
         * name)</p><p>ZCP.2</p> <p>Allows un-ambiguous identification 
         * of the ingredients of a drug for performing various alert 
         ...
         * of ingredients in vaccines.</p> Drug Ingredient Identifier 
         * <p>The unique identifier for the drug or chemical.</p> 
         * <p>Allows un-ambiguous identification of the ingredients of 
         * a drug for performing various alert checking.</p><p>Also 
         * allows for the identification of antigens as specific class 
         ...
         * in vaccines.</p><p>This attribute is marked as 
         * &quot;populated&quot; as an ingredient code should be 
         * available in most cases.</p> <p>Allows un-ambiguous 
         * identification of the ingredients of a drug for performing 
         * various alert checking.</p><p>Also allows for the 
         ...
         * name)</p><p>ZPJ1.1(mnemonic)</p><p>ZPJ1.2(print 
         * name)</p><p>ZCP.2</p> 
         * <p>CompoundIngredient.IngredientDrug.activeIngredientCode</p><p>CompoundIngredient.IngredientDrug.DIN</p><p>CompoundIngredient.IngredientDrug.hcAigNumber</p><p>CompoundIngredient.IngredientDrug.standardProductId(mnemonic)</p><p>CompoundIngredient.IngredientDrug.standard
         * ... [rest of documentation truncated due to excessive length]
         */
        [Hl7XmlMappingAttribute(new string[] {"ingredient/code"})]
        public ActiveIngredientDrugEntityType DrugIngredientIdentifier {
            get { return (ActiveIngredientDrugEntityType) this.drugIngredientIdentifier.Value; }
            set { this.drugIngredientIdentifier.Value = value; }
        }

        /**
         * <summary>K:Ingredient Name</summary>
         * 
         ...
         * be available in most cases.</p> Ingredient Name <p>The name 
         * of the contained drug or chemical.</p> <p>Used for 
         ...
         * providers.</p><p>This attribute is marked as 
         * &quot;populated&quot; as an ingredient name should be 
         * available in most cases.</p> B:Drug Ingredient Name B:Drug 
         * Ingredient Name <p>The name of the contained drug or 
         * chemical.</p> 
