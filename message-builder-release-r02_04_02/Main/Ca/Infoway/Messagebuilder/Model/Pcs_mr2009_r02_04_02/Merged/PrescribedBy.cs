...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged {
     ...
     * dispensed to the patient.</p> COCT_MT470012CA.Author2: 
     * c:consent overridden by <p>Authorization.signatory(PROV)</p> 
     * <p>Clinical circumstances may demand that a patient's 
     * information be accessed without consent to ensure patient 
     * safety.</p> <p>Indicates that information access was 
     * approved by a provider rather than a patient, client, or 
     * original provider. I.e. This is an override rather than an 
     * actual consent, and is used for the purposes of 'breaking 
     * the glass' only.</p> COCT_MT260022CA.Author1: managed by 
     ...
     * management of the issue.</p> RCMR_MT010001CA.Author2: 
     ...
     * dispensed to the patient.</p> COCT_MT260012CA.Author1: 
     ...
     * managed the issue.</p> COCT_MT260010CA.Author2: is created 
     * by <p>ZPE.1</p> <p>ZDU.5.1</p> 
     ...
     * patient.</p> COCT_MT260030CA.Author1: *managed by 
     * <p>OverrideReason.provider</p> 
     * <p>ManagedContraindication.provider</p> 
     * <p>A_DetectedMedicationIssue</p> <p>Part of the audit record 
     * and therefore mandatory.</p> <p>Identifies the provider who 
     * managed the issue.</p> PORX_MT060100CA.Author2: 
     * *b:prescribed by <p>To be a legal order, the person 
     * responsible for its creation must be identified. Thus the 
     * association is mandatory.</p> <p>This is the provider who 
     * authorized the medication to be dispensed to the 
     * patient.</p> COCT_MT260010CA.Author1: *managed by 
     * <p>OverrideReason.provider</p> 
     * <p>ManagedContraindication.provider</p> 
     * <p>A_DetectedMedicationIssue</p> <p>Part of the audit record 
     * and therefore mandatory.</p> <p>Identifies the provider who 
    ...
    public class PrescribedBy : MessagePartBean {
         ...
         * Relationship: PORX_MT060340CA.Author4.time 
         * Conformance/Cardinality: POPULATED (1) <p>Indicates when the 
         * action was performed, and may influence expiry dates for the 
         * order.</p><p>The attribute is populated because the creation 
         ...
         * Un-merged Business Name: PrescribedDate Relationship: 
         ...
         * PORX_MT030040CA.Author2.time Conformance/Cardinality: 
         * POPULATED (1) <p>Indicates when the action was performed, 
         * and may influence expiry dates for the order.</p><p>The 
         * attribute is populated because the creation date of the 
         * prescription will not always be known (as in the case of 
         ...
         * REQUIRED (0-1) Un-merged Business Name: ManagementDate 
         ...
         * prescription becomes effective. E.g. A prescription created 
         * today may not be valid to be dispensed or administered for 
         * two weeks.</p> Un-merged Business Name: ManagementDate 
