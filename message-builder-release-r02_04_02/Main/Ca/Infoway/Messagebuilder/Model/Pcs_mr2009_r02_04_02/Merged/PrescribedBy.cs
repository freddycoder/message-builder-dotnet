...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged {
     ...
     * PORX_MT060340CA.Author4: *b:prescribed by <p>This is the 
     ...
     * association is mandatory.</p> COCT_MT470012CA.Author2: 
     * c:consent overridden by <p>Indicates that information access 
     * was approved by a provider rather than a patient, client, or 
     * original provider. I.e. This is an override rather than an 
     * actual consent, and is used for the purposes of 'breaking 
     * the glass' only.</p> <p>Authorization.signatory(PROV)</p> 
     * <p>Clinical circumstances may demand that a patient's 
     * information be accessed without consent to ensure patient 
     * safety.</p> COCT_MT260022CA.Author1: managed by 
     ...
     * historical managements.</p> RCMR_MT010001CA.Author2: 
     ...
     * the patient.</p> <p>To be a legal order, the person 
     * responsible for its creation must be identified. Thus the 
     * association is mandatory.</p> PORX_MT060190CA.Author2: 
     ...
     * mandatory.</p> COCT_MT260012CA.Author1: *managed by 
     * <p>Identifies the provider who managed the issue.</p> 
     * <p>OverrideReason.provider</p><p>ManagedContraindication.provider</p><p>A_DetectedMedicationIssue</p> 
     * <p>OverrideReason.provider</p><p>ManagedContraindication.provider</p><p>A_DetectedMedicationIssue</p> 
     * <p>OverrideReason.provider</p><p>ManagedContraindication.provider</p><p>A_DetectedMedicationIssue</p> 
     * <p>Part of the audit record and therefore mandatory.</p> 
     * COCT_MT260010CA.Author2: is created by <p>Identity of the 
     ...
     * COCT_MT470002CA.Author2: c:consent overridden by 
     ...
     * EHR.</p><p>The attribute is marked as &quot;populated&quot; 
     * as the prescriber must be known or null flavour 
     * specified.</p> COCT_MT260030CA.Author2: is created by 
     ...
     * mandatory.</p> COCT_MT260030CA.Author1: *managed by 
     * <p>Identifies the provider who managed the issue.</p> 
     * <p>OverrideReason.provider</p><p>ManagedContraindication.provider</p><p>A_DetectedMedicationIssue</p> 
     * <p>OverrideReason.provider</p><p>ManagedContraindication.provider</p><p>A_DetectedMedicationIssue</p> 
     * <p>OverrideReason.provider</p><p>ManagedContraindication.provider</p><p>A_DetectedMedicationIssue</p> 
     * <p>Part of the audit record and therefore mandatory.</p> 
     * PORX_MT060100CA.Author2: *b:prescribed by <p>This is the 
     * provider who authorized the medication to be dispensed to 
     * the patient.</p> <p>To be a legal order, the person 
     * responsible for its creation must be identified. Thus the 
     * association is mandatory.</p> COCT_MT260010CA.Author1: 
     * *managed by <p>Identifies the provider who managed the 
     * issue.</p> 
     * <p>OverrideReason.provider</p><p>ManagedContraindication.provider</p><p>A_DetectedMedicationIssue</p> 
     * <p>OverrideReason.provider</p><p>ManagedContraindication.provider</p><p>A_DetectedMedicationIssue</p> 
     * <p>OverrideReason.provider</p><p>ManagedContraindication.provider</p><p>A_DetectedMedicationIssue</p> 
     * <p>Part of the audit record and therefore mandatory.</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT260010CA.Author1","COCT_MT260010CA.Author2","COCT_MT260012CA.Author1","COCT_MT260020CA.Author1","COCT_MT260020CA.Author2","COCT_MT260022CA.Author1","COCT_MT260030CA.Author1","COCT_MT260030CA.Author2","COCT_MT470002CA.Author2","COCT_MT470012CA.Author2","PORX_MT020050CA.Author2","PORX_MT030040CA.Author2","PORX_MT060020CA.Author2","PORX_MT060040CA.Author4","PORX_MT060060CA.Author2","PORX_MT060100CA.Author2","PORX_MT060160CA.Author4","PORX_MT060190CA.Author2","PORX_MT060340CA.Author4","RCMR_MT010001CA.Author2"})]
    public class PrescribedBy : MessagePartBean {

        private TS time;
        private CV prescriptionTransmissionMethod;
        private ED<String> signature;
        ...
        public PrescribedBy() {
            ...
            this.prescriptionTransmissionMethod = new CVImpl();
            this.signature = new EDImpl<String>();
        }
        /**
         ...
         * there for inferred prescriptions.</p> B:Issue Monograph 
         * Effective Date <p>The date and time on which the monograph 
         ...
         * Prescribed Date <p>The date that the prescription was 
         * written by the prescriber.</p> <p>Essential information for 
         * a prescription to be legal.</p><p>This information may not 
         ...
         * &quot;populated&quot;.</p> B:Management Date <p>The date and 
         * time on which the provider managed the issue.</p> 
         * <p>ManagedContraindication.CreationDate</p> <p>Part of the 
         * audit record, but not always available and therefore 
         * 'populated'.</p> B:Issue Monograph Effective Date Prescribed 
        ...
        public ParticipationMode PrescriptionTransmissionMethod {
            get { return (ParticipationMode) this.prescriptionTransmissionMethod.Value; }
            set { this.prescriptionTransmissionMethod.Value = value; }
        }
