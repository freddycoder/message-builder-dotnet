...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged {
    ...
    public class RelatedPerson : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Iehr.Merged.IParty, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged.IChoice, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged.IConsenter, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged.IActingPerson, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Coct_mt120600ca.IAssignedPerson {

        private CV code;
        private II relatedPersonIdentifier;
        private PN relatedPersonName;
        private SET<TEL, TelecommunicationAddress> relatedPersonPhonesAndEmails;
        private AD relatedPersonAddress;

        public RelatedPerson() {
            this.code = new CVImpl();
            this.relatedPersonIdentifier = new IIImpl();
            this.relatedPersonName = new PNImpl();
         ...
         * by the patient themselves.</p> </p> </p> Personal 
         * relationship code Personal Relationship Type C:Related 
         * Person Type <p>A coded value indicating how the related 
         * person is related to the patient.</p> </p> </p> Examples are 
         * spouse, child</remarks>
         */
         ...
         * for the related person. May include PHNs, drivers license or 
         * other identifiers.</p> <p>ZPB1.6 (Root)</p><p>ZPB1.7 
        ...
        public Identifier RelatedPersonIdentifier {
            get { return this.relatedPersonIdentifier.Value; }
            set { this.relatedPersonIdentifier.Value = value; }
        }
         ...
         * Name</p><p>04.03</p><p>Prescriber.427-DR</p><p>Prescribing 
         * Physician 
         * Name</p><p>ZPS.18.3</p><p>ZPS.18.4</p><p>ZPS.18.5</p><p>ZPS.19.3</p><p>ZPS.19.4</p><p>ZPS.19.5</p><p>ZPS.10.3</p><p>ZPS.10.4</p><p>ZPS.10.5</p><p>ProviderPreviewInfo.ProviderName</
         * ... [rest of documentation truncated due to excessive length]
         */
        [Hl7XmlMappingAttribute(new string[] {"relationshipHolder/name"})]
        public PersonName RelatedPersonName {
            get { return this.relatedPersonName.Value; }
            set { this.relatedPersonName.Value = value; }
        }
