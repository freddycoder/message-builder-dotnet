...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged {
     ...
     * facility.</p> <p>The location where the supply is expected 
     * to be delivered.</p> 
    ...
    public class ServiceDeliveryLocation : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged.IChoice, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged.IRecipient {
         ...
         * ServiceDeliveryLocationIdentifier</summary>
         * 
         ...
         * composition.</p> Un-merged Business Name: ShipToFacilityId 
         ...
         * medication was shipped.</p> Un-merged Business Name: 
         * ServiceDeliveryLocationIdentifier Relationship: 
         * PRPM_MT301010CA.ServiceDeliveryLocation.id 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Required 
         * attribute supports the validation and identification of the 
         * service delivery location</p> <p>A unique identifier for the 
         * service delivery location.</p> Un-merged Business Name: 
         * LocationIdReference Relationship: 
         * REPC_MT500002CA.ServiceDeliveryLocation.id 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows linking 
         * participants to locations.</p> <p>References the location 
         * for which the participants are being identified. This will 
         * be a location already associated with the care 
         ...
         * specific service delivery location</p> Un-merged Business 
         * Name: ServiceDeliveryLocationType Relationship: 
         * PRPM_MT301010CA.ServiceDeliveryLocation.code 
         * Conformance/Cardinality: MANDATORY (1) <p>Mandatory 
         * attribute supports the validation and identification of the 
         * service delivery location</p> <p>The code identifying the 
         ...
         * specific service delivery location</p> Un-merged Business 
         * Name: ServiceDeliveryLocationTelecom Relationship: 
         ...
         * specific service delivery location</p> Un-merged Business 
         * Name: ServiceDeliveryLocationEffectiveDate Relationship: 
        ...
        /**
         * <summary>Un-merged Business Name: 
         * ServiceDeliveryLocationName</summary>
         * 
         * <remarks>Relationship: PRPM_MT303010CA.Place.name 
         * Conformance/Cardinality: MANDATORY (1) <p>Mandatory 
         * attribute supports the validation and identification of the 
         * service delivery location</p> <p>The name of the service 
         * delivery location</p> Un-merged Business Name: 
         * ServiceDeliveryLocationName Relationship: 
         * PRPM_MT301010CA.Place.name Conformance/Cardinality: 
         * MANDATORY (1) <p>Mandatory attribute supports the validation 
         * and identification of the service delivery location</p> 
         * <p>The name of the service delivery location</p> Un-merged 
         * Business Name: ServiceLocationName Relationship: 
         * COCT_MT240012CA.Place.name Conformance/Cardinality: 
         * MANDATORY (1) <p>PVD.070</p> <p>Dispensing Pharmacy Name</p> 
         * <p>Facility.name</p> <p>Used for human communication, and 
         * for cross-checking of location Id and is therefore 
         * mandatory</p> <p>The name assigned to the service 
         * location.</p></remarks>
         */
