...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Lr.Merged {
    ...
    public class AvailableServices : MessagePartBean {
        ...
        private CV serviceType;
        private CS serviceAvailability;
        private SET<PIVL, PeriodicIntervalTime> serviceAvailabilityTime;

        public AvailableServices() {
            this.serviceType = new CVImpl();
            this.serviceAvailability = new CSImpl();
            this.serviceAvailabilityTime = new SETImpl<PIVL, PeriodicIntervalTime>(typeof(PIVLImpl));
        }
        /**
        ...
        public ActServiceDeliveryLocationService ServiceType {
            get { return (ActServiceDeliveryLocationService) this.serviceType.Value; }
        ...
        public x_ActStatusActiveSuspended ServiceAvailability {
            get { return (x_ActStatusActiveSuspended) this.serviceAvailability.Value; }
            set { this.serviceAvailability.Value = value; }
        }
        ...
        public ICollection<PeriodicIntervalTime> ServiceAvailabilityTime {
            get { return this.serviceAvailabilityTime.RawSet(); }
        }
