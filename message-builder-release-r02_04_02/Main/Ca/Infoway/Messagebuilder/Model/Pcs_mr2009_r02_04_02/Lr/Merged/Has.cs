...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Lr.Merged {
    ...
    public class Has : MessagePartBean {
        ...
        private CV identifierType;
        private ST identifyingOrganization;

        public Has() {
            this.identifier = new IIImpl();
            this.identifierType = new CVImpl();
            this.identifyingOrganization = new STImpl();
        }
        /**
        ...
        public LocationIdentifiedEntityRoleType IdentifierType {
            get { return (LocationIdentifiedEntityRoleType) this.identifierType.Value; }
            set { this.identifierType.Value = value; }
        }
        ...
        public String IdentifyingOrganization {
            get { return this.identifyingOrganization.Value; }
            set { this.identifyingOrganization.Value = value; }
        }
