...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Lr.Merged {
     ...
     * PRPA_MT202307CA.ParameterList: Query Definition <p>Allows 
     ...
     * the records to be retrieved.</p></remarks>
     */
    ...
    public class QueryDefinition : MessagePartBean {
        ...
        /**
         * <summary>Business Name: Address</summary>
         * 
         * <remarks>Un-merged Business Name: Address Relationship: 
         * PRPA_MT202306CA.Address.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Allows filtering the physical location of 
         * the facility.</p> <p>If specified, filters the returned 
         * location records to those in the specified 
         * province/territory or municipality.</p></remarks>
         */
         ...
         * Relationship: PRPA_MT202306CA.AmendedSinceDateTime.value 
         ...
         * Relationship: PRPA_MT202306CA.EHRRepositoryId.value 
         ...
         * Relationship: PRPA_MT202306CA.LocationMobileIndicator.value 
         ...
         * Relationship: PRPA_MT202306CA.LocationPlaceType.value 
        ...
        /**
         * <summary>Business Name: LocationServiceTypes</summary>
         * 
         * <remarks>Un-merged Business Name: LocationServiceTypes 
         * Relationship: PRPA_MT202306CA.LocationServiceType.value 
        ...
        /**
         * <summary>Business Name: NameContains</summary>
         * 
         * <remarks>Un-merged Business Name: NameContains Relationship: 
         * PRPA_MT202306CA.NameContains.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Allows searching by name.</p><p>Note: 
         * Searches should be case-insensitive and should ignore 
         * punctuation and spacing. Some implementations may perform 
         * &quot;sounds-like&quot; searches.</p> <p>Filters the 
         * returned location records to only include those whose name 
         * includes the specified string. If unspecified, no filter is 
         * applied.</p></remarks>
         */
        ...
        /**
         * <summary>Business Name: NearAddress</summary>
         * 
         * <remarks>Un-merged Business Name: NearAddress Relationship: 
         * PRPA_MT202306CA.NearAddress.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Allows retrieving facilities near to a 
         * particular location.</p> <p>Identifies an address that 
         * returned locations should be near to. Results will be 
         * filtered to those appearing within the specified radius from 
         * the identified address.</p></remarks>
         */
         ...
         * PRPA_MT202306CA.ProtocolId.value Conformance/Cardinality: 
         ...
         * PRPA_MT202307CA.ProtocolId.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Allows retrieving records associated with a 
         * particular protocol. Useful in clinical studies and other 
         * research.</p><p>The element is optional because support for 
         * protocols is not deemed a neccesity for many healthcare 
         ...
         * Relationship: PRPA_MT202306CA.RecordStatus.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows 
         ...
         * PRPA_MT202306CA.RecordType.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Allows constraining the type of records to 
         * be retrieved. Multiple repetitions are present to allow 
         * selection of multiple types with a single query.</p><p> 
         ...
         * type(s) or category(ies) of the records to be retrieved. The 
         * query will return both those records whose type exactly 
         * matches, as well as those whose types are subsets of the 
         * specified parameter. If no Types are specified, no 
         * restriction will be placed on the types to be 
        ...
        /**
         * <summary>Business Name: RegionIds</summary>
         * 
         * <remarks>Un-merged Business Name: RegionIds Relationship: 
         * PRPA_MT202306CA.RegionId.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Allows restricting the retrieved locations 
         * to those associated with a particular health region.</p> 
         * <p>If specified, filters the returned location records to 
         * those which are part of the specified 'region'.</p></remarks>
         */
        ...
        /**
         * <summary>Business Name: ResponsibleOrganizationId</summary>
         * 
         * <remarks>Un-merged Business Name: ResponsibleOrganizationId 
         * Relationship: 
        ...
        /**
         * <summary>Business Name: SearchRadius</summary>
         * 
         * <remarks>Un-merged Business Name: SearchRadius Relationship: 
         * PRPA_MT202306CA.SearchRadius.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Allows retrieving facilities near to a 
         * particular location.</p> <p>Identifies the distance from the 
         * &quot;Near Address&quot; within which locations should be 
         * retrieved.</p></remarks>
         */
         ...
         * PRPA_MT202307CA.RecordId.value Conformance/Cardinality: 
