 ...
 * Last modified: $LastChangedDate: 2012-01-18 21:07:06 -0500 (Wed, 18 Jan 2012) $
 * Revision:      $LastChangedRevision: 3954 $
 */
...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Iehr.Repc_mt220004ca {
    ...
    public class QueryDefinition : MessagePartBean {
        ...
        public IList<CareSummaryDocumentType> EventCategories {
            get { return new RawListWrapper<CV, CareSummaryDocumentType>(eventCategories, typeof(CVImpl)); }
        }
        ...
        public IList<ActCareEventType> RecordTypes {
            get { return new RawListWrapper<CD, ActCareEventType>(recordTypes, typeof(CDImpl)); }
        }
