...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Iehr.Merged {
    ...
    public class ComponentObservations_2 : MessagePartBean {
         ...
         * made.</p><p>E.g. score for skin color in an 
         * APGAR</p><p></p><p></p> Un-merged Business Name: 
         * ComponentObservationValue Relationship: 
         * REPC_MT420003CA.SubObservationEvent.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Depending on 
         * CommonCodedClinicalObservationSubType, one of 
         * CommonClinicalObservationResultValue or 
