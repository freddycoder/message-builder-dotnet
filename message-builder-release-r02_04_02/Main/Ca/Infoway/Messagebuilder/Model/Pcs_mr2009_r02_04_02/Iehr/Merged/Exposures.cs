...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Iehr.Merged {
    ...
    public class Exposures : MessagePartBean {
        ...
        private II incidenceIdentifier;
        private CV exposureMethod;
        private CV exposedMaterialType;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Iehr.Merged.AgentCategory consumableAdministrableMaterialAdministerableMaterialKind;

        public Exposures() {
            this.incidenceIdentifier = new IIImpl();
            this.exposureMethod = new CVImpl();
        ...
        public Identifier IncidenceIdentifier {
            get { return this.incidenceIdentifier.Value; }
            set { this.incidenceIdentifier.Value = value; }
        }
         ...
         * the cause of the reaction.</p> C:Exposure Method 
         * <p>routeCode is required if not using SNOMED</p> <p>The 
         * method by which the patient was exposed to the 
         * substance.</p> <p>Helps evaluate the cause of the 
         * reaction.</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"routeCode"})]
        public RouteOfAdministration ExposureMethod {
            get { return (RouteOfAdministration) this.exposureMethod.Value; }
            set { this.exposureMethod.Value = value; }
        }
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Iehr.Merged.AgentCategory ConsumableAdministrableMaterialAdministerableMaterialKind {
