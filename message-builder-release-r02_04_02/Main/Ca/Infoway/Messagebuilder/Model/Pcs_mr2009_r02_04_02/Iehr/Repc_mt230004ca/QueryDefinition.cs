...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Iehr.Repc_mt230004ca {
    ...
    public class QueryDefinition : MessagePartBean {
         ...
         * REPC_MT230004CA.AmendedSinceDateTime.value 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.AttestedIndicator.value 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.CareCompositionId.value 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.CareCompositionType.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: REPC_MT230004CA.EHRRepositoryId.value 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.EffectiveTimeRange.value 
         ...
         * of what information was in effect on the some date in the 
         ...
         * 
         * <remarks>Relationship: REPC_MT230004CA.EventCategory.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows filtering 
        ...
        public IList<ClinicalReportDocumentType> EventCategoryValue {
            get { return new RawListWrapper<CV, ClinicalReportDocumentType>(eventCategoryValue, typeof(CVImpl)); }
        }

        /**
         * <summary>Business Name: O: Event Location Id</summary>
         * 
         * <remarks>Relationship: REPC_MT230004CA.EventLocationId.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.EventLocationType.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: REPC_MT230004CA.HealthCondition.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: REPC_MT230004CA.Indication.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.MostRecentByTypeIndicator.value 
         ...
         * 
         * <remarks>Relationship: REPC_MT230004CA.ProtocolId.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.RecipientLocationId.value 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.RecipientProviderId.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieval 
         ...
         * 
         * <remarks>Relationship: REPC_MT230004CA.RecordStatus.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows 
         ...
         * 
         * <remarks>Relationship: REPC_MT230004CA.RecordType.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows 
        ...
        public IList<ClinicalReportObservationType> RecordTypeValue {
            get { return new RawListWrapper<CD, ClinicalReportObservationType>(recordTypeValue, typeof(CDImpl)); }
        }

        /**
         * <summary>Business Name: ZL: Request Id</summary>
         * 
         * <remarks>Relationship: REPC_MT230004CA.RequestId.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         * records in fulfillment of a particular request.</p> <p>If 
         * specified, filters the returned records to only include 
         * those which are in fulfillment of the specified request 
         * record. If unspecified, no filter is applied.</p></remarks>
         */
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.RequestingProviderId.value 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.ResponsibleProviderId.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT230004CA.ResponsibleProviderType.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
