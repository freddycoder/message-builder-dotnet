 ...
 * Last modified: $LastChangedDate: 2012-01-18 21:06:59 -0500 (Wed, 18 Jan 2012) $
 * Revision:      $LastChangedRevision: 3952 $
 */
...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Iehr.Repc_mt210004ca {
    ...
    public class QueryDefinition : MessagePartBean {
        ...
        public IList<ReferralDocumentType> EventCategories {
            get { return new RawListWrapper<CV, ReferralDocumentType>(eventCategories, typeof(CVImpl)); }
        }
        ...
        public IList<ActCareProvisionRequestType> RecordTypes {
            get { return new RawListWrapper<CD, ActCareProvisionRequestType>(recordTypes, typeof(CDImpl)); }
        }
