...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Iehr.Merged {
     ...
     * encounters, condition-related care (episodes) and 
     * longer-term care collections such as &quot;gynecological 
     * care&quot;.</p> <p>Care compositions allow grouping together 
     * numerous related records which aids searching and 
     ...
     * subsequent care.</p> 
     * REPC_MT500002CA.PatientCareProvisionEvent: Care Composition 
    ...
    public class CareComposition : MessagePartBean {
        ...
        private SET<II, Identifier> careCompositionIds;
        private CV careCompositionType;
        private BL refutedIndicator;
        private CS careCompositionStatus;
        private IVL<TS, Interval<PlatformDate>> careCompositionPeriod;
        private SET<CV, Code> careCompositionMaskingIndicators;
        ...
        public CareComposition() {
            this.careCompositionIds = new SETImpl<II, Identifier>(typeof(IIImpl));
            this.careCompositionType = new CVImpl();
            this.refutedIndicator = new BLImpl();
            this.careCompositionStatus = new CSImpl();
            this.careCompositionPeriod = new IVLImpl<TS, Interval<PlatformDate>>();
            this.careCompositionMaskingIndicators = new SETImpl<CV, Code>(typeof(CVImpl));
            this.subject2Patient = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Coct_mt050202ca.Patient>();
            this.numberOfPatients = new INTImpl();
         ...
         * 
         * <remarks>A: Care Composition Ids </p> </p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"id"})]
        public ICollection<Identifier> CareCompositionIds {
            get { return this.careCompositionIds.RawSet(); }
        }

        /**
         * <summary>CareCompositionType</summary>
         * 
         * <remarks>B: Care Composition Type </p><p>Care Composition is 
         * the generic name given to event 'containers' such as 
         * Encounters, Health-Condition-based Collections (Episodes) 
         * and Care-based Collections. The &quot;type&quot; of care 
         * composition places constraints on what elements are 
        ...
        public ActCareEventType CareCompositionType {
            get { return (ActCareEventType) this.careCompositionType.Value; }
            set { this.careCompositionType.Value = value; }
        }

        /**
         * <summary>RefutedIndicator</summary>
         * 
         * <remarks>D:Refuted Indicator <p>Refuted Indicator cannot be 
         * specified unless Care Composition Type is Encounter or a 
         * specialization there-of.</p> </p> </p> </p></remarks>
         */
        ...
        /**
         * <summary>CareCompositionStatus</summary>
         * 
         * <remarks>C: Care Composition Status </p> </p> </p> </p> C: 
         * Care Composition Status </p> </p> </p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"statusCode"})]
        public ActStatus CareCompositionStatus {
            get { return (ActStatus) this.careCompositionStatus.Value; }
            set { this.careCompositionStatus.Value = value; }
        }

        /**
         * <summary>CareCompositionPeriod</summary>
         * 
         * <remarks>F: Care Composition Period <p>Represents the start 
        ...
        public Interval<PlatformDate> CareCompositionPeriod {
            get { return this.careCompositionPeriod.Value; }
            set { this.careCompositionPeriod.Value = value; }
        }

        /**
         * <summary>CareCompositionMaskingIndicators</summary>
         * 
         * <remarks>E: Care Composition Masking Indicators 
        ...
        public ICollection<x_BasicConfidentialityKind> CareCompositionMaskingIndicators {
            get { return this.careCompositionMaskingIndicators.RawSet<x_BasicConfidentialityKind>(); }
        }
        ...
        /**
         * <summary>NumberOfPatients</summary>
         * 
         * <remarks>J:Number of Patients <p>Indicates the number of 
         * patients involved in a group encounter. For non-group 
         * encounters, this attribute will always be &quot;1&quot;.</p> 
         ...
         * making this element mandatory.</p> <p>Allows a provider to 
         ...
         * will always be known, making this element mandatory.</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subject3/patient/patientEntityQuantifiedKind/quantity"})]
        public int? NumberOfPatients {
            get { return this.numberOfPatients.Value; }
            set { this.numberOfPatients.Value = value; }
        }
