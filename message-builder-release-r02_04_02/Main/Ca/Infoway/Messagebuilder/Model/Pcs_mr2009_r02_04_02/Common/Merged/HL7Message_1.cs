...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged {
    ...
    public class HL7Message_1<CAE> : MessagePartBean {
        ...
        private II messageIdentifier;
        private TS messageTimestamp;
        private ST securityToken;
        private CS responseType;
        private II interactionType;
        private LIST<II, Identifier> conformanceProfileIdentifiers;
        private CS processingCode;
        private CS desiredAcknowledgmentType;
        ...
        private CS processingMode;

        public HL7Message_1() {
            this.messageIdentifier = new IIImpl();
            this.messageTimestamp = new TSImpl();
            this.securityToken = new STImpl();
            this.responseType = new CSImpl();
            this.interactionType = new IIImpl();
            this.conformanceProfileIdentifiers = new LISTImpl<II, Identifier>(typeof(IIImpl));
            this.processingCode = new CSImpl();
            this.desiredAcknowledgmentType = new CSImpl();
            this.attentionLine = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged.RoutingInstructionLines>();
            this.processingMode = new CSImpl();
        }
        /**
        ...
        public Identifier MessageIdentifier {
            get { return this.messageIdentifier.Value; }
            set { this.messageIdentifier.Value = value; }
        }
        ...
        public PlatformDate MessageTimestamp {
            get { return this.messageTimestamp.Value; }
            set { this.messageTimestamp.Value = value; }
        }
        ...
        public String SecurityToken {
            get { return this.securityToken.Value; }
            set { this.securityToken.Value = value; }
        }
         ...
         * application level response is desired immediately (as a 
         * direct acknowledgement), on a deferred basis (as a 
         * subsequent independent interaction) or via queue using 
         * polling.</p> <p>soap:Header\wsa:Action (after the second 
         * underscore, if any, D otherwise)</p> <p>Essential to 
         * determining receiver behavior and therefore mandatory.</p> 
         * DA: Response Type <p>Identifies whether the response is 
         * desired immediately (as a direct acknowledgement), on a 
         * deferred basis (as a subsequent independent interaction) or 
         * via queue using polling.</p> <p>soap:Header\wsa:Action 
         * (after the second underscore, if any, D otherwise)</p> 
        ...
        public ResponseMode ResponseType {
            get { return (ResponseMode) this.responseType.Value; }
            set { this.responseType.Value = value; }
        }
        ...
        public Identifier InteractionType {
            get { return this.interactionType.Value; }
            set { this.interactionType.Value = value; }
        }
        ...
        public IList<Identifier> ConformanceProfileIdentifiers {
            get { return this.conformanceProfileIdentifiers.RawList(); }
        }
        ...
        public AcknowledgementCondition DesiredAcknowledgmentType {
            get { return (AcknowledgementCondition) this.desiredAcknowledgmentType.Value; }
            set { this.desiredAcknowledgmentType.Value = value; }
        }
        ...
        public ProcessingMode ProcessingMode {
            get { return (ProcessingMode) this.processingMode.Value; }
            set { this.processingMode.Value = value; }
        }
