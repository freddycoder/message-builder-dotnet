 ...
 * Last modified: $LastChangedDate: 2012-01-18 21:02:55 -0500 (Wed, 18 Jan 2012) $
 * Revision:      $LastChangedRevision: 3912 $
 */
...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Coct_mt141007ca {
    ...
    public class DeviceProduct : MessagePartBean {
        ...
        private CV deviceCode;
        private ST deviceName;
        private ST deviceDescription;
        private INT devicePackageQuantity;

        public DeviceProduct() {
            this.deviceCode = new CVImpl();
            this.deviceName = new STImpl();
            this.deviceDescription = new STImpl();
            this.devicePackageQuantity = new INTImpl();
        }
        /**
        ...
        public Code DeviceCode {
            get { return (Code) this.deviceCode.Value; }
            set { this.deviceCode.Value = value; }
        }
        ...
        public String DeviceDescription {
            get { return this.deviceDescription.Value; }
            set { this.deviceDescription.Value = value; }
        }
        ...
        public int? DevicePackageQuantity {
            get { return this.devicePackageQuantity.Value; }
            set { this.devicePackageQuantity.Value = value; }
        }
