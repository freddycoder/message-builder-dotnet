...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged {
    ...
    public class Sender : MessagePartBean {
        ...
        private TEL sendingNetworkAddress;
        private II sendingApplicationIdentifier;
        private ST sendingApplicationName;
        private ST sendingApplicationConfigurationInformation;
        private IVL<TS, Interval<PlatformDate>> sendingApplicationVersionDate;
        private ST sendingSoftwareVersionNumber;
        private ST sendingApplicationSoftwareName;
        private II sendingOrganizationIdentifier;

        public Sender() {
            this.sendingNetworkAddress = new TELImpl();
            this.sendingApplicationIdentifier = new IIImpl();
            this.sendingApplicationName = new STImpl();
            this.sendingApplicationConfigurationInformation = new STImpl();
            this.sendingApplicationVersionDate = new IVLImpl<TS, Interval<PlatformDate>>();
            this.sendingSoftwareVersionNumber = new STImpl();
            this.sendingApplicationSoftwareName = new STImpl();
            this.sendingOrganizationIdentifier = new IIImpl();
        }
        /**
        ...
        public TelecommunicationAddress SendingNetworkAddress {
            get { return this.sendingNetworkAddress.Value; }
            set { this.sendingNetworkAddress.Value = value; }
        }
        ...
        public Identifier SendingApplicationIdentifier {
            get { return this.sendingApplicationIdentifier.Value; }
            set { this.sendingApplicationIdentifier.Value = value; }
        }
        ...
        public String SendingApplicationName {
            get { return this.sendingApplicationName.Value; }
            set { this.sendingApplicationName.Value = value; }
        }
        ...
        public String SendingApplicationConfigurationInformation {
            get { return this.sendingApplicationConfigurationInformation.Value; }
            set { this.sendingApplicationConfigurationInformation.Value = value; }
        }
        ...
        public Interval<PlatformDate> SendingApplicationVersionDate {
            get { return this.sendingApplicationVersionDate.Value; }
            set { this.sendingApplicationVersionDate.Value = value; }
        }
        ...
        public String SendingSoftwareVersionNumber {
            get { return this.sendingSoftwareVersionNumber.Value; }
            set { this.sendingSoftwareVersionNumber.Value = value; }
        }
        ...
        public String SendingApplicationSoftwareName {
            get { return this.sendingApplicationSoftwareName.Value; }
            set { this.sendingApplicationSoftwareName.Value = value; }
        }
        ...
        public Identifier SendingOrganizationIdentifier {
            get { return this.sendingOrganizationIdentifier.Value; }
            set { this.sendingOrganizationIdentifier.Value = value; }
        }
