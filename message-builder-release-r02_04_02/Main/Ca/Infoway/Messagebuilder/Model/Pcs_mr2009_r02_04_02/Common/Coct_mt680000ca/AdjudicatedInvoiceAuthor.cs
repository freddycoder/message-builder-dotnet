...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Coct_mt680000ca {
    ...
    public class AdjudicatedInvoiceAuthor : MessagePartBean {
        ...
        private ED<String> eOBSignature;
        private ST adjudicatorDeviceSoftwareName;

        public AdjudicatedInvoiceAuthor() {
            this.eOBSignature = new EDImpl<String>();
            this.adjudicatorDeviceSoftwareName = new STImpl();
        }
        /**
         * <summary>EOB signature</summary>
         * 
         * <remarks><p>EOB signature</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"signatureText"})]
        public String EOBSignature {
            get { return this.eOBSignature.Value; }
            set { this.eOBSignature.Value = value; }
        }
        ...
        public String AdjudicatorDeviceSoftwareName {
            get { return this.adjudicatorDeviceSoftwareName.Value; }
            set { this.adjudicatorDeviceSoftwareName.Value = value; }
        }
