...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged {
     ...
     * patient in order for the specified recommended dosage range 
     * to apply.</p> <p>Allows recommended dosage instructions to 
     * be bound to a particular characteristic of the patient.</p> 
     * COCT_MT260010CA.ObservationEventCriterion: Dosage 
     * Preconditions <p>A condition that must be true for the 
     * patient in order for the specified recommended dosage range 
     * to apply.</p> <p>Allows recommended dosage instructions to 
     * be bound to a particular characteristic of the patient.</p></remarks>
     */
    ...
    public class DosagePreconditions : MessagePartBean {
        ...
        private CV dosagePreconditionType;
        private URG<PQ, PhysicalQuantity> dosagePreconditionValue;

        public DosagePreconditions() {
            this.dosagePreconditionType = new CVImpl();
            this.dosagePreconditionValue = new URGImpl<PQ, PhysicalQuantity>();
        }
        /**
         ...
         * Precondition Type</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"code"})]
        public ObservationDosageDefinitionPreconditionType DosagePreconditionType {
            get { return (ObservationDosageDefinitionPreconditionType) this.dosagePreconditionType.Value; }
            set { this.dosagePreconditionType.Value = value; }
        }
         ...
         * Precondition Value B:Dosage Precondition Value <p>A specific 
         * value or range of values of the Dosage Precondition Type, 
         * for which the recommended dosage applies.</p><p>This 
         * includes min-max age range, min-max weights, etc.</p><p>This 
         ...
         * expressed.</p> <p>If not specified, it means that the range 
         * is based on a criteria (e.g. weight), but the specific range 
         * on which the criteria is based is not known.</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"value"})]
        public UncertainRange<PhysicalQuantity> DosagePreconditionValue {
            get { return this.dosagePreconditionValue.Value; }
            set { this.dosagePreconditionValue.Value = value; }
        }
