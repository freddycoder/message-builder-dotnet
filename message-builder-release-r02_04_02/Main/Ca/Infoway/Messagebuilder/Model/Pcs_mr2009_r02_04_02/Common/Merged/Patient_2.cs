...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged {
    ...
    public class Patient_2 : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged.IActingPerson, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Merged.IPatient {
         ...
         * Conformance/Cardinality: POPULATED (1-3) <p>C39 
         ...
         * or some other non-client-registry identifier.</p> Un-merged 
         * Business Name: PatientIdentifier Relationship: 
         * COCT_MT050208CA.Patient.id Conformance/Cardinality: 
         * MANDATORY (1-3) <p>C39 (Extension)</p> <p>PTT.050.01 
         ...
         * mandatory. The cardinality of patient identifiers is up to 3 
         * based on the use case to support communication of a local 
         * and jurisdictional identifier along with the national 
         * identifier.</p> <p>Unique identifier assigned to a person by 
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: COCT_MT050207CA.Patient.patientPerson 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * COCT_MT050208CA.Patient.patientPerson 
