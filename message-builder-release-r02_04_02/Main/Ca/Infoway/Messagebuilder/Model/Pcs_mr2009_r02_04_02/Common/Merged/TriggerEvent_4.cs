...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged {
     ...
     * MFMI_MT700717CA.ControlActEvent: Trigger Event <p>Key to 
    ...
    public class TriggerEvent_4<RR> : MessagePartBean {
         ...
         * Relationship: MFMI_MT700726CA.ControlActEvent.id 
         ...
         * MFMI_MT700717CA.ControlActEvent.id Conformance/Cardinality: 
         ...
         * MFMI_MT700726CA.ControlActEvent.code 
         ...
         * Relationship: MFMI_MT700717CA.ControlActEvent.code 
         * Conformance/Cardinality: MANDATORY (1) <p>This is mandatory 
         * because it is essential to understanding the meaning of the 
         * event.</p> <p>Identifies the trigger event that 
         * occurred.</p></remarks>
         ...
         * Relationship: MFMI_MT700726CA.ControlActEvent.effectiveTime 
         ...
         * Relationship: MFMI_MT700717CA.ControlActEvent.reasonCode 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Allows 
         * identifying a reason for a specific action, such as 'reason 
         * for hold' or 'reason for accessing information'.</p> <p>The 
         * domain associated with this attribute will vary for each 
         ...
         * Relationship: MFMI_MT700726CA.ControlActEvent.languageCode 
         ...
         * MFMI_MT700726CA.ControlActEvent.subject 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * MFMI_MT700717CA.ControlActEvent.subject 
         ...
         * Name: (no business name specified) Relationship: 
         * MFMI_MT700717CA.Subject.detectedIssueEvent 
