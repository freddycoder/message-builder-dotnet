...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged {
    ...
    public class Acknowledgement : MessagePartBean {
        ...
        private CS acknowledgementCode;
        private INT numberOfWaitingMessages;
        private CV messageWaitingPriority;
        private II acknowledgedMessageId;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged.ErrorsOrWarnings> acknowledgementDetail;

        public Acknowledgement() {
            this.acknowledgementCode = new CSImpl();
            this.numberOfWaitingMessages = new INTImpl();
            this.messageWaitingPriority = new CVImpl();
            this.acknowledgedMessageId = new IIImpl();
            this.acknowledgementDetail = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged.ErrorsOrWarnings>();
        }
        /**
        ...
        public AcknowledgementType AcknowledgementCode {
            get { return (AcknowledgementType) this.acknowledgementCode.Value; }
            set { this.acknowledgementCode.Value = value; }
        }
        ...
        public int? NumberOfWaitingMessages {
            get { return this.numberOfWaitingMessages.Value; }
            set { this.numberOfWaitingMessages.Value = value; }
        }
        ...
        public MessageWaitingPriority MessageWaitingPriority {
            get { return (MessageWaitingPriority) this.messageWaitingPriority.Value; }
            set { this.messageWaitingPriority.Value = value; }
        }
        ...
        public Identifier AcknowledgedMessageId {
            get { return this.acknowledgedMessageId.Value; }
            set { this.acknowledgedMessageId.Value = value; }
        }

        [Hl7XmlMappingAttribute(new string[] {"acknowledgementDetail"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged.ErrorsOrWarnings> AcknowledgementDetail {
