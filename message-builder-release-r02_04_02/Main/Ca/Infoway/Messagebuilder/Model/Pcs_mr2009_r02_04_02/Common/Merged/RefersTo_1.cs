...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged {
     ...
     * QUQI_MT120008CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     * not present.</p> <p>Indicates the item(s) being acted upon 
     * by this trigger event.</p><p>Will be mandatory in wrappers 
     * with payload messages, otherwise not present.</p> 
     * <p>Provides information about the thing being created, 
     * modified or removed.</p> <p>If there are multiple subject 
     * items, the changes to all of them must be either accepted or 
     * rejected as a single action. I.e. One trigger event = 1 unit 
     * of work.</p> MCAI_MT700211CA.Subject2: f:refers to <p>On 
     * creation interactions where the state transition is 
     * null-&gt;active, contextConductionInd must be true, 
     * otherwise it must be false.</p> <p>Indicates the item(s) 
     * being acted upon by this trigger event.</p><p>Will be 
     * mandatory in wrappers with payload messages, otherwise not 
     * present.</p> <p>Indicates the item(s) being acted upon by 
     * this trigger event.</p><p>Will be mandatory in wrappers with 
     * payload messages, otherwise not present.</p> <p>Provides 
     ...
     * work.</p> MCAI_MT700221CA.Subject2: f:refers to <p>On 
     * creation interactions where the state transition is 
     * null-&gt;active, contextConductionInd must be true, 
     * otherwise it must be false.</p> <p>Indicates the item(s) 
     * being acted upon by this trigger event.</p><p>Will be 
     ...
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     * work.</p> MCAI_MT700212CA.Subject2: f:refers to <p>On 
     * creation interactions where the state transition is 
     * null-&gt;active, contextConductionInd must be true, 
     * otherwise it must be false.</p> <p>Indicates the item(s) 
     * being acted upon by this trigger event.</p><p>Will be 
     ...
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     * work.</p> MCAI_MT700217CA.Subject2: f:refers to <p>On 
     * creation interactions where the state transition is 
     * null-&gt;active, contextConductionInd must be true, 
     * otherwise it must be false.</p> <p>Indicates the item(s) 
     * being acted upon by this trigger event.</p><p>Will be 
     ...
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     * work.</p> MCAI_MT700218CA.Subject2: f:refers to <p>On 
     * creation interactions where the state transition is 
     * null-&gt;active, contextConductionInd must be true, 
     * otherwise it must be false.</p> <p>Indicates the item(s) 
     * being acted upon by this trigger event.</p><p>Will be 
     ...
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     * work.</p> MCAI_MT700226CA.Subject2: f:refers to <p>On 
     * creation interactions where the state transition is 
     * null-&gt;active, contextConductionInd must be true, 
     * otherwise it must be false.</p> <p>Indicates the item(s) 
     * being acted upon by this trigger event.</p><p>Will be 
     ...
     * changes to all of them must be either accepted or rejected 
     * as a single action. I.e. One trigger event = 1 unit of 
     * work.</p> MCAI_MT700210CA.Subject2: f:refers to <p>Indicates 
     * the item(s) being acted upon by this trigger 
     * event.</p><p>Will be mandatory in wrappers with payload 
     ...
     * already present in the payload).</p> <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     * not present.</p><p>If true, associations in the parent act 
    ...
    public class RefersTo_1<ACT> : MessagePartBean {
        ...
        private BL cascadeResponsibilityIndicator;
        private ACT act;

        public RefersTo_1() {
            this.cascadeResponsibilityIndicator = new BLImpl();
        }
        /**
         ...
         * the state transition is null-&gt;active, 
         * contextConductionInd must be true, otherwise it must be 
         * false.</p> <p>Indicates whether or not objects of the 
         ...
         * the payload).</p> <p>Indicates whether or not objects of the 
         * trigger event are to be cascaded to the payload.</p><p>If 
         * true, associations in the parent act are conducted across 
         * the ActRelationship to the message payload (act). Conduction 
         * for each association is specifically indicated by each 
         ...
         * dataEnterer.contextControlCode (AP = propogate to the 
         * payload and add to any data enterer(s) already present in 
         * the payload).</p> <p>Cascading of trigger event objects 
         ...
         * subjectOf association is carried (to the payload) according 
         * to the subjectOf.contextControlCode (AP = propogate to the 
         * payload and add to any subject(s) (issues) already present 
         ...
         * indicated by each associations' contextControlCode 
         * value.</p><p>In other words, if the &quot;subject&quot; act 
         * relationship has contextConductionInd=t
         * ... [rest of documentation truncated due to excessive length]
         */
        [Hl7XmlMappingAttribute(new string[] {"contextConductionInd"})]
        public bool? CascadeResponsibilityIndicator {
            get { return this.cascadeResponsibilityIndicator.Value; }
            set { this.cascadeResponsibilityIndicator.Value = value; }
        }
