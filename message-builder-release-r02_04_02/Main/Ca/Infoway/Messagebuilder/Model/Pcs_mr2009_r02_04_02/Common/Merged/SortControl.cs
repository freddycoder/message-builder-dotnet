...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Merged {
    ...
    public class SortControl : MessagePartBean {
        ...
        private ST sortElementName;
        private CS sortControlDirection;

        public SortControl() {
            this.sequenceNumber = new INTImpl();
            this.sortElementName = new STImpl();
            this.sortControlDirection = new CSImpl();
        }
        /**
        ...
        public String SortElementName {
            get { return this.sortElementName.Value; }
            set { this.sortElementName.Value = value; }
        }
        ...
        public Sequencing SortControlDirection {
            get { return (Sequencing) this.sortControlDirection.Value; }
            set { this.sortControlDirection.Value = value; }
        }
