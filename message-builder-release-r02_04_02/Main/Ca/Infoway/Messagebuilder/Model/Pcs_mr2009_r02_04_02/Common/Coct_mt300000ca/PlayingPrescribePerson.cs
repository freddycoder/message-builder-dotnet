 ...
 * Last modified: $LastChangedDate: 2012-01-19 07:12:42 -0500 (Thu, 19 Jan 2012) $
 * Revision:      $LastChangedRevision: 4405 $
 */
...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Coct_mt300000ca {
    ...
    public class PlayingPrescribePerson : MessagePartBean {
        ...
        private II prescriberID;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Coct_mt300000ca.PersonPrescribing playingPrescriberPerson;

        public PlayingPrescribePerson() {
            this.prescriberID = new IIImpl();
        }
        /**
        ...
        public Identifier PrescriberID {
            get { return this.prescriberID.Value; }
            set { this.prescriberID.Value = value; }
        }

        [Hl7XmlMappingAttribute(new string[] {"playingPrescriberPerson"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Coct_mt300000ca.PersonPrescribing PlayingPrescriberPerson {
