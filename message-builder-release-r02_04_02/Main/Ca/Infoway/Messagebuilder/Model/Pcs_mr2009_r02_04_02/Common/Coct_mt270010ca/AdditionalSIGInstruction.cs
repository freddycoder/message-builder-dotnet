...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Coct_mt270010ca {
    ...
    public class AdditionalSIGInstruction : MessagePartBean {
        ...
        private ST additionalDosageInstruction;

        public AdditionalSIGInstruction() {
            this.dosageUsageContext = new CSImpl();
            this.additionalDosageInstruction = new STImpl();
        }
        /**
        ...
        public String AdditionalDosageInstruction {
            get { return this.additionalDosageInstruction.Value; }
            set { this.additionalDosageInstruction.Value = value; }
        }
