 ...
 * Last modified: $LastChangedDate: 2012-01-18 21:03:07 -0500 (Wed, 18 Jan 2012) $
 * Revision:      $LastChangedRevision: 3915 $
 */
...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Coct_mt220200ca {
    ...
    public class DrugProduct : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_02.Common.Coct_mt270010ca.IMedication {
        ...
        private CV drugForm;
        private ST drugLotNumber;
        private IVL<TS, Interval<PlatformDate>> drugExpiryDate;
        ...
        public DrugProduct() {
            this.drugCode = new CDImpl();
            this.drugName = new STImpl();
            this.drugDescription = new STImpl();
            this.drugForm = new CVImpl();
            this.drugLotNumber = new STImpl();
            this.drugExpiryDate = new IVLImpl<TS, Interval<PlatformDate>>();
         ...
         * (code system)</p><p>Claim.407-D7 
         * (mnemonic)</p><p>Claim.453-EJ (code 
         * system)</p><p>Claim.445-EA (mnemonic)</p>
         * ... [rest of documentation truncated due to excessive length]
         */
        [Hl7XmlMappingAttribute(new string[] {"administerableMedicine/code"})]
        public ManufacturedDrug DrugCode {
            get { return (ManufacturedDrug) this.drugCode.Value; }
        ...
        public String DrugLotNumber {
            get { return this.drugLotNumber.Value; }
            set { this.drugLotNumber.Value = value; }
        }
        ...
        public Interval<PlatformDate> DrugExpiryDate {
            get { return this.drugExpiryDate.Value; }
            set { this.drugExpiryDate.Value = value; }
        }
