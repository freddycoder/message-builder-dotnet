...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_shr.Common.Rcmr_mt000001ab {
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"RCMR_MT000001AB.Document"})]
    public class DocumentInformation : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_shr.Common.Merged.AssignedDataSource informantAssignedDataSource;
         ...
         * 
         * <remarks>Relationship: RCMR_MT000001AB.Document.id 
         ...
         * 
         * <remarks>Relationship: RCMR_MT000001AB.Document.code 
         ...
         * 
         * <remarks>Relationship: RCMR_MT000001AB.Document.title 
         ...
         * 
         * <remarks>Relationship: RCMR_MT000001AB.Document.statusCode 
         ...
         * RCMR_MT000001AB.Document.effectiveTime 
         ...
         * 
         * <remarks>Relationship: 
         * RCMR_MT000001AB.Document.confidentialityCode 
         ...
         * 
         * <remarks>Relationship: 
         * RCMR_MT000001AB.Document.versionNumber 
         * Conformance/Cardinality: REQUIRED (1) <p>Report version 
         * number from the repository.</p></remarks>
         */
        ...
        /**
         * <summary>Relationship: RCMR_MT000001AB.RecordTarget.patient</summary>
         * 
        ...
        /**
         * <summary>Relationship: RCMR_MT000001AB.Document.author</summary>
         * 
         ...
         * RCMR_MT000001AB.Informant.assignedDataSource</summary>
         * 
         * <remarks>Conformance/Cardinality: MANDATORY (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"informant/assignedDataSource"})]
        public Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03_shr.Common.Merged.AssignedDataSource InformantAssignedDataSource {
            get { return this.informantAssignedDataSource; }
            set { this.informantAssignedDataSource = value; }
        }

        /**
         * <summary>Business Name: Repository ID</summary>
         * 
         * <remarks>Relationship: RCMR_MT000001AB.Repository.id 
         ...
         * 
         * <remarks>Relationship: RCMR_MT000001AB.ServiceEvent.code 
         * Conformance/Cardinality: MANDATORY (1) <p>A coded value that 
         * represents the procedure being documented.</p></remarks>
         */
        ...
        /**
         * <summary>Relationship: 
         * RCMR_MT000001AB.PertinentInformation.documentObservation</summary>
         * 
         * <remarks>Conformance/Cardinality: REQUIRED (1)</remarks>
         */
