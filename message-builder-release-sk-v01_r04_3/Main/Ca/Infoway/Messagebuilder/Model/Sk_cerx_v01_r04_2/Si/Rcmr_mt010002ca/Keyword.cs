...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Si.Rcmr_mt010002ca {
    ...
    public class Keyword : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt050203ca.Patient subject1Patient;
        private ST authorSignatureText;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Si.Merged.IConsenter authorConsenter;
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt050203ca.Patient Subject1Patient {
         ...
         * keyword associated with a particular consent.</p> 
         * <p>ZKW.5</p><p>ZZZ.9</p> <p>ZKW.5</p><p>ZZZ.9</p> <p>Allows 
         * patients to change their keyword. If explicitly set to null, 
         * removes the keyword for the identified record types. Because 
         * of this, the attribute is set to 'populated' and not 
         * mandatory.</p> <p>The create/update/remove function is done 
         * in tandem with the use of the Consent CMET. To Create - the 
         * keyword in the consent CMET contains a null value and the 
         * message pa yload will provide the new keyword value To 
         * Update - the old keyword would be submitted in the consent 
         * CMET (and must match to the existing keyword), while the 
         * message payload will contain the new keyword value To Remove 
         * - the old kwyord is submitted in the consent CMET (and must 
         * match to the existing keyword), while the message payload 
         * will contain a null value which will replace the old keyword 
         * value</p></remarks>
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Si.Merged.IConsenter AuthorConsenter {
            get { return this.authorConsenter; }
            set { this.authorConsenter = value; }
        }

        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Si.Merged.Patient AuthorConsenterAsPatient {
            get { return this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Si.Merged.Patient ? (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Si.Merged.Patient) this.authorConsenter : (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Si.Merged.Patient) null; }
        }
        public bool HasAuthorConsenterAsPatient() {
            return (this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Si.Merged.Patient);
        }

        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt040205ca.ResponsiblePerson AuthorConsenterAsResponsibleParty {
            get { return this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt040205ca.ResponsiblePerson ? (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt040205ca.ResponsiblePerson) this.authorConsenter : (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt040205ca.ResponsiblePerson) null; }
        }
        public bool HasAuthorConsenterAsResponsibleParty() {
            return (this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt040205ca.ResponsiblePerson);
        }
