...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged {
    ...
    public class DrugIngredients : MessagePartBean {
        ...
        /**
         * <summary>Un-merged Business Name: DrugIngredientIdentifier</summary>
         * 
         * <remarks>Relationship: COCT_MT220200CA.Substance.code 
         ...
         * of ingredients in vaccines.</p> <div>PIN requires that an 
         * ingredient code be given.</div> <div>Ingredients that do not 
         * have a code will not be</div> <div>sent.</div> <p>This 
         * identifier must be the FDB HIC.&nbsp;</p> Un-merged Business 
         * Name: DrugIngredientCode Relationship: 
