...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged {
    ...
    public class GenericQueryParameters : MessagePartBean {
         ...
         * attribute must be known, it is mandatory.</p> Un-merged 
         * Business Name: IssueFilterCode Relationship: 
         ...
         * attribute must be known, it is mandatory.</p> Un-merged 
         * Business Name: IssueFilterCode Relationship: 
         * PORX_MT060030CA.IssueFilterCode.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Indicates whether 
         * records to be returned (e.g. prescription order, 
         * prescription dispense and/or other medication) should be 
         * filtered to those with at least one persistent un-managed 
         ...
         * mandatory.</p> Un-merged Business Name: PatientBirthDate 
         ...
         * gender of the patient.</p> <p>Used to confirm the identity 
         * of the patient for the query and is therefore mandatory.</p> 
         ...
         * error that may be raised.)</strong></p> Un-merged Business 
         * Name: PatientBirthDate Relationship: 
         ...
         * identity of the patient for the query and is therefore 
         * mandatory.</p> Un-merged Business Name: PatientGender 
         ...
         * Un-merged Business Name: PatientGender Relationship: 
         * REPC_MT000004CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> 
         ...
         * be raised.)</strong></p> Un-merged Business Name: 
         * PatientGender Relationship: 
         * REPC_MT000015CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> Un-merged 
         * Business Name: PatientGender Relationship: 
         * PORX_MT060030CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> Un-merged 
         * Business Name: PatientGender Relationship: 
         * REPC_MT000016CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> Un-merged 
         * Business Name: PatientGender Relationship: 
         * PORX_MT060280CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> Un-merged 
         * Business Name: PatientGender Relationship: 
         * PORX_MT060270CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> Un-merged 
         * Business Name: PatientGender Relationship: 
         * REPC_MT000008CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> Un-merged 
         * Business Name: PatientGender Relationship: 
         * PORX_MT060220CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> Un-merged 
         * Business Name: PatientGender Relationship: 
         * PORX_MT060110CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> Un-merged 
         * Business Name: PatientGender Relationship: 
         * PORX_MT060360CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> Un-merged 
         * Business Name: PatientGender Relationship: 
         * PORX_MT060170CA.PatientGender.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the gender (sex) of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p></remarks>
         */
         ...
         * MANDATORY (1) <p>Identifier of the patient who is the 
         * subject of the query. Filter the result set to include only 
         * those records pertaining to the patient with this Id.</p> 
         * <p>Allows filtering of result set by patient Id. This is a 
         * mandatory field because a patient must be specified for the 
         * query to be valid</p> Un-merged Business Name: PatientID 
         ...
         * be valid</p> Un-merged Business Name: PatientID 
         ...
         * specified for the query to be valid</p> Un-merged Business 
         * Name: PatientID Relationship: 
         * PORX_MT060080CA.PatientID.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Identifier of the patient who is the 
         * subject of the patient medication query. Filter the result 
         ...
         * be specified for the query to be valid</p> Un-merged 
         * Business Name: PatientID Relationship: 
         * REPC_MT120002CA.PatientID.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Identifier of the patient who is the 
         * subject of the patient measurement query. Filter the result 
         * set to include only those records pertaining to the patient 
         * with this Id.</p> <p>Allows filtering of result set by 
         * patient Id. This is a mandatory field because a patient must 
         * be specified for the query to be valid</p> Un-merged 
         * Business Name: PatientID Relationship: 
         * REPC_MT000004CA.PatientID.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Identifier of the patient who is the 
         * subject of the allergy/intolerance query. Filter the result 
         * set to include only those records pertaining to the patient 
         * with this Id.</p> <p>Allows filtering of result set by 
         * patient Id. This is a mandatory field because a patient must 
         * be specified for the query to be valid.</p> <p>Identifier of 
         * the patient who is the subject of the allergy/intolerance 
         * query. Filter the result set to include only those records 
         * pertaining to the patient with this ID. <strong>A KEY204 
         * error issue will be returned if this ID does not exist in 
         * the jurisdictional client registry.</strong></p> Un-merged 
         * Business Name: PatientID Relationship: 
         * REPC_MT000015CA.PatientID.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Identifier of the patient who is the 
         * subject of the medical condition query. Filter the result 
         * set to include only those records pertaining to the patient 
         * with this Id.</p> <p>Allows filtering of result set by 
         * patient Id. This is a mandatory field because a patient must 
         * be specified for the query to be valid</p> Un-merged 
         * Business Name: PatientID Relationship: 
         * PORX_MT060030CA.PatientID.value Conformance/Cardinality: 
         * MANDATORY (1) <p>Identifier of the patient who is the 
         * subject of the query. Filter the result set to include only 
         * those records pertaining to the patient with this Id.</p> 
         * <p>Allows filtering of result set by patient Id. This is a 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Identifier of the 
         * patient who is the subject of the adverse reaction query. 
         * Filter the result set to include only those records 
         * pertaining to the patient with this Id.</p> <p>Allows 
         * filtering of result set by patient Id. This is a mandatory 
         * field because a patient must be specified for the query to 
         ...
         * field because a patient must be specified for the query to 
         * be valid</p> Un-merged Business Name: PatientID 
         * Relationship: PORX_MT060170CA.PatientID.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Identifier of the 
         * patient who is the subject of the patient medication query. 
         * Filter the result set to include only those records 
         ...
         * MANDATORY (1) <p>The name by which the patient is known.</p> 
         ...
         * the patient is known.</p> <p>Used to confirm the identity of 
         * the patient for the query and is therefore mandatory.</p> 
         * Un-merged Business Name: PatientName Relationship: 
         * PORX_MT060180CA.PatientName.value Conformance/Cardinality: 
         * MANDATORY (1) <p>The name by which the patient is known.</p> 
         * <p>Used to confirm the identity of the patient for the query 
         * and is therefore mandatory.</p> Un-merged Business Name: 
         * PatientName Relationship: PORX_MT060200CA.PatientName.value 
         ...
         * the patient Id for the query to be valid.</p> Un-merged 
         * Business Name: PatientName Relationship: 
         * REPC_MT120001CA.PatientName.value Conformance/Cardinality: 
         * MANDATORY (1) <p>The name of the patient who is the subject 
         ...
         * patient with this name.</p> <p>Allows filtering of result 
         * set by patient name. This is a mandatory field because a 
         * patient name must match the patient Id for the query to be 
         * valid.</p> Un-merged Business Name: PatientName 
         ...
         * the patient Id for the query to be valid.</p> Un-merged 
         * Business Name: PatientName Relationship: 
         * REPC_MT120002CA.PatientName.value Conformance/Cardinality: 
         * MANDATORY (1) <p>The name of the patient who is the subject 
         * of the patient measurement query.</p><p>Filter the result 
         * set to include only those records pertaining to the patient 
         * with this name.</p> <p>The name of the patient who is the 
         ...
         * the error that may be raised.)</strong></p> Un-merged 
         * Business Name: PatientName Relationship: 
         * REPC_MT000015CA.PatientName.value Conformance/Cardinality: 
         * MANDATORY (1) <p>The name of the patient who is the subject 
         * of the medical condition query.</p><p>Filter the result set 
         ...
         * Un-merged Business Name: PatientName Relationship: 
         * PORX_MT060030CA.PatientName.value Conformance/Cardinality: 
         * MANDATORY (1) <p>The name of the patient who is the subject 
         * of the query.</p><p>Filter the result set to include only 
         ...
         * patient Id for the query to be valid.</p> Un-merged Business 
         * Name: PatientName Relationship: 
         * REPC_MT000016CA.PatientName.value Conformance/Cardinality: 
         * MANDATORY (1) <p>The name of the patient who is the subject 
         ...
         * match the patient Id for the query to be valid.</p> 
         * Un-merged Business Name: PatientName Relationship: 
         * PORX_MT060280CA.PatientName.value Conformance/Cardinality: 
         * MANDATORY (1) <p>The name of the patient who is the subject 
         ...
         * match the patient Id for the query to be valid.</p> 
         * Un-merged Business Name: PatientName Relationship: 
         * PORX_MT060270CA.PatientName.value Conformance/Cardinality: 
         * MANDATORY (1) <p>The name of the patient who is the subject 
         * of the patient medication query.</p><p>Filter the result set 
         * to include only those records pertaining to the patient with 
         * this name.</p> <p>The name of the patient who is the subject 
         ...
         * match the patient Id for the query to be valid.</p> 
         * Un-merged Business Name: PatientName Relationship: 
         * REPC_MT000008CA.PatientName.value Conformance/Cardinality: 
         * MANDATORY (1) <p>The name of the patient who is the subject 
         ...
         * match the patient Id for the query to be valid.</p> 
         * Un-merged Business Name: PatientName Relationship: 
         * PORX_MT060220CA.PatientName.value Conformance/Cardinality: 
         * MANDATORY (1) <p>The name
         * ... [rest of documentation truncated due to excessive length]
         */
         ...
         * RxDispenserIndicators Relationship: 
         ...
         * Un-merged Business Name: UsageEffectivePeriod Relationship: 
         ...
         * result set to include only those items that are 'effective' 
         * in the indicated period.</p> <p>Indicates the period for 
         * which the request/query applies.</p><p>Filter the result set 
         * to include only those items that are 'effective' in the 
         * indicated period.</p> <p>Allows the requester to specify the 
         * period of interest for the retrieval. Useful for 
         * constraining run-away queries.</p> Un-merged Business Name: 
         * AdministrationEffectivePeriod Relationship: 
         ...
         * administration period for which the request/query 
         * applies.</p><p>Filter the result set to include only those 
         * other medication records for which the patient was deemed to 
         * be taking the drug within the specified period.</p> 
         ...
         * DrugCode Relationship: PORX_MT060170CA.DrugCode.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Indicates that the 
         * result set is to be filtered to include only those records 
         * pertaining to the specified drug. The code may refer to an 
         * orderable medication or a higher level drug 
         * classification.</p> <p>Allows for the retrieval of patient 
         ...
         * such as &quot;Anti-hypertensives&quot;.</p></remarks>
         */
         ...
         * 'TRUE' or 'FALSE' it is mandatory.</p> Un-merged Business 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Indicates whether 
         * or not notes attached to the other medication records are to 
         * be returned along with the detailed information.</p> 
         * <p>Allows for the flexibility of omitting/including notes in 
         * the retrieval of information for medication 
         * data.</p><p>Because the attribute is boolean, it must 
         * explicitly indicate a 'TRUE' or 'FALSE', and thus it is 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Indicates whether 
         * or not notes attached to the professional service record are 
         * to be returned along with the detailed information.</p> 
         * <p>Allows for the flexibility of omitting/including notes in 
         ...
         * mandatory.</p> <p>Allows for the flexibility of 
         * omitting/including notes in the retrieval of information for 
         * professional service data.</p><p>Because the attribute is 
         * boolean, it must explicitly indicate a 'TRUE' or 'FALSE', 
         * and thus it is mandatory.</p> Un-merged Business Name: 
         * IncludeNotesIndicator Relationship: 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Indicates whether 
         * or not common observation record are to be returned along 
         * with notes that have been recorded against the measurement 
         * record.</p> <p>Allows for the flexibility of 
         * omitting/including notes in the retrieval of information for 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Identifier of the 
         * other medication record for which detailed information is to 
         * be retrieved.</p> <p>Allows for the retrieval of medication 
         * records based on a specific active medication record.</p></remarks>
         */
         ...
         * based on a specific prescriber.</p> Un-merged Business Name: 
         * PrescriberProviderID Relationship: 
         ...
         * to a specific dispense record.</p> Un-merged Business Name: 
         ...
         * measurement types will be included.</p> <p>Allows for the 
         * retrieval of patient measurements based on a specific type 
         * of measurement or set of measurements.</p></remarks>
         */
