...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged {
    ...
    public class DrugContains : MessagePartBean {
        ...
        private PQ quantity;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.DrugIngredients ingredient;
         ...
         * &quot;does/must not contain&quot; is essential, however in 
         * some circumstances it is necessary to say &quot;may 
         * contain&quot;.</p> <p><font color="#000080" size="2" 
         * face="Helvetica"><font color="#000080" size="2" 
         * face="Helvetica"><font color="#000080" size="2" 
         * face="Helvetica"> <p align="left">An indication that a drug 
         * does not contain the</p> <p align="left">specified 
         * ingredient (active or inactive). A null value</p> <p 
         * align="left">indicates that the drug &ldquo;may 
         * contain&rdquo; the specified</p> <p 
         ...
         * Un-merged Business Name: IngredientQuantity Relationship: 
         ...
         * <p>CompoundIngredient.amount(numerator)</p><p>CompoundIngredient.proportionOfFinal(e.g. 
         * 10% = 
         * .1mg/1mg)</p><p>ZPC.4(quantity)</p><p>ZPC.5(unit)</p><p>ZPJ1
         ...
         * Conformance/Cardinality: MANDATORY (1) <div>A list of drugs 
         * or raw chemicals that may be present in</div> <p>a 
         * manufactured drug or a custom compound.&nbsp;</p> Un-merged 
         * Business Name: (no business name specified) Relationship: 
         * POME_MT010100CA.Ingredient.ingredient 
         * Conformance/Cardinality: MANDATORY (1) <p>&nbsp;A list of 
         * drugs or raw chemicals that may be present in</p> <div>a 
         * manufactured drug or a custom compound.</div> Un-merged 
         * Business Name: (no business name specified) Relationship: 
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.DrugIngredients Ingredient {
