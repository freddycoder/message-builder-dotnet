...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged {
     ...
     * contacting the pharmacy or pharmacist involved in the 
     * dispense.</p><p>The association is marked as populated 
     * because it may be masked.</p> REPC_MT000010CA.Location: 
     * *g:recorded at <p>Indicates the service delivery location 
     * where the medical condition was recorded.</p> <p>Indicates 
     * where records are likely kept for follow-up. May also be 
     * useful in understanding the context in which the medical 
     * condition recorded.</p><p>The location of entry should 
     * always exist, and is therefore mandatory.</p> <p>Indicates 
     * where records are likely kept for follow-up. May also be 
     * useful in understanding the context in which the medical 
     * condition recorded.</p><p>The location of entry should 
     * always exist, and is therefore mandatory.</p> 
     * REPC_MT000007CA.Location: *recorded at <p>Indicates the 
     * service delivery location where the medical condition was 
     * recorded.</p> <p>Indicates where records are likely kept for 
     * follow-up. May also be useful in understanding the context 
     * in which the medical condition was recorded. The location of 
     * entry should always be known, and is therefore 
     * mandatory.</p> PORX_MT060340CA.Location: *d:dispensed from 
     * Service Delivery Location <p>Indicates the facility/location 
     * where the dispensing was performed.</p> <p>Important for 
     * performing follow-up and therefore mandatory.</p> 
     * MCAI_MT700221CA.Location: *a1:created at <p>Indicates the 
     * facility where the event occurred.</p> <p>Indicates where 
     * paper records may be located, and may be important to 
     * determining authorization. The association is therefore 
     * mandatory.</p> REPC_MT000009CA.Location: *i:recorded at 
     * <p>Indicates the service delivery location where the allergy 
     * was recorded.</p> <p>Indicates where records are likely kept 
     ...
     * mandatory.</p> MCAI_MT700223CA.Location: *a1:created at 
     ...
     * therefore mandatory.</p> PORX_MT060160CA.Location: 
     * *d:dispensed from <p>Indicates the facility/location where 
     * the dispensing was performed.</p> <p>Important for 
     * performing follow-up and therefore mandatory.</p> 
     * REPC_MT000005CA.Location: *i:recorded at <p>Indicates the 
     ...
     * mandatory.</p> PORX_MT010120CA.Location2: *c:targeted to 
     * pharmacy <p>Indicates the pharmacy to which the prescription 
     * has been directed or which has currently assumed 
     * responsibility for dispensing the prescription.</p> 
     * <p>Allows prescriptions to be directed on the request of the 
    ...
    public class RecordedAt : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt240003ca.ServiceLocation serviceDeliveryLocation;
         ...
         * Conformance/Cardinality: MANDATORY (1) <div>Indicates the 
         * service delivery location where the&nbsp;allergy was 
         * recorded.&nbsp;</div> Un-merged Business Name: (no business 
         ...
         * recorded.</p> Un-merged Business Name: (no business name 
         * specified) Relationship: 
         ...
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: CreatedAt Relationship: 
         * MCAI_MT700210CA.Location.serviceDeliveryLocation 
         * Conformance/Cardinality: MANDATORY (1) <p>&nbsp;Indicates 
         * the location where the event occurred.</p> Un-merged 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>&nbsp;Indicates 
         * the service delivery location where the</p> <div>query 
         * occurred.</div> Un-merged Business Name: (no business name 
         * specified) Relationship: 
         ...
         * Conformance/Cardinality: MANDATORY (1) <div>Indicates the 
         * service delivery location where the</div> <p>patient 
         * measurement was recorded.&nbsp;</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"serviceDeliveryLocation"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt240003ca.ServiceLocation ServiceDeliveryLocation {
