...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt240003ca {
    ...
    public class ServiceLocation : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.IRecipient {
         ...
         * mandatory.</p><p>The identifier is mandatory because it is 
         * the principal mechanism for uniquely identifying the 
         * facility.</p> <p>&nbsp;If this identifier does not exist in 
         * the</p> <div>jurisidiction&rsquo;s location registry, then a 
         * KEY204</div> <div>error issue will be returned.</div></remarks>
         */
