...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged {
    ...
    public class HL7Message_1<CAP> : MessagePartBean {
         ...
         * duplicate messages, and allows tying acknowledgments to the 
         * message they are acknowledging. The attribute is therefore 
         * mandatory.</p> <p>Used in duplicate message 
         ...
         * to communicate authentication and session information. The 
         * attribute is optional because not all jurisdictions will 
         * require this capability.</p> <div>PIN does not require the 
         * use of this field so it will be</div> <p>ignored if 
         * sent.&nbsp;</p></remarks>
         */
         ...
         * HL7StandardVersion Relationship: 
         * MCCI_MT000100CA.Message.versionCode Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the version of the messaging 
         * standard being referenced.</p> <p>Needed to know how to 
         * validate message definition, CMET definition, vocabulary and 
         * other information and is therefore mandatory.</p> <div>Fixed 
         * to &lsquo;V3-2005-12&rsquo;.</div> <p>A SYN103 error issue 
         * will be returned otherwise.&nbsp;</p></remarks>
         */
         ...
         * the receiving application should do, and how the message 
         * should be validated. The attribute is therefore 
         * mandatory.</p> <div>Must match the XML root element or a 
         * Illegal error</div> <p>issue will be returned.&nbsp;</p></remarks>
         */
         ...
         * this message complies with.</p> <p>Indicates any additional 
         * validation that may be appropriate. Also influences what 
         * extensions can be processed.</p> <p>PIN does not use this 
         * field.&nbsp;</p></remarks>
         */
         ...
         * handled and is therefore mandatory.</p> Un-merged Business 
         * Name: ProcessingCode Relationship: 
         ...
         * &lsquo;P&rsquo; for</div> <div>Production.</div> <div>A 
         * NS202 error issue will be returned if the wrong</div> 
         * <p>code is returned for the environment..&nbsp;</p></remarks>
         */
         ...
         * "NE".</strong></p> Un-merged Business Name: 
         ...
         * support for immediate, deferred and polling mode and 
         * distinguishes which mode is desired. The attribute is 
         * therefore mandatory.</p> <div>Fixed to 
         * &lsquo;AL&rsquo;.</div> <p>A SYN103 error issue will be 
         * returned otherwise.&nbsp;</p></remarks>
         */
        ...
        /**
         * <summary>Business Name: RespondToSystem</summary>
         * 
         * <remarks>Un-merged Business Name: (no business name 
         * specified) Relationship: MCCI_MT000300CA.Message.respondTo 
         * Conformance/Cardinality: OPTIONAL (0-1) Un-merged Business 
         * Name: RespondToSystem Relationship: 
         * MCCI_MT000100CA.Message.respondTo Conformance/Cardinality: 
         * OPTIONAL (0-1) <p>PIN does not use this field and it will be 
         * ignored.&nbsp;</p></remarks>
         */
         ...
         * MCCI_MT000300CA.Message.attentionLine 
         * Conformance/Cardinality: OPTIONAL (0-5) Un-merged Business 
         * Name: RoutingInstructionLines Relationship: 
         * MCCI_MT000100CA.Message.attentionLine 
         * Conformance/Cardinality: OPTIONAL (0-5) <p>PIN does not use 
         * this field and it will be ignored.&nbsp;</p></remarks>
         */
         ...
         * Name: TriggerEvent Relationship: 
         * MCCI_MT000100CA.Message.controlActProcess 
         * Conformance/Cardinality: MANDATORY (1) <div>The specific 
         * Trigger Event goes here and depends on</div> <p>the message 
         * interaction being sent.&nbsp;</p></remarks>
         */
