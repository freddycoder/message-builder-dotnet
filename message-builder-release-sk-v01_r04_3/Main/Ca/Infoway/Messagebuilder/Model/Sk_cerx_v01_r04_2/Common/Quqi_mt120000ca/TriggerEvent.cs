...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Quqi_mt120000ca {
    ...
    public class TriggerEvent<ACT,PL> : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged.RefersTo<ACT>> subject;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Porx_mt980030ca.Issues> subjectOfDetectedIssueEvent;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Quqi_mt120000ca.QueryResponseInformation queryAck;
        ...
        public TriggerEvent() {
            ...
            this.subject = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged.RefersTo<ACT>>();
            this.subjectOfDetectedIssueEvent = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Porx_mt980030ca.Issues>();
        }
        /**
         ...
         * and therefore mandatory.</p> <div>PIN will echo the ID sent 
         * in the Update Trigger</div> <p>Event.&nbsp;</p></remarks>
         */
         ...
         * event.</p> <div>This will contain the Trigger Event code 
         ...
         * the query was performed. If not specified, the assumption is 
         * that the query was performed at the same time the message 
         * was constructed.</p> <p>Sometimes messages may be 
         * constructed and sent at a significantly different time than 
         * the query was actually processed.</p> <div>As all queries 
         * are executed when the message is</div> <p>received, this 
         * will not be populated by PIN.&nbsp;</p></remarks>
         */
         ...
         * reason for the response given</p> <p>Usually used to 
         * indicate a reason why a query was unsuccessful or was not 
         * processed.</p> <div>This will contain the reason code 
         * contained in</div> <p>the original request.&nbsp;</p></remarks>
         */
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged.RefersTo<ACT>> Subject {
         ...
         * 
         * <remarks>Conformance/Cardinality: POPULATED (1) <p>&nbsp;The 
         * set of issues that were detected when</p> 
         * <div>detectedIssueEvent processing the query.</div></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subjectOf/detectedIssueEvent"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Porx_mt980030ca.Issues> SubjectOfDetectedIssueEvent {
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Quqi_mt120000ca.QueryResponseInformation QueryAck {
