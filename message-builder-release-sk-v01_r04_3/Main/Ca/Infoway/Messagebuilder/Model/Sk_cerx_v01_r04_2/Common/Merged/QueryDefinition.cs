...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged {
    ...
    public class QueryDefinition<PL> : MessagePartBean {
         ...
         * Conformance/Cardinality: REQUIRED (0-1) <p>&nbsp;Must be 
         * &lsquo;RD&rsquo;.</p> <div>This must be sent if the 
         * initialQuantity field is</div> <div>sent and must not be 
         * sent if the initialQuantity</div> <div>field is not sent. In 
         * either case, a MISSCOND</div> <div>error issue will be 
         * returned..</div> Un-merged Business Name: (no business name 
         * specified) Relationship: 
         * QUQI_MT120000CA.QueryByParameter.initialQuantityCode 
         * Conformance/Cardinality: REQUIRED (0-1) <p>If Query Limit is 
