...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt220110ca {
    ...
    public class DrugProduct : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Porx_mt980040ca.IMedication {
         ...
         * ingredients and/or recipe in free text form.</p> <p><font 
         ...
         * will never be returned.</p> </font></font></font></b></p></remarks>
         */
         ...
         * COCT_MT220110CA.ManufacturedProduct.manufacturer 
         ...
         * 
         * <remarks>Relationship: COCT_MT220110CA.Medicine.asContent 
         * Conformance/Cardinality: REQUIRED (0-1) <p><b><font 
         ...
         * 
         * <remarks>Relationship: COCT_MT220110CA.Medicine.ingredient 
         * Conformance/Cardinality: REQUIRED (0-10) <div>Identification 
         * of which ingredients are contained (or</div> <div>are not 
         * contained) in a drug, along with their</div> <p>respective 
         * quantities.&nbsp;</p></remarks>
         */
