...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged {
    ...
    public class HL7Message_2 : MessagePartBean {
         ...
         * MCCI_MT000200CA.Message.versionCode Conformance/Cardinality: 
         ...
         * other information and is therefore mandatory.</p> <p>Fixed 
         * to &lsquo;V3-2005-12&rsquo;.&nbsp;</p></remarks>
         */
         ...
         * this message complies with.</p> <p>Indicates any additional 
         * validation that may be appropriate. Also influences what 
         * extensions can be processed.</p> <p>PIN does not require 
         ...
         * MANDATORY (1) <div>This will echo the Sender section of the 
         * original</div> <p>message.&nbsp;</p></remarks>
         */
         ...
         * specified) Relationship: MCCI_MT102001CA.Message.respondTo 
         * Conformance/Cardinality: OPTIONAL (0-1) Un-merged Business 
         * Name: RespondToSystem Relationship: 
         * MCCI_MT000200CA.Message.respondTo Conformance/Cardinality: 
         * OPTIONAL (0-1) <p>PIN does not require this field so it will 
         ...
         * MANDATORY (1) <div>This will echo the Receiver section of 
         * the original</div> <div>message.&nbsp;</div></remarks>
         */
        ...
        /**
         * <summary>Business Name: RoutingInstructionLine</summary>
         * 
         * <remarks>Un-merged Business Name: (no business name 
         * specified) Relationship: 
         * MCCI_MT102001CA.Message.attentionLine 
         * Conformance/Cardinality: OPTIONAL (0-5) Un-merged Business 
         * Name: RoutingInstructionLine Relationship: 
         ...
         * whether the previous interaction was</div> <p>successfully 
         * processed.&nbsp;</p></remarks>
         */
