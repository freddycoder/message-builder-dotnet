...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged {
    ...
    public class TriggerEvent_2<ACT> : MessagePartBean {
         ...
         * MCAI_MT700220CA.ControlActEvent.code 
         * Conformance/Cardinality: MANDATORY (1) <p>Identifies the 
         * trigger event that occurred.</p> <p>This is mandatory 
         * because it is essential to understanding the meaning of the 
         * event.</p> <div>This will contain the Trigger Event code 
         * associated</div> <p>with the response.&nbsp;</p></remarks>
         */
         ...
         * an intended end date may also be indicated.</p> Un-merged 
         * Business Name: EventEffectivePeriod Relationship: 
         ...
         * may also be indicated.</p> <p>This will not be populated by 
         * PIN.&nbsp;</p></remarks>
         */
         ...
         * domain associated with this attribute will vary for each 
         * interaction and will be noted as part of the interaction 
         * description.</p> <div>No code will be returned as accept 
         * responses</div> <div>do not have a domain and the domain 
         * specified</div> <p>by Infoway for reject responses does not 
         * exist.&nbsp;</p></remarks>
         */
         ...
         * MCAI_MT700221CA.ResponsibleParty.assignedPerson 
         ...
         * 
         * <remarks>Relationship: 
         * MCAI_MT700221CA.DataEnterer.assignedPerson 
         * Conformance/Cardinality: POPULATED (1)</remarks>
         */
        ...
        /**
         * <summary>Business Name: Payload</summary>
         * 
         ...
         * Name: Payload Relationship: 
         * MCAI_MT700220CA.ControlActEvent.subject 
         * Conformance/Cardinality: REQUIRED (0-1) <p>There may be a 
         * payload for the response.&nbsp;</p> <p> <p>Acknowledgement 
         * responses tend to have payloads</p> <p>while Rejection 
         * responses do not.</p> </p></remarks>
         */
