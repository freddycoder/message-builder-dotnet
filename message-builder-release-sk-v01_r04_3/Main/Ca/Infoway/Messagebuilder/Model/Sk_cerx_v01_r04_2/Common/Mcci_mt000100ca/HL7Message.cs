...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Mcci_mt000100ca {
    ...
    public class HL7Message<CAP> : MessagePartBean {
         ...
         * &lsquo;V3-2005-12&rsquo;.</div> <p>A SYN103 error issue will 
         * be returned otherwise.&nbsp;</p></remarks>
         */
         ...
         * processed.</p> <p>PIN does not use this field.&nbsp;</p></remarks>
         */
         ...
         * 
         * <remarks>Relationship: MCCI_MT000100CA.Message.respondTo 
         * Conformance/Cardinality: OPTIONAL (0-1) <p>PIN does not use 
        ...
        /**
         * <summary>Business Name: Routing Instruction Lines</summary>
         * 
         * <remarks>Relationship: MCCI_MT000100CA.Message.attentionLine 
