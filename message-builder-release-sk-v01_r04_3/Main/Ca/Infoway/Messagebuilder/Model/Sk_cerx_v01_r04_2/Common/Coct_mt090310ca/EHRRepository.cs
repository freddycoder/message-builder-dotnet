...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt090310ca {
    ...
    public class EHRRepository : MessagePartBean {
         ...
         * the electronic address for reaching the repository where the 
         * event is stored.</p> <p>Allows direct access to the 
         * repository and is therefore mandatory.</p></remarks>
         */
