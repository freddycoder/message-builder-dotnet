...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged {
    ...
    public class Acknowledgement : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged.ErrorsOrWarnings> acknowledgementDetail;
        ...
        public Acknowledgement() {
            ...
            this.acknowledgementDetail = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged.ErrorsOrWarnings>();
        }
        /**
         ...
         * successful and is therefore mandatory.</p> Un-merged 
         * Business Name: AcknowledgementCode Relationship: 
         * MCCI_MT000200CA.Acknowledgement.typeCode 
         * Conformance/Cardinality: MANDATORY (1) <p>Indicates whether 
         * the previous interaction was successfully processed.</p> 
         * <p>Key to understanding whether the interaction has been 
         * successful and is therefore mandatory.</p> <div>This will be 
         * &lsquo;AA&rsquo; unless there are detected</div> 
         * <div>transport-level errors in which case it will be 
         * &lsquo;AE&rsquo;.</div> <p>&lsquo;AR&rsquo; will never be 
         * sent.&nbsp;</p></remarks>
         */
         ...
         * Conformance/Cardinality: OPTIONAL (0-1) <p>For applications 
         ...
         * because not all systems will support polling.</p> Un-merged 
         * Business Name: NumberOfWaitingMessages Relationship: 
         * MCCI_MT000200CA.Acknowledgement.messageWaitingNumber 
         * Conformance/Cardinality: OPTIONAL (0-1) <p> <p>This will 
         * indicate the number of messages that are</p> <p>waiting for 
         * the specified system to retrieve.</p> </p> <p>Indicates to a 
         * system how many polled messages are available without the 
         * need so send a separate query. The element is optional 
         ...
         * polling.</p> Un-merged Business Name: MessageWaitingPriority 
         * Relationship: 
         ...
         * MANDATORY (1) <p>References the identifier of the message 
         * this current message is acknowledging.</p> <p>Provides the 
         * necessary link to complete a conversation for systems using 
         * communication technologies which are not conversational. 
         * This attribute is therefore mandatory.</p></remarks>
         */
         ...
         * Conformance/Cardinality: REQUIRED (0-50) <div>Any errors, 
         * warnings, or information messages will be</div> <p>go 
         * here.&nbsp;</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"acknowledgementDetail"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Merged.ErrorsOrWarnings> AcknowledgementDetail {
