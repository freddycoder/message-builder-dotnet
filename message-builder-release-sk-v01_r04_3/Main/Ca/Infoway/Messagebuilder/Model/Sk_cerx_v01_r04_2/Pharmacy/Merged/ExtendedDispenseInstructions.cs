...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged {
     ...
     * medication to the patient.</p><p>Allows dispensing 
     * instructions to be given at specific dispensable drug level 
     * for an overall prescribed drug.</p> <p>Sets the parameters 
     * within which the dispenser must operate in dispensing the 
     * medication to the patient.</p><p>Allows dispensing 
     * instructions to be given at specific dispensable drug level 
     * for an overall prescribed drug.</p> 
    ...
    public class ExtendedDispenseInstructions : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt220110ca.DrugProduct productMedication;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.FirstFill component2InitialSupplyRequest;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.SubsequentSupplyRequest component1SubsequentSupplyRequest;
         ...
         * of the prescription based on the quantity prescribed. This 
         * attribute is mandatory because the prescriber (in discussion 
         * with the patient) has a better understanding of the days 
         * supply needed by the patient.</p> Un-merged Business Name: 
         * TotalDaysSupply Relationship: 
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt220110ca.DrugProduct ProductMedication {
         ...
         * Conformance/Cardinality: POPULATED (1) <p>&nbsp;Special 
         * instructions regarding the very first supply</p> <div>of 
         * medication to a patient.</div></remarks>
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.FirstFill Component2InitialSupplyRequest {
         ...
         * Conformance/Cardinality: MANDATORY (1) <div>Dispensing 
         * instruction for all dispenses</div> <p>subsequent to the 
         * first fill.&nbsp;</p></remarks>
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.SubsequentSupplyRequest Component1SubsequentSupplyRequest {
