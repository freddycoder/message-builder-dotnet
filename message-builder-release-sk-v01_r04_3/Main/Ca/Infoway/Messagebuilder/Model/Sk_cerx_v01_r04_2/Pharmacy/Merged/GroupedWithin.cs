...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged {
     ...
     * into.</p> <p>Shows relationship between GenericDrugproduct, 
     * Generic FormulationDrugProduct and 
     * ManufacturedDrugProduct</p><p>ZPC.7(query will reference the 
     * generic equivalency relationship in defining the boolean 
     * query parameter)</p> <p>Shows relationship between 
     * GenericDrugproduct, Generic FormulationDrugProduct and 
     * ManufacturedDrugProduct</p><p>ZPC.7(query will reference the 
     * generic equivalency relationship in defining the boolean 
     * query parameter)</p> <p>Exposes the drug hierarchy, allowing 
     * drill-down when prescribing and dispensing. Also indicates 
     ...
     * possibilities for substitution and can be important for 
     * detecting interactions such as allergies or duplicate 
     * therapy between closely-related drugs.</p></remarks>
     */
    ...
    public class GroupedWithin : MessagePartBean {
         ...
         * within a specific drug identification scheme.</p> 
         ...
         * of abstraction.</p> <p>HICL</p><p>Therapeutic 
         * Class</p><p>Therapeutic Sub 
         * Classification</p><p>DrugProduct.activeIngredientId</p><p>DrugProduct.ActiveIngredientGroupNumber</p><p>DrugProduct.StandardProductId 
         * (Mnemonic)</p><p>DrugProduct.StandardIDType(Code System)</p> 
         * <p>HICL</p><p>Therapeutic Class</p><p>Therapeutic Sub 
         * Classification</p><p>DrugProduct.activeIngredientId</p><p>DrugProduct.ActiveIngredientGroupNumber</p><p>DrugProduct.StandardProductId 
         ...
         * (e.g. generic drug, generic formulation).</p><p>This 
         * attribute is marked as &quot;populated&quot; as a drug code 
         * should be available in most cases.</p></remarks>
         */
         ...
         * specific drug identification scheme.</p> <p>Generic Name</p> 
         ...
         * to the drug at the higher level of abstraction.</p> 
         * <p>Generic Name</p> <p>To display in dropdowns and for local 
         * searching.</p><p>This attribute is marked as 
