...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Pome_mt010040ca {
     ...
     * remains in the body (as active)</p> <p>Impacts 
    ...
    public class DrugHalfLife : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Different drugs 
         ...
         * administration and other factors</p> 
         ...
         * in drug-drug interaction checking.</p></remarks>
         */
