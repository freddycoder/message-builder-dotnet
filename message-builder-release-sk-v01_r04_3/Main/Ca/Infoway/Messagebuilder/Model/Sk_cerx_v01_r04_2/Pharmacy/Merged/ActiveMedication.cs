...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged {
    ...
    public class ActiveMedication : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.ICausalActs {
         ...
         * element is therefore mandatory.</p> <p>&nbsp;Will either be 
         * &lsquo;RQO&rsquo; for a prescription or dispense</p> 
         * <div>record or &lsquo;EVN&rsquo; for an Other Medication 
         * record.</div> Un-merged Business Name: 
         ...
         * masked, this element is only marked as 
         * 'populated'.</p><p>The element allows a full 'CD' type to 
         * support SNOMED implementations.</p> <p><b><font 
         * color="#000080" size="2" face="Helvetica-Bold"><font 
         * color="#000080" size="2" face="Helvetica-Bold"><font 
         * color="#000080" size="2" face="Helvetica-Bold"> <p 
         * align="left">Must be &lsquo;DRUG&rsquo; or a CODE_INVAL 
         * error issue will be returned.</p> 
