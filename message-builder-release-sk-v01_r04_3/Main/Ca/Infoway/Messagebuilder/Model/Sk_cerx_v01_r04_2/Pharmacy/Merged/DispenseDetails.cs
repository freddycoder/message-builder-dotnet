...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged {
    ...
    public class DispenseDetails : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt141007ca.DeviceProduct productManufacturedProduct;
         ...
         * failure.</p> Un-merged Business Name: 
         * DispenseProcessingAndPickupDate Relationship: 
         ...
         * PORX_MT060020CA.SupplyEvent.effectiveTime 
         * Conformance/Cardinality: MANDATORY (1) <p>Represents the 
         * date the dispense product was prepared and when the product 
         * was picked up by or delivered to the patient. The dispense 
         * processing date and pickup date can be back dated to reflect 
         ...
         * format=102)</p><p>A_BillablePharmacyDispense</p><p>Dispense 
         * Date</p><p>Dispense 
         * Date</p><p>DispensedItem.dispense
         ...
         * against the prescription.</p> Un-merged Business Name: 
         ...
         * (Unit, qualifier=38 0r 87)</p><p>DRU.020-02 (Quantity, 
         * qualifier=38 0r 87)</p><p>DRU.020-03 (qualifier=38 0r 
         * 87)</p><p>Claim.442-E7</p><p>Claim.460-ET</p><p>Claim.600-28</p><p>A_BillablePharmacyDispense</p><p>Quantity</
         * ... [rest of documentation truncated due to excessive length]
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt141007ca.DeviceProduct ProductManufacturedProduct {
