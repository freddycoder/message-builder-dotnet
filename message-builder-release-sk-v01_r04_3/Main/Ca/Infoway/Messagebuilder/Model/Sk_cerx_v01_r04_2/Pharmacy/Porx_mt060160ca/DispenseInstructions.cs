...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Porx_mt060160ca {
    ...
    public class DispenseInstructions : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.Component3> component;
        ...
        public DispenseInstructions() {
            ...
            this.component = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.Component3>();
        }
        /**
         ...
         * &quot;Finish what you have on hand, but don't get any 
         * more.&quot;</p><p>Because the status should always be known, 
         * this element is mandatory.</p> <p><font color="#000080" 
         * size="2" face="Helvetica"><font color="#000080" size="2" 
         * face="Helvetica"><font color="#000080" size="2" 
         * face="Helvetica"> <p align="left">This generally mirrors the 
         * status for the</p> <p align="left">prescription, but in some 
         ...
         * face="Helvetica-Bold"><font color="#000080" size="2" 
         * face="Helvetica-Bold"> <p align="left">When a Revoke 
         * Dispensing transaction has</p> <p align="left">been received 
         * against this prescription or the</p> <p 
         * align="left">prescription has been renewed, then this 
         * will</p> <p>be ABORTED otherwise</p> 
         ...
         * Prescription). It reflects the prescriber perspective for 
         * the validity of the prescription. Dispenses must not be made 
         * against the prescription outside of this period. The 
         ...
         * qualifier=36, format=102)</p><p>Number of days 
         * (width)</p><p>When will drug be 
         ...
         * date dispensed(when summary type is 'most 
         * recent')</p><p>Prescription.dispensingInterval(period)</p><p>Prescription.effectiveDate 
         * (low)</p><p>Prescription.expiryDate (high)</p> <p>Indicates 
         * when the Order becomes valid, and when it ceases to be an 
         ...
         * PORX_MT060160CA.Receiver.responsibleParty</summary>
         * 
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.Component3> Component {
