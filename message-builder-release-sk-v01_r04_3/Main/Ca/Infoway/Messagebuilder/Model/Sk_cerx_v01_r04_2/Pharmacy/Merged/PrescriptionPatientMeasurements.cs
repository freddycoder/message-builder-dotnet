...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged {
    ...
    public class PrescriptionPatientMeasurements : MessagePartBean {
         ...
         * weight.</p> <p>OBS.010-01 NCPDP:Clinical.495-H2</p> 
         ...
         * Conformance/Cardinality: POPULATED (1) <p>The date on which 
         * the measurement was made</p> <p>OBS.010-04 
         ...
         * this attribute is defined as 'populated'.</p> Un-merged 
         ...
         * calculations.</p><p>The attribute is mandatory because the 
         * measurement value must be known.</p> <div>If present, 
         ...
         * secondary source (e.g. dispensing data).&nbsp;</p> Un-merged 
         * Business Name: PrescriptionPatientMeasuredValue 
         * Relationship: PORX_MT010120CA.QuantityObservationEvent.value 
         * Conformance/Cardinality: MANDATORY (1) <p>The amount 
