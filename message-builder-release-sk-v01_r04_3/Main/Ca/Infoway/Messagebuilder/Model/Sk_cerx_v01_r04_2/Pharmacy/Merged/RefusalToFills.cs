...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged {
     ...
     * associated with a refusal to dispense.</p><p>An indication 
     * of 'refusal to fill' must be indicated, thus attribute is 
     * mandatory.</p> PORX_MT060060CA.RefusalToFill: Refusal To 
    ...
    public class RefusalToFills : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.Issues> reasonDetectedIssueEvent;

        public RefusalToFills() {
            this.effectiveTime = new TSImpl();
            this.reasonCode = new CVImpl();
            this.reasonDetectedIssueEvent = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.Issues>();
        }
        /**
         ...
         * who refused to fulfill the prescription</p> Un-merged 
         ...
         * location where the refusal occurred.&nbsp;</p> Un-merged 
         * Business Name: (no business name specified) Relationship: 
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.Issues> ReasonDetectedIssueEvent {
