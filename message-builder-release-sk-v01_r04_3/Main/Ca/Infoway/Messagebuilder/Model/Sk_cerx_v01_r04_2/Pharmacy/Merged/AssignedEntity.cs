...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged {
    ...
    public class AssignedEntity : MessagePartBean {
         ...
         * for creating the medication document.</p> <p>Helps the 
         * receiver evaluate the supplied information.</p> Un-merged 
         * Business Name: RecommendingAuthorityName Relationship: 
         * POME_MT010040CA.Organization4.name Conformance/Cardinality: 
         * MANDATORY (1) <p>Indicates the name of the organization or 
         * agency that created the dosage recommendation</p> <p>The 
         * source of a recommendation may influence prescriber's 
         * willingness to use the recommended dose and is therefore 
         * mandatory</p> Un-merged Business Name: FormularyOwnerName 
         ...
         * referenced by name.</p><p>The attribute is mandatory because 
         * it is the only information collected about a knowledgebase 
         * vendor.</p> Un-merged Business Name: 
