...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Pome_mt010040ca {
     ...
     * Compound</p> <p>A_BillablePharmacyDispense</p> <p>Provides a 
     * list of drugs available for prescribing/dispensing.</p>
     */
    ...
    public class DrugOrCompound : MessagePartBean {
        ...
        private ST desc;
        private CV formCode;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.Manufacturer asManufacturedProductManufacturer;
        private CS asRegulatedProductStatusCode;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.DispensedIn asContent;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.GroupedWithin> asSpecializedKind;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.DrugContains> ingredient;
        ...
        public DrugOrCompound() {
            ...
            this.asSpecializedKind = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.GroupedWithin>();
            this.ingredient = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.DrugContains>();
        }
        /**
         ...
         * assigned to a drug.</p> <p>DrugProduct.Name 
         ...
         * ingredients and/or recipe in free text form.</p> <div>As PIN 
         * will not be returning custom compounds in</div> <p>this 
         * query, this field will never be returned.&nbsp;</p></remarks>
         */
         ...
         * influences how it can be used by the patient.</p></remarks>
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.Manufacturer AsManufacturedProductManufacturer {
         ...
         * currently approved, terminated or pending = not 
         * approved)</p> <p>Allows providers to evaluate the validity 
         * of the medication for use in Canada.</p></remarks>
         */
         ...
         * 
         * <remarks>Relationship: POME_MT010040CA.Medicine.asContent 
         * Conformance/Cardinality: REQUIRED (0-1) <div>Information 
         * about how the dispensed drug is or should&nbsp;asContent be 
         * contained.</div> <p>&nbsp;</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"asContent"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.DispensedIn AsContent {
            get { return this.asContent; }
            set { this.asContent = value; }
        }

        /**
         * <summary>Business Name: Group Within</summary>
         * 
         * <remarks>Relationship: 
         * POME_MT010040CA.Medicine.asSpecializedKind 
         ...
         * therapy between closely-related drugs.</div></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"asSpecializedKind"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.GroupedWithin> AsSpecializedKind {
         ...
         * 
         * <remarks>Conformance/Cardinality: REQUIRED (0-100) 
         * <p>Identification of which ingredients are contained (or</p> 
         * <div>are not contained) in a drug, along with their</div> 
         * <div>respective quantities.</div></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"ingredient"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.DrugContains> Ingredient {
