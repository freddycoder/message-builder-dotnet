...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Porx_mt060340ca {
    ...
    public class DispenseInstructions : MessagePartBean {
         ...
         * &quot;Finish what you have on hand, but don't get any 
         * more.&quot;</p><p>Because the status should always be known, 
         * this element is mandatory.</p> <div>When a Revoke Dispensing 
         * transaction has</div> <div>been received against this 
         * prescription or the</div> <div>prescription has been 
         * renewed, then this will</div> <div>be ABORTED otherwise it 
         * will be the same as</div> <p>the prescription 
         * status.&nbsp;</p></remarks>
         */
