...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged {
    ...
    public class Component6 : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.DispenseInstructions_2 supplyRequest;
         ...
         * Conformance/Cardinality: POPULATED (1) <div>Specification of 
         * how the prescribed medication is</div> <p>to be dispensed to 
         * the patient.&nbsp;</p> Un-merged Business Name: (no business 
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged.DispenseInstructions_2 SupplyRequest {
