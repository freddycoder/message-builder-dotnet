...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Pome_mt010040ca {
     ...
     * the patient for the dose to be appropriate.</p> <p>Allows 
     * filtering of dosages to be appropriate to the patient.</p>
     */
    ...
    public class PatientCharacteristics : MessagePartBean {
         ...
         * of patient characteristic being expressed. E.g. Height, 
         * weight, age, lab values, etc. If negation indicator is true, 
         * then this indicates a characteristic the patient should 
         * *not* have.</p> <p>Needed to identify what type of 
         * characteristic is being expressed, and therefore 
         * mandatory.</p></remarks>
         */
         ...
         * that the characteristic is one which should *not* be held by 
         * the patient for the dosage to apply.</p> <p>Many dosages are 
         ...
         * element is mandatory.</p> <p>Many dosages are inappropriate 
         * for patients with certain characteristics (e.g. INR values, 
         ...
         * specific value or range of values of the characteristic a 
         * patient should have for the dosage to be appropriate.</p> 
