...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged {
    ...
    public class Agent : MessagePartBean {
         ...
         * person who ultimately made the substitution decision. This 
         * must be either the patient's identifier, the prescriber 
         * identifier, or the dispenser identifier <strong>or a BUS 
         * error will be returned.</strong></p> Un-merged Business 
