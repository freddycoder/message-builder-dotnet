...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Pharmacy.Merged {
    ...
    public class PrescribedBy : MessagePartBean {
         ...
         * PORX_MT060340CA.Author4.time Conformance/Cardinality: 
         ...
         * signatures.</p> <div>At this time, PIN does not support 
         * digital</div> <p>signatures. This field will be ignored if 
         * it is sent.&nbsp;</p> Un-merged Business Name: Signature 
