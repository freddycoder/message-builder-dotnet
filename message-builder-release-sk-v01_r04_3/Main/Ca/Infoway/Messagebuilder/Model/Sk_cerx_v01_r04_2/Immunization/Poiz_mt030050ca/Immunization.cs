...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Poiz_mt030050ca {
    ...
    public class Immunization : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Poiz_mt030050ca.InformantionSourceRole informantInformantionSourceRole;
         ...
         * administered)</p> <p>NotImmunizedFlag</p><p>CompletionStstus 
         * (true = Not administered)</p> <p>Tracking failures to be 
         * immunized is also important in immunization reporting. This 
         * flag must always be known and is always mandatory.</p></remarks>
         */
         ...
         * etc.).</p><p>The default is 'NORMAL'.</p> <p>Denotes access 
         * restriction placed on the immunization record. Methods for 
         * accessing masked immunization records will be governed by 
         * each jurisdiction (e.g. court orders, shared secret/consent, 
         ...
         * planning future immunization encounters for the patient.</p></remarks>
         */
         ...
         * <p>RXR-1</p> <p>Ensures consistency in description of 
         ...
         * anatomical site of vaccination.</p> <p>A coded value 
         * denoting the body area where the immunization was 
         * administered.</p><p>This is also referred to as the 
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Poiz_mt030050ca.InformantionSourceRole InformantInformantionSourceRole {
