...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Poiz_mt030060ca {
    ...
    public class Immunizations : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt220200ca.DrugProduct consumableMedication;
         ...
         * datatype is CD to allow for SNOMED post-coordination.</p></remarks>
         */
         ...
         * specified vaccine at the time indicated.</p> <p>Tracking 
         * failures to be immunized is also important in immunization 
         * reporting. The attribute is mandatory because it is not 
         * meaningful to record an immunization where it is unknown</p></remarks>
         */
         ...
         * restriction placed on the immunization record. Methods for 
         * accessing masked immunization records will be governed by 
         * each jurisdiction (e.g. court orders, shared secret/consent, 
         * etc.). The default is 'NORMAL'.</p> <p>Provides support for 
         ...
         * denoting a patient's reason for refusing to be immunized. 
         * Typical reasons include: Parental decision, Religious 
         * exemption, Patient decision, etc.</p> <p>Useful information 
         * for planning future immunization encounters for the 
         * patient.</p></remarks>
         */
         ...
         * site of vaccination.</p> <p>Some immunizations are intended 
         * to adjust from site to site. (E.g. if first injection is 
         * given in right deltoid, first booster should be given in 
         * left deltoid.)</p><p>Attribute is marked 'optional' to allow 
         * for use of pre-coordinated SNOMED Codes.</p> <p>Some 
         ...
         * Conformance/Cardinality: REQUIRED (0-1) <p>The amount of the 
         * vaccine administered to/by the patient.</p> <p>Useful for 
         * evaluating reaction and for checking contraindication.</p></remarks>
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt220200ca.DrugProduct ConsumableMedication {
