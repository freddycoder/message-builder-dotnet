...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Poiz_mt060140ca {
    ...
    public class GenericQueryParameters : MessagePartBean {
         ...
         * immunizations since xxx'.</p> <p>Allows the requester to 
         * specify the period of interest for the retrieval of 
         * immunization records.</p><p>Useful for constraining run-away 
         * queries.</p> <p>Allows the requester to specify the period 
         ...
         * omitting/including issues in the retrieval of information 
         * for immunization data.</p><p>Because the attribute is 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Indicates whether 
         * or not notes attached to the immunization record are to be 
         * returned along with the detailed information.</p> <p>Allows 
         * for the flexibility of omitting/including notes in the 
         * retrieval of information for immunization data. The value of 
         * this parameter must be known to return a response, so it is 
         * marked as mandatory.</p></remarks>
         */
         ...
         * falls within the indicated time-period.</p> <p>Allows the 
         ...
         * to specify the period of interest for the retrieval of 
         * immunization records.</p><p>Useful for constraining run-away 
         * queries.</p></remarks>
         */
         ...
         * on whic the patient was born.</p> <p>Use to confirm identity 
         * of the patient for the query and is therefore mandatory.</p></remarks>
         */
         ...
         * patient who is the subject of the patient immunization 
         ...
         * the indicated time-period.</p> <p>Allows the requester to 
         * specify the period of interest for the retrieval of 
         * immunization records.</p><p>Useful for constraining run-away 
         * queries.</p> <p>Allows the requester to specify the period 
         * of interest for the retrieval of immunization 
         ...
         * specific vaccine code</p> <p>A coded value indicating a 
         ...
         * vaccine code</p> <p>Allows for finer sub-set of immunization 
         * records to be retrieved based on the vaccine code used in 
         * the immunization.</p></remarks>
         */
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>A number 
         ...
         * pertaining to specific booster number.</p> <p>A number 
         * representing the vaccine booster order that must be used in 
         * searching for patient immunization record.</p><p>The result 
         * set will be filtered to only include immunization records 
         * pertaining to specific booster number.</p> <p>Allows for 
         * finer sub-set of immunization records to be retrieved based 
         * on the sequence of the vaccine booster.</p></remarks>
         */
