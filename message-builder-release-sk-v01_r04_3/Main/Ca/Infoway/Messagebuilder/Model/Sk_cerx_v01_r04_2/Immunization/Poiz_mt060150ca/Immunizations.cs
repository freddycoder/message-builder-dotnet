...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Poiz_mt060150ca {
    ...
    using Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Merged;
     ...
     * also drug contraindication checking.</p>
     */
    ...
    public class Immunizations : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt220210ca.DrugProduct consumableMedication;
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Merged.InformationSourceRole informantInformationSourceRole;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.RecordedAt location;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Merged.PartOf inFulfillmentOf;
         ...
         * record.</p> <p>Allows for the unique referencing of a 
         ...
         * type of administration is being performed.</p> <p>Indicates 
         ...
         * attribute is CD to allow for SNOMED post-coordination</p></remarks>
         */
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>An explicit 
         * indication that a person has not been immunized with the 
         * specified vaccine at the time indicated.</p> 
         * <p>NotImmunized</p><p>CompletionStstus (true = Not 
         * administered)</p> <p>NotImmunized</p><p>CompletionStstus 
         * (true = Not administered)</p> <p>Tracking failures to be 
         * immunized is also important in immunization reporting. 
         * Marked as mandatory because it is not meaningful for this 
         * flag to be 'unknown'.</p></remarks>
         */
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>The date 
         * vaccination(s) was administered to the patient.</p> 
         ...
         * Religious exemption, Patient decision, etc</p> <p>A coded 
         * value denoting a patient's reason for refusing to be 
         * immunized.</p><p>Typical reasons include: Parental decision, 
         * Religious exemption, Patient decision, etc</p> 
         * <p>CompletionStatus (Refused)</p> <p>Allows sorting and 
         ...
         * by which the drug was administered to the patient.</p> 
         ...
         * Conformance/Cardinality: OPTIONAL (0-1) <p>A coded value 
         * denoting the body area where the immunization was 
         * administered.</p> <p>RXR.2</p> <p>Some immunizations are 
         ...
         * SNOMED Codes.</p> <p>Some immunizations are intended to 
         * adjust from site to site. (E.g. if first injection is given 
         * in right deltoid, first booster should be given in left 
         ...
         * Conformance/Cardinality: POPULATED (1) <p>The amount of the 
         * vaccine administered to/by the patient.</p> <p>Useful for 
         ...
         * flavor must be specified.</p> <p>Useful for evaluating 
         * reaction and for checking contraindication.</p><p>Attribute 
         * is populated to allow for situations where quantity may not 
         * be known and thus null flavor must be specified.</p></remarks>
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt220210ca.DrugProduct ConsumableMedication {
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Merged.InformationSourceRole InformantInformationSourceRole {
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Immunization.Merged.PartOf InFulfillmentOf {
