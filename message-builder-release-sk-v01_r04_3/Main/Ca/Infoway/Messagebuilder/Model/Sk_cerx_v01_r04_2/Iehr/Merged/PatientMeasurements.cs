...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Merged {
     ...
     * versa</p> <p>Measurement Type with a nullFlavor value must 
     ...
     * vice versa</p> <p>This comprises a single point-in-time 
     * measurement made about a patient.</p> <p>Allows pertinent 
     * patient measurements to be recorded for clinical 
     * purposes.</p> REPC_MT000018CA.CommonObservationEvent: 
     * Patient Measurements <p>Measurement Type with a 
     * nullFlavorvalue must have SubObservations Measurement Type 
     * without a nullFlavor value must not have 
     * SubObservations.</p> <p>This comprises a single 
     * point-in-time measurement made about a patient.</p> 
    ...
    public class PatientMeasurements : MessagePartBean {
        ...
        /**
         * <summary>Business Name: ObservationMeasurementId</summary>
         * 
         * <remarks>Un-merged Business Name: ObservationMeasurementId 
         * Relationship: REPC_MT100002CA.CommonObservationEvent.id 
        ...
        /**
         * <summary>Business Name: MeasurementType</summary>
         * 
         * <remarks>Un-merged Business Name: MeasurementType 
         * Relationship: REPC_MT100002CA.CommonObservationEvent.code 
         ...
         * to support SNOMED.</p> Un-merged Business Name: 
         * MeasurementType Relationship: 
         ...
         * ObservationMeasurementTimestamp</summary>
         * 
         * <remarks>Relationship: 
         * REPC_MT100002CA.CommonObservationEvent.effectiveTime 
         * Conformance/Cardinality: POPULATED (1) <p>The date to which 
         * the observation applies. E.g., if blood was drawn two days 
         * ago and White Blood Count (WBC) was done today, then WBC 
         * observation date should reflect the date of two days 
         ...
         * observations over time.</p> Un-merged Business Name: 
         * ObservationTimestamp Relationship: 
        ...
        /**
         * <summary>Business Name: CommonObservationMaskingIndicator</summary>
         * 
         * <remarks>Un-merged Business Name: 
         * CommonObservationMaskingIndicator Relationship: 
         ...
         * to their common observation data.</p><p>The attribute is 
         * optional because not all systems will support masking.</p> 
         * Un-merged Business Name: CommonObservationMaskingIndicator 
         * Relationship: 
        ...
        /**
         * <summary>Business Name: ObservationMeasurementValue</summary>
         * 
         * <remarks>Un-merged Business Name: 
         * ObservationMeasurementValue Relationship: 
         ...
         * calculations.</p> <p><b><font color="#000080" size="2" 
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: REPC_MT100002CA.Subject5.patient 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT000018CA.Subject5.patient Conformance/Cardinality: 
         * MANDATORY (1)</remarks>
         */
         ...
         * REPC_MT100002CA.ResponsibleParty.assignedPerson 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT100002CA.CommonObservationEvent.author 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT100002CA.CommonObservationEvent.location 
         * Conformance/Cardinality: MANDATORY (1)</remarks>
         */
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT100002CA.Component.subObservationEvent 
         * Conformance/Cardinality: POPULATED (1) <p>&nbsp;Represents 
         * one of the two components (systolic</p> <div>and diastolic) 
         * of a blood pressure measurement.</div> Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT000018CA.Component.subObservationEvent 
         * Conformance/Cardinality: POPULATED (1) <p>&nbsp;Represents 
         * one of the two components (systolic</p> <div>and diastolic) 
         * of a blood pressure measurement.</div></remarks>
         */
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: REPC_MT100002CA.Subject.annotation 
         * Conformance/Cardinality: POPULATED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT000018CA.Subject.annotation Conformance/Cardinality: 
         * POPULATED (1) <p>&nbsp;Indicates the various comments that 
         * providers</p> <div>have recorded about this common 
