...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Repc_mt000009ca {
     ...
     * otherwise</p> <p>A record of a patient's allergy or 
    ...
    public class AllergyIntolerance : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Repc_mt000009ca.AllergyIntolerance replacementOfIntoleranceCondition;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Repc_mt000009ca.IRecords> supportRecords;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Merged.MedicalConditionStatusChanges> subjectOf1ControlActEvent;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Common.Coct_mt120600ca.Notes> subjectOf2Annotation;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.AllergyIntoleranceSeverityLevel subjectOf3SeverityObservation;
        ...
        public AllergyIntolerance() {
            ...
            this.supportRecords = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Repc_mt000009ca.IRecords>();
            this.subjectOf1ControlActEvent = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Merged.MedicalConditionStatusChanges>();
         ...
         * types are Revise, Reactivate and Complete</p> <p>Allows 
         ...
         * the attribute is not used for SNOMED, it is optional.</p> 
         * <p><strong>Because PIN is not using SNOMED, this attribute 
         * is mandatory.</strong></p></remarks>
         */
         ...
         * 
         * <remarks>Relationship: REPC_MT000009CA.Subject2.patient 
         * Conformance/Cardinality: MANDATORY (1) <p>&nbsp;Identifies 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT000009CA.ResponsibleParty.assignedPerson 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT000009CA.IntoleranceCondition.informant 
         ...
         * 
         * <remarks>Conformance/Cardinality: POPULATED (1) <p>This is a 
         * complete Allergy/Intolerance that reflects</p> <div>what the 
         * allergy/intolerance looked like before this set</div> 
         * <div>of change.</div> <p>&nbsp;</p> <div>Since PIN does not 
         * analyze an update, all updates&nbsp;will be returned in this 
         * section instead of the Has</div> <div>History section.</div></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"replacementOf/intoleranceCondition"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Repc_mt000009ca.AllergyIntolerance ReplacementOfIntoleranceCondition {
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Repc_mt000009ca.IRecords> SupportRecords {
            get { return this.supportRecords; }
        }

        /**
         * <summary>Business Name: Allergy Intolerance Status Change</summary>
         * 
         * <remarks>Relationship: 
         * REPC_MT000009CA.Subject4.controlActEvent 
         * Conformance/Cardinality: POPULATED (1) <p>This records the 
         * history of changes that have been&nbsp;made to the 
         * allergy/intolerance, including why the&nbsp;changes were 
         * made, who made them and when.</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subjectOf1/controlActEvent"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Merged.MedicalConditionStatusChanges> SubjectOf1ControlActEvent {
            get { return this.subjectOf1ControlActEvent; }
        }

        /**
         * <summary>Business Name: Annotation</summary>
         * 
         * <remarks>Relationship: REPC_MT000009CA.Subject3.annotation 
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Merged.AllergyIntoleranceSeverityLevel SubjectOf3SeverityObservation {
