...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Merged {
    ...
    public class ComponentMeasurements : MessagePartBean {
         ...
         * twtype of blood pressure measurements.</p><p>Code is 
         * mandatory to ensure that blood pressure observations are 
         * distinguishable. The attribute is CD to support SNOMED</p> 
         * Un-merged Business Name: BloodPressureMeasurementType 
         * Relationship: REPC_MT000018CA.SubObservationEvent.code 
         * Conformance/Cardinality: MANDATORY (1) <p>Distinguishes 
         ...
         * mandatory to ensure that blood pressure observations are 
         * distinguishable. The attribute is CD to support SNOMED</p></remarks>
         */
