...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Merged {
    ...
    public class AllergyIntolerance : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Merged.IRecords> supportRecords;
        ...
        public AllergyIntolerance() {
            ...
            this.supportRecords = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Merged.IRecords>();
            this.id = new IIImpl();
        }
        /**
         ...
         * not allowed while EALG is.</strong></p> Un-merged Business 
         ...
         * default the status to 'active'. CODE_INVAL error issue will 
         * be returned if not set to either 'active' or 
         * 'completed'.</p> Un-merged Business Name: 
        ...
        /**
         * <summary>Business Name: AllergyIntoleranceMaskingIndicator</summary>
         * 
         * <remarks>Un-merged Business Name: 
         * AllergyIntoleranceMaskingIndicator Relationship: 
         ...
         * not implement record-level masking, this must be 
         * </strong><strong>NORMAL or a CODE_INVAL error issue will be 
         * returned.</strong></p> Un-merged Business Name: 
         * AllergyIntoleranceMaskingIndicator Relationship: 
         ...
         * information.</p> <p><strong>The two valid confirmation 
         * statuses are" 'U' and 'N'</strong></p> <p>An allergy or 
         ...
         * returned if not.</strong></p> Un-merged Business Name: 
        ...
        /**
         * <summary>Business Name: SufferedBy</summary>
         * 
         * <remarks>Un-merged Business Name: (no business name 
         * specified) Relationship: REPC_MT000001CA.Subject2.patient 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: SufferedBy Relationship: 
         * REPC_MT000013CA.Subject2.patient Conformance/Cardinality: 
         * MANDATORY (1) <div>Identifies the person suffering from 
         ...
         * 
         * <remarks>Un-merged Business Name: ReportedBy Relationship: 
         * REPC_MT000001CA.IntoleranceCondition.informant 
         * Conformance/Cardinality: REQUIRED (0-1) <p><strong>Indicates 
         * where the information that led to the recording of this 
         * information came from.</strong></p> Un-merged Business Name: 
        ...
        /**
         * <summary>Business Name: SupportedBy</summary>
         * 
         * <remarks>Un-merged Business Name: SupportedBy Relationship: 
         * REPC_MT000001CA.Support.records Conformance/Cardinality: 
         * POPULATED (1) <p><font color="#000080" size="2" 
         * face="Helvetica"><font color="#000080" size="2" 
         * face="Helvetica"><font color="#000080" size="2" 
         * face="Helvetica"> <p align="left">Indicates a particular 
         * type of reaction experienced by the patient or testing 
         * performed on the patient which provides evidence for the 
         * existence (or non-existence) of the allergy/intolerance.</p> 
         * </font></font></font></p> Un-merged Business Name: 
         * SupportedBy Relationship: REPC_MT000013CA.Support.records 
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_2.Iehr.Merged.IRecords> SupportRecords {
