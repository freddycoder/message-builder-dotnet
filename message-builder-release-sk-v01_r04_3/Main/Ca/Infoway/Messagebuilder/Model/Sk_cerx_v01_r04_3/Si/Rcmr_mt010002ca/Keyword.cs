...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Si.Rcmr_mt010002ca {
    ...
    using Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Si.Merged;
    using System;
    ...
    public class Keyword : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Merged.Patient subject1Patient;
        private ST authorSignatureText;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.IConsenter authorConsenter;
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Merged.Patient Subject1Patient {
         ...
         * particular consent.</p> <p>ZKW.5</p><p>ZZZ.9</p> 
         * <p>ZKW.5</p><p>ZZZ.9</p> <p>Allows patients to change their 
         * keyword. If explicitly set to null, removes the keyword for 
         * the identified record types. Because of this, the attribute 
         * is set to 'populated' and not mandatory.</p> <p>The 
         ...
         * null value which will replace the old keyword value</p></remarks>
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.IConsenter AuthorConsenter {
            get { return this.authorConsenter; }
            set { this.authorConsenter = value; }
        }

        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Si.Merged.Patient AuthorConsenterAsPatient {
            get { return this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Si.Merged.Patient ? (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Si.Merged.Patient) this.authorConsenter : (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Si.Merged.Patient) null; }
        }
        public bool HasAuthorConsenterAsPatient() {
            return (this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Si.Merged.Patient);
        }

        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt040205ca.ResponsiblePerson AuthorConsenterAsResponsibleParty {
            get { return this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt040205ca.ResponsiblePerson ? (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt040205ca.ResponsiblePerson) this.authorConsenter : (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt040205ca.ResponsiblePerson) null; }
        }
        public bool HasAuthorConsenterAsResponsibleParty() {
            return (this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt040205ca.ResponsiblePerson);
        }
