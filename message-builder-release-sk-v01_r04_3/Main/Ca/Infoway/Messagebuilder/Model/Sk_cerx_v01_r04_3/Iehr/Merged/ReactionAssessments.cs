...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Iehr.Merged {
     ...
     * administering a substance. (E.g. If a given drug typically 
     * causes nausea in the patient, an additional medication may 
     * be co-prescribed to manage the nausea.)</p></remarks>
     */
    ...
    public class ReactionAssessments : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Iehr.Merged.IRecords {

        private CD code;
        private CV value;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Iehr.Merged.Exposures startsAfterStartOfExposureEvent;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Iehr.Merged.ObservationEvent subjectObservationEvent;
         ...
         * 
         * <remarks>Assessment Type <p>Indicates the type of assessment 
        ...
        /**
         * <summary>RelatednessAssessment</summary>
         * 
         * <remarks>Relatedness Assessment <p>Indicates whether the 
         * reaction is deemed to be related to the exposure.</p> 
         ...
         * SNOMED, this is fixed to "RELATED"</strong></p> Relatedness 
         * Assessment <p>Indicates whether the reaction is deemed to be 
         ...
         * fixed value of &quot;RELATED&quot;.</p></remarks>
         */
         ...
         * 
         * <remarks></font></font></font></p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"startsAfterStartOf/exposureEvent"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Iehr.Merged.Exposures StartsAfterStartOfExposureEvent {
            get { return this.startsAfterStartOfExposureEvent; }
            set { this.startsAfterStartOfExposureEvent = value; }
        }

        /**
         * <summary>ReactionRecord</summary>
         * 
         * <remarks>Reaction Record <p>For the Reaction Record 
         * Identifier, observationEvent.id: This will be the identifier 
         * of a previously-created Adverse Drug Reaction record. Since 
         * PIN does not currently support the creation of Adverse Drug 
         * Reaction records, this field can not be populated with a 
         * valid PIN identifier. <strong>If this field is sent, a 
         * KEY204 error issue will be returned.</strong></p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subject/observationEvent"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Iehr.Merged.ObservationEvent SubjectObservationEvent {
