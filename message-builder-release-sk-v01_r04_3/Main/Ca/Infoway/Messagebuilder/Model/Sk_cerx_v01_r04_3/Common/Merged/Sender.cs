...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Merged {
    ...
    public class Sender : MessagePartBean {
         ...
         * 
         * <remarks>IA:Sending Application Identifier <p>The identifier 
         * of the system sending the message.</p> <p>Because this is 
         * the key identifier of where the message is coming from, this 
         * attribute is mandatory.</p> <p>Used in message 
         * authorization.&nbsp;</p> IA:Sending Application Identifier 
         * <p>The unique identifier of the application or system to 
         * whom the message is being routed.</p> <p>Because this is the 
         * key identifier of where the message is intended to go, this 
         ...
         * message.</p> <p>Provides useful information when 
         * debugging.</p> <p>PIN does not use this field and it will be 
         * ignored.&nbsp;</p></remarks>
         */
         ...
         * debugging interactions.</p> <p>PIN does not use this field 
         * and it will be ignored.&nbsp;</p> II:Sending Application 
         ...
         * and it will be ignored.&nbsp;</p> IH:Sending Application 
         * Version Date <p>Indicates the last time the sending 
         * application was modified or reconfigured.</p> <p>Can help to 
         * isolate the source of a problem when debugging.</p></remarks>
         */
         ...
         * field and it will be ignored.&nbsp;</p> IF:Sending 
         * Application Software Name <p>Indicates the name of the 
         ...
         * 
         * <remarks>IC:Sending Organization Identifier <p>Uniquely 
         ...
         * information.</p> ICA:Sending Facility Identifier 
         * <p>&nbsp;</p> <p>May be used for routing, or for 
         * configuration control. This attribute is optional because 
         * not all environments require communicating this 
         * information.</p> <p>Used in message authorization.&nbsp;</p></remarks>
         */
