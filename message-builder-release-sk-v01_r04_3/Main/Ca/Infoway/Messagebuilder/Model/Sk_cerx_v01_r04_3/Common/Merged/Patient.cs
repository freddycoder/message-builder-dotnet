...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Merged {
     ...
     * <p>In that case, the business rules specified below might be 
     * relaxed since PIN will not be expected to validate the 
     * patient details.</p> COCT_MT050202CA.Patient: Patient <p>A 
     ...
     * in the context of the associated action only, and should be 
     * stored separately. I.e. the address/phone/email only apply 
     * to the current prescription/dispense/lab order etc.</p> <p 
    ...
    public class Patient : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.IConsenter, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Iehr.Repc_mt000012ca.IChoice, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.IPatient, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Iehr.Merged.IParty {
         ...
         * 
         * <remarks>A:Patient ID <p>Unique identifier assigned to a 
         ...
         * EHR application.</p> <p>issue will be returned.</p> Patient 
         * ID <p>Unique identifier assigned to a person by Federal, 
         ...
         * the patient where they may be visited or found for the 
         ...
         * identity.</p><p>Important for following up with patient but 
         * not always available, and therefore only marked as 
         * 'populated'.</p> <p>registry.</p></remarks>
         */
         ...
         * has been reported or recorded.</p> <p>ZPA.1 
         ...
         * the patient. Complex genetic genders are handled as 
         ...
         * face="Helvetica"><font color="#000080" size="2" 
         * face="Helvetica">.</font></font></font></p> F:Patient Gender 
         ...
         * the patient was born.</p> <p>Used to confirm patient 
         * identity.</p><p>May also influence dosage and therapy 
         * appropriateness.</p><p>Element is mandatory because the 
         ...
         * patient's birth date is necessary for positive 
         * identification of the patient in the jurisdictional client 
         * registry.</p> </font></font></font></b></p> E:Patient Birth 
         ...
         * patient's birth date is necessary for positive 
         * identification of the patient in the jurisdictional client 
         * registry.</p> </font></font></font></b></p></remarks>
         */
