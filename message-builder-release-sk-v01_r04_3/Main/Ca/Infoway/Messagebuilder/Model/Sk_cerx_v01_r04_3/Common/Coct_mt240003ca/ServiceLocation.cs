...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt240003ca {
    ...
    public class ServiceLocation : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.IRecipient {
         ...
         * mandatory.</p><p>The identifier is mandatory because it is 
         * the principal mechanism for uniquely identifying the 
         * facility.</p> <div>error issue will be returned.</div></remarks>
         */
