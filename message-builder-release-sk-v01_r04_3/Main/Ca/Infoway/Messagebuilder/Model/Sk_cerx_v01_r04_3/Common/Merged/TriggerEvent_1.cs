...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Merged {
    ...
    public class TriggerEvent_1<ACT> : MessagePartBean {
         ...
         * caused by the same triggering event. The attribute is 
         * therefore mandatory.</p> <p>future transactions, eg. 
         * Retract.&nbsp;</p> B:Event Identifier <p>A unique identifier 
         * for this particular event assigned by the system in which 
         * the event occurred.</p> <p>Allows the event to be referenced 
         * (for retractions) and also indicates whether multiple 
         ...
         * meaning of the event.</p> <p>with this 
         ...
         * indicated.</p> <div>issue will be returned.</div> C:Event 
         * Effective Period <p>Indicates the time the change should 
         * begin (and occasionally when it should end). If not 
         * specified, assumption is that the event occurred at the same 
         * time the message was constructed.</p><p>Example use is to 
         * record a dispense pickup time on the Rx Pickup Notification 
         * interaction. This time may be in the past, but cannot be in 
         * the future.</p> <p>Indicates the time the change should 
         * begin (and occasionally when it should end). If not 
         * specified, assumption is that the event occurred at the same 
         * time the message was constructed.</p><p>Example use is to 
         * record a dispense pickup time on the Rx Pickup Notification 
         ...
         * reason for accessing information for a query.</p> <p>comes 
         * from the specified domain.&nbsp;</p></remarks>
         */
        ...
        /**
         * <summary>EnteredBy</summary>
         * 
         * <remarks>Entered By <div>specified if different from the 
         * author.</div></remarks>
         */
        ...
        /**
         * <summary>RecordedAt</summary>
         * 
         * <remarks>Recorded At <p>where the event occurred.&nbsp;</p></remarks>
         */
         ...
         * 
         * <remarks>Caused <p>as part of the current message.&nbsp;</p></remarks>
         */
