...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged {
     ...
     * 
     * <remarks>PORX_MT980020CA.SupplyEvent: Dispense <p>Indicates 
     ...
     * too soon, etc.</p> PORX_MT980010CA.SupplyEvent: Dispense 
    ...
    public class Dispense_1 : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.ICausalActs {

        private II id;
        private CS statusCode;
        private IVL<TS, Interval<PlatformDate>> effectiveTime;
        private CV confidentialityCode;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.Dispensed product;
         ...
         * populated because it may be masked.</p> A:Prescription 
         * Dispense Number <p>Unique identifier of the dispense event 
         ...
         * because it may be masked.</p> <p>Allows provider to drill 
         * down and retrieve additional information about the dispense 
         * event for consideration in their issue management 
         * decision.</p><p>The attribute is only marked as 'populated' 
         ...
         * that have not yet been picked up.</p> <div>will be set to 
         * &lsquo;NA&rsquo;.</div> B:Dispensed Date <p>The date and 
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.Dispensed Product {
