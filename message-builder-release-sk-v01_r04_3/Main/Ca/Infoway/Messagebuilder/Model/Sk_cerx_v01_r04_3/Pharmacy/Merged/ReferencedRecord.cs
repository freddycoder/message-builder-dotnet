...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class ReferencedRecord : MessagePartBean {
         ...
         * (EHR) to the Request or Order record being referred to.</p> 
         * <p>Allows the order record to be uniquely referenced and is 
         * therefore mandatory.</p> <div>reference to this order.</div> 
         * Record Id <p>The identifier assigned by the central system 
        ...
        /**
         * <summary>PertainsTo</summary>
         * 
         * <remarks>Pertains To <p>Identity of the patient who was 
         * acted on.&nbsp;</p></remarks>
         */
        ...
        /**
         * <summary>NonAuthoritative</summary>
         * 
         * <remarks>Non-Authoritative <div>is non-authoritative.</div></remarks>
         */
