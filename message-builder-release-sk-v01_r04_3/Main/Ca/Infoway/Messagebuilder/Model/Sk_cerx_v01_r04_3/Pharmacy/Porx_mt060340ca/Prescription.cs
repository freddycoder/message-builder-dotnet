...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt060340ca {
    ...
    public class Prescription : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.IPrescription {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.PrescribedBy author;
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.CoverageExtensions_2> coverageCoverage;
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.NotEligibleForTrial component2;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt060340ca.Includes component3;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.MedicationDispense> fulfillment1MedicationDispense;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.LastDispenseInformation_1 fulfillment2SupplyEventLastSummary;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.FirstDispenseInformation_1 fulfillment3SupplyEventFirstSummary;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.RemainingDispenseInformation_1 fulfillment4SupplyEventFutureSummary;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.PreviousDispenseInformation_1 fulfillment5SupplyEventPastSummary;
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.Comment> subjectOf3Annotation;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.StatusChanges> subjectOf4ControlActEvent;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.AllowedSubstitution subjectOf5SubstitutionPermission;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.RefusalToFills> subjectOf6RefusalToFill;
        ...
        public Prescription() {
            ...
            this.coverageCoverage = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.CoverageExtensions_2>();
            ...
            this.fulfillment1MedicationDispense = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.MedicationDispense>();
            ...
            this.subjectOf3Annotation = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.Comment>();
            this.subjectOf4ControlActEvent = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.StatusChanges>();
            this.subjectOf6RefusalToFill = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.RefusalToFills>();
         ...
         * systems will support masking.</p> <div>not.</div></remarks>
         */
        ...
        /**
         * <summary><p>to be dispensed to the patient.&nbsp;</p></summary>
         */
        [Hl7XmlMappingAttribute(new string[] {"author"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.PrescribedBy Author {
            get { return this.author; }
            set { this.author = value; }
        }

        /**
         * <summary><p>issued the prescription.&nbsp;</p></summary>
         */
        ...
        /**
         * <summary><div>prescribe the drug in the manner they 
         * have.</div></summary>
         */
        ...
        /**
         * <summary><p>recorded against a prescription.&nbsp;</p></summary>
         */
        ...
        /**
         * <summary><p>before the prescription can be 
         * dispensed.&nbsp;</p></summary>
         */
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.CoverageExtensions_2> CoverageCoverage {
        ...
        /**
         * <summary><p>Program.&nbsp;</p></summary>
         */
        [Hl7XmlMappingAttribute(new string[] {"component2"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.NotEligibleForTrial Component2 {
            get { return this.component2; }
            set { this.component2 = value; }
        }

        /**
         * <summary><div>medication should be dispensed to the 
         * patient.</div></summary>
         */
        [Hl7XmlMappingAttribute(new string[] {"component3"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt060340ca.Includes Component3 {
            get { return this.component3; }
            set { this.component3 = value; }
        }

        [Hl7XmlMappingAttribute(new string[] {"fulfillment1/medicationDispense"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.MedicationDispense> Fulfillment1MedicationDispense {
            get { return this.fulfillment1MedicationDispense; }
        }

        [Hl7XmlMappingAttribute(new string[] {"fulfillment2/supplyEventLastSummary"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.LastDispenseInformation_1 Fulfillment2SupplyEventLastSummary {
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.FirstDispenseInformation_1 Fulfillment3SupplyEventFirstSummary {
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.RemainingDispenseInformation_1 Fulfillment4SupplyEventFutureSummary {
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.PreviousDispenseInformation_1 Fulfillment5SupplyEventPastSummary {
        ...
        /**
         * <summary><p>notes were not to be returned and there are 
         * notes.&nbsp;</p></summary>
         */
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.Comment> SubjectOf3Annotation {
            get { return this.subjectOf3Annotation; }
        }

        /**
         * <summary><div>changes were made, who made them and 
         * when.</div></summary>
         */
        [Hl7XmlMappingAttribute(new string[] {"subjectOf4/controlActEvent"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.StatusChanges> SubjectOf4ControlActEvent {
            get { return this.subjectOf4ControlActEvent; }
        }

        [Hl7XmlMappingAttribute(new string[] {"subjectOf5/substitutionPermission"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.AllowedSubstitution SubjectOf5SubstitutionPermission {
            get { return this.subjectOf5SubstitutionPermission; }
            set { this.subjectOf5SubstitutionPermission = value; }
        }

        /**
         * <summary><div>dispenser refusing to fill the subject 
         * prescription.</div></summary>
         */
        [Hl7XmlMappingAttribute(new string[] {"subjectOf6/refusalToFill"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.RefusalToFills> SubjectOf6RefusalToFill {
            get { return this.subjectOf6RefusalToFill; }
        }

        /**
         * <summary><p>issues.&nbsp;</p></summary>
         */
        ...
        /**
         * <summary><p>prescription has been put.&nbsp;</p></summary>
         */
