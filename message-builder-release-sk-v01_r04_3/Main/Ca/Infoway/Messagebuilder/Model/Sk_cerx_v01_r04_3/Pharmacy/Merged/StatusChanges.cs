...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class StatusChanges : MessagePartBean {
         ...
         * 
         * <remarks><p>prescription status.&nbsp;</p> (no business 
         * name) <div>prescription status.</div> (no business name) 
         * <p>prescription dispense status.&nbsp;</p> (no business 
         * name) <p>medication status.&nbsp;</p></remarks>
         */
