...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class AllowedSubstitution : MessagePartBean {
        ...
        /**
         * <summary>SubstitutionNotAllowedIndicator</summary>
         * 
         * <remarks>A:Substitution Not Allowed Indicator <p>If true, 
         * indicates that the drug must be dispensed exactly as 
         * prescribed</p> <p>Many jurisdictions allow substitution by 
         * default and require prescribers to explicitly declare when 
         * they do not want substitution.</p><p>The attribute is 
         * mandatory because it must be known whether the indicator is 
         * true or false.</p> <p>Many jurisdictions allow substitution 
         * by default and require prescribers to explicitly declare 
         * when they do not want substitution.</p><p>The attribute is 
         * mandatory because it must be known whether the indicator is 
         * true or false.</p> A:Substitution Not Allowed Indicator 
         * <p>If true, indicates that the drug must be dispensed 
         * exactly as prescribed</p> <p>Many jurisdictions allow 
         * substitution by default and require prescribers to 
         ...
         * be available.</p> <p>&nbsp;May be marked as 
         * &lsquo;UNK&rsquo; if the reason is&nbsp;unknown.</p> Not 
         * Allowed Reason <p>The reason why the prescriber has 
         * indicated that substitution is not allowed by the dispensing 
         * pharmacy.</p> <p>Some jurisdictions demand that a prescriber 
         * gives a reason for prohibiting substitution.</p><p>The field 
         * is marked as 'Populated' because the reason for substitution 
         * is important to understanding the decision. However when a 
         * prescription is being recorded in the pharmacy, the 
         * information may not be available.</p> <p>Some jurisdictions 
