...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Pome_mt010100ca {
    ...
    public class Medication : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.Manufacturer playerAsManufacturedProductManufacturer;
        private CS playerAsRegulatedProductStatusCode;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.DispensedIn playerAsContent;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.GroupedWithin> playerAsSpecializedKind;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.DrugContains> playerIngredient;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.DrugCost subjectOf1PotentialCharge;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.AppearanceCharacteristics> subjectOf2Characteristic;
        ...
        public Medication() {
            ...
            this.playerAsSpecializedKind = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.GroupedWithin>();
            this.playerIngredient = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.DrugContains>();
            this.subjectOf2Characteristic = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.AppearanceCharacteristics>();
        }
        /**
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.Manufacturer PlayerAsManufacturedProductManufacturer {
        ...
        /**
         * <summary>Dispensed In</summary>
         * 
         * <remarks><div>be contained.</div></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"player/asContent"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.DispensedIn PlayerAsContent {
            get { return this.playerAsContent; }
            set { this.playerAsContent = value; }
        }

        /**
         * <summary>Grouped Within</summary>
         * 
         * <remarks><div>&nbsp;</div> <p>returned.&nbsp;</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"player/asSpecializedKind"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.GroupedWithin> PlayerAsSpecializedKind {
            get { return this.playerAsSpecializedKind; }
        }

        /**
         * <summary>Drug Contains</summary>
         * 
         * <remarks><div>respective quantities.</div></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"player/ingredient"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged.DrugContains> PlayerIngredient {
            get { return this.playerIngredient; }
        }

        [Hl7XmlMappingAttribute(new string[] {"subjectOf1/potentialCharge"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.DrugCost SubjectOf1PotentialCharge {
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.AppearanceCharacteristics> SubjectOf2Characteristic {
