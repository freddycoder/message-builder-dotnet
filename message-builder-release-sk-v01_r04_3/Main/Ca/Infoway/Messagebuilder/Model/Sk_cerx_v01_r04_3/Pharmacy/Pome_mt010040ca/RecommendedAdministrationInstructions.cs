...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Pome_mt010040ca {
    ...
    public class RecommendedAdministrationInstructions : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Pome_mt010040ca.Patient subjectPatient;
        private ST authorAssignedEntityAssignedOrganizationName;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca.AdministrationInstructions> optionDosageInstruction;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980050ca.IIndications> reasonIndications;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Pome_mt010040ca.PatientCharacteristics> preconditionObservationEventCriterion;

        public RecommendedAdministrationInstructions() {
            this.authorAssignedEntityAssignedOrganizationName = new STImpl();
            this.optionDosageInstruction = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca.AdministrationInstructions>();
            this.reasonIndications = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980050ca.IIndications>();
            this.preconditionObservationEventCriterion = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Pome_mt010040ca.PatientCharacteristics>();
        }
        /**
         * <summary>Patient Gender</summary>
         * 
         * <remarks><div>specification applies.</div></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subject/patient"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Pome_mt010040ca.Patient SubjectPatient {
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca.AdministrationInstructions> OptionDosageInstruction {
            get { return this.optionDosageInstruction; }
        }

        [Hl7XmlMappingAttribute(new string[] {"reason/indications"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980050ca.IIndications> ReasonIndications {
            get { return this.reasonIndications; }
        }

        [Hl7XmlMappingAttribute(new string[] {"precondition/observationEventCriterion"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Pome_mt010040ca.PatientCharacteristics> PreconditionObservationEventCriterion {
