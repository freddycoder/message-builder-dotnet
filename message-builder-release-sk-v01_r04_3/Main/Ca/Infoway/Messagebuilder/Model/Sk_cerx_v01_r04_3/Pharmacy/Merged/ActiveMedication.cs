...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged {
     ...
     * PORX_MT980010CA.SubstanceAdministration: Active Medication 
    ...
    public class ActiveMedication : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.ICausalActs {
         ...
         * element is therefore mandatory.</p> <div>record or 
         * &lsquo;EVN&rsquo; for an Other Medication record.</div> 
         * Other Medication Indicator <p>If the attribute is 'RQO', 
         * represents a prescription or dispense record. Otherwise if 
         * 'EVN', it represents an 'Other Medication' record.</p> 
         ...
         * 'populated'.</p><p>The element allows a full 'CD' type to 
         * support SNOMED implementations.</p> <p><strong>Must be 
         * "DRUG" or a CODE_INVAL error issue will be 
         * returned.</strong></p> Administration Type <p>Identifies 
         * whether the interaction is with a drug or a vaccine. For 
         * SNOMED, may also indicate the specific drug or vaccine at 
         * issue.</p> <p>Needed to determine what to do about the 
         * issue. Because the medication can be masked, this element is 
         * only marked as 'populated'.</p><p>The element allows a full 
         * 'CD' type to support SNOMED implementations.</p> <p>Needed 
         * to determine what to do about the issue. Because the 
         * medication can be masked, this element is only marked as 
         * 'populated'.</p><p>The element allows a full 'CD' type to 
         ...
         * 
         * <remarks><p>&nbsp;Identification of the drug that caused the 
         * issue.</p></remarks>
         */
