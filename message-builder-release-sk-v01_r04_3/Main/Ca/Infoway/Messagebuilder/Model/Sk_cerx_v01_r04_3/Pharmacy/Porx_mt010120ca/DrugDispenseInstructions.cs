...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt010120ca {
    ...
    public class DrugDispenseInstructions : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220100ca.DrugProduct productMedication;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.SubsequentSupplyRequest component1SubsequentSupplyRequest;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.FirstFill component2InitialSupplyRequest;
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220100ca.DrugProduct ProductMedication {
            get { return this.productMedication; }
            set { this.productMedication = value; }
        }

        /**
         * <summary><p>&nbsp;Dispensing instruction for all dispenses 
         * subsequent to the first fill.</p></summary>
         */
        [Hl7XmlMappingAttribute(new string[] {"component1/subsequentSupplyRequest"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.SubsequentSupplyRequest Component1SubsequentSupplyRequest {
            get { return this.component1SubsequentSupplyRequest; }
            set { this.component1SubsequentSupplyRequest = value; }
        }

        /**
         * <summary><p>&nbsp;Special instructions regarding the very 
         * first supply&nbsp;of medication to a patient.</p></summary>
         */
        [Hl7XmlMappingAttribute(new string[] {"component2/initialSupplyRequest"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.FirstFill Component2InitialSupplyRequest {
