...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class PrescriptionPatientMeasurements : MessagePartBean {
         ...
         * calculations.</p><p>The attribute is mandatory because the 
         * measurement value must be known.</p> <p>from a secondary 
         * source (e.g. dispensing data).&nbsp;</p> Prescription 
         * Patient Measured Value <p>The amount (quantity and unit) 
         * that has been recorded for the specific type of observation. 
         * E.g. height in meters, weight in kilograms.</p> 
