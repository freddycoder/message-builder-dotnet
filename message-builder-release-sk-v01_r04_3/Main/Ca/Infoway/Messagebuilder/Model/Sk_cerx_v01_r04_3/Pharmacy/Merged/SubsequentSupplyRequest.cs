...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class SubsequentSupplyRequest : MessagePartBean {
         ...
         * specified if at all possible.</strong></p></remarks>
         */
         ...
         * useful in research</p> <p><strong>PIN will only use the Fill 
         * Quantity to determine the amount per fill. If it is not 
         * specified, PIN will not use the administration instructions 
         * and the Days Supply. Instead, it will not report Number of 
         * Fills Remaining in any query responses.</strong></p> E:Days 
         * Supply <p>The number of days that each standard fill is 
         * expected to last. The dispenser must use the administration 
         ...
         * quantity of 'as needed' medication is expected to last.</p> 
