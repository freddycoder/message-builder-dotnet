...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt010120ca {
    ...
    public class Includes : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt010120ca.DispenseInstructions supplyRequest;

        public Includes() {
        }
        /**
         * <summary><p>&nbsp;Specification of how the prescribed 
         * medication is&nbsp;to be dispensed to the patient.</p></summary>
         */
        [Hl7XmlMappingAttribute(new string[] {"supplyRequest"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt010120ca.DispenseInstructions SupplyRequest {
