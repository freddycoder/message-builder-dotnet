...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca {
     ...
     * recording of other medications</p> <p>routeCode is mandatory 
     * and apporachSiteCode is required if not using SNOMED</p><p>- 
    ...
    public class AdministrationInstructions : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca.IMedication consumableMedication1;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca.AdditionalSIGInstruction component1SupplementalInstruction;
        private IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca.ConsistsOf> component2;
        ...
        public AdministrationInstructions() {
            ...
            this.component2 = new List<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca.ConsistsOf>();
        }
        /**
         ...
         * the date the prescription was written</p> 
         ...
         * 
         * <remarks><p>This is the means by which the dispensed drug is 
         * to be administered to the patient.</p> 
        ...
        /**
         * <summary>D:Maximum Doses per Period</summary>
         * 
         * <remarks><p>The maximum amount of the dispensed medication 
         * to be administered to the patient in a specified period of 
         * time. Examples include: per hour, 24-hr period (doses per 
         * day), 7 day period (doses per week), yearly.</p> 
        ...
        /**
         * <summary>Administers Package Component</summary>
         * 
         * <remarks><p>otherwise.&nbsp;</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"consumable/medication1"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca.IMedication ConsumableMedication1 {
            get { return this.consumableMedication1; }
            set { this.consumableMedication1 = value; }
        }

        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220100ca.DrugProduct ConsumableMedication1AsMedication1 {
            get { return this.consumableMedication1 is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220100ca.DrugProduct ? (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220100ca.DrugProduct) this.consumableMedication1 : (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220100ca.DrugProduct) null; }
        }
        public bool HasConsumableMedication1AsMedication1() {
            return (this.consumableMedication1 is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220100ca.DrugProduct);
        }

        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220110ca.DrugProduct ConsumableMedication1AsMedication2 {
            get { return this.consumableMedication1 is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220110ca.DrugProduct ? (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220110ca.DrugProduct) this.consumableMedication1 : (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220110ca.DrugProduct) null; }
        }
        public bool HasConsumableMedication1AsMedication2() {
            return (this.consumableMedication1 is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220110ca.DrugProduct);
        }

        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220200ca.DrugProduct ConsumableMedication1AsMedication3 {
            get { return this.consumableMedication1 is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220200ca.DrugProduct ? (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220200ca.DrugProduct) this.consumableMedication1 : (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220200ca.DrugProduct) null; }
        }
        public bool HasConsumableMedication1AsMedication3() {
            return (this.consumableMedication1 is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220200ca.DrugProduct);
        }

        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220210ca.DrugProduct ConsumableMedication1AsMedication4 {
            get { return this.consumableMedication1 is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220210ca.DrugProduct ? (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220210ca.DrugProduct) this.consumableMedication1 : (Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220210ca.DrugProduct) null; }
        }
        public bool HasConsumableMedication1AsMedication4() {
            return (this.consumableMedication1 is Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt220210ca.DrugProduct);
        }
        ...
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca.AdditionalSIGInstruction Component1SupplementalInstruction {
            get { return this.component1SupplementalInstruction; }
            set { this.component1SupplementalInstruction = value; }
        }

        /**
         * <summary><p align="left">prescription that are coded 
         * elsewhere.</p></summary>
         */
        [Hl7XmlMappingAttribute(new string[] {"component2"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca.ConsistsOf> Component2 {
