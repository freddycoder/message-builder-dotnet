...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class Classifies : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.DrugUse workingListEvent;
         ...
         * 
         * <remarks><p>intended duration of the prescribed 
         * therapy.&nbsp;</p> (no business name) <div>intended duration 
         * of the prescribed therapy.</div></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"workingListEvent"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Pharmacy.Merged.DrugUse WorkingListEvent {
