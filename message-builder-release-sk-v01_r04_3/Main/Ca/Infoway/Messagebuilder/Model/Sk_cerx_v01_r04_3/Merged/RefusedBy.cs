...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged {
     ...
     * therefore mandatory.</p> POIZ_MT060150CA.Author: 
     * *administered by <p>Identity of the provider who performed 
     * the immunization event.</p> <p>Allows for the tracking of 
     * the provider who did the immunization and therefore 
     ...
     * PORX_MT060190CA.Author: *recorded by <p>Indicates the 
     * provider who recorded the &quot;other active 
     * medication&quot;.</p> <p>Useful for follow-up and audit 
     * purposes, and therefore mandatory.</p> 
    ...
    public class RefusedBy : MessagePartBean {
        ...
        private TS time;
        private Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt090107ca.Provider assignedPerson;
        private CV modeCode;
         ...
         * influence expiry dates for the order.</p><p>The attribute is 
         * populated because the creation date of the prescription 
         * shall always be known or absent for a reason.</p> Recording 
         * Datetime <p>The date and time on which the observation was 
         * recorded.</p> <p>ZPB3.20</p><p>Annotation.annotationDate</p> 
         ...
         * overall order will be assumed.</p> CreateTimestamp <p>The 
         * date and time at which the note was posted.</p> 
         ...
         * 'record common observation' interaction.</p> Create 
         ...
         * which the medication condition record was created.</p> 
         ...
         * condition' interaction.</p> B:Patient Note Date <p>The date 
         * on which the patient note was created.</p> <p>Allows other 
         * provider to evaluate the currency of the information 
         * contained in the note.</p><p>The date of the note creation 
         * is always known and is therefore mandatory.</p> <p>Allows 
         * other provider to evaluate the currency of the information 
         * contained in the note.</p><p>The date of the note creation 
         * is always known and is therefore mandatory.</p> Change Time 
         ...
         * mandatory.</p> Create Timestamp <p>The date and time on 
         * which the medical condition record was created.</p> 
         ...
         * observation' interaction.</p> D:Time of Creation <p>The time 
         * the person responsible for the event made the decision for 
         * it to occur. This may be different than the time the change 
         * became effective. (E.g. If a provider decides today to put a 
         ...
         * time the person responsible for the query made the decision 
         * for it to occur. This may be different than the time the 
         * time the query was actually performed.</p> <p>The time a 
         * decision is made is a critical piece of audit information 
         * and is therefore mandatory.</p> Prescription Order Date 
         ...
         * influence expiry dates for the order.</p><p>The attribute is 
         * populated because the creation date of the prescription 
         * shall always be known or absent for a reason.</p> D:Time of 
         * Creation <p>The time the person responsible for the event 
         * made the decision for it to occur. This may be different 
         * than the time the change became effective. (E.g. If a 
         * provider decides today to put a prescription on hold 
         * starting next Tuesday, the time of creation would be today 
         * and the change effective period would be next 
         * Tuesday.)</p><p>This date can be back-dated.</p> <p>The time 
         * the person responsible for the event made the decision for 
         ...
         * creation would be today and the change effective period 
         * would be next Tuesday.)</p><p>This date can be 
         * back-dated.</p> <p>The time a change is made is a critical 
         * piece of audit information and is therefore mandatory.</p> 
         * <p>was constructed.&nbsp;</p> Create Timestamp <p>The date 
         * and time on which the adverse reaction record was 
         * created.</p> <p>Identifies timing of adverse reaction for 
         * sorting and for audit purposes. Attribute is populated 
         * because the source of the data may not be through the 
         * 'record common observation' interaction.</p> Change Time 
         * <p>The date on which the change was made.</p> <p>Gives other 
         ...
         * the attribute is mandatory.</p> Change Datetime <p>The date 
         * on which the change was made. Note that this may be earlier 
         * or occassionally later than when the change is actually 
         ...
         * change is always known and thus the attribute is 
         * mandatory.</p> Prescription Order Date <p>The date at which 
         ...
         * reason.</p> <p>The date and time at which the drug was 
         * prescribed. This may differ for mthe date on which the 
         * prescription becomes effective.</p> Prescription Order Date 
         * <p>The calendar date on which the device was pres
         * ... [rest of documentation truncated due to excessive length]
         */
        ...
        /**
         * <summary>Authored By</summary>
         * 
         * <remarks><p>&nbsp;Identifies the provider who reported the 
         * allergy or&nbsp;intolerance.</p> Authored By <div>Identifies 
         * the provider who reported the allergy 
         * or&nbsp;intolerance.&nbsp;</div> Created By <p>are allowed 
         * to do the specified interaction.&nbsp;</p> Created By 
         * <p>specified interaction.&nbsp;</p> Authored By 
         * <p>&nbsp;Identifies the provider who reported the note.</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"assignedPerson"})]
        public Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Common.Coct_mt090107ca.Provider AssignedPerson {
         ...
         * it will be used.</p> <p>This field will be ignored if it is 
         * sent.&nbsp;</p></remarks>
         */
