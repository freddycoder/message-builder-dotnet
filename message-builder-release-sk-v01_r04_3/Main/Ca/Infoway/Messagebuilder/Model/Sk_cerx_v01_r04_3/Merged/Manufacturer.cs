...
namespace Ca.Infoway.Messagebuilder.Model.Sk_cerx_v01_r04_3.Merged {
    ...
    public class Manufacturer : MessagePartBean {
         ...
         * specific manufacturer is a criterion.</p> 
         * </font></font></font></b></p> Manufacturer Id <p>An 
         * identifier denoting a specific drug manufacturer.</p> 
         * <p>Allows sending of identifiers in place of manufacturer 
         * name. May be used in drug search where specific manufacturer 
         * is a criterion.</p> <p>&nbsp;PIN does not have this 
         * information.</p> Manufacturer Id <p>An identifier denoting a 
         * specific drug manufacturer.</p> <p>Allows sending of 
         * identifiers in place of manufacturer name. May be used in 
         * drug search where specific manufacturer is a criterion.</p> 
         * Organization Id <p>An identifier denoting a specific drug 
         * manufacturer.</p> <p>Allows sending of identifiers in place 
         * of manufacturer name. May be used in drug search where 
