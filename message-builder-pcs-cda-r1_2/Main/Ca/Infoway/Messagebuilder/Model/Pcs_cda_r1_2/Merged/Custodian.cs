...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Merged {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"BaseModel.Custodian","PcCDAHeader.Custodian"})]
    public class Custodian : MessagePartBean {

        private LIST<CS, Code> realmCode;
        private II typeId;
        private LIST<II, Identifier> templateId;
        private Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Merged.AssignedCustodian assignedCustodian;
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: PcCDAHeader.Custodian.realmCode 
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: PcCDAHeader.Custodian.typeId 
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: PcCDAHeader.Custodian.templateId 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         ...
         * PcCDAHeader.Custodian.assignedCustodian 
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Merged.AssignedCustodian AssignedCustodian {
