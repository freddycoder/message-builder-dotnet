...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Merged {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"BaseModel.AuthoringDevice","PcCDAHeader.AuthoringDevice"})]
    public class AuthoringDevice : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.IAssignedAuthorChoice, Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Pccdaheader.IAssignedAuthorChoice {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.MaintainedEntity> asMaintainedEntity;
         ...
         * PcCDAHeader.AuthoringDevice.realmCode 
         ...
         * Name: (no business name specified) Relationship: 
         * PcCDAHeader.AuthoringDevice.typeId Conformance/Cardinality: 
         ...
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PcCDAHeader.AuthoringDevice.templateId 
         * Conformance/Cardinality: OPTIONAL (0-*)</remarks>
         */
         ...
         * Conformance/Cardinality: OPTIONAL (0-1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PcCDAHeader.AuthoringDevice.code Conformance/Cardinality: 
         * OPTIONAL (0-1)</remarks>
         */
         ...
         * Conformance/Cardinality: OPTIONAL (0-1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PcCDAHeader.AuthoringDevice.manufacturerModelName 
         ...
         * Conformance/Cardinality: OPTIONAL (0-1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PcCDAHeader.AuthoringDevice.softwareName 
         * Conformance/Cardinality: POPULATED (1)</remarks>
         */
         ...
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PcCDAHeader.AuthoringDevice.asMaintainedEntity 
         * Conformance/Cardinality: OPTIONAL (0-*)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"asMaintainedEntity"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.MaintainedEntity> AsMaintainedEntity {
