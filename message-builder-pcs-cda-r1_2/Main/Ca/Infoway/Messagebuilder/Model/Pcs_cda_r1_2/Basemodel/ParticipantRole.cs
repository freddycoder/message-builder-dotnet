...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel {
    ...
    public class ParticipantRole : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.IParticipantRoleChoice participantRoleChoice;
        private Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.Entity scopingEntity;
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.IParticipantRoleChoice ParticipantRoleChoice {
            get { return this.participantRoleChoice; }
            set { this.participantRoleChoice = value; }
        }

        public Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.Device ParticipantRoleChoiceAsPlayingDevice {
            get { return this.participantRoleChoice is Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.Device ? (Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.Device) this.participantRoleChoice : (Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.Device) null; }
        }
        public bool HasParticipantRoleChoiceAsPlayingDevice() {
            return (this.participantRoleChoice is Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.Device);
        }

        public Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.PlayingEntity ParticipantRoleChoiceAsPlayingEntity {
            get { return this.participantRoleChoice is Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.PlayingEntity ? (Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.PlayingEntity) this.participantRoleChoice : (Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.PlayingEntity) null; }
        }
        public bool HasParticipantRoleChoiceAsPlayingEntity() {
            return (this.participantRoleChoice is Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.PlayingEntity);
        }
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_cda_r1_2.Basemodel.Entity ScopingEntity {
