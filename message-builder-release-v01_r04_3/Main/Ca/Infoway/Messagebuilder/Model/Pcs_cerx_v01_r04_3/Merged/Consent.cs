...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Merged {
    ...
    public class Consent : MessagePartBean {
         ...
         * the patient retains a level of control</p> C:Consent 
         * Effective and End Time <p>Indicates the time that the 
         * consent will expire. 'Low' is effective time and 'High' is 
         * end time.</p> <p>Authorization.endTime (high)</p> <p>Most 
