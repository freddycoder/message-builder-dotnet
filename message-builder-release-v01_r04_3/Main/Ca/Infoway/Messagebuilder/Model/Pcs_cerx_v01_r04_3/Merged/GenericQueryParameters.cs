...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Merged {
     ...
     * parameters that may be used to filter the query 
     * response.</p> <p>Root class for query definition.</p> 
     * PORX_MT060270CA.ParameterList: (no business name) <p>Defines 
     * the set of parameters that may be used to filter the query 
     * response.</p> <p>Root class for query definition</p> 
     * REPC_MT000008CA.ParameterList: Condition History Query 
     * Parameters <p>Defines the set of parameters that may be used 
     * to filter the query response</p> <p>Root class for query 
     * definition</p> PORX_MT060220CA.ParameterList: (no business 
     * name) <p>Defines the set of parameters that may be used to 
     * filter the query response.</p> <p>Root class for query 
     * definition</p> PORX_MT060110CA.ParameterList: (no business 
     * name) <p>Defines the set of parameters that may be used to 
     * filter the query response.</p> <p>Root class for query 
     * definition</p> PORX_MT060170CA.ParameterList: Generic Query 
     * Parameters <p>Defines the set of parameters that may be used 
     * to filter the query response.</p> <p>Root class for query 
    ...
    public class GenericQueryParameters : MessagePartBean {
         ...
         * E:Patient Birth Date <p>Indicates the gender of the 
         * patient.</p> <p>Used to confirm the identity of the patient 
         * for the query and is therefore mandatory.</p> Patient Birth 
         * Date <p>Indicates the date on which the patient was 
         ...
         * the patient.</p> <p>Used to confirm the of the patient for 
         * the query and is therefore mandatory.</p> Patient Gender 
         * <p>Indicates the gender (sex) of the patient.</p> <p>Used to 
         * confirm the identity of the patient for the query and is 
         * therefore mandatory.</p> D:Patient Gender <p>Indicates the 
         ...
         * the subject of the patient measurement query. Filter the 
         ...
         * is the subject of the allergy/intolerance query. Filter the 
         * result set to include only those records pertaining to the 
         * patient with this Id.</p> <p>Allows filtering of result set 
         * by patient Id. This is a mandatory field because a patient 
         * must be specified for the query to be valid.</p> B:Patient 
         * ID <p>Identifier of the patient who is the subject of the 
         ...
         * the patient measurement query.</p><p>Filter the result set 
         * to include only those records pertaining to the patient with 
         ...
         * 
         * <remarks>Usage Effective Period <p>Indicates the usage 
         * period for which the request/query applies.</p><p>Filter the 
         * result set to include only those device records (device 
         * order and device dispense) for which the patient was deemed 
