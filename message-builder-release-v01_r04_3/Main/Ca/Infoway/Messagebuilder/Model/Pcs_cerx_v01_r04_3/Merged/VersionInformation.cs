...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Merged {
     ...
     * when.</p> COCT_MT130001CA.ControlActEvent: Version 
     * Information <p>Provides a record changes, providing deeper 
     * clinical understanding, particularly of past clinical 
     * decisions.</p> <p>This records the history of changes that 
     * have been made to the record, including why the changes were 
    ...
    public class VersionInformation : MessagePartBean {
         ...
         * Reactivate and Complete.</p> Un-merged Business Name: 
         * ChangeType Relationship: 
         * COCT_MT130001CA.ControlActEvent.code 
         * Conformance/Cardinality: MANDATORY (1) <p>This attribute is 
         * mandatory to ensure that change types are 
         * distinguishable.</p> <p>Identifies what kind of change 
         * occurred.</p></remarks>
         ...
         * an allergy/intolerance become valid and applicable.</p> 
         * Un-merged Business Name: ChangeEffectiveDateAndEndDate 
         * Relationship: COCT_MT130001CA.ControlActEvent.effectiveTime 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows 
         * applications to sort and filter by time. The date on which a 
         * change is effective should always be known and thus is 
         ...
         * for change. Allows CWE because not all reasons will 
         * correspond to a pre-defined code.</p> <p>Denotes the reason 
         * the the allergy/intolerance was changed.</p> Un-merged 
