...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Merged {
    ...
    public class DrugContains : MessagePartBean {
         ...
         * essential.</p> <p>Useful for filtering searches. Allows 
         ...
         * &quot;does/must not contain&quot; is essential.</p> D:Drug 
         ...
         * &quot;does/must not contain&quot; is essential, however in 
         * some circumstances it is necessary to say &quot;may 
         * contain&quot;.</p> L:Does Not Contain Indicator <p>An 
         ...
         * .1mg/1mg)</p><p>ZCP.3</p><p>ZDU.4.3</p><p>ZDU.6.1.2</p><p>Compound.448-ED 
         * (quantity)</p><p>Compound.451-EG (unit)</p> 
         * <p>CompoundIngredient.amount(numer
