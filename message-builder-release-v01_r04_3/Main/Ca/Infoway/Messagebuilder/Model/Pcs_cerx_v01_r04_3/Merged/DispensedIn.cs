...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Merged {
     ...
     * such as compliance packaging.</p> COCT_MT220200CA.Content: 
     * drug dispensed in <p>Must specify at least one of Drug 
     * Package quantity and Drug Container Type.</p> <p>Information 
     * about how the dispensed drug is or should be contained</p> 
     ...
     * be contained</p> <p>A_BillablePharmacyDispense</p> <p>May 
    ...
    public class DispensedIn : MessagePartBean {
         ...
         * supplied.</p> B:Drug Package Quantity <p>The quantity of the 
