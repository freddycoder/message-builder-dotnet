...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Merged {
    ...
    public class RefusedBy : MessagePartBean {
         ...
         * overall order will be assumed.</p> Create Timestamp <p>The 
         * date and time on which the allergy/intolerance record was 
         ...
         * influence expiry dates for the order.</p><p>The attribute is 
         * populated because the creation date of the prescription 
         * shall always be known or absent for a reason.</p> Note 
         * Timestamp <p>The date and time at which the note was 
         ...
         * annotation will always be known.</p> Create Timestamp <p>The 
         * date and time on which the adverse reaction record was 
         ...
         * change is always known and thus the attribute is 
         * mandatory.</p> Prescription Order Date <p>The calendar date 
         * on which the device was prescribed. This may differ from the 
