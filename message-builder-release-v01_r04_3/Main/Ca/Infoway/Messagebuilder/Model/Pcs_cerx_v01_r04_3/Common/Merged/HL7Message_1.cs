...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged {
     ...
     * 
     * <remarks>MCCI_MT000300CA.Message: HL7 Message <p>Conveys 
     * information about the interaction and how it is to be 
     * processed</p> <p>The root class of all messages.</p> 
     * MCCI_MT000100CA.Message: HL7 Message <p>Conveys information 
    ...
    public class HL7Message_1<CAP> : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.Receiver receiver;
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.ToBeRespondedToBy respondTo;
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.Sender sender;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.RoutingInstructionLines> attentionLine;
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.Acknowledgement acknowledgement;
        ...
        public HL7Message_1() {
            ...
            this.attentionLine = new List<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.RoutingInstructionLines>();
        }
        /**
         ...
         * message.</p> Un-merged Business Name: MessageIdentifier 
         ...
         * MCCI_MT000100CA.Message.creationTime 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows 
         * identification of how current the information in a message 
         * is. Also provides a baseline for identifying the time-zone 
         * of other times within the message. As a result, the 
         ...
         * MCCI_MT000100CA.Message.securityText 
         * Conformance/Cardinality: OPTIONAL (0-1) <p>Allows 
         * jurisdictions and applications to communicate authentication 
         * and session information. The attribute is optional because 
         * not all jurisdictions will require this capability.</p> <p>A 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Needed to know how 
         * to validate message definition, CMET definition, vocabulary 
         * and other information and is therefore mandatory.</p> 
         * <p>Indicates the version of the messaging standard being 
         * referenced.</p> Un-merged Business Name: HL7StandardVersion 
         ...
         * message.</p> Un-merged Business Name: InteractionType 
         ...
         * MCCI_MT000300CA.Message.profileId Conformance/Cardinality: 
         ...
         * ConformanceProfileIdentifiers Relationship: 
         * MCCI_MT000100CA.Message.profileId Conformance/Cardinality: 
         * REQUIRED (0-10) <p>Indicates any additional validation that 
         * may be appropriate. Also influences what extensions can be 
         * processed.</p> <p>Identifies the conformance profile(s) this 
         ...
         * Un-merged Business Name: ProcessingCode Relationship: 
         * MCCI_MT000100CA.Message.processingCode 
         * Conformance/Cardinality: MANDATORY (1) <p>Indicates how the 
         * message should be handled and is therefore mandatory.</p> 
         * <p>Indicates whether this message is intended to be 
         ...
         * be acknowledged.</p> Un-merged Business Name: 
         * DesiredAcknowledgmentType Relationship: 
         * MCCI_MT000100CA.Message.acceptAckCode 
         * Conformance/Cardinality: MANDATORY (1) <p>Provides support 
         * for immediate, deferred and polling mode and distinguishes 
         * which mode is desired. The attribute is therefore 
         * mandatory.</p> <p>Indicates how the message is expected to 
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: MCCI_MT000300CA.Message.receiver 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * MCCI_MT000100CA.Message.receiver Conformance/Cardinality: 
         * MANDATORY (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"receiver"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.Receiver Receiver {
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: MCCI_MT000300CA.Message.respondTo 
         * Conformance/Cardinality: OPTIONAL (0-1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * MCCI_MT000100CA.Message.respondTo Conformance/Cardinality: 
         * OPTIONAL (0-1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"respondTo"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.ToBeRespondedToBy RespondTo {
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: MCCI_MT000300CA.Message.sender 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * MCCI_MT000100CA.Message.sender Conformance/Cardinality: 
         * MANDATORY (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"sender"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.Sender Sender {
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: MCCI_MT000300CA.Message.attentionLine 
         * Conformance/Cardinality: OPTIONAL (0-5) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * MCCI_MT000100CA.Message.attentionLine 
         * Conformance/Cardinality: OPTIONAL (0-5)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"attentionLine"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.RoutingInstructionLines> AttentionLine {
         ...
         * MCCI_MT000300CA.Message.acknowledgement 
         * Conformance/Cardinality: MANDATORY (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"acknowledgement"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged.Acknowledgement Acknowledgement {
         ...
         * 
         * <remarks>Relationship: 
         * MCCI_MT000300CA.Message.controlActProcess 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * MCCI_MT000100CA.Message.controlActProcess 
         * Conformance/Cardinality: MANDATORY (1)</remarks>
         */
