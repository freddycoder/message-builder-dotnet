...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Quqi_mt120000ca {
    ...
    public class QueryResponseInformation : MessagePartBean {
         ...
         * 
         * <remarks><p>The number of item repetitions returned in the 
         * current response.</p> <p>Provides a quick overview of the 
         * number of items without having to go through and count the 
         * data and is therefore mandatory.</p></remarks>
         */
