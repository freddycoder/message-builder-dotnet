...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Merged {
     ...
     * 
     * <remarks>COCT_MT050203CA.Patient: Patient <p>Information 
     ...
     * current prescription/dispense/lab order etc.</p> <p>A person 
     * who is receiving or may receive healthcare services and has 
     * personal attributes (e.g. name, birth date). .</p> 
     * COCT_MT050202CA.Patient: Patient <p>Information used to 
    ...
    public class Patient : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Iehr.Repc_mt000012ca.IChoice, Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged.IPatient, Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Merged.IConsenter, Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Iehr.Merged.IParty {
         ...
         * identifying humans, the attribute is mandatory. If an 
         ...
         * jurisdiction.</p> Un-merged Business Name: PatientID 
         ...
         * MANDATORY (1) <p>ZPA.1 (partType=Given)</p> <p>ZPA.2 
         ...
         * <p>Person.nameSuffix</p> <p>Used, with other patient 
         * identity attributes, to confirm patient identity, as well as 
         * when addressing the patient. Element is mandatory because 
         * the patient's name is necessary for positive identification 
         * of the patient in the jurisdictional client registry.</p> 
         * <p>The name by which the patient is known and which apply to 
         * a particular clinical action that has been reported or 
         * recorded.</p> Un-merged Business Name: PatientName 
         * Relationship: COCT_MT050203CA.Person.name 
         ...
         * considered relevant.</p> Un-merged Business Name: 
         ...
         * born.</p> Un-merged Business Name: PatientBirthDate 
         * Relationship: COCT_MT050203CA.Person.birthTime 
