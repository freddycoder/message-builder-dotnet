 ...
 * Last modified: $LastChangedDate: 2012-02-16 10:58:14 -0500 (Thu, 16 Feb 2012) $
 * Revision:      $LastChangedRevision: 5372 $
 */
/* This class was auto-generated by the message builder generator tools. */
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Immunization.Poiz_mt060140ca {
    ...
    public class GenericQueryParameters : MessagePartBean {
         ...
         * 
         * <remarks><p>Indicates whether or not issues attached to the 
         ...
         * of omitting/including issues in the retrieval of information 
         * for immunization data.</p><p>Because the attribute is 
         * boolean, it must explicitly indicate a 'TRUE' or 'FALSE', 
         ...
         * immunization data. The value of this parameter must be known 
         * to return a response, so it is marked as mandatory.</p></remarks>
         */
        ...
        /**
         * <summary>H:Next Planned Dose Period</summary>
         * 
         * <remarks><p>Indicates that the returned records should be 
         * filtered to only include those immunization records for 
         * which the next planned dose date falls within the indicated 
         * time-period.</p> <p>Allows the requester to specify the 
        ...
        /**
         * <summary>D:Patient Birth Date</summary>
         * 
         * <remarks><p>Indicates the date on whic the patient was 
         * born.</p> <p>Use to confirm identity of the patient for the 
         * query and is therefore mandatory.</p></remarks>
         */
        ...
        /**
         * <summary>I:Renewal Period</summary>
         * 
         * <remarks><p>Indicates that the returned records should be 
         * filtered to only include those immunization records for 
         * which the renewal date falls within the indicated 
         * time-period.</p> <p>Allows the requester to specify the 
         * period of interest for the retrieval of immunization 
         * records.</p><p>Useful for constraining run-away queries.</p> 
         * <p>Allows the requester to specify the period of interest 
        ...
        /**
         * <summary>F:Vaccine Dose Number</summary>
         * 
         * <remarks><p>A number representing the vaccine booster order 
         * that must be used in searching for patient immunization 
         * record.</p><p>The result set will be filtered to only 
         * include immunization records pertaining to specific booster 
         * number.</p> <p>A number representing the vaccine booster 
         * order that must be used in searching for patient 
         * immunization record.</p><p>The result set will be filtered 
         * to only include immunization records pertaining to specific 
         * booster number.</p> <p>Allows for finer sub-set of 
         * immunization records to be retrieved based on the sequence 
         * of the vaccine booster.</p></remarks>
         */
