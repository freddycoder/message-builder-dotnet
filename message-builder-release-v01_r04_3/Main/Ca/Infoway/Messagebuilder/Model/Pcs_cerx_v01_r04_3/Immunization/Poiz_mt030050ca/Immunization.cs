...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Immunization.Poiz_mt030050ca {
     ...
     * <p>Route must be required if not using SNOMED</p> <p>If 
     * immunization was not refused, then refusal reason must not 
     * be specified otherwise field should be treated as 
     * populated.</p> <p>Allows capturing a patient's immunization 
     * profile</p> <p>Represents a single immunization occurrence 
    ...
    public class Immunization : MessagePartBean {
         ...
         * (Refused)</p> <p>Useful information for planning future 
         * immunization encounters for the patient.</p> <p>A coded 
         ...
         * allow for use of pre-coordinated SNOMED Codes.</p> <p>This 
         * is the means by which the drug was administered to the 
         * patient.</p></remarks>
         */
         ...
         * the body area where the immunization was 
