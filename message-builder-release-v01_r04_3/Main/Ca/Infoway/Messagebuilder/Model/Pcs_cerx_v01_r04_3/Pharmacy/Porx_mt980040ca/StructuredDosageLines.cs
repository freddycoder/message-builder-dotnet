...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Porx_mt980040ca {
     ...
     * be specified t one time }</p> <p>Enables SIG instructions to 
     * be discretely specified. Also, supports scaling doses and 
     * parallel dose specification.</p> <p>This information, along 
     * with the order/sequence of the dosage lines, constitutes the 
     * details of a structured dosage instruction.</p>
     */
    ...
    public class StructuredDosageLines : MessagePartBean {
         ...
         * preferred solution.</p> <p>This specifies the minimum and 
