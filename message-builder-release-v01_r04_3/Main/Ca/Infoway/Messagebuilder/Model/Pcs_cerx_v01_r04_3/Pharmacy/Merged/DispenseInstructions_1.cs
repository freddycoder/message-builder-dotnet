...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged {
     ...
     * dispensed, etc.</p> PORX_MT020060CA.SupplyRequest: (no 
     * business name) <p>AT least one of Total Prescribed Quantity 
     * or Total Days Supply must be specified</p> 
    ...
    public class DispenseInstructions_1 : MessagePartBean {
         ...
         * against the prescription.</p> <p>The overall amount of 
         * device to be dispensed under this prescription.</p> 
         * Un-merged Business Name: TotalPrescribedQuantity 
         * Relationship: PORX_MT010110CA.SupplyRequest.quantity 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Sets upper limit 
         ...
         * ('Fill-Too-Soon', 'Fill-Too-Late').</p> <p>The number of 
