...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Porx_mt060180ca {
    ...
    public class MedicationProfileGenericQueryParameters : MessagePartBean {
         ...
         * 
         * <remarks>Relationship: 
         * PORX_MT060180CA.PatientBirthDate.value 
         ...
         * 
         * <remarks>Relationship: PORX_MT060180CA.PatientGender.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Used to confirm 
         * the identity of the patient for the query and is therefore 
         ...
         * 
         * <remarks>Relationship: PORX_MT060180CA.PatientID.value 
         ...
         * 
         * <remarks>Relationship: PORX_MT060180CA.PatientName.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Used to confirm 
         * the identity of the patient for the query and is therefore 
