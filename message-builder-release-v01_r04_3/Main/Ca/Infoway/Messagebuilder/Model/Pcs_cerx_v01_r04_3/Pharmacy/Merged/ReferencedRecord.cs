...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class ReferencedRecord : MessagePartBean {
         ...
         * identifiers are allowed to support assigning of prescripti
