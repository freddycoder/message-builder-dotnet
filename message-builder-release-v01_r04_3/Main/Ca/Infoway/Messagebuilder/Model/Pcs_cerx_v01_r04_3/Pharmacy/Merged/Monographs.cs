...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class Monographs : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged.AssignedEntity3 authorAssignedEntity;
         ...
         * Un-merged Business Name: MedicationDocumentId Relationship: 
         * PORR_MT050016CA.Document.id Conformance/Cardinality: 
         * MANDATORY (1) <p>Monograph.monographId</p> <p>Allows 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Allows distinction 
         * between Drug Monograph and Patient Monograph.</p> 
         * <p>ZPC1.2</p> <p>ZPD2.2</p> <p>Allows monograph types to be 
         * distinguished for display, printing, etc.</p><p>Code is 
         * mandatory because an application can't know what to do with 
         * a monograph without knowing its type.</p> <p>Distinguishes 
         * between different kinds of documents and monographs. Kinds 
         * of monographs include: Clinical Monograph, Patient Education 
         * Monograph, etc.</p> Un-merged Business Name: 
         * MedicationDocumentType Relationship: 
         * PORR_MT050016CA.Document.code Conformance/Cardinality: 
         * MANDATORY (1) <p>Allows distinction between Drug Monograph 
         * and Patient Monograph.</p> <p>ZPC1.2</p> <p>ZPD2.2</p> 
         ...
         * without knowing its type.</p> <p>Distinguishes between 
         * different kinds of documents and medication documents. Kinds 
         * of medication documents include: Clinical Medication 
         * document, Patient Education Medication document, Indication 
         * Protocol, etc</p></remarks>
         */
         ...
         * <p>PatientMonograph.PatientMonographLines</p> <p>ZPD3.1</p> 
         * <p>Allows delivery of the monograph information to the 
         * provider either embedded or by reference</p> <p>Includes 
         ...
         * monograph was superseded</p> Un-merged Business Name: 
         ...
         * information in the medication document was superseded.</p></remarks>
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged.AssignedEntity3 AuthorAssignedEntity {
