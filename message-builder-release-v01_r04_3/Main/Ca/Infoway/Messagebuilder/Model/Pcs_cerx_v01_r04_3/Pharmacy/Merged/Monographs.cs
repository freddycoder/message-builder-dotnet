...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class Monographs : MessagePartBean {
         ...
         * Monograph Id <p>Unique identifier assigned to a monograph 
         * record.</p> <p>Monograph.monographId</p> <p>Allows matching 
         ...
         * locally-stored monographs.</p><p>This attribute is marked as 
         ...
         * knowing its type.</p> A:Medication Document Type 
         ...
         * document, Indication Protocol, etc</p> <p>Allows distinction 
         * between Drug Monograph and Patient 
         * Monograph.</p><p>ZPC1.2</p><p>ZPD2.2</p> <p>Allows 
         * distinction between Drug Monograph and Patient 
         * Monograph.</p><p>ZPC1.2</p><p>ZPD2.2</p> <p>Allows 
         * distinction between Drug Monograph and Patient 
         ...
         * can be accessed on the network via HTTP or FTP</p> 
