...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Porx_mt980050ca {
     ...
     * <p>Value is mandatory if not using SNOMED</p> <p>Allows 
     * separation of conditions from symptoms from other forms of 
     * indication.</p> <p>Describes symptom-related indications</p>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"PORX_MT980050CA.ObservationSymptom"})]
    public class SymptomIndications : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Porx_mt980050ca.IIndications {
         ...
         * is optional because it is not used for SNOMED.</p> <p>A 
         * coded representation of the symptom that is the reason for 
         * the current therapy.</p></remarks>
         */
