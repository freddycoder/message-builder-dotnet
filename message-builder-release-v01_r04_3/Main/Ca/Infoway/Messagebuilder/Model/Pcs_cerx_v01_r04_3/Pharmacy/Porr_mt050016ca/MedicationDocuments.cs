...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Porr_mt050016ca {
    ...
    public class MedicationDocuments : MessagePartBean {
         ...
         * available.</p> <p>Unique identifier assigned to a medication 
         * document record.</p></remarks>
         */
         ...
         * document, Indication Protocol, etc</p></remarks>
         */
