...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged {
     ...
     * POME_MT010100CA.SpecializedKind: grouped within <p>Shows 
     ...
     * medication in a particular abstract hierarchy. For example, 
     * what generic, generic formulation, or therapeutic class does 
     * the medication fall into.</p></remarks>
     */
    ...
    public class GroupedWithin : MessagePartBean {
         ...
         * POPULATED (1) <p>HICL</p> <p>Therapeutic Class</p> 
         ...
         * <p>DrugProduct.StandardIDType(Code System)</p> <p>Used to 
         ...
         * should be available in most cases.</p> <p>A code that 
         * uniquely identifiers a drug within a specific drug 
         * identification scheme.</p> Un-merged Business Name: DrugCode 
         * Relationship: POME_MT010100CA.MedicineClass.code 
         * Conformance/Cardinality: POPULATED (1) <p>HICL</p> 
         * <p>Therapeutic Class</p> <p>Therapeutic Sub 
         * Classification</p> <p>DrugProduct.activeIngredientId</p> 
         * <p>DrugProduct.ActiveIngredientGroupNumber</p> 
         * <p>DrugProduct.StandardProductId (Mnemonic)</p> 
         * <p>DrugProduct.StandardIDType(Code System)</p> <p>Used to 
         * uniquely identify a particular drug product when 
         ...
         * should be available in most cases.</p> <p>An identifier for 
         * a drug at a higher level of abstraction.</p></remarks>
         */
         ...
         * POPULATED (1) <p>Generic Name</p> <p>To display in dropdowns 
