...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class GroupedWithin : MessagePartBean {
         ...
         * level of abstraction.</p> <p>HICL</p><p>Therapeutic 
         ...
         * (e.g. generic drug, generic formulation).</p><p>This 
         * attribute is marked as &quot;populated&quot; as a drug code 
         * should be available in most cases.</p> Drug Code <p>A code 
         * that uniquely identifiers a drug within a specific drug 
         * identification scheme.</p> <p>HICL</p><p>Therapeutic 
         * Class</p><p>Therapeutic Sub 
         * Classification</p><p>DrugProduct.activeIngredientId</p><p>DrugProduct.ActiveIngredientGroupNumber</p><p>DrugProduct.StandardProductId 
         * (Mnemonic)</p><p>DrugProduct.StandardIDType(Code System)</p> 
         * <p>HICL</p><p>Therapeutic Class</p><p>Therapeutic Sub 
         ...
         * 
         * <remarks>Drug Name <p>The name assigned to a drug within a 
         ...
         * searching.</p><p>This attribute is marked as 
         * &quot;populated&quot; as a drug name should be available in 
         * most cases.</p> Drug Name <p>The name assigned to the drug 
         * at the higher level of abstraction.</p> <p>Generic Name</p> 
         * <p>To display in dropdowns and for local 
         * searching.</p><p>This attribute is marked as 
