...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged {
     ...
     * ID is Null</p> <p>Dispenses for electronically created 
    ...
    public class DeviceRequest_1 : MessagePartBean {
         ...
         * POPULATED (1) <p>Prescription.prescriptionNumber</p> 
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: PORX_MT020060CA.DeviceRequest.author 
         * Conformance/Cardinality: REQUIRED (0-1)</remarks>
         */
