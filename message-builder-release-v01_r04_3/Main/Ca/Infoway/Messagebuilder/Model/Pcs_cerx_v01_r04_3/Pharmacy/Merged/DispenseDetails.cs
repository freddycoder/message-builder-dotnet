...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class DispenseDetails : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Coct_mt141007ca.DeviceProduct productManufacturedProduct;
         ...
         * indicate the date it was processed.</p> Dispense Processing 
         * and Pickup Date <p>Represents the date the dispense product 
         ...
         * the date it was processed.</p> Dispense Processing and 
         * Pickup Date <p>Represents the date the dispense product was 
         ...
         * days supply.</p> <p>D59(width)</p><p>ZDP.11</p><p>DRU.040-02 
         * (low, qualifier=ZDS, 
         ...
         * the dispensed quantity is expected to last.</p> 
         * <p>D59(width)</p><p>ZDP.11</p><p>DRU.040-02 (low, 
         * qualifier=ZDS, 
         * format=804)</p><p>Claim.405-D5</p><p>A_BillablePharmacyDispense</p><p>Days 
         * Supply</p><p>DispensedItem.daysSupply</p> 
         ...
         * Therapy'). Because 'Days Supply' may be necessary to compute 
         * total dispensed quantity, it is made a 'populated' 
         * field.</p> Dispense Days Supply <p>The number of days that 
         * the dispensed quantity is expected to last.</p><p>Cannot be 
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Common.Coct_mt141007ca.DeviceProduct ProductManufacturedProduct {
