 ...
 * Last modified: $LastChangedDate: 2012-02-16 10:59:37 -0500 (Thu, 16 Feb 2012) $
 * Revision:      $LastChangedRevision: 5387 $
 */
/* This class was auto-generated by the message builder generator tools. */
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Porx_mt060030ca {
    ...
    public class GenericQueryParameters : MessagePartBean {
         ...
         * the query.</p><p>Filter the result set to include only those 
         ...
         * avoid run-away queries.</p></remarks>
         */
