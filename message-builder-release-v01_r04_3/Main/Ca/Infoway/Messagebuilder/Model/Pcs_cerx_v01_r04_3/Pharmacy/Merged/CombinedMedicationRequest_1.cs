...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class CombinedMedicationRequest_1 : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged.IPrescription_1 {
         ...
         * is therefore mandatory.</p><p>The element allows 'CD' to 
         * provide support for SNOMED.</p> <p>Needed to convey the 
         * meaning of this class and is therefore mandatory.</p><p>The 
         * element allows 'CD' to provide support for SNOMED.</p></remarks>
         */
