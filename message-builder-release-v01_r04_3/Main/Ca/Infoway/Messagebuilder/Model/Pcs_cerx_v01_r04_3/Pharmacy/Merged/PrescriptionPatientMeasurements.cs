...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Pharmacy.Merged {
    ...
    public class PrescriptionPatientMeasurements : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>OBS.010-01</p> 
         * <p>Clinical.495-H2</p> <p>Distinguishes height from 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>OBS.010-01 
         ...
         * types are height and weight.</p> Un-merged Business Name: 
         * PrescriptionPatientMeasurementType Relationship: 
         * PORX_MT060160CA.QuantityObservationEvent.code 
         * Conformance/Cardinality: MANDATORY (1) <p>OBS.010-01</p> 
         * <p>Clinical.495-H2</p> <p>Distinguishes height from 
         * weight.</p><p>Code is mandatory to ensure that 
         * measurements/observations are distinguishable.</p> 
         ...
         * Conformance/Cardinality: POPULATED (1) <p>OBS.010-04</p> 
         * <p>Clinical.494-ZE</p> <p>Clinical.495-H1</p> <p>Allows 
         * provider to evaluate currency of the information.</p><p>The 
         * attribute is populated because the measurement time must be 
         * known or a null flavor must be specified.</p> <p>The date on 
         ...
         * is defined as 'populated'.</p> <p>The date on which the 
         ...
         * attribute is populated because the measurement time must be 
         * known or a null flavor must be specified.</p> <p>The date on 
         * which the measurement was made.</p></remarks>
         */
