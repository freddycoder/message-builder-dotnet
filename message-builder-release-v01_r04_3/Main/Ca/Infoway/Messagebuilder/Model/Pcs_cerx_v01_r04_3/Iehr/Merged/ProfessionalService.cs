...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Iehr.Merged {
     ...
     * Service <p>A_BillableClinicalService</p> <p>May be pertinent 
     ...
     * REPC_MT100001CA.ProcedureEvent: Professional Service 
     ...
     * maintained on a consultative service provided to a patient. 
     * This service may or may not be related to a prescribed, 
     * dispensed or administered drug.</p></remarks>
     */
    ...
    public class ProfessionalService : MessagePartBean {
         ...
         * MANDATORY (1) <p>PatientConsultation.category</p> <p>D57</p> 
         ...
         * provider.</p> Un-merged Business Name: ServiceCode 
         ...
         * Un-merged Business Name: ConsultationTimeAndLength 
         * Relationship: REPC_MT100001CA.ProcedureEvent.effectiveTime 
         * Conformance/Cardinality: POPULATED (1) <p>Center date cannot 
         * be null But duration can be left unspecified if not 
         * known.</p> <p>PatientConsultation.eventTime(Low)</p> 
         * <p>patientConsultation.eventDuration(Width)</p> <p>ZPS.4 
         ...
         * Un-merged Business Name: ProfessionalServiceMaskingIndicator 
         * Relationship: 
