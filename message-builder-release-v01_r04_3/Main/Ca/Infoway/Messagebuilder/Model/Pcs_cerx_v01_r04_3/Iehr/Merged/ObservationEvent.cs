...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Iehr.Merged {
     ...
     * Reactions <p>Value must be mandatory if not using SNOMED</p> 
     * <p>Code must be fixed to DX if not using SNOMED</p> <p>Helps 
     ...
     * otherwise it is mandatory and code must be 'DX'</p></remarks>
     */
