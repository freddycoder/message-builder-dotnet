...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Iehr.Merged {
    ...
    public class PatientMeasurements : MessagePartBean {
         ...
         * calculations.</p> B:Observation Measurement Value <p>The 
         * amount (quantity and unit) that has been recorded for the 
         * specific type of observation. E.g. height in centimeters, 
         * weight in kilograms, etc.</p><p>Valid observation unit types 
         * are: kg, cm, mmHg, mmol/mL, L/min, C, 1/min, etc</p> <p>The 
         * amount (quantity and unit) that has been recorded for the 
         * specific type of observation. E.g. height in centimeters, 
         * weight in kilograms, etc.</p><p>Valid observation unit types 
         * are: kg, cm, mmHg, mmol/mL, L/min, C, 1/min, etc</p> 
         * <p>OBS.010-02 (value) eScript:OBS.010-03 (unit) 
         * NCPDP:Clinical.595-H4 (value) NCPDP:Clinical.495-H3 
         * (unit)</p> <p>Provides standard representation of the 
         * measurement. May be used in calculations.</p></remarks>
         */
