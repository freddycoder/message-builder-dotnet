...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_3.Iehr.Merged {
     ...
     * versa</p> <p>Allows pertinent patient measurements to be 
     * recorded for clinical purposes.</p> <p>This comprises a 
     ...
     * SubObservations Measurement Type without a nullFlavor value 
     * must not have SubObservations.</p> <p>Allows pertinent 
     * patient measurements to be recorded for clinical 
     * purposes.</p> <p>This comprises a single point-in-time 
     * measurement made about a patient.</p>
     */
    ...
    public class PatientMeasurements : MessagePartBean {
         ...
         * body mass, etc.</p> Un-merged Business Name: MeasurementType 
         * Relationship: REPC_MT000018CA.CommonObservationEvent.code 
         * Conformance/Cardinality: POPULATED (1) <p>Distinguishes what 
         * kind of information is being specified.</p><p>The attribute 
         * is CD to support SNOMED</p> <p>Identification of the type of 
         ...
         * to evaluate currency of the information. Because the date of 
         ...
         * days ago.</p> Un-merged Business Name: ObservationTimestamp 
         * Relationship: 
         * REPC_MT000018CA.CommonObservationEvent.effectiveTime 
         * Conformance/Cardinality: POPULATED (1) <p>OBS.010-04 
         ...
         * observation</p> Un-merged Business Name: 
         * ObservationMeasurementValue Relationship: 
         * REPC_MT000018CA.CommonObservationEvent.value 
         * Conformance/Cardinality: REQUIRED (0-1) <p>OBS.010-02 
         ...
         * calculations.</p> <p>The amount (quantity and unit) that has 
         * been recorded for the specific type of observation. E.g. 
         * height in centimeters, weight in kilograms, etc.</p><p>Valid 
