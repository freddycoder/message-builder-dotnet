...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Pr.Prpm_mt309000ca {
    ...
    public class QualifiedEntity : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Pr.Prpm_mt309000ca.IRoleChoice {
        ...
        /**
         * <summary>Business Name: Expertise Identifier</summary>
         * 
         ...
         * credentials</p> <p>A code for the Expertise type.</p></remarks>
         */
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Required attribute 
         * supports the identification of the healthcare provider 
         * credentials</p> <p>If Expertise are included in the message, 
         * then Role Effective Date Must Exist</p> <p>The effective 
         * date of the provider expertise in the healthcare provider 
         * role.</p></remarks>
         */
