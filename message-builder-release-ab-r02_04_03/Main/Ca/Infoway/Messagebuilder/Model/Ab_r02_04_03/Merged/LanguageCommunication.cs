...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Merged {
    ...
    /**
     * <summary>PRPA_MT101102CA.LanguageCommunication: Language 
     ...
     * PRPA_MT101001AB.LanguageCommunication: LanguageCommunication 
     * <p>Supports the business requirement to identify languages 
     * used by client for the purposes of communication</p> 
     * <p>Information about what language(s) should be used to 
     * communicate with the focal person can be sent in the 
     * LanguageCommunication class.</p> 
     * PRPA_MT101991AB.LanguageCommunication: LanguageCommunication 
     * <p>Supports the business requirement to identify languages 
     * used by client for the purposes of communication</p> 
     * <p>Information about what language(s) should be used to 
     * communicate with the focal person can be sent in the 
     ...
     * communicate with the focal person can be sent in the 
     * LanguageCommunication class.</p> 
     * PRPA_MT101002AB.LanguageCommunication: LanguageCommunication 
     * <p>Supports the business requirement to identify languages 
     * used by client for the purposes of communication</p> 
     * <p>Information about what language(s) should be used to 
     * communicate with the focal person can be sent in the 
    ...
    public class LanguageCommunication : MessagePartBean {
         ...
         * PRPA_MT101001AB.LanguageCommunication.languageCode 
         ...
         * PRPA_MT101991AB.LanguageCommunication.languageCode 
         * Conformance/Cardinality: MANDATORY (1) <p>Mandatory 
         * attribute conveying the expected language message elements 
         * are to be transmitted in.</p> <p>A code indicating the 
         * language of communication</p> Un-merged Business Name: 
         ...
         * language of communication</p> Un-merged Business Name: 
         * LanguageOfCommunicationCode Relationship: 
         * PRPA_MT101002AB.LanguageCommunication.languageCode 
         * Conformance/Cardinality: MANDATORY (1) <p>Mandatory 
         * attribute conveying the expected language message elements 
         * are to be transmitted in</p> <p>A code indicating the 
         * language of communication</p> Un-merged Business Name: 
         ...
         * language of communication</p> Un-merged Business Name: 
         * LanguageOfCommunicationCode Relationship: 
         * PRPA_MT101102AB.LanguageCommunication.languageCode 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: LanguageOfCommunicationCode Relationship: 
         * PRPA_MT101104AB.LanguageCommunication.languageCode 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: LanguageOfCommunicationCode Relationship: 
         ...
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: LanguageOfCommunicationSkillsCode Relationship: 
         ...
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: LanguageOfCommunicationProficiencyLevelCode 
         * Relationship: 
         ...
         * PRPA_MT101001AB.LanguageCommunication.preferenceInd 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Required 
         ...
         * Relationship: 
         * PRPA_MT101991AB.LanguageCommunication.preferenceInd 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Required 
         * attribute that supports the business requirement to indicate 
         * the preferred language for all communications.</p> 
         * <p>Indicates the preferred language for all 
         ...
         * communications.</p> Un-merged Business Name: 
         * LanguageOfCommunicationPreferenceIndicator Relationship: 
         * PRPA_MT101002AB.LanguageCommunication.preferenceInd 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Required 
         * attribute that supports the business requirement to indicate 
         * the preferred language for all communications.</p> 
         * <p>Indicates the preferred language for all 
         ...
         * communications.</p> Un-merged Business Name: 
         * LanguageOfCommunicationPreferenceIndicator Relationship: 
         * PRPA_MT101102AB.LanguageCommunication.preferenceInd 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: LanguageOfCommunicationPreferenceIndicator 
         * Relationship: 
         * PRPA_MT101104AB.LanguageCommunication.preferenceInd 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: LanguageOfCommunicationPreferenceIndicator 
         * Relationship: 
