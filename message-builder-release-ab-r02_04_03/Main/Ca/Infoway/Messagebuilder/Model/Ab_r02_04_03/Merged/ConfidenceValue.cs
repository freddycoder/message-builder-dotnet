...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Merged {
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"PRPA_MT101102AB.ObservationEvent","PRPA_MT101102CA.ObservationEvent","PRPA_MT101104AB.ObservationEvent","PRPA_MT101104CA.ObservationEvent","PRPA_MT101106CA.ObservationEvent","PRPM_MT306011CA.ObservationEvent"})]
    public class ConfidenceValue : MessagePartBean {
         ...
         * PRPA_MT101104AB.ObservationEvent.code 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: ProbabilityMatchCode Relationship: 
         ...
         * name for the algorithm for the confidence value</p> 
         * Un-merged Business Name: ProbabilityMatchCode Relationship: 
         * PRPA_MT101102AB.ObservationEvent.code 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: ProbabilityMatchCode Relationship: 
         ...
         * PRPA_MT101104AB.ObservationEvent.value 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: ConfidenceValue Relationship: 
         * PRPM_MT306011CA.ObservationEvent.value 
         * Conformance/Cardinality: MANDATORY (1) <p>A real number 
         * expressing how close the result is to the query 
         * parameters.</p> Un-merged Business Name: ConfidenceValue 
         ...
         * the value would be the computed confidence value.</p> 
         * Un-merged Business Name: ConfidenceValue Relationship: 
         * PRPA_MT101102AB.ObservationEvent.value 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: ConfidenceValue Relationship: 
