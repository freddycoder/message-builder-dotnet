...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Common.Coct_mt260030ca {
     ...
     * current action.</p>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT260030CA.DetectedIssueEvent"})]
    public class Issues : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Common.Coct_mt260030ca.ICausalActs> subjectCausalActs;
        private Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Common.Merged.IssueDescription instantiationDetectedIssueDefinition;
        private IList<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Common.Merged.IssueManagements_2> mitigatedByDetectedIssueManagement;
        ...
        public Issues() {
            ...
            this.subjectCausalActs = new List<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Common.Coct_mt260030ca.ICausalActs>();
            this.mitigatedByDetectedIssueManagement = new List<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Common.Merged.IssueManagements_2>();
         ...
         * duplicate therapies, suspect fraud etc.</p></remarks>
         */
        ...
        /**
         * <summary>Relationship: COCT_MT260030CA.Subject2.causalActs</summary>
         * 
         * <remarks>Conformance/Cardinality: REQUIRED (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subject/causalActs"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Common.Coct_mt260030ca.ICausalActs> SubjectCausalActs {
            get { return this.subjectCausalActs; }
        }

        /**
         * <summary>Relationship: 
         * COCT_MT260030CA.Definition.detectedIssueDefinition</summary>
         * 
         * <remarks>Conformance/Cardinality: REQUIRED (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"instantiation/detectedIssueDefinition"})]
        public Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Common.Merged.IssueDescription InstantiationDetectedIssueDefinition {
        ...
        /**
         * <summary>Relationship: 
         * COCT_MT260030CA.Mitigates.detectedIssueManagement</summary>
         * 
         * <remarks>Conformance/Cardinality: REQUIRED (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"mitigatedBy/detectedIssueManagement"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Common.Merged.IssueManagements_2> MitigatedByDetectedIssueManagement {
            get { return this.mitigatedByDetectedIssueManagement; }
        }

        /**
         * <summary>Business Name: B:Severity Code</summary>
         * 
         * <remarks>Relationship: 
