...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Cr.Merged {
     ...
     * organizations are sent in the OtherIDs class. The other 
     * organization can be sent in the E_Organization Entity 
     * Class</p> PRPA_MT101002AB.OtherIDs: Other IDs Non Healthcare 
     * Identifiers <p>Provides the ability to capture additional 
     * client identifiers that are not healthcare specific</p> 
     * <p>Identifiers used for the focal person by other 
     * organizations are sent in the OtherIDs class. The other 
     * organization can be sent in the E_Organization Entity 
     * Class</p> PRPA_MT101991AB.OtherIDs: Other IDs Non Healthcare 
     * Identifiers <p>Provides the ability to capture additional 
     * client identifiers that are not healthcare specific</p> 
     * <p>Identifiers used for the focal person by other 
     * organizations are sent in the OtherIDs class. The other 
     * organization can be sent in the E_Organization Entity 
     * Class</p> PRPA_MT101001AB.OtherIDs: Other IDs Non Healthcare 
     * Identifiers <p>Provides the ability to capture additional 
     * client identifiers that are not healthcare specific</p> 
     * <p>Identifiers used for the focal person by other 
     * organizations are sent in the OtherIDs class. The other 
     ...
     * Class</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"PRPA_MT101001AB.OtherIDs","PRPA_MT101001CA.OtherIDs","PRPA_MT101002AB.OtherIDs","PRPA_MT101002CA.OtherIDs","PRPA_MT101102AB.OtherIDs","PRPA_MT101102CA.OtherIDs","PRPA_MT101104AB.OtherIDs","PRPA_MT101104CA.OtherIDs","PRPA_MT101106CA.OtherIDs","PRPA_MT101991AB.OtherIDs"})]
    public class OtherIDsNonHealthcareIdentifiers : MessagePartBean {
         ...
         * PRPA_MT101104AB.OtherIDs.id Conformance/Cardinality: 
         ...
         * NonHealthcareIdentification Relationship: 
         * PRPA_MT101102AB.OtherIDs.id Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: 
         * NonHealthcareIdentification Relationship: 
         * PRPA_MT101002AB.OtherIDs.id Conformance/Cardinality: 
         * MANDATORY (1) <p>Mandatory attribute supports the 
         * identification of the client</p> <p>Other non-healthcare 
         * identifiers for the Client (e.g. Passport, SIN, DND, DIAND, 
         * Drivers License)</p> Un-merged Business Name: 
         * NonHealthcareIdentification Relationship: 
         * PRPA_MT101991AB.OtherIDs.id Conformance/Cardinality: 
         * MANDATORY (1) <p>Mandatory attribute supports the 
         * identification of the client</p> <p>Other non-healthcare 
         * identifiers for the Client (e.g. Passport, SIN, DND, DIAND, 
         * Drivers License)</p> Un-merged Business Name: 
         * NonHealthcareIdentification Relationship: 
         * PRPA_MT101001AB.OtherIDs.id Conformance/Cardinality: 
         * MANDATORY (1) <p>Mandatory attribute supports the 
         * identification of the client</p> <p>Other non-healthcare 
         * identifiers for the Client (e.g. Passport, SIN, DND, DIAND, 
         * Drivers License)</p> Un-merged Business Name: 
         ...
         * PRPA_MT101104AB.OtherIDs.code Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: 
         * NonHealthcareIdentificationCode Relationship: 
         ...
         * RCMP, DND, Social Insurance Number</p> Un-merged Business 
         * Name: NonHealthcareIdentificationCode Relationship: 
         * PRPA_MT101102AB.OtherIDs.code Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: 
         * NonHealthcareIdentificationCode Relationship: 
         * PRPA_MT101002AB.OtherIDs.code Conformance/Cardinality: 
         * REQUIRED (1) <p>Populated attribute supports the 
         * identification of the client</p> <p>A pan Canadian code 
         * further specifying the kind of Role such as Drivers License, 
         * RCMP, DND, Social Insurance Number</p> Un-merged Business 
         * Name: NonHealthcareIdentificationCode Relationship: 
         * PRPA_MT101991AB.OtherIDs.code Conformance/Cardinality: 
         * REQUIRED (1) <p>Populated attribute supports the 
         * identification of the client</p> <p>A pan Canadian code 
         * further specifying the kind of Role such as Drivers License, 
         * RCMP, DND, Social Insurance Number</p> Un-merged Business 
         * Name: NonHealthcareIdentificationCode Relationship: 
         * PRPA_MT101001AB.OtherIDs.code Conformance/Cardinality: 
         * REQUIRED (1) <p>Populated attribute supports the 
         * identification of the client</p> <p>A pan Canadian code 
         * further specifying the kind of Role such as Drivers License, 
         * RCMP, DND, Social Insurance Number</p> Un-merged Business 
         ...
         * PRPA_MT101104AB.IdOrganization.id Conformance/Cardinality: 
         * MANDATORY (1) Un-merged Business Name: 
         * NonHealthcareOrganizationIdentifier Relationship: 
         ...
         * client.</p> Un-merged Business Name: 
         * NonHealthcareOrganizationIdentifier Relationship: 
         * PRPA_MT101102AB.IdOrganization.id Conformance/Cardinality: 
         * MANDATORY (1) Un-merged Business Name: 
         * NonHealthcareOrganizationIdentifier Relationship: 
         * PRPA_MT101002AB.IdOrganization.id Conformance/Cardinality: 
         * MANDATORY (1) <p>Mandatory attribute supports the 
         * identification of the organization assigning the identifier 
         * to the client</p> <p>Unique identifier for the organization 
         * that assigned the non-healthcare identifier for the 
         * client.</p> Un-merged Business Name: 
         * NonHealthcareOrganizationIdentifier Relationship: 
         * PRPA_MT101991AB.IdOrganization.id Conformance/Cardinality: 
         * MANDATORY (1) <p>Mandatory attribute supports the 
         * identification of the organization assigning the identifier 
         * to the client</p> <p>Unique identifier for the organization 
         * that assigned the non-healthcare identifier for the 
         * client.</p> Un-merged Business Name: 
         * NonHealthcareOrganizationIdentifier Relationship: 
         * PRPA_MT101001AB.IdOrganization.id Conformance/Cardinality: 
         * MANDATORY (1) <p>Mandatory attribute supports the 
         * identification of the organization assigning the identifier 
         * to the client</p> <p>Unique identifier for the organization 
         * that assigned the non-healthcare identifier for the 
         ...
         * PRPA_MT101104AB.IdOrganization.name Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: 
         * NonHealthcareOrganizationName Relationship: 
         ...
         * organization</p> Un-merged Business Name: 
         * NonHealthcareOrganizationName Relationship: 
         * PRPA_MT101102AB.IdOrganization.name Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: 
         * NonHealthcareOrganizationName Relationship: 
         * PRPA_MT101002AB.IdOrganization.name Conformance/Cardinality: 
         * REQUIRED (1) <p>Populated attribute supports the 
         * identification of the organization assigning the identifier 
         * to the client</p> <p>A name for the non-healthcare 
         * organization</p> Un-merged Business Name: 
         * NonHealthcareOrganizationName Relationship: 
         * PRPA_MT101991AB.IdOrganization.name Conformance/Cardinality: 
         * REQUIRED (1) <p>Populated attribute supports the 
         * identification of the organization assigning the identifier 
         * to the client</p> <p>A name for the non-healthcare 
         * organization</p> Un-merged Business Name: 
         * NonHealthcareOrganizationName Relationship: 
         * PRPA_MT101001AB.IdOrganization.name Conformance/Cardinality: 
         * REQUIRED (1) <p>Populated attribute supports the 
         * identification of the organization assigning the identifier 
         * to the client</p> <p>A name for the non-healthcare 
         * organization</p> Un-merged Business Name: 
         ...
         * PRPA_MT101991AB.OtherIDs.effectiveTime 
