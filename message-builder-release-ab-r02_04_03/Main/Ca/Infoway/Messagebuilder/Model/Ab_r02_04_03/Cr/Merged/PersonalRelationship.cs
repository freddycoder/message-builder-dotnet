...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Cr.Merged {
     ...
     * 
     * <remarks>PRPA_MT101001AB.PersonalRelationship: Personal 
     ...
     * PRPA_MT101991AB.PersonalRelationship: Personal Relationship 
     ...
     * &quot;daughter&quot; where the child is the player and the 
     * parent is the scoper.</p> 
     * PRPA_MT101002AB.PersonalRelationship: Personal Relationship 
     * <p>Supports the business requirement to capture additional 
     * information about the Identified Client's Next of Kin</p> 
    ...
    public class PersonalRelationship : MessagePartBean {
         ...
         * Relationship: PRPA_MT101001AB.PersonalRelationship.code 
         ...
         * PRPA_MT101001CA.PersonalRelationship.code 
         * Conformance/Cardinality: MANDATORY (1) <p>Mandatory 
         * attribute that supports understanding the relationship 
         * between the client and the ParentClient</p> <p>A code 
         * further specifying the kind of Role such as Mother, Father, 
         * Natural Parent or Step Parent</p> Un-merged Business Name: 
         * ClientNextOfKin Relationship: 
         * PRPA_MT101102AB.PersonalRelationship.code 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: ClientNextOfKin Relationship: 
         * PRPA_MT101991AB.PersonalRelationship.code 
         * Conformance/Cardinality: MANDATORY (1) <p>Mandatory 
         * attribute that supports understanding the relationship 
         * between the client and the ParentClient</p> <p>A code 
         * further specifying the kind of Role such as Mother, Father, 
         ...
         * ClientNextOfKin Relationship: 
         * PRPA_MT101104AB.PersonalRelationship.code 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: ClientNextOfKin Relationship: 
         * PRPA_MT101002AB.PersonalRelationship.code 
         * Conformance/Cardinality: MANDATORY (1) <p>Mandatory 
         * attribute that supports understanding the relationship 
         * between the client and the ParentClient</p> <p>A code 
         * further specifying the kind of Role such as Mother, Father, 
         ...
         * Relationship: PRPA_MT101001AB.ParentPerson.id 
         * Conformance/Cardinality: REQUIRED (1) <p>Populated attribute 
         * supports the identification of the next of kin and allows 
         * for the use of null flavours when the identifier is not 
         * known or available.</p> <p>A unique identifier for the next 
         * of kin</p> Un-merged Business Name: NextOfKinIdentifier 
         ...
         * known or available.</p> <p>A unique identifier for the next 
         * of kin</p> Un-merged Business Name: NextOfKinIdentifier 
         * Relationship: PRPA_MT101102AB.ParentPerson.id 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: NextOfKinIdentifier Relationship: 
         ...
         * available.</p> <p>A unique identifier for the next of 
         * kin</p> Un-merged Business Name: NextOfKinIdentifier 
         * Relationship: PRPA_MT101104AB.ParentPerson.id 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: NextOfKinIdentifier Relationship: 
         * PRPA_MT101002AB.ParentPerson.id Conformance/Cardinality: 
         * REQUIRED (1) <p>Populated attribute supports the 
         * identification of the next of kin and allows for the use of 
         * null flavours when the identifier is not known or 
         * available.</p> <p>A unique identifier for the next of 
         ...
         * Relationship: PRPA_MT101001AB.ParentPerson.name 
         ...
         * PRPA_MT101001CA.ParentPerson.name Conformance/Cardinality: 
         ...
         * Relationship: PRPA_MT101102AB.ParentPerson.name 
         ...
         * identification of the next of kin</p> <p>A name for the next 
         * of kin</p> Un-merged Business Name: NextOfKinName 
         * Relationship: PRPA_MT101104AB.ParentPerson.name 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: NextOfKinName Relationship: 
         * PRPA_MT101002AB.ParentPerson.name Conformance/Cardinality: 
         * REQUIRED (0-1) <p>Required attribute supports the 
         * identification of the next of kin</p> <p>A name for the next 
         * of kin</p> Un-merged Business Name: NextOfKinName 
