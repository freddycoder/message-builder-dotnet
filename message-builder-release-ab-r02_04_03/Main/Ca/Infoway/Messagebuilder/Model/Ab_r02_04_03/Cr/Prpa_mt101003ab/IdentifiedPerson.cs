...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Cr.Prpa_mt101003ab {
     ...
     * registry.</p>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"PRPA_MT101003AB.IdentifiedEntity"})]
    public class IdentifiedPerson : MessagePartBean {
         ...
         * Number</summary>
         * 
         * <remarks>Relationship: PRPA_MT101003AB.IdentifiedEntity.id 
         ...
         * 
         * <remarks>Relationship: PRPA_MT101003AB.Person.name 
         ...
         * PRPA_MT101003AB.Person.administrativeGenderCode 
         ...
         * 
         * <remarks>Relationship: PRPA_MT101003AB.Person.birthTime 
         * Conformance/Cardinality: REQUIRED (1) <p>Populated attribute 
