...
namespace Ca.Infoway.Messagebuilder.Model.Ab_r02_04_03.Cr.Prpa_mt101001ab {
     ...
     * registry.</p>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"PRPA_MT101001AB.IdentifiedEntity"})]
    public class IdentifiedClient : MessagePartBean {
         ...
         * Number</summary>
         * 
         * <remarks>Relationship: PRPA_MT101001AB.IdentifiedEntity.id 
         * Conformance/Cardinality: REQUIRED (1-40) <p>Mandatory 
         * attribute required for future identification of the 
         * client.</p> <p>One identifier is always mandatory: the 
         * record key, consisting of the facility's WDFA key (four 
         * characters) followed by the EMR software's unique patient 
         * identifier (should be no longer than 16 characters). If the 
         * payload is being used to request the creation of a ULI, then 
         * no other identifier is required. Otherwise, the patient's 
         * ULI is also mandatory.</p> <p>This identification attribute 
         * supports capture of a healthcare identifier specific to the 
         * client. This identifier may be assigned jurisdictionally or 
         * by care facility.</p></remarks>
         */
         ...
         * PRPA_MT101001AB.IdentifiedEntity.statusCode 
         ...
         * 
         * <remarks>Relationship: 
         * PRPA_MT101001AB.IdentifiedEntity.effectiveTime 
         ...
         * 
         * <remarks>Relationship: 
         * PRPA_MT101001AB.IdentifiedEntity.confidentialityCode 
         * Conformance/Cardinality: REQUIRED (1) <p>Populated attribute 
         ...
         * 
         * <remarks>Relationship: PRPA_MT101001AB.Person.name 
         ...
         * 
         * <remarks>Relationship: PRPA_MT101001AB.Person.telecom 
         ...
         * 
         * <remarks>Relationship: 
         * PRPA_MT101001AB.Person.administrativeGenderCode 
         ...
         * 
         * <remarks>Relationship: PRPA_MT101001AB.Person.birthTime 
         * Conformance/Cardinality: MANDATORY (1) <p>Populated 
         * attribute supports the identification of the client</p> 
         ...
         * 
         * <remarks>Relationship: PRPA_MT101001AB.Person.deceasedInd 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Required 
         * attribute supports the identification of the client</p> 
         ...
         * 
         * <remarks>Relationship: PRPA_MT101001AB.Person.deceasedTime 
         ...
         * 
         * <remarks>Relationship: 
         * PRPA_MT101001AB.Person.multipleBirthInd 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Required 
         * attribute supports the identification of the client</p> 
         ...
         * 
         * <remarks>Relationship: 
         * PRPA_MT101001AB.Person.multipleBirthOrderNumber 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Required 
         * attribute supports the identification of the client</p> 
         ...
         * 
         * <remarks>Relationship: PRPA_MT101001AB.Person.addr 
        ...
        /**
         * <summary>Relationship: PRPA_MT101001AB.Person.asOtherIDs</summary>
         * 
         ...
         * PRPA_MT101001AB.Person.personalRelationship</summary>
         * 
        ...
        /**
         * <summary>Relationship: 
         * PRPA_MT101001AB.Person.languageCommunication</summary>
         * 
