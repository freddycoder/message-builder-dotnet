...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Si.Rcmr_mt010002ca {
    ...
    using Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Si.Merged;
    using System;
    ...
    public class Keyword : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Common.Coct_mt050203ca.Patient subject1Patient;
        private ST authorSignatureText;
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Si.Merged.IConsenter authorConsenter;
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Common.Coct_mt050203ca.Patient Subject1Patient {
         ...
         * Conformance/Cardinality: REQUIRED (1) <p>ZKW.5</p> 
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Si.Merged.IConsenter AuthorConsenter {
            get { return this.authorConsenter; }
            set { this.authorConsenter = value; }
        }

        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Si.Merged.Patient AuthorConsenterAsPatient {
            get { return this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Si.Merged.Patient ? (Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Si.Merged.Patient) this.authorConsenter : (Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Si.Merged.Patient) null; }
        }
        public bool HasAuthorConsenterAsPatient() {
            return (this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Si.Merged.Patient);
        }

        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Common.Coct_mt040205ca.ResponsiblePerson AuthorConsenterAsResponsibleParty {
            get { return this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Common.Coct_mt040205ca.ResponsiblePerson ? (Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Common.Coct_mt040205ca.ResponsiblePerson) this.authorConsenter : (Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Common.Coct_mt040205ca.ResponsiblePerson) null; }
        }
        public bool HasAuthorConsenterAsResponsibleParty() {
            return (this.authorConsenter is Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Common.Coct_mt040205ca.ResponsiblePerson);
        }
