...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged {
     ...
     * 
     * <remarks>PORX_MT060040CA.Author4: *b:prescribed by 
     ...
     * patient.</p> PORX_MT060340CA.Author4: *b:prescribed by 
     * <p>Prescription.Prescriber</p> 
     * <p>A_BillablePharmacyDispense</p> <p>To be a legal order, 
     * the person responsible for its creation must be identified. 
     * Thus the association is mandatory.</p> <p>This is the 
     * provider who authorized the medication to be dispensed to 
     * the patient.</p> PORX_MT060160CA.Author4: *b:prescribed by 
     * <p>Prescription.Prescriber</p> 
     * <p>A_BillablePharmacyDispense</p> <p>To be a legal order, 
     * the person responsible for its creation must be identified. 
     * Thus the association is mandatory.</p> <p>This is the 
    ...
    public class PrescribedBy : MessagePartBean {
         ...
         * Conformance/Cardinality: OPTIONAL (0-1) <p>Signature</p> 
         * <p>Allows for pure electronic prescriptions without a 
         * trusted intermediary. The attribute is optional because all 
         * jurisdictions may not support digital signatures.</p> <p>An 
         * electronic signature of the prescription by the 
         * prescriber.</p> Un-merged Business Name: Signature 
         * Relationship: PORX_MT060340CA.Author4.signatureText 
         * Conformance/Cardinality: OPTIONAL (0-1) <p>Signature</p> 
         * <p>Allows for pure electronic prescriptions without a 
         * trusted intermediary. The attribute is optional because all 
         * jurisdictions may not support digital signatures.</p> <p>An 
         ...
         * PORX_MT060040CA.Author4.assignedPerson 
