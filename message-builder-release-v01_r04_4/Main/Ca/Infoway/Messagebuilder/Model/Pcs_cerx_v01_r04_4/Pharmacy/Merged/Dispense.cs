...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged {
    ...
    public class Dispense : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Porx_mt980010ca.ICausalActs, Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Porx_mt980020ca.ICausalActs {

        private II id;
        private CS statusCode;
        private IVL<TS, Interval<PlatformDate>> effectiveTime;
        private CV confidentialityCode;
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged.Dispensed product;
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Merged.RecordedAt location;
        private II inFulfillmentOfSubstanceAdministrationEventId;
        ...
        public Dispense() {
            ...
            this.inFulfillmentOfSubstanceAdministrationEventId = new IIImpl();
        }
        /**
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged.Dispensed Product {
         ...
         * Relationship: 
         * PORX_MT980020CA.SubstanceAdministrationEvent.id 
         * Conformance/Cardinality: MANDATORY (1) <p>When specifying an 
         * issue between multiple prescriptions and dispenses - say for 
         * example a Duplicate Drug issue where you have subject 
         * elements for Prescription A, a Dispense for Prescript ion A, 
         * Prescription B and a Dispense for Prescription B, it can be 
         * confusing for the pharmacists because they see the two 
         * Dispenses (supplyEvent class), but there is nothing to link 
         * them to their parent prescriptions.</p> <p>A Prescription 
         * Order Number linked to a specific Issue Detected.</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"inFulfillmentOf/substanceAdministrationEvent/id"})]
        public Identifier InFulfillmentOfSubstanceAdministrationEventId {
            get { return this.inFulfillmentOfSubstanceAdministrationEventId.Value; }
            set { this.inFulfillmentOfSubstanceAdministrationEventId.Value = value; }
        }
