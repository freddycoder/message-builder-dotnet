...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Porx_mt060110ca {
    ...
    public class ParameterList : MessagePartBean {
         ...
         * 
         * <remarks>Relationship: 
         * PORX_MT060110CA.PatientBirthDate.value 
         ...
         * 
         * <remarks>Relationship: PORX_MT060110CA.PatientGender.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Used to confirm 
         * the identity of the patient for the query and is therefore 
         ...
         * 
         * <remarks>Relationship: PORX_MT060110CA.PatientID.value 
         ...
         * 
         * <remarks>Relationship: PORX_MT060110CA.PatientName.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows filtering 
