...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged {
    ...
    public class FirstDispenseInformation_1 : MessagePartBean {
        ...
        /**
         * <summary>Un-merged Business Name: FirstDispensePickupDate</summary>
         * 
         ...
         * Business Name: FirstDispenseProcessing&PickupDate 
         * Relationship: 
         * PORX_MT060190CA.SupplyEventFirstSummary.effectiveTime 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Useful in 
         * establishing start of therapy.</p><p>Important information 
         * for compliance</p> <p>The LOW end of the IVL will contain 
         * the processing date &amp; the HIGH end will contain the 
         * pick-up date.</p> <p>Indicates when the first dispense 
         * against the prescription was processed &amp; picked up.</p> 
         * Un-merged Business Name: FirstDispensePickupDate 
         * Relationship: 
