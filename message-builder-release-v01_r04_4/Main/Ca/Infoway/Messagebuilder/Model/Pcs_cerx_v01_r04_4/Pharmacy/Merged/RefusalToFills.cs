...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged {
     ...
     * PORX_MT060060CA.RefusalToFill: Refusal To Fills <p>Exposes 
     * in the model that this issue is associated with a refusal to 
     ...
     * PORX_MT030040CA.RefusalToFill: Refusal to Fills <p>Exposes 
     * in the model that this issue is associated with a refusal to 
     * dispense.</p><p>An indication of 'refusal to fill' must be 
     * indicated, thus attribute is mandatory.</p> <p>Indicates 
     * that the identified issue resulted in a dispenser refusing 
     * to fill the subject prescription.</p> 
     * PORX_MT060190CA.RefusalToFill: Refusal To Fills <p>Exposes 
     * in the model that this issue is associated with a refusal to 
     * dispense.</p><p>An indication of 'refusal to fill' must be 
     * indicated, thus attribute is mandatory.</p> <p>Indicates 
     * that the identified issue resulted in a dispenser refusing 
     * to fill the subject prescription.</p> 
     * PORX_MT060040CA.RefusalToFill: Refusals To Fills <p>Exposes 
     * in the model that this issue is associated with a refusal to 
     * dispense.</p><p>An indication of 'refusal to fill' must be 
     * indicated, thus attribute is mandatory.</p> <p>Indicates 
     * that the identified issue resulted in a dispenser refusing 
     * to fill the subject prescription. .</p> 
     * PORX_MT060160CA.RefusalToFill: Fill Refusals <p>Exposes in 
    ...
    public class RefusalToFills : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged.Issues> reasonDetectedIssueEvent;

        public RefusalToFills() {
            this.effectiveTime = new TSImpl();
            this.reasonCode = new CVImpl();
            this.reasonDetectedIssueEvent = new List<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged.Issues>();
        }
        /**
         ...
         * PORX_MT060340CA.RefusalToFill.effectiveTime 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: RefusalToFillDate Relationship: 
         * PORX_MT030040CA.RefusalToFill.effectiveTime 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: RefusalToFillDate Relationship: 
         * PORX_MT060040CA.RefusalToFill.effectiveTime 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: RefusalToFillDate Relationship: 
         * PORX_MT060190CA.RefusalToFill.effectiveTime 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: RefusalToFillDate Relationship: 
         ...
         * Conformance/Cardinality: REQUIRED (0-1) <p>One of 'Refusal 
         * To Fill Reason' or 'Issue Type' must be specified but not 
         * both</p> <p>Supports capture of reasons such as 'moral 
         * objection' which are not tied to specific issues. Set as CWE 
         * to allow non-coded reasons.</p> <p>Indicates a 
         * non-clinical-issue based reason for refusing to fill.</p> 
         * Un-merged Business Name: RefusalToFillReason Relationship: 
         * PORX_MT060340CA.RefusalToFill.reasonCode 
         * Conformance/Cardinality: REQUIRED (0-1) <p>One of 'Refusal 
         * to Fill Reason' or an 'Issue Type' must be specified but not 
         * both</p> <p>Supports capture of reasons such as 'moral 
         * objection' which are not tied to specific issues. Set to CWE 
         * to allow non-coded reasons.</p> <p>Indicates a 
         * non-clinical-issue based reason for refusing to fill.</p> 
         * Un-merged Business Name: RefusalToFillReason Relationship: 
         ...
         * Conformance/Cardinality: REQUIRED (0-1) <p>One of 'Refusal 
         * To Fill Reason' or 'Issue Type' must be specified, but not 
         * both.</p> <p>Indicates a non-clinical-issue based reason for 
         * refusing to fill. Allows CWE for non-coded reasons.</p> 
         * <p>Indicates a non-clinical-issue based reason for refusing 
         * to fill.</p> Un-merged Business Name: RefusalToFillReason 
         * Relationship: PORX_MT060040CA.RefusalToFill.reasonCode 
         ...
         * both</p> <p>Supports capture of reasons such as 'moral 
         * objection' which are not tied to specific issues. Set as CWE 
         * to allow for non-coded reasons.</p> <p>Indicates a 
         * non-clinical-issue based reason for refusing to fill.</p></remarks>
         */
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged.Issues> ReasonDetectedIssueEvent {
