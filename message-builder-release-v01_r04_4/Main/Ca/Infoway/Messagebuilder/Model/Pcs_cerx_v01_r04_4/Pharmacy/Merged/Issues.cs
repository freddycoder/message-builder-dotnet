...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged {
    ...
    public class Issues : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>One of 'Refusal To 
         * Fill Reason' or 'Issue Type' must be specified, but not 
         * both.</p> <p>Identifies what kind of issue was detected or 
         * is being managed.</p><p>This is mandatory so as to ensure 
         ...
         * suspect fraud etc.</p><p>.</p> Un-merged Business Name: 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>One of 'Refusal To 
         * Fill Reason' or 'Issue Type' must be specified but not 
         * both</p> <p>Identifies what kind of issue was detected or is 
         * being managed.</p><p>This is mandatory so as to ensure that 
         * one issue type can be distinguished from another.</p> <p>A 
