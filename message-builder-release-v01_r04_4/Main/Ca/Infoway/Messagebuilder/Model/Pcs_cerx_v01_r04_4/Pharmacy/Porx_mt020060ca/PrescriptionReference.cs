...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Porx_mt020060ca {
    ...
    public class PrescriptionReference : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged.DispenseInstructions_1 componentSupplyRequest;
         ...
         * Conformance/Cardinality: REQUIRED (1) <p>Component must be 
         * specified if the id is null and can not be specified if the 
         * id is not null.</p> <p>Prescription.prescriptionNumber</p> 
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged.DispenseInstructions_1 ComponentSupplyRequest {
