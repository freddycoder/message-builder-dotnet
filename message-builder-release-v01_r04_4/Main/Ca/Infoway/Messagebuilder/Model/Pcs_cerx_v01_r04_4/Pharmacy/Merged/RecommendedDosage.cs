...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged {
    ...
    public class RecommendedDosage : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged.DosagePreconditions> componentObservationEventCriterion;

        public RecommendedDosage() {
            this.effectiveTime = new IVLImpl<TS, Interval<PlatformDate>>();
            this.doseQuantity = new URGImpl<PQ, PhysicalQuantity>();
            this.componentObservationEventCriterion = new List<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged.DosagePreconditions>();
        }
        /**
         ...
         * Duration (width)</p> <p>Allows calculation of amount under 
         * or over.</p> <p>Indicates the recommended duration for drug 
         * therapy that was exceeded or not met.</p></remarks>
         */
         ...
         * specification of the range of quantity of medication 
         * (Min/Max figures) that is recommended for the drug to avoid 
         * triggering of dosage issues.</p></remarks>
         */
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Merged.DosagePreconditions> ComponentObservationEventCriterion {
