...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Common.Coct_mt220110ca {
    ...
    public class DrugProduct : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Pharmacy.Porx_mt980040ca.IMedication {
         ...
         * SNOMED CT(R) as well as translation between multiple code 
         * sets for drugs (e.g. DIN, GTIN, UPC).</p> <p>An identifier 
         * for a type of drug. Depending on where the drug is being 
         * referenced, the drug may be identified at different levels 
         * of abstraction. E.g. Manufactured drug (including vaccines), 
         * generic formulation, generic, therapeutic class, etc.</p></remarks>
         */
