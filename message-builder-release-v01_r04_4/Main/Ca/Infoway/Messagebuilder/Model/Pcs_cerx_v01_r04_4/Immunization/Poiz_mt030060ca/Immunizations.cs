...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Immunization.Poiz_mt030060ca {
    ...
    public class Immunizations : MessagePartBean {
         ...
         * encounters for the patient.</p> <p>A coded value denoting a 
         * patient's reason for refusing to be immunized. Typical 
         * reasons include: Parental decision, Religious exemption, 
         * Patient decision, etc.</p></remarks>
         */
         ...
         * must be required if not using SNOMED</p> <p>Some 
