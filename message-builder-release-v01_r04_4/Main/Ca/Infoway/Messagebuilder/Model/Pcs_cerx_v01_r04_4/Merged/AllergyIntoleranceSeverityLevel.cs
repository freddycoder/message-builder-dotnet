...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Merged {
     ...
     * PORX_MT980020CA.SeverityObservation: Severity Level 
     ...
     * involving such medical conditions.</p> <p>This is a ranking/ 
     * an assertion of the seriouness of the diagnosed/reported 
     * medical condition.</p> PORX_MT980030CA.SeverityObservation: 
     ...
     * conditions.</p> <p>This is a ranking/ an assertion of the 
     * seriouness of the diagnosed/reported medical condition.</p> 
     * PORX_MT980010CA.SeverityObservation: Severity Level 
     * <p>Suggests the importance of managing the issue.</p> 
     * <p>This is a ranking/assertion of gravity of the detected 
     * issue.</p> REPC_MT000005CA.SeverityObservation: 
     * Allergy/Intolerance Severity Level <p>Allows providers to 
     * determine appropriate managements for contraindications 
     * involving such medical conditions.</p> <p>This is a ranking/ 
     * an assertion of the seriouness of the diagnosed/reported 
    ...
    public class AllergyIntoleranceSeverityLevel : MessagePartBean {
         ...
         * issue.</p> Un-merged Business Name: SeverityLevel 
         ...
         * <p>A coded value denoting the gravity of the detected 
         * issue.</p> Un-merged Business Name: SeverityLevel 
         * Relationship: REPC_MT000005CA.SeverityObservation.value 
         * Conformance/Cardinality: MANDATORY (1) 
         * <p>AllergyIntolerance.severity</p> <p>Allows for sorting of 
         * allergy records. May influence whether contraindications 
