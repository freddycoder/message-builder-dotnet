...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Iehr.Repc_mt100002ca {
     ...
     * not present and vice versa</p> <p>Allows pertinent patient 
    ...
    public class PatientMeasurement : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>'code' 
         * (Measurement Type) with a 'nullFlavor' value must have 
         * SubObservations 'code' (Measurement Type) without a 
         ...
         * height, weight, blood pressure, body mass, etc.</p></remarks>
         */
