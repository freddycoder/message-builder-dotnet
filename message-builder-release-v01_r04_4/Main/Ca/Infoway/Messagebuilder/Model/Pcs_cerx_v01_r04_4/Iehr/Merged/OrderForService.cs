...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Iehr.Merged {
    ...
    /**
     * <summary>Business Name: OrderForService</summary>
     * 
     * <remarks>REPC_MT100001CA.ActRequest: Order for Service 
     * <p>Allows linking the service to the person responsible for 
     * requesting it.</p> <p>Represents the order or prescription 
     * against which the service was performed.</p></remarks>
     */
    ...
    public class OrderForService : MessagePartBean {
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: REPC_MT000017CA.ActRequest.author 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT100001CA.ActRequest.author Conformance/Cardinality: 
         * MANDATORY (1)</remarks>
         */
