...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Iehr.Merged {
     ...
     * Reactions <p>Helps providers to distinguish between proper 
     ...
     * nausea.)</p> <p>This is a recording of a patient reaction 
     * that is believed to be associated with the 
    ...
    public class ObservationEvent : MessagePartBean {
         ...
         * fixed to DX if not using SNOMED</p> <p>Indicates that the 
         ...
         * if not using SNOMED</p> <p>B.1</p> <p>Ensures consistency in 
