...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Iehr.Repc_mt000018ca {
     ...
     * clinical purposes.</p> <p>This comprises a single 
    ...
    public class PatientMeasurements : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Iehr.Merged.ComponentMeasurements> componentSubObservationEvent;
        ...
        public PatientMeasurements() {
            ...
            this.componentSubObservationEvent = new List<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Iehr.Merged.ComponentMeasurements>();
        }
        /**
         ...
         * Conformance/Cardinality: REQUIRED (1) <p>'code' (Measurement 
         * Type) with a 'nullFlavor' value must have SubObservations 
         * 'code' (Measurement Type) without a 'nullFlavor' value must 
         * not have SubObservations.</p> <p>Distinguishes what kind of 
         * information is being specified.</p><p>The attribute is CD to 
         * support SNOMED</p> <p>Identification of the type of 
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_cerx_v01_r04_4.Iehr.Merged.ComponentMeasurements> ComponentSubObservationEvent {
