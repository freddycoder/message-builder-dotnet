...
namespace Ca.Infoway.Messagebuilder.Util.Xml {
	...
	public class ClasspathResource : InputStreamResource {
		...
		public ClasspathResource(Type c, String resourceName) {
			this.c = c;
			this.resourceName = resourceName;
		...
		public virtual Stream InputStream {
		  get {
				return ResourceLoader.GetResource(c != null ? c.Assembly : null, resourceName);
			}
		}
