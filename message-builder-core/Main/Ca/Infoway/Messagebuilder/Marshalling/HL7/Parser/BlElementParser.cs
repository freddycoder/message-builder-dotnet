...
namespace Ca.Infoway.Messagebuilder.Marshalling.HL7.Parser
{
	...
	public class BlElementParser : AbstractSingleElementParser<Boolean?>
	{
		...
		private Boolean? ParseNonNullNode(ParseContext context, XmlElement element, XmlToModelResult xmlToModelResult)
		{
			 ...
			 attr)
		{
			...
			else
			{
				...
				{
					return ILOG.J2CsMapping.Util.BooleanUtil.ValueOf(unparsedBoolean);
				}
				else
				{
