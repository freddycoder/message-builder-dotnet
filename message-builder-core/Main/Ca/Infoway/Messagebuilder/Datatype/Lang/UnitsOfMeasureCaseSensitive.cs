...
namespace Ca.Infoway.Messagebuilder.Datatype.Lang {
	...
	///
	[Serializable]
	public class UnitsOfMeasureCaseSensitive : EnumPattern, 		Ca.Infoway.Messagebuilder.Domainvalue.UnitsOfMeasureCaseSensitive,
			Describable {
		...
		private UnitsOfMeasureCaseSensitive(String name, String codeValue_0) : this(name, codeValue_0, Ca.Infoway.Messagebuilder.Domainvalue.Util.DescribableUtil.GetDefaultDescription(name)) {
		}
	
		private UnitsOfMeasureCaseSensitive(String name, String codeValue_0,
				String description_1) : base(name) {
