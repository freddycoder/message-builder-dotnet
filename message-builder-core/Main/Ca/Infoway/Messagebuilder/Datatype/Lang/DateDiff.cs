...
namespace Ca.Infoway.Messagebuilder.Datatype.Lang {
	...
	public class DateDiff : Diff<Ca.Infoway.Messagebuilder.PlatformDate>, NullFlavorSupport {
		...
		public DateDiff(Ca.Infoway.Messagebuilder.PlatformDate value_ren) : base(value_ren) {
			this.value_ren = null;
		...
		public DateDiff(int value_ren, Domainvalue.UnitsOfMeasureCaseSensitive unit) : this(new PhysicalQuantity(new BigDecimal(value_ren.ToString()),unit)) {
		}
		...
		public DateDiff(PhysicalQuantity quantity_0) : base(AsDate(quantity_0)) {
		...
		public DateDiff(NullFlavor nullFlavor_0) : base(null) {
			this.value_ren = null;
		...
		private static Ca.Infoway.Messagebuilder.PlatformDate AsDate(PhysicalQuantity physicalQuantity) {
			...
			if (unit != null && unit  is  DateConverter) {
				...
				DefaultTimeUnit timeUnit = Ca.Infoway.Messagebuilder.Datatype.Lang.DefaultTimeUnit.Lookup(unit.CodeValue);
		...
		/// <summary>
		/// Returns the null flavor.
		/// </summary>
		///
		/// <returns>the null flavor</returns>
		public override NullFlavor NullFlavor {
		/// <summary>
		/// Returns the null flavor.
		/// </summary>
		///
		...
		/// <summary>
		/// Returns whether this object has a null flavor.
		/// </summary>
		///
		/// <returns>whether this object has a null flavor.</returns>
		public override bool HasNullFlavor() {
