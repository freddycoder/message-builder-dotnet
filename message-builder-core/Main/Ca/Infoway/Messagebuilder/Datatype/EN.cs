...
namespace Ca.Infoway.Messagebuilder.Datatype {
	...
	/// <summary>
	/// Interface for HL7 name-based datatypes. Backed by a   datatype that must be an extension of EntityName.
	/// </summary>
	///
	/// <param name="V"> the underlying  v entity name type</param>
	public interface EN<V> : ANY<V>  where V : EntityName {
