...
namespace Ca.Infoway.Messagebuilder.Datatype.Impl {
	...
	/// </summary>
	///
	public class BLImpl : ANYImpl<Boolean?>, BL {
	
		/// <summary>
		/// Constructs an empty BL.
		/// </summary>
		///
		public BLImpl() : this((Boolean?)null) {
		}
		...
		public BLImpl(Boolean? defaultValue) : base(typeof(Boolean?), defaultValue, null, Ca.Infoway.Messagebuilder.Datatype.StandardDataType.BL) {
		}
		...
		public BLImpl(NullFlavor nullFlavor) : base(typeof(Boolean?), null, nullFlavor, Ca.Infoway.Messagebuilder.Datatype.StandardDataType.BL) {
		}
