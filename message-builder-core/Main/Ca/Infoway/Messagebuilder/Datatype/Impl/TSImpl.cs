...
namespace Ca.Infoway.Messagebuilder.Datatype.Impl {
	...
	/// <summary>
	/// HL7 datatype TS backed by a   Date.
	...
	/// </summary>
	///
	public class TSImpl : QTYImpl<PlatformDate>, TS {
	
		/// <summary>
		/// Constructs an empty TS.
		/// </summary>
		///
		public TSImpl() : this((PlatformDate)null) {
		}
		...
		public TSImpl(NullFlavor nullFlavor) : base(typeof(PlatformDate), null, nullFlavor, Ca.Infoway.Messagebuilder.Datatype.StandardDataType.TS) {
		}
