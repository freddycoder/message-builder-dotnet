...
namespace Ca.Infoway.Messagebuilder.Datatype.Impl
{
    ...
    /// <summary>
    /// Set Component (SXCM) datatype.  (this version for CDA/R1 usage)
    /// </summary>
    public class SXCMTSCDAR1Impl : ANYImpl<MbDate>, SXCMTSCDAR1
    {
        /// <summary>
        ...
        public SXCMTSCDAR1Impl(MbDate defaultValue) :
            base(defaultValue == null ? null : typeof(MbDate), defaultValue, null, StandardDataType.SXCM_TS)
        {
        }
        ...
        public SXCMTSCDAR1Impl(NullFlavor nullFlavor) :
            base(null, null, nullFlavor, StandardDataType.SXCM_TS)
        {
        }
    }
}