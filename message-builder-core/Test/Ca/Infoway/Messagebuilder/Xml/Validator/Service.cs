...
{
	class Service : BaseMessageDefinitionService
	{
        protected override IList<ResourcePair> Names
		{
			get
			{
				return Arrays.AsList(new ResourcePair("/ca/infoway/messagebuilder/xml/validator/messageSet_v02r02.xml",GetType().Assembly));
			}
		}
	}
}
