	...
	public class Hl7SourceMapperRequestMessageBeanTest
	{
		private static readonly string XML = "<NLPN_IN100200CA xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"urn:hl7-org:v3\" ITSVersion=\"XML_1.0\">"
			...
			"        <id extension=\"123\" root=\"1.2.3\" use=\"BUS\"/>" + "        <manufacturerModelName>1.0</manufacturerModelName>"
			 ...
			 + "      <statusCode code=\"completed\"/>" + "      <effectiveTime>" + "        <low value=\"20080918\"/>" + "      </effectiveTime>"
			 + "      <author typeCode=\"AUT\" contextControlCode=\"AP\">" + "        <time value=\"20080625141610-0500\"/>" + "       <assignedEntity1 classCode=\"ASSIGNED\">"
			 + "          <id extension=\"EHR ID EXT\" root=\"2.16.840.1.113883.4.267\" displayable=\"true\"/>" + "          <assignedPerson classCode=\"PSN\" determinerCode=\"INSTANCE\">"
			 + "            <name use=\"L\"><given>Jane</given><family>Doe</family></name>" + "            <asHealthCareProvider classCode=\"PROV\">"
			 + "              <id extension=\"55555\" root=\"2.16.840.1.113883.4.268\" displayable=\"true\" />" + "            </asHealthCareProvider>"
			 + "          </assignedPerson>" + "        </assignedEntity1>" + "      </author>" + "      <location typeCode=\"LOC\" contextControlCode=\"AP\">"
			 + "        <serviceDeliveryLocation classCode=\"SDLOC\">" + "          <id extension=\"1\" root=\"2.16.124.113620.1.1.11111\" displayable=\"true\" />"
			 + "          <location classCode=\"PLC\" determinerCode=\"INSTANCE\">" + "            <name>Intelliware&apos;s Pharmacy</name>"
			 + "          </location>" + "        </serviceDeliveryLocation>" + "      </location>" + "      <subject typeCode=\"SUBJ\" contextControlCode=\"ON\" contextConductionInd=\"false\">"
