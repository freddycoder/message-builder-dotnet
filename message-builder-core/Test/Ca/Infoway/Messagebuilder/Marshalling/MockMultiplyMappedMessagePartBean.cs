...
namespace Ca.Infoway.Messagebuilder.Marshalling {
	...
	public class MockMultiplyMappedMessagePartBean {
	    ...
	    [Hl7XmlMappingAttribute(new string[] {"theType"})]
		[Hl7MapByPartType(Name="theType",Type="MOCK_MT123456CA.SubType")]
	    ...
	    [Hl7XmlMappingAttribute(new string[] {"theType"})]
		[Hl7MapByPartType(Name="theType",Type="MOCK_MT898989CA.SubType")]
