...
namespace Ca.Infoway.Messagebuilder.Marshalling.HL7.Formatter
{
	...
	public class RealCoordPropertyFormatterTest
	{
		...
		{
			IDictionary<string, string> result = new RealCoordPropertyFormatter().GetAttributeNameValuePairs(new FormatContextImpl(this
		...
		public virtual void TestValueHasTooManyDigitsToRightOfDecimal()
		{
			...
			string result = new RealCoordPropertyFormatter().Format(new FormatContextImpl(this.modelToXmlResult, null, "name", null, 
				null), new REALImpl(bigDecimal));
