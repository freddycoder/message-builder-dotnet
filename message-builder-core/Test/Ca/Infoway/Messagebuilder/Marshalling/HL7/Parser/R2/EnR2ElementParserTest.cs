...
{
	[TestFixture]
	public class EnR2ElementParserTest : MarshallingTestCase
	{
		...
		public virtual void TestParseEmptyNode()
		{
			...
			PersonName personName = (PersonName)new PnR2ElementParser().Parse(CreateContext("EN", SpecificationVersion.R02_04_02), node
		...
		public virtual void TestParsePrefixes()
		{
			...
			personName = (PersonName)new PnR2ElementParser().Parse(CreateContext("EN", SpecificationVersion.R02_04_02), node, this.xmlResult
				).BareValue;
			Assert.IsTrue(this.xmlResult.IsValid());
