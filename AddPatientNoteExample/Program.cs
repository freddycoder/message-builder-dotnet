 ...
 * Last modified: $LastChangedDate: 2012-01-18 20:51:48 -0500 (Wed, 18 Jan 2012) $
 * Revision:      $LastChangedRevision: 3828 $
 */
...
namespace AddPatientNoteExample
{
    ...
    public class Program
    {
		...
		private static Comment CreateComment() {
			...
			noteBean.PatientNoteCategory =
					CodeResolverRegistry.Lookup<ActPatientAnnotationCode>("MED", CodeSystem.VOCABULARY_ACT_CODE.Root);
			noteBean.Text = "note text";
			noteBean.RestrictedPatientAccess.Add(Ca.Infoway.Messagebuilder.Domainvalue.Payload.Confidentiality.NORMAL);
			return noteBean;
		}
