...
namespace Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Procedurenote {
    ...
    using Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Medicalgeneralhistorysection;
    using System.Collections.Generic;


    [Hl7PartTypeMappingAttribute(new string[] {"ProcedureNote.MedicalGeneralHistorySectionComponent3"})]
    public class MedicalGeneralHistorySectionComponent3 : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Procedurenote.IComponent3Choice {

        private II typeId;
        private LIST<II, Identifier> templateId;
        private Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Medicalgeneralhistorysection.Section section;
        ...
        public Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Medicalgeneralhistorysection.Section Section {
