...
namespace Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Merged {
    ...
    public class ServiceEvent : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Merged.Performer1_1> performer;
        ...
        public ServiceEvent() {
            ...
            this.performer = new List<Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Merged.Performer1_1>();
         ...
         * specified)</summary>
         * 
         * <remarks>Relationship: ProgressNote.ServiceEvent.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * DischargeSummary.ServiceEvent.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * HistoryAndPhysical.ServiceEvent.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * USRealmHeader.ServiceEvent.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * ConsultationNote.ServiceEvent.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * UnstructuredDocument.ServiceEvent.realmCode 
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Merged.Performer1_1> Performer {
