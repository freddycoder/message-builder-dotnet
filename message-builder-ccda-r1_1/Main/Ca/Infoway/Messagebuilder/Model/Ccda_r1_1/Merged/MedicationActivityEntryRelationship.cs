...
namespace Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Merged {
    ...
    public class MedicationActivityEntryRelationship : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Reactionobservation.IEntryRelationshipChoice, Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Merged.IEntryRelationshipChoice_6, Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Procedureactivityobservation.IEntryRelationshipChoice {
         ...
         * 
         * <remarks>Relationship: 
         * ProcedureActivityObservation.MedicationActivityEntryRelationship.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * ProcedureActivityProcedure.MedicationActivityEntryRelationship.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * ReactionObservation.MedicationActivityEntryRelationship.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * ProcedureActivityAct.MedicationActivityEntryRelationship.realmCode 
