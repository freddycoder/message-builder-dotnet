...
namespace Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Merged {
    ...
    using Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Complicationssection;
    ...
    public class ComplicationsSectionComponent3 : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Procedurenote.IComponent3Choice, Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Operativenote.IComponent3Choice {

        private LIST<CS_R2<Code>, CodedTypeR2<Code>> realmCode;
        private II typeId;
        private LIST<II, Identifier> templateId;
        private Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Complicationssection.Section section;
         ...
         * OperativeNote.ComplicationsSectionComponent3.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * ProcedureNote.ComplicationsSectionComponent3.realmCode 
        ...
        public Ca.Infoway.Messagebuilder.Model.Ccda_r1_1.Complicationssection.Section Section {
