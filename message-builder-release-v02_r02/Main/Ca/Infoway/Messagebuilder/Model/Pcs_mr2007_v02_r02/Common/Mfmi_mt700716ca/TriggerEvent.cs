...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Mfmi_mt700716ca {
    ...
    using Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt090310ca;
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"MFMI_MT700716CA.ControlActEvent"})]
    public class TriggerEvent<RR> : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.RegisteredItem<RR> subjectRegistrationRequestSubject;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt090310ca.EHRRepository subjectRegistrationRequestCustodianAssignedDevice;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.Replaces> subjectRegistrationRequestReplacementOf;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt260012ca.Issues> subjectOfDetectedIssueEvent;
        ...
        public TriggerEvent() {
            ...
            this.subjectRegistrationRequestReplacementOf = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.Replaces>();
            this.subjectOfDetectedIssueEvent = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt260012ca.Issues>();
        }
        /**
         * <summary>Business Name: B:Event Identifier</summary>
         * 
         * <remarks>Relationship: MFMI_MT700716CA.ControlActEvent.id 
         ...
         * 
         * <remarks>Relationship: MFMI_MT700716CA.ControlActEvent.code 
         ...
         * 
         * <remarks>Relationship: 
         * MFMI_MT700716CA.ControlActEvent.reasonCode 
         ...
         * MFMI_MT700716CA.RegistrationRequest.subject</summary>
         * 
         * <remarks>Conformance/Cardinality: MANDATORY (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subject/registrationRequest/subject"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.RegisteredItem<RR> SubjectRegistrationRequestSubject {
            get { return this.subjectRegistrationRequestSubject; }
            set { this.subjectRegistrationRequestSubject = value; }
        }

        /**
         * <summary>Relationship: 
         * MFMI_MT700716CA.Custodian.assignedDevice</summary>
         * 
         * <remarks>Conformance/Cardinality: MANDATORY (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subject/registrationRequest/custodian/assignedDevice"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt090310ca.EHRRepository SubjectRegistrationRequestCustodianAssignedDevice {
            get { return this.subjectRegistrationRequestCustodianAssignedDevice; }
            set { this.subjectRegistrationRequestCustodianAssignedDevice = value; }
        }

        /**
         * <summary>Relationship: 
         * MFMI_MT700716CA.RegistrationRequest.replacementOf</summary>
         * 
         * <remarks>Conformance/Cardinality: OPTIONAL (0-10)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subject/registrationRequest/replacementOf"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.Replaces> SubjectRegistrationRequestReplacementOf {
            get { return this.subjectRegistrationRequestReplacementOf; }
        }

        /**
         * <summary>Relationship: 
         * MFMI_MT700716CA.Subject.detectedIssueEvent</summary>
         * 
         * <remarks>Conformance/Cardinality: REQUIRED (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subjectOf/detectedIssueEvent"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt260012ca.Issues> SubjectOfDetectedIssueEvent {
