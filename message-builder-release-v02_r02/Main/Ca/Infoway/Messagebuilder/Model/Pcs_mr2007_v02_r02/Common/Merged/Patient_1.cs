...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged {
     ...
     * 
     * <remarks>COCT_MT050207CA.Patient: Patient <p>Information 
     * used to identify the patient and to support clinical 
     * decisions. This is used when the patient is not known to the 
     * client registry but information still needs to be 
     * communicated. E.g. lab or drug reporting to PHS for an 
     ...
     * COCT_MT050208CA.Patient: Patient <p>Information used to 
     * identify the patient and to support clinical decisions. This 
     * information is that captured within the client registry 
     * record for the patient.</p> <p>A person who is receiving or 
     * may receive healthcare services and has personal attributes 
     * (e.g. name, birth date).</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT050207CA.Patient","COCT_MT050208CA.Patient"})]
    public class Patient_1 : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.IPatient_2, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.IActingPerson {
         ...
         * Conformance/Cardinality: POPULATED (1) <p>C39 
         ...
         * the attribute is only 'populated'.</p> <p>Unique identifier 
         * assigned to a person, possibly by a local system or some 
         * other non-client-registry identifier.</p> Un-merged Business 
         * Name: PatientIdentifier Relationship: 
         * COCT_MT050208CA.Patient.id Conformance/Cardinality: 
         * MANDATORY (1) <p>C39 (Extension)</p> <p>PTT.050.01 
         * (Extension)</p> <p>PTT.050.02 (Root)</p> <p>A.1</p> 
         * <p>PID.2</p> <p>Patient.332-CY (Extension)</p> 
         ...
         * unambiguously. Because this is the principal mechanism for 
         * identifying patients to computer systems, the attribute is 
         * mandatory.</p> <p>Unique identifier assigned to a person by 
         ...
         * they may be visited or found.</p> Un-merged Business Name: 
         * PatientContactAddress Relationship: 
         * COCT_MT050208CA.Patient.addr Conformance/Cardinality: 
         * REQUIRED (0-1) <p>ZPA2.1 (use)</p> <p>ZPA2.2 
         ...
         * POPULATED (1-5) <p>ZPA1.1 (Use and/or URL.scheme)</p> 
         * <p>ZPA1.2 (usablePeriod (IVL&lt;TS&gt;).low) BC:ZPA1.3 
         * (url.address - as per RFC2396)</p> <p>ZPA1.4 (url.address - 
         * as per RFC2396)</p> <p>ZPA1.5 (usablePeriod 
         * (IVL&lt;TS&gt;).high)</p> <p>PTT.070-01</p> 
         * <p>PTT.070-02</p> <p>D99.03 (url.address - as per 
         * RFC2396)</p> <p>patient.326-CQ</p> <p>PID.13</p> 
         ...
         * principal means of contact for the patient.</p> Un-merged 
         ...
         * <p>Person.nameSuffix</p> <p>Used by to help identify the 
         * patient and also when referring to the patient</p><p>The 
         * element is populated because the patient's name is important 
         * for display. However, there may be circumstances where a 
         * name is not known by the reporting system.</p> <p>The name 
         * by which the patient is known.</p> Un-merged Business Name: 
         * PatientName Relationship: COCT_MT050208CA.Person.name 
         ...
         * Conformance/Cardinality: POPULATED (1) <p>C34</p> 
         ...
         * client registry.</p> Un-merged Business Name: 
