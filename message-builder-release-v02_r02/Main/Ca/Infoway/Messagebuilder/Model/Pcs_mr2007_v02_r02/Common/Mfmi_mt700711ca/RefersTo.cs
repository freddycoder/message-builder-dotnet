...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Mfmi_mt700711ca {
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"MFMI_MT700711CA.Subject2"})]
    public class RefersTo<RR> : MessagePartBean {

        private BL contextConductionInd;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.RegisteredItem<RR> registrationRequestSubject;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt090310ca.EHRRepository registrationRequestCustodianAssignedDevice;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.Replaces> registrationRequestReplacementOf;

        public RefersTo() {
            this.contextConductionInd = new BLImpl();
            this.registrationRequestReplacementOf = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.Replaces>();
        }
        /**
         ...
         * MFMI_MT700711CA.RegistrationRequest.subject</summary>
         * 
         * <remarks>Conformance/Cardinality: MANDATORY (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"registrationRequest/subject"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.RegisteredItem<RR> RegistrationRequestSubject {
        ...
        /**
         * <summary>Relationship: 
         * MFMI_MT700711CA.Custodian.assignedDevice</summary>
         * 
         * <remarks>Conformance/Cardinality: MANDATORY (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"registrationRequest/custodian/assignedDevice"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt090310ca.EHRRepository RegistrationRequestCustodianAssignedDevice {
        ...
        /**
         * <summary>Relationship: 
         * MFMI_MT700711CA.RegistrationRequest.replacementOf</summary>
         * 
         * <remarks>Conformance/Cardinality: OPTIONAL (0-10)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"registrationRequest/replacementOf"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged.Replaces> RegistrationRequestReplacementOf {
