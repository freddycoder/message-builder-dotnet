...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Merged {
     ...
     * 
     * <remarks>MFMI_MT700751CA.SortControl: Sort Control 
     * <p>Optional for systems which can receive query requests and 
     * sort the results before returning to the query 
     * requestor.</p> <p>Holds specification of sort order for 
     * instance matches to a query.</p> 
     * MFMI_MT700746CA.SortControl: Sort Control <p>Optional for 
     * systems which can receive query requests and sort the 
     * results before returning to the query requestor.</p> 
