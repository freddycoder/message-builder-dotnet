...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged {
    ...
    public class DrugContains : MessagePartBean {
         ...
         * Conformance/Cardinality: REQUIRED (0-1) <p>Essential for 
         ...
         * Relationship: POME_MT010040CA.Substance.code 
         * Conformance/Cardinality: REQUIRED (1) <p>Allows un-ambiguous 
         ...
         * checking.</p><p>Also allows for the identification of 
         * antigens as class of ingredients in a vaccine.</p> <p>The 
         * unique identifier for the drug or chemical.</p></remarks>
         */
        ...
        /**
         * <summary>Un-merged Business Name: IngredientName</summary>
         * 
         * <remarks>Relationship: POME_MT010040CA.Substance.name 
         ...
         * Business Name: IngredientName Relationship: 
         * POME_MT010100CA.Substance.name Conformance/Cardinality: 
