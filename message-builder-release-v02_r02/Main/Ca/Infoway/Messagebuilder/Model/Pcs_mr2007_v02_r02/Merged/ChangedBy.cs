...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged {
     ...
     * status.</p> PORX_MT060160CA.Author1: *changed by <p>In an 
     * EHR integrated health services environment, it is important 
     * that other providers are able to query who (or what 
     * application) is responsible for status changes. Also used by 
     * applications for auditing and sorting.</p><p>The attribute 
     * is &quot;mandatory&quot; because provider or application 
     ...
     * specified.</p> <p>Identity of the health service provider or 
     * the application responsible for the change in the 
     * prescription dispense status.</p> COCT_MT260012CA.Author1: 
     ...
     * managed the issue.</p>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT260010CA.Author1","COCT_MT260012CA.Author1","PORX_MT060010CA.Author6","PORX_MT060040CA.Author1","PORX_MT060090CA.Author6","PORX_MT060160CA.Author1","PORX_MT060210CA.Author7","PORX_MT060340CA.Author1"})]
    public class ChangedBy : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt090102ca.HealthcareWorker assignedEntity;
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt090102ca.HealthcareWorker AssignedEntity {
