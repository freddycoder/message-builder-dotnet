...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged {
     ...
     * COCT_MT680000CA.CarrierRole: Carrier Role <p>Role of 
     * Carrier, eg. underwriter</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT680000CA.CarrierRole","FICR_MT600201CA.CarrierRole","FICR_MT610201CA.CarrierRole","PORX_MT060160CA.CarrierRole","PORX_MT060340CA.CarrierRole"})]
    public class CarrierRole : MessagePartBean {
         ...
         * extension that identifies the insurance carrier.</p> 
         * Un-merged Business Name: CarrierRoleId Relationship: 
