...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged {
    ...
    public class PrescribedBy : MessagePartBean {
         ...
         * was prescribed/dispensed. This may differ from the date on 
         ...
         * PrescribedDate Relationship: PORX_MT030040CA.Author2.time 
         * Conformance/Cardinality: REQUIRED (1) <p>Indicates when the 
         * action was performed, and may influence expiry dates for the 
         * order.</p><p>The attribute is populated because the creation 
         ...
         * REQUIRED (1) <p>Prescription.prescribedDate</p> <p>Date 
         ...
         * Conformance/Cardinality: REQUIRED (1) <p>Essential 
