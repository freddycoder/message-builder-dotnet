...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged {
     ...
     * mandatory.</p> COCT_MT260010CA.Author2: is created by 
     ...
     * mandatory.</p> COCT_MT260020CA.Author2: is created by 
     * <p>Identity of the organization who is responsible for the 
     * contents of the monograph.</p> 
     * <p>ZPE.1</p><p>ZDU.5.1</p><p>Contraindication.dataSource</p> 
     * <p>ZPE.1</p><p>ZDU.5.1</p><p>Contraindication.dataSource</p> 
     ...
     * the patient.</p> <p>To be a legal order, the person 
     * responsible for its creation must be identified. Thus the 
     * association is mandatory.</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT260010CA.Author2","COCT_MT260020CA.Author2","COCT_MT260030CA.Author2","COCT_MT470002CA.Author2","COCT_MT470012CA.Author2","PORX_MT020050CA.Author2","PORX_MT030040CA.Author2","PORX_MT060020CA.Author2","PORX_MT060040CA.Author4","PORX_MT060060CA.Author2","PORX_MT060100CA.Author2","PORX_MT060160CA.Author4","PORX_MT060190CA.Author2","PORX_MT060340CA.Author4","RCMR_MT010001CA.Author2"})]
    public class PrescribedBy : MessagePartBean {
         ...
         * which the device was prescribed/dispensed. This may differ 
         ...
         * always be known.</p> Prescribed Date <p>The date at which 
         ...
         * order.</p><p>The attribute is populated because the creation 
         * date of the prescription will always be known, except for 
         * inferred prescriptions.</p> Prescribed Date <p>The date at 
         * which the drug was prescribed/dispensed. This may differ 
         * from the date on which the prescription becomes effective. 
         * E.g. A prescription created today may not be valid to be 
         * dispensed or administered for two weeks.</p> <p>Indicates 
         * when the action was performed, and may influence expiry 
         * dates for the order.</p><p>The attribute is populated 
         * because the creation date of the prescription will not 
         * always be known (as in the case of 'inferred 
         * prescription').</p> <p>Indicates when the action was 
         * performed, and may influence expiry dates for the 
         * order.</p><p>The attribute is populated because the creation 
         * date of the prescription will not always be known (as in the 
         * case of 'inferred prescription').</p> Prescription Order 
