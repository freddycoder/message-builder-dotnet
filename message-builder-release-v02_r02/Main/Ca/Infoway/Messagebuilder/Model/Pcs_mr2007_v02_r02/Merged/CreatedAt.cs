...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged {
     ...
     * COMT_MT300003CA.Location: *c:recorded at <p>Important for 
     * performing follow-up and is therefore mandatory.</p> 
     * <p>Indicates the facility/location where the patient note 
     * was recorded.</p> MCAI_MT700211CA.Location: *a1:created at 
     * <p>If AuthorizationToken not specified, association is 
     * required. If AuthorizationToken specified, association is 
     * required if authorization does not cover this 
     * participation.</p> <p>Indicates where paper records may be 
     ...
     * of the authentication token.</p> <p>Indicates the service 
     * delivery location where the event occurred.</p> 
     * PORX_MT060060CA.Location2: *c:targeted to pharmacy <p>Allows 
     ...
     * prescription has been directed or which has currently 
     * assumed responsibility for dispensing the prescription.</p> 
     * MCAI_MT700222CA.Location: *a1:created at <p>If 
     ...
     * the event occurred.</p> MCAI_MT700212CA.Location: 
     ...
     * dispense event was performed</p> MCAI_MT700220CA.Location: 
     * *a1:created at <p>If AuthorizationToken not specified, 
     * association is required. If AuthorizationToken specified, 
     * association is required if authorization does not cover this 
     * participation.</p> <p>Indicates where paper records may be 
     ...
     * dispensing was performed.</p> MCAI_MT700231CA.Location: 
     * *a1:created at <p>If AuthorizationToken not specified, 
     * association is required. If AuthorizationToken specified, 
     * association is required if authorization does not cover this 
     * participation.</p> <p>Indicates where paper records may be 
     ...
     * of the authentication token.</p> <p>Indicates the service 
     * delivery location where the event occurred.</p> 
     * MCAI_MT700221CA.Location: *a1:created at <p>If 
     * AuthorizationToken not specified, association is required. 
     * If AuthorizationToken specified, association is required if 
     * authorization does not cover this participation.</p> 
     * <p>Indicates where paper records may be located, and may be 
     ...
     * information will be conveyed as part of the authentication 
     * token.</p> <p>Indicates the service delivery location where 
     * the event occurred.</p> REPC_MT000009CA.Location: 
     ...
     * QUQI_MT020002CA.Location: *a1:created at <p>If 
     * AuthorizationToken not specified, association is required. 
     * If AuthorizationToken specified, association is required if 
     * authorization does not cover this participation.</p> 
     * <p>Indicates where paper records may be located, and may be 
     ...
     * information will be conveyed as part of the authentication 
     * token.</p> <p>Indicates the service delivery location where 
     * the event occurred.</p> PORX_MT060160CA.Location: 
     * *d:dispensed from <p>Important for performing follow-up and 
     * therefore mandatory.</p> <p>Indicates the facility/location 
     * where the dispensing was performed.</p> 
     ...
     * 'populated'.</p> <p>Indicates the pharmacy to which the 
     * prescription has been directed or which has currently 
     * assumed responsibility for dispensing the prescript
