...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged {
    ...
    using Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt960002ca;
    using System;
     ...
     * Location <p>Used for tracking service delivery 
     * responsibility, to provide contact information for follow-up 
     * and for statistical analysis. Also important for indicating 
     * where paper records can be located.</p> <p>Information other 
     * than the id is expected to be extracted from the service 
     * delivery location registry.</p> <p>An identification of a 
     ...
     * Hospital</p> COCT_MT240002CA.ServiceDeliveryLocation: 
     * Service Location <p>Used for tracking service delivery 
     * responsibility, to provide contact information for follow-up 
     * and for statistical analysis. Also important for indicating 
     * where paper records can be located.</p> <p>An identification 
     * of a service location (or facility) that can be found in the 
     * service delivery location. E.g. Pharmacy, Medical Clinic, 
     * Hospital</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT240002CA.ServiceDeliveryLocation","COCT_MT240003CA.ServiceDeliveryLocation","COCT_MT240007CA.ServiceDeliveryLocation","COCT_MT240012CA.ServiceDeliveryLocation"})]
    public class ServiceLocation : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged.IRecipient {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt960002ca.GeographicCoordinates> subjectOfPosition;
        ...
        public ServiceLocation() {
            ...
            this.subjectOfPosition = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt960002ca.GeographicCoordinates>();
        }
        /**
         * <summary>Business Name: ServiceLocationIdentifier</summary>
         * 
         * <remarks>Un-merged Business Name: ServiceLocationIdentifier 
         ...
         * location.</p> Un-merged Business Name: 
         ...
         * ServiceLocationType Relationship: 
         ...
         * mail.</p> Un-merged Business Name: ServiceLocationAddress 
         ...
         * contacted.</p> Un-merged Business Name: 
         * ServiceLocationPhonesAndEMails Relationship: 
         ...
         * the service location.</p> Un-merged Business Name: 
         ...
         * COCT_MT240003CA.Subject.position Conformance/Cardinality: 
         * POPULATED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: COCT_MT240002CA.Subject.position 
         * Conformance/Cardinality: POPULATED (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"subjectOf/position"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt960002ca.GeographicCoordinates> SubjectOfPosition {
