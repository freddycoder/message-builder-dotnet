...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pr.Merged {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"PRPM_MT306011CA.ResponsibleParty","PRPM_MT309000CA.ResponsibleParty"})]
    public class ResponsibleParty : MessagePartBean {

        private CS typeCode;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pr.Merged.Privilege privilege;
         ...
         * PRPM_MT306011CA.ResponsibleParty.typeCode 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PRPM_MT309000CA.ResponsibleParty.typeCode 
         ...
         * 
         * <remarks>Relationship: 
         * PRPM_MT306011CA.ResponsibleParty.privilege 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PRPM_MT309000CA.ResponsibleParty.privilege 
         * Conformance/Cardinality: REQUIRED (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"privilege"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pr.Merged.Privilege Privilege {
