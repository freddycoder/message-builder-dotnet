...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pr.Merged {
    ...
    public class InformRequest : MessagePartBean {
         ...
         * Inform Request Code <p>A code specifying the particular kind 
         * of Act that the Act-instance represents within its class. 
         * Ex. Document Type</p> <p>Populated attribute supports the 
