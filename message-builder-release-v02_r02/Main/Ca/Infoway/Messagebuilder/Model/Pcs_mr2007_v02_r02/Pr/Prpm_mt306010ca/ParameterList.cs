...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pr.Prpm_mt306010ca {
    ...
    public class ParameterList : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Mandatory 
         * attribute supports the identification of the healthcare 
         * provider</p> <p>The principal persons gender.</p></remarks>
         */
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Mandatory 
         * attribute supports the identification of the healthcare 
         * provider</p> <p>The principal persons date of birth.</p></remarks>
         */
         ...
         * PROV</p> <p>Mandatory attribute where queried upon</p> 
         * <p>Indicates Role Class being queried upon</p></remarks>
         */
