...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Merged {
     ...
     * 
     * <remarks><p>Cancel reasons are noted in the control 
     * wrapper</p> FICR_MT600201CA.InvoiceElementGroup: Invoice 
     * Grouping Information <p>The statement and justification of 
     * the Total Billed Amount. For an invoice it is the statement 
     * and justification of the Total Billed amount requesting the 
     ...
     * payor.</p> <p>There are some situations where all items for 
     ...
     * patient.</p> FICR_MT610201CA.InvoiceElementGroup: Submitted 
     * Invoice Group <p>Unique number generated by the pharmacy 
     * software for the specific invoice element group</p></remarks>
     */
    ...
    public class SubmittedInvoiceGroup : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt600201ca.IInvoiceElementChoice, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Merged.IInvoiceElementChoice {
         ...
         * Grouping.</p> <p>For example:</p><p>1. unique invoice group 
         ...
         * by adjudicator.</p><p>Obligation on adjudicator is to return 
         * and communicate about this item with all identifiers (i.e. 
         * identifier 1. and 2.).</p> <p>OID (object identifier) + 
         * unique number generated by the pharmacy software for the 
         * specific invoice element group.</p><p>For child Invoice 
         * Element Groups, the identifier will be the same as its 
         ...
         * as the PaymentRequest.id or the InvoiceElementDetail.id.</p> 
         ...
         * InvoiceElementDetail.id.</p> <p>OID (object identifier) + 
         * unique number generated by the pharmacy software for the 
         * specific invoice element group.</p><p>For child Invoice 
         * Element Groups, the identifier will be the same as its 
         * parent Invoice Element Group, appended with a 
         ...
         * &quot;12942.2&quot;.</p><p>Must not be the same identifier 
         * as the PaymentRequest.id or the InvoiceElementDetail.id.</p> 
         * Invoice Grouping Identifier <p>Set of identifiers that 
         * uniquely identify the Invoice Grouping.</p> <p>For 
         ...
         * this item would be &quot;12942.2&quot;.</p><p>Must not be 
         * the same identifier as the PaymentRequest.id or the 
         * InvoiceElementDetail.id.</p> Invoice Grouping Identifiers 
         ...
         * invoice grouping identifier by adjudicator.</p><p>Obligation 
         * on adjudicator is to return and communicate about this item 
         * with all identifiers (i.e. identifier 1. and 2.).</p> <p>F
         ...
         * 
         * <remarks>Invoice Type <p>Invoice Type is the indication to 
         ...
         * Service, Preferred Accom, Rx Dispense, Rx Compound</p> <p>of 
         * Invoice Grouping.</p><p>Each Invoice Type is used to specify 
         * 1. vocabulary, 2. structure of the Invoice Element Choice 
         * and 3. which Billable Act(s) can be included for the 
         ...
         * Type.</p> <p>of Invoice Grouping.</p><p>Each Invoice Type is 
         * used to specify 1. vocabulary, 2. structure of the Invoice 
         ...
         * invoice element group. DRGING for specify drug group.</p> 
         * Invoice Type <p>Invoice Type e.g. Healthcare Services, Rx 
         * Dispense, Rx Compound, Healthcare Goods, Preferred 
         * Accomodation</p> <p>RXDINV, RXCINV, CSINV, CPINV, CSPINV 
         * only for root invoice element group. RXDINV only for root 
         * invoice element group. DRGING for specify drug group.</p> 
         ...
         * distinct XML schemas that can tested independent of each 
         * other. They must be tested together within an Message 
         * Type.</p> <p>This is used to indicate the type of Invoice 
         ...
         * distinct XML schemas that can tested independent of each 
         * other. They must be tested together within an Message 
         * Type.</p> (no business name) <p>Invoice Type e.g. Healthcare 
         ...
         * 
         * <remarks>Invoice sub-total <p>Invoice sub-total - This is 
         * the sum of the Submitted Invoice Line amounts; Identifies 
         * the total monetary amount billed for the invoice 
         * element.</p> <p>For Cancel Request: This would serve as a 
         ...
         * that is being cancelled.</p><p>Attribute cannot be mandatory 
         * as it may not be present for a Coverage Extension 
         * Request.</p> Invoice SubTotal <p>Identifies the total 
         * monetary amount billed for the invoice element. This is the 
         * sum of the Submitted Invoice Line amounts.</p> <p>For Cancel 
         ...
         * total).</p> <p>For Coverage Extension Results: Some 
         * adjudicators will indicate a dollar amount allowed for the 
         * coverage extension.</p><p>RxS1: Sum of 
         * InvoiceElementDetail.netAmt for all immediate child invoice 
         * elements. The root invoice element group will be the 
         * transaction total (invoice total).</p> Invoice Sub-total 
         * <p>Identifies the total monetary amount billed for the 
         * invoice element. This is the sum of the Submitted Invoice 
         * Line amounts.</p> <p>For Cancel Request: This would serve as 
         * a cross-check for the Adjudicator for the Invoice Grouping 
         * that is being cancelled.</p><p>Attribute cannot be mandatory 
         * as it may not be present for a Coverage Extension 
         * Request.</p> <p>For Cancel Request: This would serve as a 
         * cross-check for the Adjudicator for the Invoice Grouping 
         * that is being cancelled.</p><p>Attribute cannot be mandatory 
         * as it may not be present for a Coverage Extension 
         * Request.</p> <p>For Coverage Extension Results: Some 
         * adjudicators will indicate a dollar amount allowed for the 
         * coverage extension.</p><p>RxS1: Sum of 
         * InvoiceElementDetail.netAmt for all immediate child invoice 
         * elements. The root invoice element group will be the 
         * transaction total (invoice total).</p> <p>For Coverage 
         * Extension Results: Some adjudicators will indicate a dollar 
         * amount allowed for the coverage extension.</p><p>RxS1: Sum 
         * of InvoiceElementDetail.netAmt for all immediate child 
         * invoice elements. The root invoice element group will be the 
         * transaction total (invoice total).</p></remarks>
         */
         ...
         * 
         * <remarks>Time period for invoice <p>The period of time that 
         * the invoice pertains to. This may be a specific date or a 
         * date range (as in the month of January) for the invoice.</p> 
         ...
         * physician invoices only.</p> <p>Transmission of this 
         * information suggests a transfer of liability for how this 
         * information/invoice is used/communicated.</p><p>Legislation 
         * and service level agreements typically cover the requirement 
         * to send this code with every invoice.</p><p>This will be 
         * required for Alberta physician invoices only.</p> 
         * <p>Transmission of this information suggests a transfer of 
         * liability for how this information/invoice is 
         * used/communicated.</p><p>Legislation and service level 
         * agreements typically cover the requirement to send this code 
