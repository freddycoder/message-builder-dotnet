...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca {
    ...
    public class ComponentInvoiceElement : MessagePartBean {
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.PaymentIntent AdjudicatedInvoiceElementChoiceAsAdjudicatedInvoiceElementGroup {
            get { return this.adjudicatedInvoiceElementChoice is Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.PaymentIntent ? (Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.PaymentIntent) this.adjudicatedInvoiceElementChoice : (Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.PaymentIntent) null; }
        }
        public bool HasAdjudicatedInvoiceElementChoiceAsAdjudicatedInvoiceElementGroup() {
            return (this.adjudicatedInvoiceElementChoice is Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.PaymentIntent);
        }

        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.AdjudicatedInvoiceElementLineItem AdjudicatedInvoiceElementChoiceAsAdjudicatedInvoiceElementDetail {
            get { return this.adjudicatedInvoiceElementChoice is Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.AdjudicatedInvoiceElementLineItem ? (Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.AdjudicatedInvoiceElementLineItem) this.adjudicatedInvoiceElementChoice : (Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.AdjudicatedInvoiceElementLineItem) null; }
        }
        public bool HasAdjudicatedInvoiceElementChoiceAsAdjudicatedInvoiceElementDetail() {
            return (this.adjudicatedInvoiceElementChoice is Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.AdjudicatedInvoiceElementLineItem);
        }
