...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Merged {
    ...
    public class SummaryDetails : MessagePartBean {
         ...
         * Conformance/Cardinality: REQUIRED (1) <p>Identify the 
         ...
         * Conformance/Cardinality: REQUIRED (1) <p>PQ or MO - Value of 
         * summary</p> Un-merged Business Name: SummaryTotalAmount 
         * Relationship: 
         * FICR_MT610201CA.AdjudResultsGroupSummaryData.value 
         * Conformance/Cardinality: REQUIRED (1) <p>Data type can be PQ 
         * or MO only.</p> <p>Summary Total</p> Un-merged Business 
         * Name: SummaryTotalAmt Relationship: 
         * FICR_MT630000CA.AdjudResultsGroupSummaryData.value 
         * Conformance/Cardinality: REQUIRED (1) <p>PQ or MO only - 
