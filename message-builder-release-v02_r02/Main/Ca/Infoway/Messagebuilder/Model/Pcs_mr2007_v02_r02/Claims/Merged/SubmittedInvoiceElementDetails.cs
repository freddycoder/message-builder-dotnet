...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Merged {
    ...
    /**
     * <summary>Business Name: InvoiceElementDetails</summary>
     * 
     ...
     * bottle)</p> <p>The details of the Invoice item billed for, 
     * as in the product or service.</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"FICR_MT600201CA.InvoiceElementDetail","FICR_MT610201CA.InvoiceElementDetail"})]
    public class SubmittedInvoiceElementDetails : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.IInvoiceElementChoice, Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt600201ca.IInvoiceElementChoice {
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Attribute cannot 
         * be mandatory as it may not be present for a Coverage 
         ...
         * Conformance/Cardinality: REQUIRED (1) <p>Field length for 
         ...
         * applied to unitPriceAmt.</p> <p>RxS1: Not permitted, as 
