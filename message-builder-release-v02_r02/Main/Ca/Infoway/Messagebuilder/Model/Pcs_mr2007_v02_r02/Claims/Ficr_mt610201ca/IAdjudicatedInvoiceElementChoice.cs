...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca {
    ...
    public interface IAdjudicatedInvoiceElementChoice {
        ...
        Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.AllowableAmount Reference1Allowable {
            get;
            set;
        }

        [Hl7XmlMappingAttribute(new string[] {"outcomeOf"})]
        Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt610201ca.AdjudicatedResultOutcome OutcomeOf {
            get;
            set;
        }
