...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Claims.Ficr_mt620000ca {
    ...
    public class InvoiceType : MessagePartBean {
         ...
         * FICR_MT620000CA.InvoiceElementGroup.code</summary>
         * 
         * <remarks>Conformance/Cardinality: MANDATORY (1) <p>Each 
         * Invoice Type is used to specify 1. vocabulary, 2. structure 
         * of the Invoice Element Choice and 3. which Billable Act(s) 
         * can be included for the specified Invoice 
