...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Cr.Prpa_mt101102ca {
    ...
    public class OtherIDsNonHealthcareIdentifiers : MessagePartBean {
         ...
         * supports the identification of the client</p> <p>Other 
         * non-healthcare identifiers for the Client (e.g. Drivers 
         * License, RCMP, DND, Social Insurance Number)</p></remarks>
         */
         ...
         * Conformance/Cardinality: REQUIRED (1) <p>Populated attribute 
         * supports the identification of the client</p> <p>A pan 
         * Canadian code further specifying the kind of Role such as 
         ...
         * the identifier to the client</p> <p>A name for the 
