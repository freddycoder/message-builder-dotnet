...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Iehr.Merged {
     ...
     * the patient was exposed.</p> REPC_MT000005CA.MaterialKind: 
     ...
     * REPC_MT000009CA.MaterialKind: Agent Category <p>Allows 
     * exposed materials or agents to be collectively 
     * referenced.</p> <p>Category of material or agent to which 
     * the patient was exposed.</p> REPC_MT000013CA.MaterialKind: 
     * Agent Category <p>Allows exposed materials or agents to be 
     * collectively referenced.</p> <p>Category of material or 
     * agent to which the patient was exposed.</p> 
     * REPC_MT000001CA.MaterialKind: Agent Category <p>Allows 
     * exposed materials or agents to be collectively 
     * referenced.</p> <p>Category of material or agent to which 
    ...
    public class AgentCategory : MessagePartBean {
         ...
         * Conformance/Cardinality: REQUIRED (1) <p>Allows different 
         ...
         * REPC_MT000005CA.MaterialKind.code Conformance/Cardinality: 
         * REQUIRED (1) <p>Allows different kinds of reaction agents to 
         * be distinguished. Coding strength is set to CWE because the 
