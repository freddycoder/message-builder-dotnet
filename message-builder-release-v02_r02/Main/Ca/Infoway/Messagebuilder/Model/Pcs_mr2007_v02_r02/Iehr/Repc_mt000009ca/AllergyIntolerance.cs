 ...
 * Last modified: $LastChangedDate: 2012-02-16 11:12:57 -0500 (Thu, 16 Feb 2012) $
 * Revision:      $LastChangedRevision: 5548 $
 */
...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Iehr.Repc_mt000009ca {
     ...
     * 
     * <remarks><p>Value is not permitted when using SNOMED, 
     * mandatory otherwise</p> <p>A record of a patient's allergy 
     * or intolerance.</p> <p>Necessary component of a person's 
    ...
    public class AllergyIntolerance : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Iehr.Repc_mt000009ca.AllergyIntolerance replacementOfIntoleranceCondition;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Iehr.Merged.IRecords> supportRecords;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Iehr.Repc_mt000009ca.AllergyIntoleranceStatusChanges> subjectOf1ControlActEvent;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt120600ca.Notes> subjectOf2Annotation;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged.AllergyIntoleranceSeverityLevel subjectOf3SeverityObservation;
         ...
         * essential to know whether the record refutes or affirms an 
         * allergy, this attribute is mandatory.</p></remarks>
         */
         ...
         * Complete</p> <p>Allows providers to evaluate the relevance 
         * of a recorded allergy/intolerance. The status has a default 
         * value of 'active' and is therefore mandatory.</p> <p>System 
         * must default the status to 'ACTIVE'.</p></remarks>
         */
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Iehr.Repc_mt000009ca.AllergyIntolerance ReplacementOfIntoleranceCondition {
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Iehr.Repc_mt000009ca.AllergyIntoleranceStatusChanges> SubjectOf1ControlActEvent {
            get { return this.subjectOf1ControlActEvent; }
        }

        [Hl7XmlMappingAttribute(new string[] {"subjectOf2/annotation"})]
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt120600ca.Notes> SubjectOf2Annotation {
            get { return this.subjectOf2Annotation; }
        }

        [Hl7XmlMappingAttribute(new string[] {"subjectOf3/severityObservation"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged.AllergyIntoleranceSeverityLevel SubjectOf3SeverityObservation {
