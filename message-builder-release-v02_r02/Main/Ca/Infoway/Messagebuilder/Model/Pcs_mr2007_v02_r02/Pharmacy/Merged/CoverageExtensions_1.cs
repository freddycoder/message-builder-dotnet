...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged {
    ...
    public class CoverageExtensions_1 : MessagePartBean {
        ...
        private CS moodCode;
        private II id;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged.Underwriter authorUnderwriter;
         ...
         * is 'populated'.</p> <p>Unique identification for a specific 
         * coverage extension.</p> Un-merged Business Name: 
         ...
         * REQUIRED (1) <p>Allows for referencing of a specific 
         * coverage extension.</p><p>This identifier may be needed on 
         * claims against the coverage.</p><p>At times when the ID will 
         * not be available (such as when the request has just been 
         * submitted), the attribute is 'populated'.</p> <p>Unique 
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged.Underwriter AuthorUnderwriter {
