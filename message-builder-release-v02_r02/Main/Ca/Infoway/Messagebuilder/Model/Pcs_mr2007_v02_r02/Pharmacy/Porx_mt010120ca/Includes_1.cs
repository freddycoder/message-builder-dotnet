...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Porx_mt010120ca {
    ...
    public class Includes_1 : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Porx_mt010120ca.DispenseInstructions supplyRequest;

        public Includes_1() {
        }
        [Hl7XmlMappingAttribute(new string[] {"supplyRequest"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Porx_mt010120ca.DispenseInstructions SupplyRequest {
