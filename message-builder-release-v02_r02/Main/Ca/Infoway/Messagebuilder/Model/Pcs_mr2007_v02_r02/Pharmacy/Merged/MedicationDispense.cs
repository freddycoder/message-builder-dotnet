...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged {
     ...
     * integral part of the overall medication process.</p> <p>This 
     * is the detailed information about a medication dispense that 
     * has been performed on behalf of a patient.</p> 
     ...
     * Indicator is not present</p> <p>This is a 'core' class of 
     * the medication model and is important for understanding what 
     * drugs the patient is actually receiving.</p> <p>Describes 
     * the issuing of a drug in response to an authorizing 
     * prescription.</p> PORX_MT060160CA.MedicationDispense: 
     * Prescription Dispenses <p>Reported Issue is only permitted 
     * if Issue Indicator is not present and vice versa</p> 
     * <p>Annotation is only permitted if Annotation Indicator is 
     * not present and vice versa</p> <p>Dispensing is an integral 
     * part of the overall medication process.</p> <p>This is the 
     * detailed information about a medication dispense that has 
     * been performed on behalf of a patient.</p>
     */
    ...
    public class MedicationDispense : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt270010ca.AdministrationInstructions> component2DosageInstruction;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged.Substitution component3SubstitutionMade;
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt120600ca.Notes> subjectOf4Annotation;
        private BL subjectOf3DetectedIssueIndicator;
        private IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged.Issues> subjectOf5DetectedIssueEvent;
        private BL subjectOf2AnnotationIndicator;
        private SET<CV, Code> confidentialityCode;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged.PrescriptionReference inFulfillmentOfSubstanceAdministrationRequest;

        public MedicationDispense() {
            this.id = new IIImpl();
            this.statusCode = new CSImpl();
            this.component2DosageInstruction = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt270010ca.AdministrationInstructions>();
            this.subjectOf1ControlActEvent = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged.StatusChanges>();
            this.subjectOf4Annotation = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt120600ca.Notes>();
            this.subjectOf3DetectedIssueIndicator = new BLImpl(false);
            this.subjectOf5DetectedIssueEvent = new List<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged.Issues>();
         ...
         * Name: (no business name specified) Relationship: 
         * PORX_MT060090CA.Performer3.assignedEntity 
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt270010ca.AdministrationInstructions> Component2DosageInstruction {
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged.Substitution Component3SubstitutionMade {
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Common.Coct_mt120600ca.Notes> SubjectOf4Annotation {
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Merged.Issues> SubjectOf5DetectedIssueEvent {
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged.PrescriptionReference InFulfillmentOfSubstanceAdministrationRequest {
