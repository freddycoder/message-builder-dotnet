...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged {
    ...
    public class DispenseInstructions_2 : MessagePartBean {
        ...
        /**
         * <summary>A:Prescription Dispensable Indicator</summary>
         * 
         ...
         * of the prescription will always be known.</p> <p>Allows the 
         ...
         * prescription will always be known.</p> A:Prescription 
         * Dispense Indicator <p>This generally mirrors the status for 
         * the prescription, but in some circumstances may be changed 
         * to 'aborted' while the prescription is still active. When 
         * this occurs, it means the prescription may no longer be 
         * dispensed, though it may still be administered.</p> 
         ...
         * specified as a total quantity.</p> B:Total Prescribed 
         * Quantity <p>The overall amount of amount medication to be 
         ...
         * be dispensed in the context of a part-fill prescription.</p> 
         * Total Prescribed Quantity <p>The overall amount of amount 
