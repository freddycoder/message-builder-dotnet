...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged {
    ...
    public class DispensedIn : MessagePartBean {
         ...
         * 
         * <remarks>Container Type <p>A coded value denoting a specific 
         * kind of a container. Used to identify a requirement for a 
         * particular type of compliance packaging</p> <p>Many 
         * insurance plans require that a prescriber specifically 
         * authorize the use of compliance packaging before it will be 
         * covered by the plan.</p> H:Container Type <p>A coded value 
