...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2007_v02_r02.Pharmacy.Merged {
     ...
     * 
     * <remarks>POME_MT010100CA.Content: dispensed in <p>May 
     ...
     * instructions with respect to special packaging such as 
     * compliance packaging.</p> <p>Information about how the 
     * dispensed drug is or should be contained</p></remarks>
     */
    ...
    public class DispensedIn : MessagePartBean {
         ...
         * denominator a '1'.</p> <p>The quantity of the medication 
         * dosage form contained in the package given or to be given to 
         * the patient.</p> Un-merged Business Name: PackageQuantity 
