...
namespace Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Merged {
    ...
    using Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Allergiessectionentriesoptional;
    ...
    public class AllergiesSectionentriesOptionalComponent3 : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Procedurenote.IComponent3Choice, Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Progressnote.IComponent3Choice, Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Consultationnote.IComponent3Choice, Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Historyandphysical.IComponent3Choice, Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Dischargesummary.IComponent3Choice {
        ...
        private Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Allergiessectionentriesoptional.Section section;
         ...
         * ConsultationNote.AllergiesSectionentriesOptionalComponent3.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * ProcedureNote.AllergiesSectionentriesOptionalComponent3.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * HistoryAndPhysical.AllergiesSectionentriesOptionalComponent3.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * ProgressNote.AllergiesSectionentriesOptionalComponent3.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * DischargeSummary.AllergiesSectionentriesOptionalComponent3.realmCode 
        ...
        public Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Allergiessectionentriesoptional.Section Section {
