...
namespace Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Merged {
    ...
    public class NonMedicinalSupplyActivityEntryRelationship : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Merged.IEntryRelationshipChoice_4 {
         ...
         * 
         * <remarks>Relationship: 
         * FunctionalStatusResultObservation.NonMedicinalSupplyActivityEntryRelationship.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * CognitiveStatusProblemObservation.NonMedicinalSupplyActivityEntryRelationship.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * CognitiveStatusResultObservation.NonMedicinalSupplyActivityEntryRelationship.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * FunctionalStatusProblemObservation.NonMedicinalSupplyActivityEntryRelationship.realmCode 
