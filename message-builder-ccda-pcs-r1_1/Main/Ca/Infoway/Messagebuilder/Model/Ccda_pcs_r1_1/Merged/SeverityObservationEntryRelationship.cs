...
namespace Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Merged {
    ...
    using Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Severityobservation;
    using System;
    ...
    public class SeverityObservationEntryRelationship : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Reactionobservation.IEntryRelationshipChoice, Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Merged.IEntryRelationshipChoice_2 {
        ...
        private Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Severityobservation.Observation observation;
         ...
         * 
         * <remarks>Relationship: 
         * SubstanceOrDeviceAllergyIntoleranceObservation.SeverityObservationEntryRelationship.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * AllergyIntoleranceObservation.SeverityObservationEntryRelationship.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * ReactionObservation.SeverityObservationEntryRelationship.realmCode 
        ...
        public Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Severityobservation.Observation Observation {
