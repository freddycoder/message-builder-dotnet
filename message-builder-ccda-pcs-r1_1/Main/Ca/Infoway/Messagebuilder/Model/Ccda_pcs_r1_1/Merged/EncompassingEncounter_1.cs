...
namespace Ca.Infoway.Messagebuilder.Model.Ccda_pcs_r1_1.Merged {
    ...
    public class EncompassingEncounter_1 : MessagePartBean {
         ...
         * ContinuityOfCareDocumentCCD.EncompassingEncounter.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * OperativeNote.EncompassingEncounter.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * UnstructuredDocument.EncompassingEncounter.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * DischargeSummary.EncompassingEncounter.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * BaseModel.EncompassingEncounter.realmCode 
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * USRealmHeader.EncompassingEncounter.realmCode 
