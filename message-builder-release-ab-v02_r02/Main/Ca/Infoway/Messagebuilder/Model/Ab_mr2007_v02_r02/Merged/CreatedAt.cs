...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Merged {
     ...
     * *a1:created at <p>Indicates the service delivery location 
     * where the event occurred.</p> <p>Indicates where paper 
     ...
     * authorization.</p><p>The association is optional because in 
     * some jurisdictions this information will be conveyed as part 
     * of the authentication token.</p> PORX_MT060060CA.Location2: 
     ...
     * known or should have an explicit null flavor of 'NA' 
     * (non-assigned) or 'UNK' (paper prescription). Thus the 
     * association is 'populated'.</p> COCT_MT260020CA.Location: 
     ...
     * MCAI_MT700231CA.Location: *a1:created at <p>If 
     ...
     * authorization.</p><p>The association is optional because in 
     * some jurisdictions this information will be conveyed as part 
     * of the authentication token.</p> PORX_MT060160CA.Location: 
     ...
     * mandatory.</p> PORX_MT010110CA.Location2: *c:targeted to 
     ...
     * known or should have an explicit null flavor of 'NA' 
     * (non-assigned) or 'UNK' (paper prescription). Thus the 
     * association is 'populated'.</p> REPC_MT000006CA.Location: 
     * *i:recorded at <p>Indicates the service delivery location 
     * where the adverse reaction was recorded.</p> <p>Indicates 
     * where records are likely kept for follow-up. May also be 
     * useful in understanding the context in which the adverse 
     * reaction was recorded. The location of entry should always 
     * be known, and is therefore mandatory.</p> 
     * PORX_MT060100CA.Location: *dispensed from <p>Identification 
     * of the service delivery location where the medication was 
     * dispensed.</p> <p>Used for follow-up communication on the 
     * dispensed product, and therefore mandatory.</p> 
     * PORX_MT060160CA.Location5: *c:targeted to pharmacy 
     ...
     * <p>Prescription.facility</p> <p>Allows prescriptions to be 
     ...
     * always be known or should have an explicit null flavor of 
     * 'NA' (non-assigned) or 'UNK' (paper prescription). Thus the 
     * association is 'populated'.</p> PORX_MT060160CA.Location4: 
     * *refused at <p>Identifies the location where the refusal 
     * occurred</p> <p>Allows follow-up and traceability of the 
     * refusal.</p><p>Association is mandatory as the dispensing 
     * facility refusing the fill must be known.</p> <p>Allows 
     * follow-up and traceability of the refusal.</p><p>Association 
     * is mandatory as the dispensing facility refusing the fill 
     * must be known.</p> PORX_MT060010CA.Location: *d:dispensed 
     * from <p>Indicates the facility/location where the dispensing 
     * was performed.</p> <p>Important for performing follow-up and 
     * therefore mandatory.</p> PORX_MT060160CA.Location3: 
     * *prescribed at <p>Indicates the clinic or facility which 
     * originally issued the prescription.</p> <p>Identifies where 
     * paper records are likely located for follow-up. This is 
     * marked as 'populated' because it won't always be known for 
     * 'inferred prescriptions.</p> PORX_MT060160CA.Location2: 
     * *recorded at <p>Indicates the facility/location where the 
     * other active medication was recorded.</p> <p>Important for 
     * performing follow-up and is therefore mandatory.</p> 
     * MFMI_MT700711CA.Location: *a1:created at <p>If 
     * AuthorizationToken not specified, association is required. 
     * If AuthorizationToken specified, association is required if 
     * authorization does not cover this participation.</p> 
     * <p>Indicates the service delivery location where the event 
    ...
    public class CreatedAt : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Merged.ServiceLocation serviceDeliveryLocation;
