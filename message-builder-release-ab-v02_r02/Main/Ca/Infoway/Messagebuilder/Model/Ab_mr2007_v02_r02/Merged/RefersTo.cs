...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Merged {
     ...
     * item(s) being acted upon by this trigger event.</p> 
     ...
     * work.</p> MCAI_MT700216CA.Subject2: f:refers to <p>On 
     ...
     * of work.</p> MCAI_MT700211CA.Subject2: f:refers to 
     ...
     * either accepted or rejected as a single action. I.e. One 
     * trigger event = 1 unit of work.</p> 
     * MCAI_MT700221CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     * not present.</p> <p>Indicates the item(s) being acted upon 
     * by this trigger event.</p><p>Will be mandatory in wrappers 
     ...
     * items, the changes to all of them must be either accepted or 
     * rejected as a single action. I.e. One trigger event = 1 unit 
     * of work.</p> MCAI_MT700212CA.Subject2: f:refers to <p>On 
     * &#226;&#128;&#152;creation&#226;&#128;&#153; interactions 
     * where the state transition is null-&gt;active, 
     * contextConductionInd must be true, otherwise it must be 
     * false.</p> <p>Indicates the item(s) being acted upon by this 
     ...
     * of them must be either accepted or rejected as a single 
     * action. I.e. One trigger event = 1 unit of work.</p> 
     * MCAI_MT700217CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     * not present.</p> <p>Indicates the item(s) being acted upon 
     * by this trigger event.</p><p>Will be mandatory in wrappers 
     ...
     * items, the changes to all of them must be either accepted or 
     * rejected as a single action. I.e. One trigger event = 1 unit 
     * of work.</p> MCAI_MT700227CA.Subject2: f:refers to 
     * <p>Indicates the item(s) being acted upon by this trigger 
     * event.</p><p>Will be mandatory in wrappers with payload 
     * messages, otherwise not present.</p> <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     ...
     * either accepted or rejected as a single action. I.e. One 
     * trigger event = 1 unit of work.</p> 
     * MCAI_MT700220CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p> 
     * <p>Provides information about the thing being created or 
     * modified.</p> <p>If there are multiple subject items, the 
     * changes to all of them must be either accepted or rejected 
     ...
     * of them must be either accepted or rejected as a single 
     * action. I.e. One trigger event = 1 unit of work.</p> 
     * MCAI_MT700226CA.Subject2: f:refers to <p>Indicates the 
     * item(s) being acted upon by this trigger event.</p><p>Will 
     * be mandatory in wrappers with payload messages, otherwise 
     * not present.</p> <p>Indicates the item(s) being acted upon 
     * by this trigger event.</p><p>Will be mandatory in wrappers 
