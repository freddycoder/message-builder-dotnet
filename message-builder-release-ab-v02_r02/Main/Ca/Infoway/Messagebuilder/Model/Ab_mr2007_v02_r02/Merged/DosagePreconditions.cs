...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Merged {
     ...
     * to apply.</p> <p>Allows recommended dosage instructions to 
     * be bound to a particular characteristic of the patient.</p> 
     * COCT_MT260030CA.ObservationEventCriterion: Dosage 
     * Preconditions <p>A condition that must be true for the 
     * patient in order for the specified recommended dosage range 
     * to apply.</p> <p>Allows recommended dosage instructions to 
     * be bound to a particular characteristic of the patient.</p> 
     ...
     * to apply.</p> <p>Allows recommended dosage instructions to 
     * be bound to a particular characteristic of the patient.</p> 
     * COCT_MT260020CA.ObservationEventCriterion: Dosage 
     * Preconditions <p>A condition that must be true for the 
     * patient in order for the specified recommended dosage range 
     * to apply.</p> <p>Allows recommended dosage instructions to 
     * be bound to a particular characteristic of the patient.</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT260010CA.ObservationEventCriterion","COCT_MT260020CA.ObservationEventCriterion","COCT_MT260030CA.ObservationEventCriterion","PORX_MT980010CA.ObservationEventCriterion","PORX_MT980020CA.ObservationEventCriterion","PORX_MT980030CA.ObservationEventCriterion"})]
