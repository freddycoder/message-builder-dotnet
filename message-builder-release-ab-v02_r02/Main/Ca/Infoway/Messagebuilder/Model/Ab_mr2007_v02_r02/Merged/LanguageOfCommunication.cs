...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Merged {
     ...
     * provider for the purposes of communication</p>
     */
    ...
    public class LanguageOfCommunication : MessagePartBean {
         ...
         * the language of communication</p> <p>Required attribute 
         * conveying the expected language message elements are to be 
         * transmitted in</p> Un-merged Business Name: 
         * LanguageOfCommunicationCode Relationship: 
         ...
         * healthcare provider's ability to communicate in the 
         ...
         * language</p> Un-merged Business Name: 
         * LanguageOfCommunicationSkillsCode Relationship: 
         ...
         * Conformance/Cardinality: REQUIRED (0-1) <p>Indicates the 
         * proficiency level at which healthcare provider is able to 
         * communicate in the indicated language of communication</p> 
         * <p>Required attribute provides additional information about 
         * the healthcare provider's communication skills in a given 
         * language</p> Un-merged Business Name: 
         * LanguageOfCommunicationProficiencyLevelCode Relationship: 
