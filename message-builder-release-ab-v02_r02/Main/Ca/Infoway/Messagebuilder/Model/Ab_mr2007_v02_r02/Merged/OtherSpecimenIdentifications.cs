...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Merged {
    ...
    public class OtherSpecimenIdentifications : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Associated 
         * specimen identifiers.</p> <p>For referral and redirected 
         * orders, this information helps keep track of the different 
         * id's assigned during each phase of processing.</p> Un-merged 
         * Business Name: ClientHealthcareIdentificationNumber 
         * Relationship: PRPA_MT101003CA.IdentifiedEntity.id 
         * Conformance/Cardinality: MANDATORY (1) <p>This 
         ...
         * of other specimen identifier (referral, primary, etc.)</p> 
         ...
         * POPULATED (1-10) <p>Name(s) for the Client</p> <p>Populated 
         ...
         * Male (M), Female (F) or Unknown (U)</p> <p>Populated 
         * attribute supports the identification of the client</p></remarks>
         */
