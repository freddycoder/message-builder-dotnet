...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Merged {
     ...
     * the message.</p> MCCI_MT002300CA.AcknowledgementDetail: 
     * Errors or Warnings <p>An error, warning or information 
     * message associated with the message being acknowledged.</p> 
     * <p>Allows identification issues related to the parsing and 
     * low-level processing of the message.</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"MCCI_MT000300CA.AcknowledgementDetail","MCCI_MT002200CA.AcknowledgementDetail","MCCI_MT002300CA.AcknowledgementDetail"})]
