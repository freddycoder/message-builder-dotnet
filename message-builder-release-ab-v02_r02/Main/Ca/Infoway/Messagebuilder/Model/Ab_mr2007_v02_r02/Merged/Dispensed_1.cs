...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Merged {
     ...
     * populated because it may be masked.</p> 
     * PORX_MT980010CA.Product: *a:dispensed <p>Indicates the drug 
     * that was dispensed</p> <p>Important information for issue 
     * management.</p><p>The association is marked as populated 
     * because it may be masked.</p> <p>Important information for 
     * issue management.</p><p>The association is marked as 
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT260010CA.Product","COCT_MT260020CA.Product","PORX_MT980010CA.Product","PORX_MT980020CA.Product"})]
    public class Dispensed_1 : MessagePartBean {

        private Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Sessionmgmt.Coct_mt220200ca.DrugProduct medication;
         ...
         * COCT_MT260020CA.Product.medication Conformance/Cardinality: 
         * POPULATED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: COCT_MT260010CA.Product.medication 
         * Conformance/Cardinality: POPULATED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
        ...
        public Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Sessionmgmt.Coct_mt220200ca.DrugProduct Medication {
