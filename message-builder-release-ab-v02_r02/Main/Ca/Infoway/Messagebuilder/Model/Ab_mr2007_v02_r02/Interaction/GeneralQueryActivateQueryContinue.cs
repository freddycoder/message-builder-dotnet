...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Interaction {
    ...
    /**
     * <summary>Business Name: QUQI_IN000003CA: General Query 
     * Activate Query Continue</summary>
     * 
     * <remarks>Message: MCCI_MT000100CA.Message Control Act: 
     * QUQI_MT000001CA.ControlActEvent</remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"QUQI_IN000003CA"})]
    public class GeneralQueryActivateQueryContinue : HL7Message<Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Merged.TriggerEvent>, IInteraction {


        public GeneralQueryActivateQueryContinue() {
        }
    }
