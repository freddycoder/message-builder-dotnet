...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Pharmacy.Merged {
    ...
    public class GroupedWithin : MessagePartBean {
         ...
         * 
         * <remarks>Drug Code <p>A code that uniquely identifiers a 
         * drug within a specific drug identification scheme.</p> 
         ...
         * (e.g. generic drug, generic formulation).</p><p>This 
         * attribute is marked as &quot;populated&quot; as drug code 
         * should be available in most cases.</p> Drug Code <p>An 
         * identifier for a drug at a higher level of abstraction.</p> 
         * <p>Used to uniquely identify a particular drug product when 
         * prescribing/dispensing at a higher level of abstraction 
         * (e.g. generic drug, generic formulation).</p><p>This 
