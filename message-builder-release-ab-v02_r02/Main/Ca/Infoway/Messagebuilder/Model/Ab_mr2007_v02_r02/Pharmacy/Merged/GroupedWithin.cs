...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Pharmacy.Merged {
    ...
    public class GroupedWithin : MessagePartBean {
         ...
         * denoting a specific level in the hierarchical definition of 
         * drugs.</p> <p>Describes the relationship between two levels 
         * of drug products (e.g. Drug A is the generic for Drug B)</p> 
         * Un-merged Business Name: DrugCategoryCode Relationship: 
         * POME_MT010100CA.SpecializedKind.code 
         * Conformance/Cardinality: REQUIRED (0-1) <p>A coded value 
         * denoting a specific level in the hierarchical definition of 
         * drugs.</p> <p>Describes the relationship between two levels 
         * of drug products (e.g. Drug A is the generic for Drug B)</p></remarks>
         */
         ...
         * POPULATED (1) <p>A code that uniquely identifiers a drug 
         * within a specific drug identification scheme.</p> <p>Used to 
         ...
         * should be available in most cases.</p> <p>Used to uniquely 
         * identify a particular drug product when 
         * prescribing/dispensing at a higher level of abstraction 
         * (e.g. generic drug, generic formulation).</p><p>This 
         * attribute is marked as &quot;populated&quot; as drug code 
         * should be available in most cases.</p> Un-merged Business 
         * Name: DrugCode Relationship: 
         * POME_MT010100CA.MedicineClass.code Conformance/Cardinality: 
         * POPULATED (1) <p>An identifier for a drug at a higher level 
         * of abstraction.</p> <p>Used to uniquely identify a 
         ...
         * POPULATED (1) <p>The name assigned to a drug within a 
         * specific drug identification scheme.</p> <p>To display in 
         * dropdowns and for local searching.</p><p>This attribute is 
         * marked as &quot;populated&quot; as a drug name should be 
         * available in most cases.</p> <p>To display in dropdowns and 
         * for local searching.</p><p>This attribute is marked as 
         * &quot;populated&quot; as a drug name should be available in 
         * most cases.</p> Un-merged Business Name: DrugName 
         * Relationship: POME_MT010100CA.MedicineClass.name 
         * Conformance/Cardinality: POPULATED (1) <p>The name assigned 
         * to the drug at the higher level of abstraction.</p> <p>To 
         * display in dropdowns and for local searching.</p><p>This 
         * attribute is marked as &quot;populated&quot; as drug name 
