...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Pharmacy.Merged {
    ...
    public class Monographs : MessagePartBean {
         ...
         * 'mandatory', as it is always available.</p></remarks>
         */
         ...
         * type.</p> Un-merged Business Name: MedicationDocumentType 
         ...
         * Indication Protocol, etc</p> <p>Allows medication document 
         * types to be distinguished for display, printing, etc. Code 
         * is mandatory because an application can't know what to do 
         * with a medication document without knowing its type.</p></remarks>
         */
         ...
         * document was superseded.</p> <p>Indicates currency of 
         * information or when monograph no longer applies. Different 
         * systems may update their monographs at different times, and 
         * it is important to know what version contains the most 
         * current information</p><p>Monograph effective and/or expiry 
         * date should be available in most situations and is 
         * clinically relevant; thus attribute is marked as 
         * 'populated'.</p> <p>Indicates currency of information or 
         * when monograph no longer applies. Different systems may 
         * update their monographs at different times, and it is 
         * important to know what version contains the most current 
         * information</p><p>Monograph effective and/or expiry date 
         * should be available in most situations and is clinically 
