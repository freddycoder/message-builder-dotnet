...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Pharmacy.Merged {
    ...
    public class SupplementalFillInformation : MessagePartBean {
         ...
         * prescriber to specify the number of fills authorized by this 
         * prescription.</p> <p>A prescription can authorize multiple 
         * fills.</p> Un-merged Business Name: NumberOfFills 
         * Relationship: 
         ...
         * quantity for each fill.</p> <p>The prescription is usually 
         * authorized for a specific quantity for each fill.</p> 
         * Un-merged Business Name: FillQuantity Relationship: 
         * PORX_MT060040CA.SupplementalFillInformation.quantity 
         * Conformance/Cardinality: REQUIRED (0-1) <p>Specifies the 
         * quantity for each fill.</p> <p>The prescription is usually 
         * authorized for a specific quantity for each fill.</p></remarks>
         */
