...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Common.Merged {
     ...
     * Parameter <p>Class which describes the query specifics and 
     * parameter list.</p></remarks>
     */
    ...
    public class QueryByParameter<PL> : MessagePartBean {
        ...
        private IList<Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Common.Merged.SortControl> sortControl;
        ...
        public QueryByParameter() {
            ...
            this.sortControl = new List<Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Common.Merged.SortControl>();
        }
        /**
         ...
         * Conformance/Cardinality: REQUIRED (0-1) <p>This allows the 
         ...
         * a response to a query request.</p> Un-merged Business Name: 
         ...
         * message containing multiple payloads, or a stream of 
         * response messages (notifications) each identifying itself as 
         * a response to a query request.</p> <p>R=Real Time</p> 
         ...
         * request.</p> Un-merged Business Name: 
         * ExpeditedQueryIndicator Relationship: 
         ...
         * matching rows. To manage communication bandwidth, a limited 
         * set may initially be returned with further data retrieved by 
         * using query continuations.</p> Un-merged Business Name: 
         ...
         * Conformance/Cardinality: REQUIRED (0-1) <p>Defines the units 
         * associated with the magnitude of the maximum size limit of a 
         * query response that can be accepted by the requesting 
         * application.</p> <p>Needed to quantify the types of records 
         * requested to be returned in the query.</p> Un-merged 
         ...
         * query response that can be accepted by the requesting 
         * application.</p> <p>Needed to quantify the types of records 
         * requested to be returned in the query.</p> <p>RD=Record</p> 
         * Un-merged Business Name: QueryLimitType Relationship: 
        ...
        public IList<Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Common.Merged.SortControl> SortControl {
