...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Common.Merged {
    ...
    public class QueryByParameter<PL> : MessagePartBean {
         ...
         * request.</p> K: Expedited Query Indicator <p>This allows the 
         * sender to indicate to the receiver that this query should 
         * follow an expedited processing flow.</p> <p>Intended to 
         ...
         * a response to a query request.</p> <p>R=Real Time</p> K: 
         * Expedited Query Indicator <p>This allows the sender to 
         * indicate to the receiver that this query should follow an 
         * expedited processing flow.</p> <p>Intended to convey the 
         * requested 'packaging' of query results. This attribute does 
         * not affect which rows are selected by the query, just the 
         * manner in which they are returned. For example, a batch file 
         * containing responses, a response message containing multiple 
         * payloads, or a stream of response messages (notifications) 
         ...
         * J:Query Limit Type <p>Defines the units associated with the 
         * magnitude of the maximum size limit of a query response that 
         * can be accepted by the requesting application.</p> <p>Needed 
         * to quantify the types of records requested to be returned in 
         * the query.</p></remarks>
         */
