...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Common.Merged {
     ...
     * triggering the issue.</p> <p>Allows providers to identify 
     * the offending drugs when determining their management 
     * approach.</p> COCT_MT260020CA.SubstanceAdministration: 
     * Active Medication <p>Indicates an active medication 
     * (prescription or non-prescription medication) that is 
     * recorded in the patient's record and which contributed to 
     * triggering the issue.</p> <p>Allows providers to identify 
     * the implicated drugs when determining their management 
     * approach.</p></remarks>
     */
    ...
    public class ActiveMedication : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Merged.ICausalActs {
         ...
         * approach for the issue</p> A:Active Medication Record Number 
         ...
         * to evaluate &#226;&#128;&#152;duplicate 
         * therapy&#226;&#128;&#153; and similar timing-based 
         * issues.</p></remarks>
         */
         ...
         * E:Active Medication Masking Indicator <p>An indication of 
