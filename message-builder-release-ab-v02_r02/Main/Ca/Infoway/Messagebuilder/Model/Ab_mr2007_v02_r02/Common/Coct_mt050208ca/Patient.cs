...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Common.Coct_mt050208ca {
     ...
     * to support clinical decisions. This information is that 
    ...
    public class Patient : MessagePartBean {
         ...
         * the patient avoiding the need to separately query the client 
         * registry.</p><p>Important for following up with patient but 
         * not always available, and therefore only marked as 
         ...
         * the patient is known to the client registry.</p> <p>ZPA.1 
         ...
         * identification of the patient in the jurisdictional client 
         * registry. However, in some cases the date of birth may not 
         * be known to the client registry</p></remarks>
         */
