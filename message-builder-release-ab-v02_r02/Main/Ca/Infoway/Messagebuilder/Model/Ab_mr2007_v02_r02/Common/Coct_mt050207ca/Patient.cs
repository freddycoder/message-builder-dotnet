...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Common.Coct_mt050207ca {
     ...
     * to support clinical decisions. This is used when the patient 
     * is not known to the client registry but information still 
     * needs to be communicated. E.g. lab or drug reporting to PHS 
     * for an unconscious or otherwise unidentifiable patient.</p>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COCT_MT050207CA.Patient"})]
    public class Patient : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Common.Coct_mt911107ca.IActingPerson, Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Common.Merged.IPatient {
         ...
         * the attribute is only 'populated'.</p></remarks>
         */
         ...
         * and/or e-mail addresses intended as the principal means of 
         * contact for the patient.</p> <p>ZPA1.1 (Use and/or 
         ...
         * etc.) will be conveyed as part of the payload.</p></remarks>
         */
         ...
         * Conformance/Cardinality: POPULATED (1) <p>The name by which 
         * the patient is known.</p> <p>ZPA.1 
