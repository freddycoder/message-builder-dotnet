...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Pr.Prpm_mt306010ca {
    ...
    public class ParameterList : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>The address for 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>The principal 
         * person&#226;&#128;&#153;s gender.</p> <p>Mandatory attribute 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>A real number 
         * value indicating the confidence of the query with regard to 
         * finding the intended target provider i.e. the value would be 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>The principal 
         * person&#226;&#128;&#153;s date of birth.</p> <p>Mandatory 
         * attribute supports the identification of the healthcare 
         * provider</p></remarks>
         */
         ...
         * or not historical records should be included in this query 
         * response</p> <p>Mandatory attribute when queried upon</p></remarks>
         */
         ...
         * PRPM_MT306010CA.ParameterList.responseObject</summary>
         * 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>ASSIGNED or 
         * PROV</p> <p>Indicates Role Class being queried upon</p> 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Address for the 
         * Service Delivery Location</p> <p>Mandatory attribute when 
         * queried upon</p></remarks>
         */
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>A unique value for 
         * the service delivery location type.</p> <p>Mandatory 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>The telecom for 
         * the provider when playing the role of healthcare 
         * provider.</p> <p>Mandatory attribute supports the 
         * identification of the healthcare provider</p></remarks>
         */
