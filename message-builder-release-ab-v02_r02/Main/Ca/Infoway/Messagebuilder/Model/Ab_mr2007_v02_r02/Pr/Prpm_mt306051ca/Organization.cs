...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Pr.Prpm_mt306051ca {
    ...
    public class Organization : MessagePartBean {
        ...
        private II id;
        private ST name;
        private IList<Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Pr.Prpm_mt306051ca.TerritorialAuthority> territorialAuthority;
         ...
         * is responsible for registering the provider for a specific 
         * healthcare provider role.</p><p>2. Organization associated 
         * with a provider&#226;&#128;&#153;s functional role.</p><p>3. 
         * Organization that grants the qualifications or 
         * expertise.</p> <p>The name of the organization supporting 
