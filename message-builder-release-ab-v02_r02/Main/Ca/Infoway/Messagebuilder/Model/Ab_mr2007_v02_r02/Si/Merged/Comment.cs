...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Si.Merged {
    ...
    using Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Si.Comt_mt300003ca;
    using System;
    ...
    public class Comment : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Si.Comt_mt300003ca.AnnotatedBy author;
         ...
         * annotation unless there's actually content in the note.</p></remarks>
         */
         ...
         * Conformance/Cardinality: OPTIONAL (0-2) <p>Allows a provider 
         * to request restricted access by the patient.</p><p>Valid 
         ...
         * signifying 'Not Masked'.</p> <p>Allows a provider to request 
         ...
         * Masked'.</p> <p>Allows a provider to request restricted 
         ...
         * Restricted').</p><p>The default is 'normal' signifying 'Not 
         * Masked'.</p> <p>Taboo allows the provider to request 
         ...
         * masking.</p> <p>Taboo allows the provider to request 
         * restricted access to patient or their care 
         * giver.</p><p>Constraint: Can&#226;&#128;&#153;t have both 
         * normal and one of the other codes simultaneously.</p><p>The 
         * attribute is optional because not all systems will support 
         ...
         * Conformance/Cardinality: REQUIRED (0-2) <p>Allows a provider 
         * to request restricted access by the patient.</p><p>Valid 
         * values are: 'N' (normal - denotes 'Not Masked'); 'R' 
         * (restricted - denotes 'Masked') and 'T' (taboo - denotes 
         * 'Patient Access Restricted').</p><p>The default is 'normal' 
        ...
        public Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Si.Comt_mt300003ca.AnnotatedBy Author {
         ...
         * MANDATORY (1) <p>The identifier assigned by the central 
         * system (EHR) to the record item being annotated.</p> 
