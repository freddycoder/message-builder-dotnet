...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Si.Merged {
    ...
    public class Comment : MessagePartBean {
        ...
        /**
         * <summary>C:Annotation Text</summary>
         * 
         * <remarks><p>Free text comment to be attached to a 
         ...
         * C:Patient Note Text <p>Free textual description of the 
         * patient note.</p> <p>Allows a provider to attach comments to 
         * a patient as a whole or to the patient's profile (such as 
         ...
         * 
         * <remarks>D:Restricted Patient Access <p>Allows a provider to 
         ...
         * normal and one of the other codes simultaneously.</p><p>The 
         * attribute is optional because not all systems will support 
         * masking.</p> D:Restricted Patient Access <p>Allows a 
         ...
         * 'normal' signifying 'Not Masked'.</p> <p>Allows a provider 
