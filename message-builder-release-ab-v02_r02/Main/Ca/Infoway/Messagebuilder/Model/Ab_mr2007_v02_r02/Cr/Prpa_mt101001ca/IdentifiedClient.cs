...
namespace Ca.Infoway.Messagebuilder.Model.Ab_mr2007_v02_r02.Cr.Prpa_mt101001ca {
    ...
    public class IdentifiedClient : MessagePartBean {
         ...
         * Conformance/Cardinality: POPULATED (1-40) <p>This 
         ...
         * controls the disclosure of information about this client 
         * record.</p> <p>Populated attribute supports the business 
         ...
         * only present if deceasedInd is = TRUE</p> <p>The date and 
         * time that a client's death occurred</p> <p>Required 
