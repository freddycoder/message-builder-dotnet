...
namespace Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Caabtranscribedreports {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"CAABTranscribedReports.AssignedAuthorPerson"})]
    public class AssignedAuthorPerson : MessagePartBean {
         ...
         * CAABTranscribedReports.AssignedAuthorPerson.realmCode</summary>
         * 
