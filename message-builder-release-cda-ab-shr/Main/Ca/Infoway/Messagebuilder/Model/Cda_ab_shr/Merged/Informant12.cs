...
namespace Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Merged {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"BaseModel.Informant12","CAABTranscribedReports.Informant12"})]
    public class Informant12 : MessagePartBean {

        private LIST<CS_R2<Code>, CodedTypeR2<Code>> realmCode;
        private II typeId;
        private LIST<II, Identifier> templateId;
        private Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Basemodel.IInformant12Choice informant12Choice;
         ...
         * CAABTranscribedReports.Informant12.realmCode 
         ...
         * Name: (no business name specified) Relationship: 
         * CAABTranscribedReports.Informant12.typeId 
         ...
         * Conformance/Cardinality: OPTIONAL (0-*) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * CAABTranscribedReports.Informant12.templateId 
         * Conformance/Cardinality: OPTIONAL (0-*)</remarks>
         */
         ...
         * Name: (no business name specified) Relationship: 
         * CAABTranscribedReports.Informant12.informant12Choice 
         * Conformance/Cardinality: MANDATORY (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"informant12Choice"})]
        public Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Basemodel.IInformant12Choice Informant12Choice {
