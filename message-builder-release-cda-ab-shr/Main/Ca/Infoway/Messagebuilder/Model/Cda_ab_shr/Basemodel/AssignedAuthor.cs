...
namespace Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Basemodel {
    ...
    public class AssignedAuthor : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Merged.IAssignedAuthorChoice assignedAuthorChoice;
        ...
        public Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Merged.IAssignedAuthorChoice AssignedAuthorChoice {
            get { return this.assignedAuthorChoice; }
            set { this.assignedAuthorChoice = value; }
        }

        public Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Basemodel.Person AssignedAuthorChoiceAsAssignedPerson {
            get { return this.assignedAuthorChoice is Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Basemodel.Person ? (Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Basemodel.Person) this.assignedAuthorChoice : (Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Basemodel.Person) null; }
        }
        public bool HasAssignedAuthorChoiceAsAssignedPerson() {
            return (this.assignedAuthorChoice is Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Basemodel.Person);
        }

        public Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Merged.AuthoringDevice AssignedAuthorChoiceAsAssignedAuthoringDevice {
            get { return this.assignedAuthorChoice is Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Merged.AuthoringDevice ? (Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Merged.AuthoringDevice) this.assignedAuthorChoice : (Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Merged.AuthoringDevice) null; }
        }
        public bool HasAssignedAuthorChoiceAsAssignedAuthoringDevice() {
            return (this.assignedAuthorChoice is Ca.Infoway.Messagebuilder.Model.Cda_ab_shr.Merged.AuthoringDevice);
        }
