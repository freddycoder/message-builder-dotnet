 ...
 *****************************************************************************
 *
 *	File Name:	ElementMapAttribute.cs
 *
 *	Facility:	.NET SimpleXml library
 *
 *	Purpose:	This module implements ElementMapAttribute, which marks a
 *              field as being a key based list of XML elements.
 *              
 *              This is the equivalent of SimpleXml's @ElementMap
 *              
...
namespace Platform.SimpleXml
{
    ...
    public class ElementMapAttribute : BaseAttribute
    {
        /// <summary>
        /// Actual entry name. Can be null, in which case the name will be extracted
        /// from the value type (class name, or name specified by its [Root] attribute).
        /// </summary>
        private String  name;

        /// <summary>
        /// Name of entry (can be null in which case the name "entry" will be used)
        /// </summary>
        ...
        /// <summary>
        /// Whether the key is an attribute. Note that this is currently ignored by the
        /// serialization, and assumed to be true.
        /// </summary>
        private bool    keyAttribute;
