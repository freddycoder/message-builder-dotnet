 ...
 *****************************************************************************
 *
 *	File Name:	ObjectTreeXmlReader.cs
 *
 *	Facility:	.NET SimpleXml library
 *
 *	Purpose:	This module implements ObjectTreeXmlReader class, which is
 *	            responsible for the logic to read an object graph from an
 *	            XML file/stream.
 *              
