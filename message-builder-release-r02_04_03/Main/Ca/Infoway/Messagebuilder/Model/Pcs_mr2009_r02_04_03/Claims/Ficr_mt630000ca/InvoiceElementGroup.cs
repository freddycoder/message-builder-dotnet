...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_03.Claims.Ficr_mt630000ca {
    ...
    public class InvoiceElementGroup : MessagePartBean {
         ...
         * centre and sequence numbers</p><p>1. unique invoice group 
         ...
         * identifier 1. and 2.).</p> <p>May include data centre and 
         * sequence numbers</p><p>1. unique invoice group identifier, 
         ...
         * with all identifiers (i.e. identifier 1. and 2.).</p> <p>May 
         * include data centre and sequence numbers</p><p>1. unique 
         ...
         * to indicate the type of Invoice Grouping.</p><p>Each Invoice 
         * Type is used to specify 1. vocabulary, 2. structure of the 
