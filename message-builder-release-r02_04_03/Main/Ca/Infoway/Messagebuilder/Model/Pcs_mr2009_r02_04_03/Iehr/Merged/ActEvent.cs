...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_03.Iehr.Merged {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"REPC_MT230001CA.ActEvent","REPC_MT230002CA.ActEvent","REPC_MT230003CA.ActEvent","REPC_MT500001CA.ActEvent","REPC_MT500002CA.ActEvent","REPC_MT500004CA.ActEvent"})]
    public class ActEvent : MessagePartBean {
         ...
         * created</p> Un-merged Business Name: ReportedOnServiceLink 
         * Relationship: REPC_MT230002CA.ActEvent.id 
         * Conformance/Cardinality: MANDATORY (1) <p>Provides a direct 
         * link for drill-down to the discrete record of the procedure 
         * or observation being reported on.</p> <p>A unique identifier 
         * assigned to the discrete record associated with the 
         * procedure or observation being reported upon.</p> Un-merged 
