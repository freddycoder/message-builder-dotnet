...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_03.Immunization.Merged {
     ...
     * asserted antigen count.</p> POIZ_MT061150CA.AntigenCount: 
     ...
     * POIZ_MT030060CA.AntigenCount: Antigen Count <p>Allows for an 
     * immunization registry to communicate the current antigen 
     * count value.</p> <p>Represents the asserted antigen 
     * count.</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"POIZ_MT030050CA.AntigenCount","POIZ_MT030060CA.AntigenCount","POIZ_MT060150CA.AntigenCount","POIZ_MT061150CA.AntigenCount"})]
    public class AntigenCount : MessagePartBean {
         ...
         * count value.</p> <p>Represents the asserted antigen 
         * count.</p> Un-merged Business Name: AntigenCountValue 
         * Relationship: POIZ_MT061150CA.AntigenCount.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows for an 
         * immunization registry to communicate the current antigen 
         * count value.</p> <p>Represents the asserted antigen 
         * count.</p> Un-merged Business Name: AntigenCountValue 
