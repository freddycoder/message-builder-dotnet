...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_03.Pharmacy.Merged {
    ...
    public class AssignedEntity3 : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Helps the receiver 
         * evaluate the supplied information.</p> <p>The name of the 
         * organization responsible for creating the medication 
         * document.</p> Un-merged Business Name: FormularyOwnerName 
         * Relationship: POME_MT010040CA.Organization3.name 
         * Conformance/Cardinality: MANDATORY (1) <p>Helps identify the 
         * circumstances in which the formulary applies.</p> <p>The 
         * name of the organization or facility responsible for the 
         * formulary.</p> Un-merged Business Name: 
