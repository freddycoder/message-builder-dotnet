...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_03.Common.Merged {
     ...
     * QUQI_MT020000CA.AuthorRole: Null Author Role <p>This is a 
     ...
     * MCAI_MT700230CA.AuthorRole: Null Author Role <p>This is a 
     * messaging artifact used by HL7 to allow the time, signiture 
     * and method to be captured when the author is not sent. This 
     * will happen in circumstances where the author information is 
     * sent as part of the authentication token.</p> 
     ...
     * will happen in circumstances where the author information is 
     * sent as part of the authentication token.</p> 
     * MCAI_MT700231CA.AuthorRole: Null Author Role <p>This is a 
     * messaging artifact used by HL7 to allow the time, signiture 
     * and method to be captured when the author is not sent. This 
     * will happen in circumstances where the author information is 
     * sent as part of the authentication token.</p> 
     ...
     * will happen in circumstances where the author information is 
     * sent as part of the authentication token.</p> 
     * MCAI_MT700232CA.AuthorRole: Null Author Role <p>This is a 
     * messaging artifact used by HL7 to allow the time, signiture 
     * and method to be captured when the author is not sent. This 
     * will happen in circumstances where the author information is 
     * sent as part of the authentication token.</p> 
     ...
     * will happen in circumstances where the author information is 
     * sent as part of the authentication token.</p> 
     * MCAI_MT700222CA.AuthorRole: Null Author Role <p>This is a 
     * messaging artifact used by HL7 to allow the time, signiture 
     * and method to be captured when the author is not sent. This 
     * will happen in circumstances where the author information is 
     * sent as part of the authentication token.</p> 
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"MCAI_MT700210CA.AuthorRole","MCAI_MT700211CA.AuthorRole","MCAI_MT700212CA.AuthorRole","MCAI_MT700220CA.AuthorRole","MCAI_MT700221CA.AuthorRole","MCAI_MT700222CA.AuthorRole","MCAI_MT700230CA.AuthorRole","MCAI_MT700231CA.AuthorRole","MCAI_MT700232CA.AuthorRole","MFMI_MT700711CA.AuthorRole","MFMI_MT700751CA.AuthorRole","QUQI_MT020000CA.AuthorRole","QUQI_MT020002CA.AuthorRole"})]
    public class NullAuthorRole : MessagePartBean, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_03.Common.Merged.IAuthorPerson_1, Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_03.Common.Merged.IAuthorPerson_2 {
