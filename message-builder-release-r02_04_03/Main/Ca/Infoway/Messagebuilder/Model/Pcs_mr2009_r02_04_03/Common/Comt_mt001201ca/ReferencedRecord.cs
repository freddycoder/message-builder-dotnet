...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_03.Common.Comt_mt001201ca {
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"COMT_MT001201CA.Role"})]
    public class ReferencedRecord : MessagePartBean {
         ...
         * 
         * <remarks>Relationship: COMT_MT001201CA.Role.id 
         * Conformance/Cardinality: MANDATORY (1-2) <p>Allows the role 
         * record to be uniquely referenced and is therefore 
         * mandatory.</p> <p>The identifier assigned by the registry to 
         * the role record being referred to</p></remarks>
         */
