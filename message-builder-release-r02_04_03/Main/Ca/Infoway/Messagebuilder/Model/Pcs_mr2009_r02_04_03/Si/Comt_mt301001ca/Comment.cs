...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_04_03.Si.Comt_mt301001ca {
    ...
    public class Comment : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Allows the record 
         * to be uniquely referenced and is therefore mandatory.</p> 
         * <p>The identifier assigned by the central system (EHR) to 
         * the record item being annotated.</p></remarks>
         */
