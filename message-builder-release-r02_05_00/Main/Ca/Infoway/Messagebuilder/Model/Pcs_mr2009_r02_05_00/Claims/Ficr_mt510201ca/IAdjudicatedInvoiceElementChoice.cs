...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Claims.Ficr_mt510201ca {
    ...
    public interface IAdjudicatedInvoiceElementChoice {
        ...
        Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Claims.Merged.Allowable Reference1Allowable {
            get;
            set;
        }

        [Hl7XmlMappingAttribute(new string[] {"outcomeOf/adjudicationResult"})]
        Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Claims.Ficr_mt510201ca.AdjudicationResult OutcomeOfAdjudicationResult {
            get;
            set;
        }
