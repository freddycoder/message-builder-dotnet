...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Iehr.Merged {
    ...
    public class DischargeDiagnoses : MessagePartBean {
         ...
         * attribute.</p> Un-merged Business Name: 
         * DischargeDiagnosisType Relationship: 
         * REPC_MT220001CA.ConditionEvent.code Conformance/Cardinality: 
         * MANDATORY (1) <p>Denotes assertion of diagnosis. The 
         * diagnosis is conveyed in the value attribute.</p> Un-merged 
         * Business Name: DischargeDiagnosisType Relationship: 
         * REPC_MT220003CA.ConditionEvent.code Conformance/Cardinality: 
         * MANDATORY (1) <p>Denotes assertion of diagnosis. The 
         * diagnosis is conveyed in the value attribute.</p></remarks>
         */
         ...
         * into the result of the care provision.</p> <p>Conformance 
         * (Optional) under review.</p> <p>Identifies the actual 
         * discharge diagnosis.</p> Un-merged Business Name: 
         * DiagnosisCode Relationship: 
         * REPC_MT220001CA.ConditionEvent.value 
         * Conformance/Cardinality: OPTIONAL (0-1) <p>Provides context 
         * into the result of the care provision.</p><p>The attribute 
         * is optional because for systems that support SNOMED, this 
         * concept will be communicated as part of the Discharge 
         * Diagnosis Type</p> <p>Identifies the actual discharge 
         * diagnosis.</p> Un-merged Business Name: DiagnosisCode 
         * Relationship: REPC_MT220003CA.ConditionEvent.value 
         * Conformance/Cardinality: OPTIONAL (0-1) <p>Provides context 
         * into the result of the care provision.</p> <p>Conformance 
         * (Optional) under review.</p> <p>Identifies the actual 
