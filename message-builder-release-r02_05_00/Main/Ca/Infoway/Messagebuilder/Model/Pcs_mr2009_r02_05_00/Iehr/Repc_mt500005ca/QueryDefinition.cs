...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Iehr.Repc_mt500005ca {
     ...
     */
    [Hl7PartTypeMappingAttribute(new string[] {"REPC_MT500005CA.ParameterList"})]
    public class QueryDefinition : MessagePartBean {
         ...
         * REPC_MT500005CA.AmendedSinceDateTime.value 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT500005CA.CareCompositionId.value 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT500005CA.CareCompositionType.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: REPC_MT500005CA.EHRRepositoryId.value 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT500005CA.EffectiveTimeRange.value 
         ...
         * 
         * <remarks>Relationship: REPC_MT500005CA.EventLocationId.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT500005CA.EventLocationType.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: REPC_MT500005CA.HealthCondition.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: REPC_MT500005CA.Indication.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT500005CA.MostRecentByTypeIndicator.value 
         ...
         * 
         * <remarks>Relationship: REPC_MT500005CA.ProtocolId.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: REPC_MT500005CA.RecordStatus.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows 
         ...
         * 
         * <remarks>Relationship: REPC_MT500005CA.RecordType.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows 
         ...
         * placed on the types to be returned.</p><p> <i>Query results 
         * should include those with an match of this code, as well 
         * those matching any specializations of the coded 
         * parameter.</i> </p></remarks>
         */
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT500005CA.RequestingProviderId.value 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT500005CA.ResponsibleProviderId.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
         ...
         * 
         * <remarks>Relationship: 
         * REPC_MT500005CA.ResponsibleProviderType.value 
         * Conformance/Cardinality: MANDATORY (1) <p>Allows retrieving 
