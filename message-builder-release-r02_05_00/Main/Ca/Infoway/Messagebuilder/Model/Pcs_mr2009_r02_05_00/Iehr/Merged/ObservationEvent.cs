...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Iehr.Merged {
    ...
    public class ObservationEvent : MessagePartBean {
         ...
         * allergy. The attribute is CWE because not all possible types 
         * of reactions are expressible by coded values.</p> 
         * <p>Conformance (Optional) under review.</p> <p>Specifies the 
         * kind of reaction, as experienced by the patient.</p></remarks>
         */
