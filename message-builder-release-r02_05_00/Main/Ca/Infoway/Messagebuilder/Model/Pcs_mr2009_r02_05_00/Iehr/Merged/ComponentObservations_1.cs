...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Iehr.Merged {
     ...
     * a more complex observation, such as blood pressure.</p> 
     * REPC_MT410003CA.SubObservationEvent: Component Observations 
     * <p>Not all observations can be expressed as a single code or 
     * code and value.</p> <p>Captures components of a more complex 
     * observation, such as apgar or blood pressure.</p></remarks>
     */
    ...
    public class ComponentObservations_1 : MessagePartBean {
         ...
         * Relationship: REPC_MT410001CA.SubObservationEvent.code 
         ...
         * pressure.</p> Un-merged Business Name: 
         * ComponentObservationType Relationship: 
         * REPC_MT410003CA.SubObservationEvent.code 
         * Conformance/Cardinality: MANDATORY (1) <p>Distinguishes 
         * between multiple types of sub-observations that together 
         * make a single Observation.</p><p>Code is mandatory to ensure 
         * that sub-observations are distinguishable.</p><p> <i>This 
        ...
        public SimpleMeasurableClinicalObservationComponentType Code {
            get { return (SimpleMeasurableClinicalObservationComponentType) this.code.Value; }
         ...
         * Relationship: REPC_MT410001CA.SubObservationEvent.value 
         * Conformance/Cardinality: MANDATORY (1) <p>PHS 07-feb-02. 
         * Some appropriate vocab concept is needed for 
         ...
         * Relationship: REPC_MT410003CA.SubObservationEvent.value 
         * Conformance/Cardinality: MANDATORY (1) <p>PHS 07-feb-02. 
         * Some appropriate vocab concept is needed for 
         * observation.code, to pair with EPHS mappings.</p> <p>Conveys 
         * the clinical information resulting from the sub-observation 
         ...
         * needed for CAUSE OF DEATH;VACCINE</p> <p>Indicates what was 
         * actually observed when the sub-observation was 
         * made.</p><p>E.g. 120 mmHg for systolic blood pressure.</p></remarks>
         */
