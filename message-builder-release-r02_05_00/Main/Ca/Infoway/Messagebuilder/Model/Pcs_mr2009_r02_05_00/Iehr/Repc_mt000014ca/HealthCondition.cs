...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Iehr.Repc_mt000014ca {
    ...
    public class HealthCondition : MessagePartBean {
         ...
         * Conformance/Cardinality: MANDATORY (1-2) <p>Allows for 
         ...
         * therefore the attribute is mandatory.</p><p>This element 
         * makes use of the CD datatype because some terminologies used 
         * for the domain require use of modifiers.</p><p>The element 
         * uses CWE to allow for the capture of Condition concepts not 
         ...
         * categorizing.</p> <p>A code indicating the specific 
         * condition. E.g. Hypertension, Pregnancy.</p></remarks>
         */
