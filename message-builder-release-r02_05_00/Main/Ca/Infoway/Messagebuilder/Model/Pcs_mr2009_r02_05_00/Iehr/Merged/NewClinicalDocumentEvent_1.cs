...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Iehr.Merged {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"REPC_MT210002CA.NewClinicalDocumentEvent","REPC_MT230002CA.NewClinicalDocumentEvent","REPC_MT230003CA.NewClinicalDocumentEvent"})]
    public class NewClinicalDocumentEvent_1 : MessagePartBean {

        private II id;

        public NewClinicalDocumentEvent_1() {
            this.id = new IIImpl();
        }
        /**
         ...
         * Observation Document.</p> <p>Used to identify the record 
         * that supersedes the current record. This attribute is set 
         * when a new record identifies the current record as being 
         * replaced.</p> Un-merged Business Name: ReplacedByRecordId 
         * Relationship: REPC_MT230002CA.NewClinicalDocumentEvent.id 
         * Conformance/Cardinality: MANDATORY (1) <p>Used in 
         * circumstances where a newer or corrected version of the 
         * record of this event exists. May also be used when there is 
         * a newer &quot;version&quot; of the type of the Clinical 
