...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Iehr.Merged {
    ...
    [Hl7PartTypeMappingAttribute(new string[] {"REPC_MT210001CA.PatientCareProvisionEvent2","REPC_MT210002CA.PatientCareProvisionEvent2","REPC_MT210003CA.PatientCareProvisionEvent2"})]
    public class PatientCareProvisionEvent2 : MessagePartBean {

        private II id;

        public PatientCareProvisionEvent2() {
            this.id = new IIImpl();
        }
        /**
         * <summary>Business Name: ReferralReportLink</summary>
         * 
         * <remarks>Un-merged Business Name: ReferralReportLink 
