...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Merged {
    ...
    public class HealthcareWorker : MessagePartBean {
        ...
        private II id;
        private CV code;
        private PN assignedProviderName;
        ...
        public HealthcareWorker() {
            ...
            this.assignedProviderName = new PNImpl();
         ...
         * REQUIRED (1) <p>Allows unique identification of the person 
        ...
        public PersonName AssignedProviderName {
            get { return this.assignedProviderName.Value; }
            set { this.assignedProviderName.Value = value; }
        }
