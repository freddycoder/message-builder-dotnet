...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Merged {
    ...
    /**
     * <summary>REPC_MT210003CA.Location3: v:referred to</summary>
     * 
     * <p>If the referral was targeted to a service delivery 
     * location then the identity of the location must be 
     * known.</p> <p>Indicates the service Delivery Location where 
     * the referral service is targeted to be preformed.</p><p>The 
     * target site of the referral service provides context for 
     * interpreting the record. In some cases, it may also provide 
     * follow-up information</p> REPC_MT220001CA.Location2: 
     ...
     * information</p> REPC_MT230001CA.Location: i:occurred at 
     ...
     * record. In some cases, it may also provide follow-up 
     * information</p> REPC_MT500003CA.Location: h:occurred at 
     ...
     * used.</p> REPC_MT500002CA.Location: h:occurred at <p>Must 
     * not be specified when Care Composition Type is 
     * 'Condition-based'</p> <p> <i>The site of the actual event 
     * provides context for interpreting the record. In some cases, 
     * it may also provide follow-up information</i> 
     * </p><p>Multiple repetitions are allowed for telehealth and 
     ...
     * where number of locations involved is greater than the limit 
     * supported by the message, multiple encounters should be 
     * used.</p> REPC_MT500004CA.Location: h:occurred at <p>Must 
     * not be specified when Care Composition Type is 
     * 'Condition-based'</p> <p> <i>The site of the actual event 
     * provides context for interpreting the record. In some cases, 
     * it may also provide follow-up information</i> 
     ...
     * where number of locations involved is greater than the limit 
     * supported by the message, multiple encounters should be 
     * used.</p> REPC_MT420003CA.Location: *g:occurred at' <p> 
     * <i>The site of the actual event provides context for 
     * interpreting the record. In some cases, it may also provide 
     * follow-up information</i> </p> <p> <i>This identifies the 
     * location where the Coded Observation actually occurred. E.g. 
     * Patient's residence, clinic, work site, etc. It only needs 
     * to be specified when the occurrence location differs from 
     * the official record location.</i> </p> 
     * REPC_MT220001CA.Destination: i:occurred at <p>The site of 
     * the actual event provides context for interpreting the 
     * record. In some cases, it may also provide follow-up 
     * information</p> <p>This identifies the location where the 
     * actual discharge/care event occurred. E.g. Patient's 
     * residence, clinic, work site, hospital, etc. It only needs 
     * to be specified when the occurrence location differs from 
     * the official record location.</p><p>The site of the actual 
     * event provides context for interpreting the record. In some 
     * cases, it may alsoprovide follow-up information</p> 
     * REPC_MT610002CA.Location: g:occurred at <p> <i>The site of 
     * the actual event provides context for interpreting the 
     * record. In some cases, it may also provide follow-up 
     * information</i> </p> <p> <i>This identifies the location 
     * where the Professional Service actually occurred. E.g. 
     * Patient's residence, clinic, work site, etc. It only needs 
     * to be specified when the occurrence location differs from 
     * the official record location.</i> </p> 
     * REPC_MT230003CA.Location: i:occurred at <p>The site of the 
     ...
     * performed.</p> REPC_MT610001CA.Location: g:occurred at <p> 
     * <i>The site of the actual event provides context for 
     * interpreting the record. In some cases, it may also provide 
     * follow-up information</i> </p> <p> <i>This identifies the 
     * location where the Professional Service actually occurred. 
     * E.g. Patient's residence, clinic, work site, etc. It only 
     * needs to be specified when the occurrence location differs 
     * from the official record location.</i> </p> 
     * REPC_MT220002CA.Location2: i:occurred at <p>The site of the 
     * actual event provides context for interpreting the record. 
     * In some cases, it may also provide follow-up information</p> 
     ...
     * REPC_MT220003CA.Location2: i:occurred at <p>The site of the 
     * actual event provides context for interpreting the record. 
     * In some cases, it may also provide follow-up information</p> 
     * <p>This identifies the location where the actual 
     * discharge/care event occurred. E.g. Patient's residence, 
     ...
     * provides context for interpreting the record. In some cases, 
     * it may also provide follow-up information</p> 
     * REPC_MT500001CA.Location: h:occurred at <p>Must not be 
    ...
    public class OccurredAt : MessagePartBean {
         ...
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT220001CA.Destination.serviceDeliveryLocation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT230003CA.Location.serviceDeliveryLocation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT610002CA.Location.serviceDeliveryLocation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         ...
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT220003CA.Destination.serviceDeliveryLocation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Coct_mt240007ca.ServiceLocation ServiceDeliveryLocation {
