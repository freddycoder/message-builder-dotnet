...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Merged {
    ...
    public class Diagnosis : MessagePartBean {
         ...
         * MANDATORY (1) <p>Needed to convey the diagnosis information 
         * to be masked, and attribute is therefore mandatory.</p> 
         ...
         * Conformance/Cardinality: MANDATORY (1) <p>Diagnosis Code</p> 
         * Un-merged Business Name: DiagnosisValue Relationship: 
         * COCT_MT490000CA.Diagnosis.value Conformance/Cardinality: 
         * MANDATORY (1) <p>coded Value denoting diagnosis</p> 
         * Un-merged Business Name: Diagnosis Relationship: 
         * COMT_MT400001CA.Diagnosis.value Conformance/Cardinality: 
         * OPTIONAL (0-1) <p>Allows masking of all records 
         * (prescriptions, dispenses, encounters, lab tests, etc.) 
         * associated with the specified diagnosis. This element is 
         * optional because it is not used for SNOMED.</p> <p>The 
         * diagnosis whose associated records should be masked.</p></remarks>
         */
