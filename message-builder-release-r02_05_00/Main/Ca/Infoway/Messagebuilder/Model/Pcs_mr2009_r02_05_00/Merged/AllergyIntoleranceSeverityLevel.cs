...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Merged {
    ...
    public class AllergyIntoleranceSeverityLevel : MessagePartBean {
         ...
         * managed.</p> <p>Indicates the gravity of the allergy, 
         ...
         * must be managed.</p> <p>Indicates the gravity of the 
         * allergy, intolerance or reaction in terms of its actual or 
         * potential impact on the patient.</p> Un-merged Business 
         * Name: SeverityLevel Relationship: 
         ...
         * must be managed.</p> <p>Indicates the gravity of the 
         * allergy, intolerance or reaction in terms of its actual or 
         * potential impact on the patient.</p></remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"value"})]
        public SeverityObservationValue Value {
            get { return (SeverityObservationValue) this.value.Value; }
