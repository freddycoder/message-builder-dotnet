...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Merged {
    ...
    using Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Coct_mt120600ca;
    using System;
     ...
     * REPC_MT000003CA.Subject3: *g:includes <p>Allows for 
     ...
     * created.</p> <p>This indicates comments that providers have 
     * recorded about the Health Condition.</p> 
     ...
     * </p> REPC_MT220001CA.Subject4: *g:includes <p>Allows for 
     * additional free-text comments to be communicated. Such notes 
     * can be added by the provider at the time the record is 
     * created and by any provider at any time after the record is 
     * created.</p> <p>This indicates comments that providers have 
     * recorded about the Discharge-Care Summary.</p> 
     * REPC_MT210002CA.Subject4: *g:includes <p> <i>Allows for 
     * additional free-text comments to be communicated. Such notes 
     * can be added by the provider at the time the record is 
     * created and by any provider at any time after the record is 
     * created.</i> </p> <p> <i>This indicates comments that 
     * providers have recorded about the Referral.</i> </p> 
     * PORX_MT010120CA.Subject4: k:includes <p>Improves 
     ...
     * prescription.</p> PORX_MT060340CA.Subject4: k:includes 
     * <p>Improves communication between providers by allowing a 
     * mechanism to exchange un-coded free-form information.</p> 
     * <p>Indicates the various comments that providers have 
     * recorded about this prescription.</p> 
     * COCT_MT080100CA.Subject1: has notes <p>To capture, 
     * communicate collector's notes.</p> <p>Associates notes or 
     * annotations with the specimen collection procedure event 
     * act.</p> REPC_MT500001CA.Subject2: l:includes <p> <i>Allows 
     * for additional free-text comments to be communicated. Such 
     * notes can be added by the provider at the time the record is 
     * created and by any provider at any time after the record is 
     * created.</i> </p> <p> <i>This indicates comments that 
     * providers have recorded about the Care Composition.</i> </p> 
     * PORX_MT020050CA.Subject7: *c:includes <p>Improves 
     * communication between providers by allowing a mechanism to 
     * exchange un-coded free-form information.</p> <p>Indicates 
     * the various comments that providers have recorded about this 
     * office supply.</p> PORX_MT060340CA.Subject7: k:includes 
     * <p>Improves communication between providers by allowing a 
     * mechanism to exchange un-coded free-form information.</p> 
     * <p>Indicates the various comments that providers have 
     * recorded about this dispense record.</p> 
     * REPC_MT230001CA.Subject4: *g:includes <p> <i>Allows for 
     * additional free-text comments to be communicated. Such notes 
     * can be added by the provider at the time the record is 
     * created and by any provider at any time after the record is 
     * created.</i> </p> <p> <i>This indicates comments that 
     * providers have recorded about the Clinical Observation 
     * Document.</i> </p> REPC_MT000002CA.Subject3: *c:includes 
     * <p>Improves communication between providers by allowing a 
     * mechanism to exchange un-coded free-form information.</p> 
     * <p>Indicates the various comments that providers have 
     ...
     * name) <p>Supports the communication of nurses notes and 
     * other annotations to the immunization record. As a result, 
     * this association is required.</p> <
    ...
    public class Includes : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Coct_mt120600ca.Notes annotation;
         ...
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT000010CA.Subject3.annotation Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: REPC_MT610001CA.Subject2.annotation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT220001CA.Subject4.annotation Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: FICR_MT490102CA.Subject2.annotation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT210002CA.Subject4.annotation Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: PORX_MT010120CA.Subject4.annotation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PORX_MT060340CA.Subject4.annotation Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: COCT_MT080100CA.Subject1.annotation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * FICR_MT490102CA.Subject.annotation Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: REPC_MT500001CA.Subject2.annotation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PORX_MT020050CA.Subject7.annotation Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: PORX_MT060340CA.Subject7.annotation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT230001CA.Subject4.annotation Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: REPC_MT000005CA.Subject4.annotation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT000002CA.Subject3.annotation Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: (no business name 
         * specified) Relationship: FICR_MT400004CA.Subject2.annotation 
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT210001CA.Subject4.annotation Conformance/Cardinality: 
         * REQUIRED (1) Un-merged Business Name: (no business name 
         ...
         * Conformance/Cardinality: REQUIRED (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * REPC_MT230002CA.Subject4.annotation Conformance/Cardinality: 
         * REQUIRED (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"annotation"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Coct_mt120600ca.Notes Annotation {
