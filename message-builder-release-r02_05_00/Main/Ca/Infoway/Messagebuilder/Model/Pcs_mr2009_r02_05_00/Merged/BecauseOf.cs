...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Merged {
    ...
    using Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Coct_mt120402ca;
    using System;
     ...
     * being done for multiple reasons.</p> <p>Identifies the 
     * clinical reason(s) for performing the action described by 
     * the record.</p> REPC_MT410001CA.Reason: *j:because of <p> 
     ...
     * Indications <p>Essential for understanding the context in 
     * which the action was performed. Also frequently used in 
     ...
     * Document is being done for multiple reasons.</p> 
     * <p>Identifies the clinical reason(s) for performing the 
     * action described by the record.</p> PORX_MT060040CA.Reason2: 
     ...
     * the reason(s) for this specific prescription; it must not be 
     * interpreted as a permanent diagnosis.</p> 
     * REPC_MT210002CA.Reason: *m:because of Indications <p> 
     * <i>Essential for understanding the context in which the 
     * action was performed. Also frequently used in searching and 
     * filtering and can impact whether the record will be 
     * automatically masked. Multiple indications are supported for 
     * circumstances where the Referral is being done for multiple 
     * reasons.</i> </p> <p> <i>Identifies the clinical reason(s) 
     * for performing the action described by the record.</i> </p> 
     * REPC_MT420003CA.Reason: *j:because of <p> <i>Essential for 
    ...
    public class BecauseOf : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Coct_mt120402ca.IIndications indications;
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Coct_mt120402ca.IIndications Indications {
