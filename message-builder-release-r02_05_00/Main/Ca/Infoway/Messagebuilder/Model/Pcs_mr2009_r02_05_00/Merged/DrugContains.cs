...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Merged {
    ...
    public class DrugContains : MessagePartBean {
         ...
         * REQUIRED (1) <p>Allows un-ambiguous identification of the 
         ...
         * REQUIRED (1) <p>Used for communication between and display 
         ...
         * Conformance/Cardinality: REQUIRED (1) <p>Used for 
