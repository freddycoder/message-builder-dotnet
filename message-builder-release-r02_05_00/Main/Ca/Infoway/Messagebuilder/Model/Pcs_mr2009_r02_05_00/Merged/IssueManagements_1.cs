...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Merged {
    ...
    public class IssueManagements_1 : MessagePartBean {
        ...
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Pr.Coct_mt090102ca.HealthcareWorker authorAssignedEntity;
        ...
        public ActDetectedIssueManagementType Code {
            get { return (ActDetectedIssueManagementType) this.code.Value; }
         ...
         * ManagementDate Relationship: COCT_MT260010CA.Author1.time 
         * Conformance/Cardinality: REQUIRED (1) 
         * <p>ManagedContraindication.CreationDate</p> <p>Part of the 
         * audit record, but not always available and therefore 
         * 'populated'.</p> <p>The date and time on which the provider 
        ...
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Pr.Coct_mt090102ca.HealthcareWorker AuthorAssignedEntity {
