...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Pharmacy.Merged {
    ...
    public class StatusChanges : MessagePartBean {
         ...
         * 
         * <remarks>Relationship: 
         * PORX_MT060340CA.ControlActEvent.responsibleParty 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PORX_MT060160CA.ControlActEvent.responsibleParty 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PORX_MT060040CA.ControlActEvent.responsibleParty 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PORX_MT060210CA.ControlActEvent.responsibleParty 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PORX_MT060010CA.ControlActEvent.responsibleParty 
         * Conformance/Cardinality: REQUIRED (0-1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * PORX_MT060090CA.ControlActEvent.responsibleParty 
