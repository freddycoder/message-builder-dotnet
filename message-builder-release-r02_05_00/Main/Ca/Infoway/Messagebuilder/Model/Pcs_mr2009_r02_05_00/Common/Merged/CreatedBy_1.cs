...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Merged {
     ...
     * R_ActingPerson CMET must be specified.</p> <p>Critical for 
     * auditing and for validating permissions and therefore 
     * mandatory.</p> <p>Choice of CMET is as follows:</p><p>1. 
     * AuthorRole if AuthorizationToken is specified and 
     * communicates author,</p><p>2. otherwise the R_ActingPerson 
     * CMET must be specified.</p> <p>Indicates the person 
     * responsible for the event that caused this message.</p></remarks>
     */
    [Hl7PartTypeMappingAttribute(new string[] {"MCAI_MT700210CA.Author","MCAI_MT700211CA.Author","MCAI_MT700212CA.Author","MCAI_MT700220CA.Author","QUQI_MT020000CA.Author","QUQI_MT020002CA.Author"})]
    public class CreatedBy_1 : MessagePartBean {

        private TS time;
        private CV modeCode;
        private ED<String> signatureText;
        private Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Merged.IAuthorPerson_1 authorPerson;
         ...
         * Conformance/Cardinality: MANDATORY (1) Un-merged Business 
         * Name: (no business name specified) Relationship: 
         * MCAI_MT700210CA.Author.authorPerson Conformance/Cardinality: 
         * MANDATORY (1)</remarks>
         */
        [Hl7XmlMappingAttribute(new string[] {"authorPerson"})]
        public Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Merged.IAuthorPerson_1 AuthorPerson {
