...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Cr.Prpa_mt101104ca {
    ...
    public class IdentifiedPerson : MessagePartBean {
         ...
         * Data in the EHR may at some point (and in some 
         ...
         * Conformance/Cardinality: REQUIRED (0-1) <p>deceasedTime is 
         * only present when deceasedInd = TRUE</p> <p>Required 
