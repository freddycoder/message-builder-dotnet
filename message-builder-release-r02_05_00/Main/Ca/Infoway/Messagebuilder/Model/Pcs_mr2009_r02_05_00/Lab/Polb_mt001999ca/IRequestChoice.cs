...
namespace Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Lab.Polb_mt001999ca {
    ...
    public interface IRequestChoice : Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Iehr.Comt_mt111111ca.ILab {

        [Hl7XmlMappingAttribute(new string[] {"specimen/specimen"})]
        IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Coct_mt080100ca.SpecimenRole> SpecimenSpecimen {
            get;
        }
        ...
        Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Common.Coct_mt090508ca.HealthcareOrganization PerformerAssignedEntity {
            get;
            set;
        }

        [Hl7XmlMappingAttribute(new string[] {"callBackContact/assignedEntity"})]
        IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Pr.Coct_mt090108ca.HealthcareWorker> CallBackContactAssignedEntity {
            get;
        }
        ...
        Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Lab.Merged.ReferralRedirectIndicator Component1ReferralRedirectIndicator {
            get;
            set;
        }

        [Hl7XmlMappingAttribute(new string[] {"component2/requestSortKey"})]
        Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Lab.Merged.OrderSortKey Component2RequestSortKey {
            get;
            set;
        }

        [Hl7XmlMappingAttribute(new string[] {"component3/labInitiatedOrderIndicator"})]
        Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Lab.Merged.LabInitiatedOrderIndicator Component3LabInitiatedOrderIndicator {
            get;
            set;
        }

        [Hl7XmlMappingAttribute(new string[] {"component4/requestChoice"})]
        IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Lab.Polb_mt001999ca.IRequestChoice> Component4RequestChoice {
            get;
        }

        [Hl7XmlMappingAttribute(new string[] {"fulfillment/resultChoice1"})]
        IList<Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Lab.Polb_mt001999ca.IResultChoice> FulfillmentResultChoice1 {
            get;
        }
        ...
        Ca.Infoway.Messagebuilder.Model.Pcs_mr2009_r02_05_00.Lab.Merged.PriorTestRequest ComponentOfPriorActRequest {
            get;
            set;
        }
